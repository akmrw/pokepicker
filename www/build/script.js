(()=>{var pt=Object.defineProperty;var ee=(n,e)=>()=>(n&&(e=n(n=0)),e);var yt=(n,e)=>()=>(e||n((e={exports:{}}).exports,e),e.exports),Ce=(n,e)=>{for(var t in e)pt(n,t,{get:e[t],enumerable:!0})};var ft,bt,Ue,en,tn,de,pe,vt,wt,Et,ve,Ve,nn,we,Te=ee(()=>{ft=n=>{let e=new Map;e.set("web",{name:"web"});let t=n.CapacitorPlatforms||{currentPlatform:{name:"web"},platforms:e},r=(l,g)=>{t.platforms.set(l,g)},i=l=>{t.platforms.has(l)&&(t.currentPlatform=t.platforms.get(l))};return t.addPlatform=r,t.setPlatform=i,t},bt=n=>n.CapacitorPlatforms=ft(n),Ue=bt(typeof globalThis!="undefined"?globalThis:typeof self!="undefined"?self:typeof window!="undefined"?window:typeof global!="undefined"?global:{}),en=Ue.addPlatform,tn=Ue.setPlatform;(function(n){n.Unimplemented="UNIMPLEMENTED",n.Unavailable="UNAVAILABLE"})(de||(de={}));pe=class extends Error{constructor(e,t){super(e),this.message=e,this.code=t}},vt=n=>{var e,t;return n!=null&&n.androidBridge?"android":!((t=(e=n==null?void 0:n.webkit)===null||e===void 0?void 0:e.messageHandlers)===null||t===void 0)&&t.bridge?"ios":"web"},wt=n=>{var e,t,r,i,l;let g=n.CapacitorCustomPlatform||null,p=n.Capacitor||{},E=p.Plugins=p.Plugins||{},S=n.CapacitorPlatforms,W=()=>g!==null?g.name:vt(n),I=((e=S==null?void 0:S.currentPlatform)===null||e===void 0?void 0:e.getPlatform)||W,x=()=>I()!=="web",G=((t=S==null?void 0:S.currentPlatform)===null||t===void 0?void 0:t.isNativePlatform)||x,N=B=>{let k=re.get(B);return!!(k!=null&&k.platforms.has(I())||se(B))},X=((r=S==null?void 0:S.currentPlatform)===null||r===void 0?void 0:r.isPluginAvailable)||N,z=B=>{var k;return(k=p.PluginHeaders)===null||k===void 0?void 0:k.find(R=>R.name===B)},se=((i=S==null?void 0:S.currentPlatform)===null||i===void 0?void 0:i.getPluginHeader)||z,le=B=>n.console.error(B),ne=(B,k,R)=>Promise.reject(`${R} does not have an implementation of "${k}".`),re=new Map,ie=(B,k={})=>{let R=re.get(B);if(R)return console.warn(`Capacitor plugin "${B}" already registered. Cannot register plugins twice.`),R.proxy;let D=I(),q=se(B),F,M=async()=>(!F&&D in k?F=typeof k[D]=="function"?F=await k[D]():F=k[D]:g!==null&&!F&&"web"in k&&(F=typeof k.web=="function"?F=await k.web():F=k.web),F),j=(H,K)=>{var U,Y;if(q){let _=q==null?void 0:q.methods.find(V=>K===V.name);if(_)return _.rtype==="promise"?V=>p.nativePromise(B,K.toString(),V):(V,ce)=>p.nativeCallback(B,K.toString(),V,ce);if(H)return(U=H[K])===null||U===void 0?void 0:U.bind(H)}else{if(H)return(Y=H[K])===null||Y===void 0?void 0:Y.bind(H);throw new pe(`"${B}" plugin is not implemented on ${D}`,de.Unimplemented)}},Z=H=>{let K,U=(...Y)=>{let _=M().then(V=>{let ce=j(V,H);if(ce){let c=ce(...Y);return K=c==null?void 0:c.remove,c}else throw new pe(`"${B}.${H}()" is not implemented on ${D}`,de.Unimplemented)});return H==="addListener"&&(_.remove=async()=>K()),_};return U.toString=()=>`${H.toString()}() { [capacitor code] }`,Object.defineProperty(U,"name",{value:H,writable:!1,configurable:!1}),U},fe=Z("addListener"),L=Z("removeListener"),be=(H,K)=>{let U=fe({eventName:H},K),Y=async()=>{let V=await U;L({eventName:H,callbackId:V},K)},_=new Promise(V=>U.then(()=>V({remove:Y})));return _.remove=async()=>{console.warn("Using addListener() without 'await' is deprecated."),await Y()},_},Q=new Proxy({},{get(H,K){switch(K){case"$$typeof":return;case"toJSON":return()=>({});case"addListener":return q?be:fe;case"removeListener":return L;default:return Z(K)}}});return E[B]=Q,re.set(B,{name:B,proxy:Q,platforms:new Set([...Object.keys(k),...q?[D]:[]])}),Q},he=((l=S==null?void 0:S.currentPlatform)===null||l===void 0?void 0:l.registerPlugin)||ie;return p.convertFileSrc||(p.convertFileSrc=B=>B),p.getPlatform=I,p.handleError=le,p.isNativePlatform=G,p.isPluginAvailable=X,p.pluginMethodNoop=ne,p.registerPlugin=he,p.Exception=pe,p.DEBUG=!!p.DEBUG,p.isLoggingEnabled=!!p.isLoggingEnabled,p.platform=p.getPlatform(),p.isNative=p.isNativePlatform(),p},Et=n=>n.Capacitor=wt(n),ve=Et(typeof globalThis!="undefined"?globalThis:typeof self!="undefined"?self:typeof window!="undefined"?window:typeof global!="undefined"?global:{}),Ve=ve.registerPlugin,nn=ve.Plugins,we=class{constructor(e){this.listeners={},this.windowListeners={},e&&(console.warn(`Capacitor WebPlugin "${e.name}" config object was deprecated in v3 and will be removed in v4.`),this.config=e)}addListener(e,t){this.listeners[e]||(this.listeners[e]=[]),this.listeners[e].push(t);let i=this.windowListeners[e];i&&!i.registered&&this.addWindowListener(i);let l=async()=>this.removeListener(e,t),g=Promise.resolve({remove:l});return Object.defineProperty(g,"remove",{value:async()=>{console.warn("Using addListener() without 'await' is deprecated."),await l()}}),g}async removeAllListeners(){this.listeners={};for(let e in this.windowListeners)this.removeWindowListener(this.windowListeners[e]);this.windowListeners={}}notifyListeners(e,t){let r=this.listeners[e];r&&r.forEach(i=>i(t))}hasListeners(e){return!!this.listeners[e].length}registerWindowListener(e,t){this.windowListeners[t]={registered:!1,windowEventName:e,pluginEventName:t,handler:r=>{this.notifyListeners(t,r)}}}unimplemented(e="not implemented"){return new ve.Exception(e,de.Unimplemented)}unavailable(e="not available"){return new ve.Exception(e,de.Unavailable)}async removeListener(e,t){let r=this.listeners[e];if(!r)return;let i=r.indexOf(t);this.listeners[e].splice(i,1),this.listeners[e].length||this.removeWindowListener(this.windowListeners[e])}addWindowListener(e){window.addEventListener(e.windowEventName,e.handler),e.registered=!0}removeWindowListener(e){e&&(window.removeEventListener(e.windowEventName,e.handler),e.registered=!1)}}});var Je,Pe,Ie,xe=ee(()=>{Je=async n=>new Promise((e,t)=>{let r=new FileReader;r.onload=()=>{let i=r.result,l=i.substr(i.indexOf(",")+1);e(l)},r.onerror=i=>t(i),r.readAsDataURL(n)}),Pe=n=>encodeURIComponent(n).replace(/%(2[346B]|5E|60|7C)/g,decodeURIComponent).replace(/[()]/g,escape),Ie=n=>n.replace(/(%[\dA-F]{2})+/gi,decodeURIComponent)});var _e,Ee,Xe,Ze,Be,Qe=ee(()=>{xe();_e=(n,e,t={})=>{let r=Pe(n),i=Pe(e),l=`; expires=${(t.expires||"").replace("expires=","")}`,g=(t.path||"/").replace("path=","");document.cookie=`${r}=${i||""}${l}; path=${g}`},Ee=()=>{let n=[],e={};if(!document.cookie)return n;let t=document.cookie.split(";")||[];for(let i of t){let[l,g]=i.replace(/=/,"CAP_COOKIE").split("CAP_COOKIE");l=Ie(l).trim(),g=Ie(g).trim(),e[l]=g}let r=Object.entries(e);for(let[i,l]of r)n.push({key:i,value:l});return n},Xe=n=>{let e=Ee();for(let t of e)if(t.key===n)return t;return{key:n,value:""}},Ze=n=>{document.cookie=`${n}=; Max-Age=0`},Be=()=>{let n=document.cookie.split(";")||[];for(let e of n)document.cookie=e.replace(/^ +/,"").replace(/=.*/,`=;expires=${new Date().toUTCString()};path=/`)}});var St,Lt,Me,oe,Ye,et,tt,nt,rt,at=ee(()=>{xe();St=(n={})=>{let e=Object.keys(n);return Object.keys(n).map(i=>i.toLocaleLowerCase()).reduce((i,l,g)=>(i[l]=n[e[g]],i),{})},Lt=(n,e=!0)=>n?Object.entries(n).reduce((r,i)=>{let[l,g]=i,p,E;return Array.isArray(g)?(E="",g.forEach(S=>{p=e?encodeURIComponent(S):S,E+=`${l}=${p}&`}),E.slice(0,-1)):(p=e?encodeURIComponent(g):g,E=`${l}=${p}`),`${r}&${E}`},"").substr(1):null,Me=(n,e={})=>{let t=Object.assign({method:n.method||"GET",headers:n.headers},e),i=St(n.headers)["content-type"]||"";if(typeof n.data=="string")t.body=n.data;else if(i.includes("application/x-www-form-urlencoded")){let l=new URLSearchParams;for(let[g,p]of Object.entries(n.data||{}))l.set(g,p);t.body=l.toString()}else if(i.includes("multipart/form-data")){let l=new FormData;if(n.data instanceof FormData)n.data.forEach((p,E)=>{l.append(E,p)});else for(let p of Object.keys(n.data))l.append(p,n.data[p]);t.body=l;let g=new Headers(t.headers);g.delete("content-type"),t.headers=g}else(i.includes("application/json")||typeof n.data=="object")&&(t.body=JSON.stringify(n.data));return t},oe=async n=>{let e=Me(n,n.webFetchExtra),t=Lt(n.params,n.shouldEncodeUrlParams),r=t?`${n.url}?${t}`:n.url,i=await fetch(r,e),l=i.headers.get("content-type")||"",{responseType:g="text"}=i.ok?n:{};l.includes("application/json")&&(g="json");let p;switch(g){case"arraybuffer":case"blob":let S=await i.blob();p=await Je(S);break;case"json":p=await i.json();break;case"document":case"text":default:p=await i.text()}let E={};return i.headers.forEach((S,W)=>{E[W]=S}),{data:p,headers:E,status:i.status,url:i.url}},Ye=async n=>oe(Object.assign(Object.assign({},n),{method:"GET"})),et=async n=>oe(Object.assign(Object.assign({},n),{method:"POST"})),tt=async n=>oe(Object.assign(Object.assign({},n),{method:"PUT"})),nt=async n=>oe(Object.assign(Object.assign({},n),{method:"PATCH"})),rt=async n=>oe(Object.assign(Object.assign({},n),{method:"DELETE"}))});var Re={};Ce(Re,{HttpWeb:()=>Ae});var Ae,qe=ee(()=>{Te();Qe();at();Ae=class extends we{constructor(){super(),this.request=async e=>oe(e),this.get=async e=>Ye(e),this.post=async e=>et(e),this.put=async e=>tt(e),this.patch=async e=>nt(e),this.del=async e=>rt(e),this.getCookiesMap=async e=>{let t=Ee(),r={};for(let i of t)r[i.key]=i.value;return r},this.getCookies=async e=>{let{url:t}=e;return{cookies:Ee()}},this.setCookie=async e=>{let{key:t,value:r,expires:i="",path:l=""}=e;_e(t,r,{expires:i,path:l})},this.getCookie=async e=>Xe(e.key),this.deleteCookie=async e=>Ze(e.key),this.clearCookies=async e=>Be(),this.clearAllCookies=async()=>Be(),this.uploadFile=async e=>{let t=new FormData;t.append(e.name,e.blob||"undefined");let r=Object.assign(Object.assign({},e),{body:t,method:"POST"});return this.post(r)},this.downloadFile=async e=>{let t=Me(e,e.webFetchExtra),r=await fetch(e.url,t),i;if(!(e!=null&&e.progress))i=await r.blob();else if(!(r!=null&&r.body))i=new Blob;else{let l=r.body.getReader(),g=0,p=[],E=r.headers.get("content-type"),S=parseInt(r.headers.get("content-length")||"0",10);for(;;){let{done:x,value:G}=await l.read();if(x)break;p.push(G),g+=(G==null?void 0:G.length)||0;let N={type:"DOWNLOAD",url:e.url,bytes:g,contentLength:S};this.notifyListeners("progress",N)}let W=new Uint8Array(g),I=0;for(let x of p)typeof x!="undefined"&&(W.set(x,I),I+=x.length);i=new Blob([W.buffer],{type:E||void 0})}return{blob:i}}}}});var it=yt((mn,Tt)=>{Tt.exports={API_KEY:"a5d75d50-65e6-41a4-aa2f-9b2c93afaaa7"}});var ue,ye,Pt,It,xt,De,ke,me,ot,st,Fe,hn,Bt,Mt,At,Rt,He,gn,Ke=ee(()=>{(function(n){n.Unimplemented="UNIMPLEMENTED",n.Unavailable="UNAVAILABLE"})(ue||(ue={}));ye=class extends Error{constructor(e,t,r){super(e),this.message=e,this.code=t,this.data=r}},Pt=n=>{var e,t;return n!=null&&n.androidBridge?"android":!((t=(e=n==null?void 0:n.webkit)===null||e===void 0?void 0:e.messageHandlers)===null||t===void 0)&&t.bridge?"ios":"web"},It=n=>{let e=n.CapacitorCustomPlatform||null,t=n.Capacitor||{},r=t.Plugins=t.Plugins||{},i=()=>e!==null?e.name:Pt(n),l=()=>i()!=="web",g=I=>{let x=S.get(I);return!!(x!=null&&x.platforms.has(i())||p(I))},p=I=>{var x;return(x=t.PluginHeaders)===null||x===void 0?void 0:x.find(G=>G.name===I)},E=I=>n.console.error(I),S=new Map,W=(I,x={})=>{let G=S.get(I);if(G)return console.warn(`Capacitor plugin "${I}" already registered. Cannot register plugins twice.`),G.proxy;let N=i(),X=p(I),z,se=async()=>(!z&&N in x?z=typeof x[N]=="function"?z=await x[N]():z=x[N]:e!==null&&!z&&"web"in x&&(z=typeof x.web=="function"?z=await x.web():z=x.web),z),le=(k,R)=>{var D,q;if(X){let F=X==null?void 0:X.methods.find(M=>R===M.name);if(F)return F.rtype==="promise"?M=>t.nativePromise(I,R.toString(),M):(M,j)=>t.nativeCallback(I,R.toString(),M,j);if(k)return(D=k[R])===null||D===void 0?void 0:D.bind(k)}else{if(k)return(q=k[R])===null||q===void 0?void 0:q.bind(k);throw new ye(`"${I}" plugin is not implemented on ${N}`,ue.Unimplemented)}},ne=k=>{let R,D=(...q)=>{let F=se().then(M=>{let j=le(M,k);if(j){let Z=j(...q);return R=Z==null?void 0:Z.remove,Z}else throw new ye(`"${I}.${k}()" is not implemented on ${N}`,ue.Unimplemented)});return k==="addListener"&&(F.remove=async()=>R()),F};return D.toString=()=>`${k.toString()}() { [capacitor code] }`,Object.defineProperty(D,"name",{value:k,writable:!1,configurable:!1}),D},re=ne("addListener"),ie=ne("removeListener"),he=(k,R)=>{let D=re({eventName:k},R),q=async()=>{let M=await D;ie({eventName:k,callbackId:M},R)},F=new Promise(M=>D.then(()=>M({remove:q})));return F.remove=async()=>{console.warn("Using addListener() without 'await' is deprecated."),await q()},F},B=new Proxy({},{get(k,R){switch(R){case"$$typeof":return;case"toJSON":return()=>({});case"addListener":return X?he:re;case"removeListener":return ie;default:return ne(R)}}});return r[I]=B,S.set(I,{name:I,proxy:B,platforms:new Set([...Object.keys(x),...X?[N]:[]])}),B};return t.convertFileSrc||(t.convertFileSrc=I=>I),t.getPlatform=i,t.handleError=E,t.isNativePlatform=l,t.isPluginAvailable=g,t.registerPlugin=W,t.Exception=ye,t.DEBUG=!!t.DEBUG,t.isLoggingEnabled=!!t.isLoggingEnabled,t},xt=n=>n.Capacitor=It(n),De=xt(typeof globalThis!="undefined"?globalThis:typeof self!="undefined"?self:typeof window!="undefined"?window:typeof global!="undefined"?global:{}),ke=De.registerPlugin,me=class{constructor(){this.listeners={},this.retainedEventArguments={},this.windowListeners={}}addListener(e,t){let r=!1;this.listeners[e]||(this.listeners[e]=[],r=!0),this.listeners[e].push(t);let l=this.windowListeners[e];l&&!l.registered&&this.addWindowListener(l),r&&this.sendRetainedArgumentsForEvent(e);let g=async()=>this.removeListener(e,t);return Promise.resolve({remove:g})}async removeAllListeners(){this.listeners={};for(let e in this.windowListeners)this.removeWindowListener(this.windowListeners[e]);this.windowListeners={}}notifyListeners(e,t,r){let i=this.listeners[e];if(!i){if(r){let l=this.retainedEventArguments[e];l||(l=[]),l.push(t),this.retainedEventArguments[e]=l}return}i.forEach(l=>l(t))}hasListeners(e){return!!this.listeners[e].length}registerWindowListener(e,t){this.windowListeners[t]={registered:!1,windowEventName:e,pluginEventName:t,handler:r=>{this.notifyListeners(t,r)}}}unimplemented(e="not implemented"){return new De.Exception(e,ue.Unimplemented)}unavailable(e="not available"){return new De.Exception(e,ue.Unavailable)}async removeListener(e,t){let r=this.listeners[e];if(!r)return;let i=r.indexOf(t);this.listeners[e].splice(i,1),this.listeners[e].length||this.removeWindowListener(this.windowListeners[e])}addWindowListener(e){window.addEventListener(e.windowEventName,e.handler),e.registered=!0}removeWindowListener(e){e&&(window.removeEventListener(e.windowEventName,e.handler),e.registered=!1)}sendRetainedArgumentsForEvent(e){let t=this.retainedEventArguments[e];t&&(delete this.retainedEventArguments[e],t.forEach(r=>{this.notifyListeners(e,r)}))}},ot=n=>encodeURIComponent(n).replace(/%(2[346B]|5E|60|7C)/g,decodeURIComponent).replace(/[()]/g,escape),st=n=>n.replace(/(%[\dA-F]{2})+/gi,decodeURIComponent),Fe=class extends me{async getCookies(){let e=document.cookie,t={};return e.split(";").forEach(r=>{if(r.length<=0)return;let[i,l]=r.replace(/=/,"CAP_COOKIE").split("CAP_COOKIE");i=st(i).trim(),l=st(l).trim(),t[i]=l}),t}async setCookie(e){try{let t=ot(e.key),r=ot(e.value),i=`; expires=${(e.expires||"").replace("expires=","")}`,l=(e.path||"/").replace("path=",""),g=e.url!=null&&e.url.length>0?`domain=${e.url}`:"";document.cookie=`${t}=${r||""}${i}; path=${l}; ${g};`}catch(t){return Promise.reject(t)}}async deleteCookie(e){try{document.cookie=`${e.key}=; Max-Age=0`}catch(t){return Promise.reject(t)}}async clearCookies(){try{let e=document.cookie.split(";")||[];for(let t of e)document.cookie=t.replace(/^ +/,"").replace(/=.*/,`=;expires=${new Date().toUTCString()};path=/`)}catch(e){return Promise.reject(e)}}async clearAllCookies(){try{await this.clearCookies()}catch(e){return Promise.reject(e)}}},hn=ke("CapacitorCookies",{web:()=>new Fe}),Bt=async n=>new Promise((e,t)=>{let r=new FileReader;r.onload=()=>{let i=r.result;e(i.indexOf(",")>=0?i.split(",")[1]:i)},r.onerror=i=>t(i),r.readAsDataURL(n)}),Mt=(n={})=>{let e=Object.keys(n);return Object.keys(n).map(i=>i.toLocaleLowerCase()).reduce((i,l,g)=>(i[l]=n[e[g]],i),{})},At=(n,e=!0)=>n?Object.entries(n).reduce((r,i)=>{let[l,g]=i,p,E;return Array.isArray(g)?(E="",g.forEach(S=>{p=e?encodeURIComponent(S):S,E+=`${l}=${p}&`}),E.slice(0,-1)):(p=e?encodeURIComponent(g):g,E=`${l}=${p}`),`${r}&${E}`},"").substr(1):null,Rt=(n,e={})=>{let t=Object.assign({method:n.method||"GET",headers:n.headers},e),i=Mt(n.headers)["content-type"]||"";if(typeof n.data=="string")t.body=n.data;else if(i.includes("application/x-www-form-urlencoded")){let l=new URLSearchParams;for(let[g,p]of Object.entries(n.data||{}))l.set(g,p);t.body=l.toString()}else if(i.includes("multipart/form-data")||n.data instanceof FormData){let l=new FormData;if(n.data instanceof FormData)n.data.forEach((p,E)=>{l.append(E,p)});else for(let p of Object.keys(n.data))l.append(p,n.data[p]);t.body=l;let g=new Headers(t.headers);g.delete("content-type"),t.headers=g}else(i.includes("application/json")||typeof n.data=="object")&&(t.body=JSON.stringify(n.data));return t},He=class extends me{async request(e){let t=Rt(e,e.webFetchExtra),r=At(e.params,e.shouldEncodeUrlParams),i=r?`${e.url}?${r}`:e.url,l=await fetch(i,t),g=l.headers.get("content-type")||"",{responseType:p="text"}=l.ok?e:{};g.includes("application/json")&&(p="json");let E,S;switch(p){case"arraybuffer":case"blob":S=await l.blob(),E=await Bt(S);break;case"json":E=await l.json();break;case"document":case"text":default:E=await l.text()}let W={};return l.headers.forEach((I,x)=>{W[x]=I}),{data:E,headers:W,status:l.status,url:l.url}}async get(e){return this.request(Object.assign(Object.assign({},e),{method:"GET"}))}async post(e){return this.request(Object.assign(Object.assign({},e),{method:"POST"}))}async put(e){return this.request(Object.assign(Object.assign({},e),{method:"PUT"}))}async patch(e){return this.request(Object.assign(Object.assign({},e),{method:"PATCH"}))}async delete(e){return this.request(Object.assign(Object.assign({},e),{method:"DELETE"}))}},gn=ke("CapacitorHttp",{web:()=>new He})});var Se,Le,lt=ee(()=>{Se=class{constructor(e){this.sqlite=e,this._connectionDict=new Map}async initWebStore(){try{return await this.sqlite.initWebStore(),Promise.resolve()}catch(e){return Promise.reject(e)}}async saveToStore(e){try{return await this.sqlite.saveToStore({database:e}),Promise.resolve()}catch(t){return Promise.reject(t)}}async saveToLocalDisk(e){try{return await this.sqlite.saveToLocalDisk({database:e}),Promise.resolve()}catch(t){return Promise.reject(t)}}async getFromLocalDiskToStore(e){let t=e!=null?e:!0;try{return await this.sqlite.getFromLocalDiskToStore({overwrite:t}),Promise.resolve()}catch(r){return Promise.reject(r)}}async echo(e){try{let t=await this.sqlite.echo({value:e});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async isSecretStored(){try{let e=await this.sqlite.isSecretStored();return Promise.resolve(e)}catch(e){return Promise.reject(e)}}async setEncryptionSecret(e){try{return await this.sqlite.setEncryptionSecret({passphrase:e}),Promise.resolve()}catch(t){return Promise.reject(t)}}async changeEncryptionSecret(e,t){try{return await this.sqlite.changeEncryptionSecret({passphrase:e,oldpassphrase:t}),Promise.resolve()}catch(r){return Promise.reject(r)}}async clearEncryptionSecret(){try{return await this.sqlite.clearEncryptionSecret(),Promise.resolve()}catch(e){return Promise.reject(e)}}async checkEncryptionSecret(e){try{let t=await this.sqlite.checkEncryptionSecret({passphrase:e});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async addUpgradeStatement(e,t){try{return e.endsWith(".db")&&(e=e.slice(0,-3)),await this.sqlite.addUpgradeStatement({database:e,upgrade:t}),Promise.resolve()}catch(r){return Promise.reject(r)}}async createConnection(e,t,r,i,l){try{e.endsWith(".db")&&(e=e.slice(0,-3)),await this.sqlite.createConnection({database:e,encrypted:t,mode:r,version:i,readonly:l});let g=new Le(e,l,this.sqlite),p=l?`RO_${e}`:`RW_${e}`;return this._connectionDict.set(p,g),Promise.resolve(g)}catch(g){return Promise.reject(g)}}async closeConnection(e,t){try{e.endsWith(".db")&&(e=e.slice(0,-3)),await this.sqlite.closeConnection({database:e,readonly:t});let r=t?`RO_${e}`:`RW_${e}`;return this._connectionDict.delete(r),Promise.resolve()}catch(r){return Promise.reject(r)}}async isConnection(e,t){let r={};e.endsWith(".db")&&(e=e.slice(0,-3));let i=t?`RO_${e}`:`RW_${e}`;return r.result=this._connectionDict.has(i),Promise.resolve(r)}async retrieveConnection(e,t){e.endsWith(".db")&&(e=e.slice(0,-3));let r=t?`RO_${e}`:`RW_${e}`;if(this._connectionDict.has(r)){let i=this._connectionDict.get(r);return typeof i!="undefined"?Promise.resolve(i):Promise.reject(`Connection ${e} is undefined`)}else return Promise.reject(`Connection ${e} does not exist`)}async getNCDatabasePath(e,t){try{let r=await this.sqlite.getNCDatabasePath({path:e,database:t});return Promise.resolve(r)}catch(r){return Promise.reject(r)}}async createNCConnection(e,t){try{await this.sqlite.createNCConnection({databasePath:e,version:t});let r=new Le(e,!0,this.sqlite),i=`RO_${e})`;return this._connectionDict.set(i,r),Promise.resolve(r)}catch(r){return Promise.reject(r)}}async closeNCConnection(e){try{await this.sqlite.closeNCConnection({databasePath:e});let t=`RO_${e})`;return this._connectionDict.delete(t),Promise.resolve()}catch(t){return Promise.reject(t)}}async isNCConnection(e){let t={},r=`RO_${e})`;return t.result=this._connectionDict.has(r),Promise.resolve(t)}async retrieveNCConnection(e){if(this._connectionDict.has(e)){let t=`RO_${e})`,r=this._connectionDict.get(t);return typeof r!="undefined"?Promise.resolve(r):Promise.reject(`Connection ${e} is undefined`)}else return Promise.reject(`Connection ${e} does not exist`)}async isNCDatabase(e){try{let t=await this.sqlite.isNCDatabase({databasePath:e});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async retrieveAllConnections(){return this._connectionDict}async closeAllConnections(){let e=new Map;try{for(let t of this._connectionDict.keys()){let r=t.substring(3),i=t.substring(0,3)==="RO_";await this.sqlite.closeConnection({database:r,readonly:i}),e.set(t,null)}for(let t of e.keys())this._connectionDict.delete(t);return Promise.resolve()}catch(t){return Promise.reject(t)}}async checkConnectionsConsistency(){try{let e=[...this._connectionDict.keys()],t=[],r=[];for(let l of e)t.push(l.substring(0,2)),r.push(l.substring(3));let i=await this.sqlite.checkConnectionsConsistency({dbNames:r,openModes:t});return i.result||(this._connectionDict=new Map),Promise.resolve(i)}catch(e){return this._connectionDict=new Map,Promise.reject(e)}}async importFromJson(e){try{let t=await this.sqlite.importFromJson({jsonstring:e});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async isJsonValid(e){try{let t=await this.sqlite.isJsonValid({jsonstring:e});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async copyFromAssets(e){let t=e!=null?e:!0;try{return await this.sqlite.copyFromAssets({overwrite:t}),Promise.resolve()}catch(r){return Promise.reject(r)}}async getFromHTTPRequest(e,t){let r=t!=null?t:!0;try{return await this.sqlite.getFromHTTPRequest({url:e,overwrite:r}),Promise.resolve()}catch(i){return Promise.reject(i)}}async isDatabaseEncrypted(e){e.endsWith(".db")&&(e=e.slice(0,-3));try{let t=await this.sqlite.isDatabaseEncrypted({database:e});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async isInConfigEncryption(){try{let e=await this.sqlite.isInConfigEncryption();return Promise.resolve(e)}catch(e){return Promise.reject(e)}}async isInConfigBiometricAuth(){try{let e=await this.sqlite.isInConfigBiometricAuth();return Promise.resolve(e)}catch(e){return Promise.reject(e)}}async isDatabase(e){e.endsWith(".db")&&(e=e.slice(0,-3));try{let t=await this.sqlite.isDatabase({database:e});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async getDatabaseList(){try{let t=(await this.sqlite.getDatabaseList()).values;t.sort();let r={values:t};return Promise.resolve(r)}catch(e){return Promise.reject(e)}}async getMigratableDbList(e){let t=e||"default";try{let r=await this.sqlite.getMigratableDbList({folderPath:t});return Promise.resolve(r)}catch(r){return Promise.reject(r)}}async addSQLiteSuffix(e,t){let r=e||"default",i=t||[];try{let l=await this.sqlite.addSQLiteSuffix({folderPath:r,dbNameList:i});return Promise.resolve(l)}catch(l){return Promise.reject(l)}}async deleteOldDatabases(e,t){let r=e||"default",i=t||[];try{let l=await this.sqlite.deleteOldDatabases({folderPath:r,dbNameList:i});return Promise.resolve(l)}catch(l){return Promise.reject(l)}}async moveDatabasesAndAddSuffix(e,t){let r=e||"default",i=t||[];return this.sqlite.moveDatabasesAndAddSuffix({folderPath:r,dbNameList:i})}},Le=class{constructor(e,t,r){this.dbName=e,this.readonly=t,this.sqlite=r}getConnectionDBName(){return this.dbName}getConnectionReadOnly(){return this.readonly}async open(){try{return await this.sqlite.open({database:this.dbName,readonly:this.readonly}),Promise.resolve()}catch(e){return Promise.reject(e)}}async close(){try{return await this.sqlite.close({database:this.dbName,readonly:this.readonly}),Promise.resolve()}catch(e){return Promise.reject(e)}}async beginTransaction(){try{let e=await this.sqlite.beginTransaction({database:this.dbName});return Promise.resolve(e)}catch(e){return Promise.reject(e)}}async commitTransaction(){try{let e=await this.sqlite.commitTransaction({database:this.dbName});return Promise.resolve(e)}catch(e){return Promise.reject(e)}}async rollbackTransaction(){try{let e=await this.sqlite.rollbackTransaction({database:this.dbName});return Promise.resolve(e)}catch(e){return Promise.reject(e)}}async isTransactionActive(){try{let e=await this.sqlite.isTransactionActive({database:this.dbName});return Promise.resolve(e)}catch(e){return Promise.reject(e)}}async loadExtension(e){try{return await this.sqlite.loadExtension({database:this.dbName,path:e,readonly:this.readonly}),Promise.resolve()}catch(t){return Promise.reject(t)}}async enableLoadExtension(e){try{return await this.sqlite.enableLoadExtension({database:this.dbName,toggle:e,readonly:this.readonly}),Promise.resolve()}catch(t){return Promise.reject(t)}}async getUrl(){try{let e=await this.sqlite.getUrl({database:this.dbName,readonly:this.readonly});return Promise.resolve(e)}catch(e){return Promise.reject(e)}}async getVersion(){try{let e=await this.sqlite.getVersion({database:this.dbName,readonly:this.readonly});return Promise.resolve(e)}catch(e){return Promise.reject(e)}}async getTableList(){try{let e=await this.sqlite.getTableList({database:this.dbName,readonly:this.readonly});return Promise.resolve(e)}catch(e){return Promise.reject(e)}}async execute(e,t=!0,r=!0){try{if(this.readonly)return Promise.reject("not allowed in read-only mode");{let i=await this.sqlite.execute({database:this.dbName,statements:e,transaction:t,readonly:!1,isSQL92:r});return Promise.resolve(i)}}catch(i){return Promise.reject(i)}}async query(e,t,r=!0){let i;try{return t&&t.length>0?i=await this.sqlite.query({database:this.dbName,statement:e,values:t,readonly:this.readonly,isSQL92:!0}):i=await this.sqlite.query({database:this.dbName,statement:e,values:[],readonly:this.readonly,isSQL92:r}),i=await this.reorderRows(i),Promise.resolve(i)}catch(l){return Promise.reject(l)}}async run(e,t,r=!0,i="no",l=!0){let g;try{return this.readonly?Promise.reject("not allowed in read-only mode"):(t&&t.length>0?g=await this.sqlite.run({database:this.dbName,statement:e,values:t,transaction:r,readonly:!1,returnMode:i,isSQL92:!0}):g=await this.sqlite.run({database:this.dbName,statement:e,values:[],transaction:r,readonly:!1,returnMode:i,isSQL92:l}),g.changes=await this.reorderRows(g.changes),Promise.resolve(g))}catch(p){return Promise.reject(p)}}async executeSet(e,t=!0,r="no",i=!0){let l;try{return this.readonly?Promise.reject("not allowed in read-only mode"):(l=await this.sqlite.executeSet({database:this.dbName,set:e,transaction:t,readonly:!1,returnMode:r,isSQL92:i}),l.changes=await this.reorderRows(l.changes),Promise.resolve(l))}catch(g){return Promise.reject(g)}}async isExists(){try{let e=await this.sqlite.isDBExists({database:this.dbName,readonly:this.readonly});return Promise.resolve(e)}catch(e){return Promise.reject(e)}}async isTable(e){try{let t=await this.sqlite.isTableExists({database:this.dbName,table:e,readonly:this.readonly});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async isDBOpen(){try{let e=await this.sqlite.isDBOpen({database:this.dbName,readonly:this.readonly});return Promise.resolve(e)}catch(e){return Promise.reject(e)}}async delete(){try{return this.readonly?Promise.reject("not allowed in read-only mode"):(await this.sqlite.deleteDatabase({database:this.dbName,readonly:!1}),Promise.resolve())}catch(e){return Promise.reject(e)}}async createSyncTable(){try{if(this.readonly)return Promise.reject("not allowed in read-only mode");{let e=await this.sqlite.createSyncTable({database:this.dbName,readonly:!1});return Promise.resolve(e)}}catch(e){return Promise.reject(e)}}async setSyncDate(e){try{return this.readonly?Promise.reject("not allowed in read-only mode"):(await this.sqlite.setSyncDate({database:this.dbName,syncdate:e,readonly:!1}),Promise.resolve())}catch(t){return Promise.reject(t)}}async getSyncDate(){try{let e=await this.sqlite.getSyncDate({database:this.dbName,readonly:this.readonly}),t="";return e.syncDate>0&&(t=new Date(e.syncDate*1e3).toISOString()),Promise.resolve(t)}catch(e){return Promise.reject(e)}}async exportToJson(e,t=!1){try{let r=await this.sqlite.exportToJson({database:this.dbName,jsonexportmode:e,readonly:this.readonly,encrypted:t});return Promise.resolve(r)}catch(r){return Promise.reject(r)}}async deleteExportedRows(){try{return this.readonly?Promise.reject("not allowed in read-only mode"):(await this.sqlite.deleteExportedRows({database:this.dbName,readonly:!1}),Promise.resolve())}catch(e){return Promise.reject(e)}}async executeTransaction(e,t=!0){let r=0,i=!1;if(this.readonly)return Promise.reject("not allowed in read-only mode");if(await this.sqlite.beginTransaction({database:this.dbName}),i=await this.sqlite.isTransactionActive({database:this.dbName}),!i)return Promise.reject("After Begin Transaction, no transaction active");try{for(let p of e){if(typeof p!="object"||!("statement"in p))throw new Error("Error a task.statement must be provided");if("values"in p&&p.values&&p.values.length>0){let E=p.statement.toUpperCase().includes("RETURNING")?"all":"no",S=await this.sqlite.run({database:this.dbName,statement:p.statement,values:p.values,transaction:!1,readonly:!1,returnMode:E,isSQL92:t});if(S.changes.changes<0)throw new Error("Error in transaction method run ");r+=S.changes.changes}else{let E=await this.sqlite.execute({database:this.dbName,statements:p.statement,transaction:!1,readonly:!1});if(E.changes.changes<0)throw new Error("Error in transaction method execute ");r+=E.changes.changes}}let l=await this.sqlite.commitTransaction({database:this.dbName});r+=l.changes.changes;let g={changes:{changes:r}};return Promise.resolve(g)}catch(l){let g=l.message?l.message:l;return await this.sqlite.rollbackTransaction({database:this.dbName}),Promise.reject(g)}}async reorderRows(e){let t=e;if(e!=null&&e.values&&typeof e.values[0]=="object"&&Object.keys(e.values[0]).includes("ios_columns")){let r=e.values[0].ios_columns,i=[];for(let l=1;l<e.values.length;l++){let g=e.values[l],p={};for(let E of r)p[E]=g[E];i.push(p)}t.values=i}return Promise.resolve(t)}}});var ct={};Ce(ct,{CapacitorSQLiteWeb:()=>Oe});var Oe,dt=ee(()=>{Ke();Oe=class extends me{constructor(){super(...arguments),this.jeepSqliteElement=null,this.isWebStoreOpen=!1}async initWebStore(){await customElements.whenDefined("jeep-sqlite"),this.jeepSqliteElement=document.querySelector("jeep-sqlite"),this.ensureJeepSqliteIsAvailable(),this.jeepSqliteElement.addEventListener("jeepSqliteImportProgress",e=>{this.notifyListeners("sqliteImportProgressEvent",e.detail)}),this.jeepSqliteElement.addEventListener("jeepSqliteExportProgress",e=>{this.notifyListeners("sqliteExportProgressEvent",e.detail)}),this.jeepSqliteElement.addEventListener("jeepSqliteHTTPRequestEnded",e=>{this.notifyListeners("sqliteHTTPRequestEndedEvent",e.detail)}),this.jeepSqliteElement.addEventListener("jeepSqlitePickDatabaseEnded",e=>{this.notifyListeners("sqlitePickDatabaseEndedEvent",e.detail)}),this.jeepSqliteElement.addEventListener("jeepSqliteSaveDatabaseToDisk",e=>{this.notifyListeners("sqliteSaveDatabaseToDiskEvent",e.detail)}),this.isWebStoreOpen||(this.isWebStoreOpen=await this.jeepSqliteElement.isStoreOpen())}async saveToStore(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.saveToStore(e);return}catch(t){throw new Error(`${t}`)}}async getFromLocalDiskToStore(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.getFromLocalDiskToStore(e);return}catch(t){throw new Error(`${t}`)}}async saveToLocalDisk(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.saveToLocalDisk(e);return}catch(t){throw new Error(`${t}`)}}async echo(e){return this.ensureJeepSqliteIsAvailable(),await this.jeepSqliteElement.echo(e)}async createConnection(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.createConnection(e);return}catch(t){throw new Error(`${t}`)}}async open(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.open(e);return}catch(t){throw new Error(`${t}`)}}async closeConnection(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.closeConnection(e);return}catch(t){throw new Error(`${t}`)}}async getVersion(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.getVersion(e)}catch(t){throw new Error(`${t}`)}}async checkConnectionsConsistency(e){this.ensureJeepSqliteIsAvailable();try{return await this.jeepSqliteElement.checkConnectionsConsistency(e)}catch(t){throw new Error(`${t}`)}}async close(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.close(e);return}catch(t){throw new Error(`${t}`)}}async beginTransaction(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.beginTransaction(e)}catch(t){throw new Error(`${t}`)}}async commitTransaction(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.commitTransaction(e)}catch(t){throw new Error(`${t}`)}}async rollbackTransaction(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.rollbackTransaction(e)}catch(t){throw new Error(`${t}`)}}async isTransactionActive(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.isTransactionActive(e)}catch(t){throw new Error(`${t}`)}}async getTableList(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.getTableList(e)}catch(t){throw new Error(`${t}`)}}async execute(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.execute(e)}catch(t){throw new Error(`${t}`)}}async executeSet(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.executeSet(e)}catch(t){throw new Error(`${t}`)}}async run(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.run(e)}catch(t){throw new Error(`${t}`)}}async query(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.query(e)}catch(t){throw new Error(`${t}`)}}async isDBExists(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.isDBExists(e)}catch(t){throw new Error(`${t}`)}}async isDBOpen(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.isDBOpen(e)}catch(t){throw new Error(`${t}`)}}async isDatabase(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.isDatabase(e)}catch(t){throw new Error(`${t}`)}}async isTableExists(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.isTableExists(e)}catch(t){throw new Error(`${t}`)}}async deleteDatabase(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.deleteDatabase(e);return}catch(t){throw new Error(`${t}`)}}async isJsonValid(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.isJsonValid(e)}catch(t){throw new Error(`${t}`)}}async importFromJson(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.importFromJson(e)}catch(t){throw new Error(`${t}`)}}async exportToJson(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.exportToJson(e)}catch(t){throw new Error(`${t}`)}}async createSyncTable(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.createSyncTable(e)}catch(t){throw new Error(`${t}`)}}async setSyncDate(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.setSyncDate(e);return}catch(t){throw new Error(`${t}`)}}async getSyncDate(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.getSyncDate(e)}catch(t){throw new Error(`${t}`)}}async deleteExportedRows(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.deleteExportedRows(e);return}catch(t){throw new Error(`${t}`)}}async addUpgradeStatement(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.addUpgradeStatement(e);return}catch(t){throw new Error(`${t}`)}}async copyFromAssets(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.copyFromAssets(e);return}catch(t){throw new Error(`${t}`)}}async getFromHTTPRequest(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.getFromHTTPRequest(e);return}catch(t){throw new Error(`${t}`)}}async getDatabaseList(){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.getDatabaseList()}catch(e){throw new Error(`${e}`)}}ensureJeepSqliteIsAvailable(){if(this.jeepSqliteElement===null)throw new Error("The jeep-sqlite element is not present in the DOM! Please check the @capacitor-community/sqlite documentation for instructions regarding the web platform.")}ensureWebstoreIsOpen(){if(!this.isWebStoreOpen)throw new Error('WebStore is not open yet. You have to call "initWebStore()" first.')}async getUrl(){throw this.unimplemented("Not implemented on web.")}async getMigratableDbList(e){throw console.log("getMigratableDbList",e),this.unimplemented("Not implemented on web.")}async addSQLiteSuffix(e){throw console.log("addSQLiteSuffix",e),this.unimplemented("Not implemented on web.")}async deleteOldDatabases(e){throw console.log("deleteOldDatabases",e),this.unimplemented("Not implemented on web.")}async moveDatabasesAndAddSuffix(e){throw console.log("moveDatabasesAndAddSuffix",e),this.unimplemented("Not implemented on web.")}async isSecretStored(){throw this.unimplemented("Not implemented on web.")}async setEncryptionSecret(e){throw console.log("setEncryptionSecret",e),this.unimplemented("Not implemented on web.")}async changeEncryptionSecret(e){throw console.log("changeEncryptionSecret",e),this.unimplemented("Not implemented on web.")}async clearEncryptionSecret(){throw console.log("clearEncryptionSecret"),this.unimplemented("Not implemented on web.")}async checkEncryptionSecret(e){throw console.log("checkEncryptionPassPhrase",e),this.unimplemented("Not implemented on web.")}async getNCDatabasePath(e){throw console.log("getNCDatabasePath",e),this.unimplemented("Not implemented on web.")}async createNCConnection(e){throw console.log("createNCConnection",e),this.unimplemented("Not implemented on web.")}async closeNCConnection(e){throw console.log("closeNCConnection",e),this.unimplemented("Not implemented on web.")}async isNCDatabase(e){throw console.log("isNCDatabase",e),this.unimplemented("Not implemented on web.")}async isDatabaseEncrypted(e){throw console.log("isDatabaseEncrypted",e),this.unimplemented("Not implemented on web.")}async isInConfigEncryption(){throw this.unimplemented("Not implemented on web.")}async isInConfigBiometricAuth(){throw this.unimplemented("Not implemented on web.")}async loadExtension(e){throw console.log("loadExtension",e),this.unimplemented("Not implemented on web.")}async enableLoadExtension(e){throw console.log("enableLoadExtension",e),this.unimplemented("Not implemented on web.")}}});var ut,mt=ee(()=>{Ke();lt();ut=ke("CapacitorSQLite",{web:()=>Promise.resolve().then(()=>(dt(),ct)).then(n=>new n.CapacitorSQLiteWeb),electron:()=>window.CapacitorCustomPlatform.plugins.CapacitorSQLite})});var ht={};Ce(ht,{getCardById:()=>Nt,getCardIds:()=>Ot,getCardsByIds:()=>Wt,getDaten:()=>Ft,getEnergieById:()=>Qt,getEnergieCardIds:()=>Zt,getEnergies:()=>_t,getEngName:()=>Kt,getName:()=>Ht,getTrainerById:()=>Vt,getTrainerCardIds:()=>Jt,getTrainers:()=>zt,initDatabase:()=>Dt,insertCard:()=>$t,insertEnergie:()=>Xt,insertTrainer:()=>Ut,updateCardIds:()=>jt,updatePrice:()=>Gt});async function Dt(){return A=await qt.createConnection("pokepicker",!1,"no-encryption",1),await A.open(),await A.execute(`
  ...
  `),(await A.query("SELECT COUNT(*) as count FROM pokemon")).values[0].count===0&&await A.execute(`
      ...
      `),A}async function Ft(){return await A.query("SELECT * FROM pokemon")}async function Ht(n){return(await A.query("SELECT name FROM pokemon WHERE dex = ?",[n])).values[0].name}async function Kt(n){return(await A.query("SELECT engName FROM pokemon WHERE dex = ?",[n])).values[0].engName}async function Ot(n){return(await A.query("SELECT cardIds FROM pokemon WHERE dex = ?",[n])).values[0].cardIds}async function jt(n,e){await A.run("UPDATE pokemon SET cardIds = ? WHERE dex = ?",[e,n])}async function $t(n){var e,t,r,i,l;try{let g=typeof n.imageSmall=="string"?n.imageSmall:null,p=typeof n.imageLarge=="string"?n.imageLarge:null;return((l=(await A.run(`INSERT INTO cards (cardId, cardName, rarity, setName, imageLow, imageHigh, subTypes, addedAt, avg30)
       VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)`,[n.id,n.name,n.rarity||"",((e=n.set)==null?void 0:e.name)||"",g,p,Array.isArray(n.subtypes)?n.subtypes.join(", "):"",new Date().toISOString(),(i=(r=(t=n.cardmarket)==null?void 0:t.prices)==null?void 0:r.avg30)!=null?i:null])).changes)==null?void 0:l.lastId)||null}catch(g){return console.error("Fehler in insertCard():",g.message||g,(n==null?void 0:n.id)||"unbekannte Karte"),null}}async function Nt(n){var t;return((t=(await A.query("SELECT * FROM cards WHERE id = ?",[n])).values)==null?void 0:t[0])||null}async function Wt(n){let e=n.map(()=>"?").join(",");return(await A.query(`SELECT * FROM cards WHERE id IN (${e})`,n)).values}async function Gt(n,e){try{await A.run("UPDATE cards SET avg30 = ? WHERE cardId = ?",[e,n])}catch(t){console.error(`Fehler beim Speichern von avg30 f\xFCr ${n}:`,t.message)}}async function zt(){return(await A.query("SELECT * FROM trainer")).values}async function Ut(n){var e,t,r,i,l;try{let g=typeof n.imageSmall=="string"?n.imageSmall:null,p=typeof n.imageLarge=="string"?n.imageLarge:null;return((l=(await A.run(`INSERT INTO trainer (cardId, cardName, rarity, setName, imageLow, imageHigh, subTypes, addedAt, avg30)
       VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)`,[n.id,n.name,n.rarity||"",((e=n.set)==null?void 0:e.name)||"",g,p,Array.isArray(n.subtypes)?n.subtypes.join(", "):"",new Date().toISOString(),(i=(r=(t=n.cardmarket)==null?void 0:t.prices)==null?void 0:r.avg30)!=null?i:null])).changes)==null?void 0:l.lastId)||null}catch(g){return console.error("Fehler in insertTrainer():",g.message||g,(n==null?void 0:n.id)||"unbekannte Karte"),null}}async function Vt(n){var t;return((t=(await A.query("SELECT * FROM trainer WHERE id = ?",[n])).values)==null?void 0:t[0])||null}async function Jt(){return(await A.query("SELECT id FROM trainer")).values.map(e=>e.id)}async function _t(){return(await A.query("SELECT * FROM energy")).values}async function Xt(n){var e,t,r,i,l;try{let g=typeof n.imageSmall=="string"?n.imageSmall:null,p=typeof n.imageLarge=="string"?n.imageLarge:null;return((l=(await A.run(`INSERT INTO energy (cardId, cardName, rarity, setName, imageLow, imageHigh, subTypes, addedAt, avg30)
       VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)`,[n.id,n.name,n.rarity||"",((e=n.set)==null?void 0:e.name)||"",g,p,Array.isArray(n.subtypes)?n.subtypes.join(", "):"",new Date().toISOString(),(i=(r=(t=n.cardmarket)==null?void 0:t.prices)==null?void 0:r.avg30)!=null?i:null])).changes)==null?void 0:l.lastId)||null}catch(g){return console.error("Fehler in insertEnergie():",g.message||g,(n==null?void 0:n.id)||"unbekannte Karte"),null}}async function Zt(){return(await A.query("SELECT id FROM energy")).values.map(e=>e.id)}async function Qt(n){var t;return((t=(await A.query("SELECT * FROM energy WHERE id = ?",[n])).values)==null?void 0:t[0])||null}var qt,A,gt=ee(()=>{mt();qt=new Se(ut)});Te();var te=Ve("Http",{web:()=>Promise.resolve().then(()=>(qe(),Re)).then(n=>new n.HttpWeb),electron:()=>Promise.resolve().then(()=>(qe(),Re)).then(n=>new n.HttpWeb)});var ae=it(),$;document.addEventListener("DOMContentLoaded",()=>{(async()=>{let n=document.getElementById("cardLoader");n.innerHTML=`
      <p id="loaderText">Lade Karten\u2026</p>
      <div id="progressBarContainer">
        <div id="progressBar"></div>
      </div>
      <div id="progressText">0%</div>
    `,n.classList.remove("hidden"),n.classList.add("shown");let{initDatabase:e,getDaten:t,getName:r,getEngName:i,getCardIds:l,updateCardIds:g,insertCard:p,getCardById:E,getCardsByIds:S,updatePrice:W,getTrainers:I,insertTrainer:x,getTrainerCardIds:G,getTrainerById:N,getEnergies:X,insertEnergie:z,getEnergieCardIds:se,getEnergieById:le}=await Promise.resolve().then(()=>(gt(),ht));$=await e();let ne=await t(),re=document.querySelector("#kartentabelle tbody");window.cachedCards={},window.cachedPokemonCardsByName={},window.cachedTrainerCardsByType={},window.cachedEnergyCardsByType={};let ie=0,he=ne.values.length;for(let c of ne.values){let a=document.createElement("tr"),o=parseInt(c.dex),u=`
      ...
      `;a.innerHTML=u,re.appendChild(a),await R(c.dex),ie++;let s=Math.min(99,Math.round(ie/he*100)),m=document.getElementById("progressBar"),d=document.getElementById("progressText");m&&(m.style.width=s+"%"),d&&(d.textContent=s+"%")}progressBar.style.width="100%",progressText.textContent="100%",n.classList.add("hidden"),n.classList.remove("shown"),n.innerHTML="",B(),k(),j();function B(){let c=document.querySelectorAll("#kartentabelle tbody tr"),a=0;c.forEach(o=>{o.style.display!=="none"&&a++}),document.getElementById("eintragsAnzahl").textContent=`(${a})`}function k(){let c=document.querySelectorAll("#kartentabelle tbody tr"),a=0;c.forEach(o=>{if(o.style.display==="none")return;let u=o.querySelectorAll("div[id^='kartenContainer_'] img");a+=u.length}),document.getElementById("kartenAnzahl").textContent=`(${a})`}async function R(c){let a=document.getElementById(`kartenContainer_${c}`),o=await l(c);if(!o)return;let u=o.split(";").filter(d=>d.trim()),s=await S(u.map(d=>parseInt(d)));s.sort((d,y)=>(y.avg30||0)-(d.avg30||0));let m=document.createDocumentFragment();for(let d of s){window.cachedCards[d.cardId]=d;let y=document.createElement("img");y.alt=d.cardId,y.style.width="50px",y.style.height="69px",y.style.objectFit="cover",y.src=d.imageLow,y.addEventListener("click",()=>D(c,u.indexOf(String(d.id)))),m.appendChild(y)}a.appendChild(m)}async function D(c,a){let o=document.querySelector("#overlay");o.innerHTML='<div id="overlayContent"><div class="loader"></div></div>',o.classList.remove("hidden"),o.classList.add("shown");let u=await l(c);if(!u)return;let s=u.split(";").filter(y=>y.trim()!=="");if(s.length===0){o.classList.add("hidden"),o.classList.remove("shown");return}let m=a;async function d(){let y=s[m];try{let b=await E(y),f="Unbekannt";if(b.addedAt){let w=new Date(b.addedAt),T={day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"};f=w.toLocaleString("de-DE",T)}let h="Keine Angabe";b.basic==1&&(h="Basic"),b.reverse==1&&(h="Reverse"),b.holo==1&&(h="Holo");let v=await M(b.cardId);if(v==null){let w=q(b.cardId);v=await M(w)}let C="\u2013";if(v!=null){let w=v.toFixed(2),T="#DEDEDE",P="\u{1FA99}";v>20?(T="#FF4444",P="\u{1F525}"):v>5&&(T="#FFAA00",P="\u{1F4B0}"),C=`<span style="color:${T};">${P} ${w}\u20AC</span>`}o.innerHTML=`
            <div id="overlayContent">
            <button class="closeGallery" id="closeGallery">X</button>
              <h2>Karte ansehen</h2>
              <div style="display:flex; align-items:center; justify-content:center;">
                <div style="display:flex; flex-direction:column; align-items:center;">
                  <img src="${b.imageHigh}" alt="${y}" style="max-width:300px; max-height:400px; margin:0 20px;">
                  <p style="margin-top:10px;">
                    ID: ${b.cardId} | Variante: <strong>${h}</strong><br>
                    30d-Wert: <strong>${C}</strong><br>
                    Hinzugef\xFCgt am: <strong>${f}
                  </p>
                </div>
              </div>
          ...
          `,document.getElementById("prevCard").addEventListener("click",()=>{m=(m-1+s.length)%s.length,d()}),document.getElementById("nextCard").addEventListener("click",()=>{m=(m+1)%s.length,d()}),document.getElementById("deleteCard").addEventListener("click",async()=>{if(confirm("Willst du diese Karte wirklich l\xF6schen?")){let w=s[m];await $.run("DELETE FROM cards WHERE id = ?",[w]),s.splice(m,1),await g(c,s.join(";")+";"),o.classList.add("hidden"),o.classList.remove("shown"),o.innerHTML="";let T=document.getElementById(`kartenContainer_${c}`);T.innerHTML="",R(c),k(),j()}}),document.getElementById("closeGallery").addEventListener("click",()=>{o.classList.add("hidden"),o.classList.remove("shown"),o.innerHTML=""})}catch(b){console.error("Fehler beim Anzeigen der Karte:",b),o.classList.add("hidden"),o.classList.remove("shown"),o.innerHTML=""}}d()}window.openOverlay=async function(c){let a=document.querySelector("#overlay");a.innerHTML=`
        <div id="overlayContent">
          <h2>Bitte warten...</h2>
          <p>Karten werden geladen</p>
          <div class="loader"></div>
        </div>
      `,a.classList.remove("hidden"),a.classList.add("shown");try{let o=await r(c),u=await i(c);u=="Nidoran\u2642"&&(u="Nidoran \u2642"),u=="Nidoran\u2640"&&(u="Nidoran \u2640"),u=="Sirfetch\u2019d"&&(u="Sirfetch'd");let s=window.cachedPokemonCardsByName[u];if(s||(s=await F(u),s&&(window.cachedPokemonCardsByName[u]=s)),!s||s.length===0){a.innerHTML=`
            <div id='overlayContent'>
              <h2>Keine Karten gefunden.</h2> 
              <button class="overlayMenuBtn" id="BackBtn">Schlie\xDFen</button>
            </div>
          `,document.getElementById("BackBtn").addEventListener("click",d=>{d.preventDefault(),a.classList.add("hidden"),a.classList.remove("shown"),a.innerHTML=""});return}let m=`
          <div id="overlayContent">
        ...
        `;for(let d of s){let y=d.avg30,b="\u2013";if(y!=null){let f=y.toFixed(2),h="#DEDEDE",v="\u{1FA99}";y>20?(h="#FF4444",v="\u{1F525}"):y>5&&(h="#FFAA00",v="\u{1F4B0}"),b=`<span style="color:${h}; font-size:14px;">${v} ${f}\u20AC</span>`}m+=`
        ...
        `,a.innerHTML=m,document.getElementById("BackBtn").addEventListener("click",d=>{d.preventDefault(),a.classList.add("hidden"),a.classList.remove("shown"),a.innerHTML=""})}catch(o){console.error(o),a.innerHTML=`
        <div id='overlayContent'>
          <h2>Fehler beim Laden.</h2>
          <button class="overlayMenuBtn" id="BackBtn">Schlie\xDFen</button>
        </div>`,document.getElementById("BackBtn").addEventListener("click",u=>{u.preventDefault(),a.classList.add("hidden"),a.classList.remove("shown"),a.innerHTML=""})}};function q(c){return c.replace(/-(0*)(\d+)/,(a,o,u)=>"-"+parseInt(u,10))}async function F(c){var a,o;try{let u=`https://api.pokemontcg.io/v2/cards?q=name:"${c}"&orderBy=-set.releaseDate`,s=await te.get({url:u,headers:{Accept:"application/json","X-Api-Key":ae.API_KEY,Connection:"close"}});if(s.status!==200)return console.error("Fehler beim Abrufen der Karten:",s.status,s),null;let m=s.data.data;for(let d of m){let y=(a=d.cardmarket)==null?void 0:a.prices;d.avg30=(o=y==null?void 0:y.avg30)!=null?o:null}return m}catch(u){return console.error("Fehler beim Abrufen \xFCber HTTP:",u.message),null}}async function M(c){var a,o,u,s,m;try{let d=`https://api.pokemontcg.io/v2/cards?q=id:${c}`,y=await te.get({url:d,headers:{Accept:"application/json","X-Api-Key":ae.API_KEY,Connection:"close"}});if(y.status!==200||!((o=(a=y.data)==null?void 0:a.data)!=null&&o.length))return console.error("Fehler beim Abrufen der Karte:",y.status,y),null;let b=(s=(u=y.data.data[0])==null?void 0:u.cardmarket)==null?void 0:s.prices;return(m=b==null?void 0:b.avg30)!=null?m:null}catch(d){return console.error("Fehler beim Preisabruf:",d.message),null}}window.karteAusw\u00E4hlen=async function(c,a,o){var b,f;let u=document.querySelector("#overlay");u.innerHTML='<div id="overlayContent"><div class="loader"></div></div>',u.classList.remove("hidden"),u.classList.add("shown");let s=await te.get({url:`https://api.pokemontcg.io/v2/cards/${c}`,headers:{Accept:"application/json","X-Api-Key":ae.API_KEY,Connection:"close"}});if(s.status!==200){console.error("Fehler beim Abrufen der Karte:",s.status,s);return}let m=s.data.data;m.imageSmall=((b=m.images)==null?void 0:b.small)||null,m.imageLarge=((f=m.images)==null?void 0:f.large)||null;let d=await p(m);if(!d){console.error("Keine ID von insertCard erhalten \u2013 Abbruch.");return}m.id=d,window.cachedCards[m.cardId]=m,u.innerHTML=`
        <div id="overlayContent">
      ...
      `;async function y(h){u.innerHTML='<div id="overlayContent"><div class="loader"></div></div>',u.classList.remove("hidden"),u.classList.add("shown"),h!=="none"&&await $.run(`UPDATE cards SET ${h} = 1 WHERE id = ?`,[d]);let v=await l(a);v||(v=""),v+=d+";",await g(a,v);let C=document.getElementById(`kartenContainer_${a}`);C.innerHTML="",await R(a),u.classList.add("hidden"),u.classList.remove("shown"),u.innerHTML="",B(),k(),j()}document.getElementById("btnBasic").addEventListener("click",()=>y("basic")),document.getElementById("btnReverse").addEventListener("click",()=>y("reverse")),document.getElementById("btnHolo").addEventListener("click",()=>y("holo")),document.getElementById("closeOverlayConfirm").addEventListener("click",()=>y("none"))};async function j(){try{let c=await $.query("SELECT avg30 FROM cards WHERE avg30 IS NOT NULL"),a=await $.query("SELECT avg30 FROM trainer WHERE avg30 IS NOT NULL"),o=await $.query("SELECT avg30 FROM energy WHERE avg30 IS NOT NULL"),u=0;for(let d of c.values)u+=d.avg30;for(let d of a.values)u+=d.avg30;for(let d of o.values)u+=d.avg30;let s="\u{1FA99}";u>1e3?s="\u{1F525}":u>500&&(s="\u{1F4B0}");let m=`Gesamtwert: ${s} ${u.toFixed(2)}\u20AC`;document.getElementById("gesamtwert").textContent=m}catch(c){console.error("Fehler beim Berechnen des Gesamtwerts:",c)}}async function Z(){let c=await $.query("SELECT cardId FROM cards"),a=await $.query("SELECT cardId FROM trainer"),o=await $.query("SELECT cardId FROM energy"),u=0,s=0,m=c.values.length+a.values.length+o.values.length;alert(`Aktualisierung von ${m} Preisen gestartet.`);for(let y of c.values){let b=y.cardId,f=await M(b);if(f==null){let C=q(b);f=await M(C)}f!=null&&(await W(b,f),u++),s++;let h=Math.round(s/m*100),v=document.getElementById("preiseAktualisierenProgress");v&&(v.textContent=h+"%")}for(let y of a.values){let b=y.cardId,f=await M(b);if(f==null){let C=q(b);f=await M(C)}f!=null&&(await $.run("UPDATE trainer SET avg30 = ? WHERE cardId = ?",[f,b]),u++),s++;let h=Math.round(s/m*100),v=document.getElementById("preiseAktualisierenProgress");v&&(v.textContent=h+"%")}for(let y of o.values){let b=y.cardId,f=await M(b);if(f==null){let C=q(b);f=await M(C)}f!=null&&(await $.run("UPDATE energy SET avg30 = ? WHERE cardId = ?",[f,b]),u++),s++;let h=Math.round(s/m*100),v=document.getElementById("preiseAktualisierenProgress");v&&(v.textContent=h+"%")}let d=document.getElementById("preiseAktualisierenProgress");d&&(d.textContent=""),alert(`${u} Preise wurden aktualisiert!`),j()}window.aktualisiereAllePreise=Z;function fe(){let a=document.getElementById("search").value.toUpperCase(),u=document.getElementById("kartentabelle").getElementsByTagName("tr");for(let s=1;s<u.length;s++){u[s].style.display="none";let m=u[s].getElementsByTagName("td");for(let d=0;d<m.length;d++){let y=m[d];if(y&&y.innerHTML.toUpperCase().indexOf(a)>-1){u[s].style.display="";break}}}B(),k(),j()}window.searchTable=fe;let L={reverse:"neutral",holo:"neutral",v:"neutral",vmax:"neutral",ex:"neutral",shiny:"neutral"};function be(){document.querySelectorAll("#kartentabelle tbody tr").forEach(a=>{let u=a.querySelector("div[id^='kartenContainer_']").querySelectorAll("img"),s=!1,m=!1,d=!1,y=!1,b=!1,f=!1;u.forEach(v=>{var T,P,O,J,ge,je,$e,Ne,We,Ge,ze;let C=v.alt,w=(T=window.cachedCards)==null?void 0:T[C];w&&(w.reverse==1&&(s=!0),w.holo==1&&(m=!0),((P=w.subTypes)!=null&&P.toLowerCase().includes("v")||(O=w.cardName)!=null&&O.toLowerCase().includes(" v"))&&(d=!0),((J=w.subTypes)!=null&&J.toLowerCase().includes("vmax")||(ge=w.cardName)!=null&&ge.toLowerCase().includes(" vmax")||(je=w.subTypes)!=null&&je.toLowerCase().includes("vstar")||($e=w.cardName)!=null&&$e.toLowerCase().includes(" vstar"))&&(y=!0),((Ne=w.subTypes)!=null&&Ne.toLowerCase().includes("ex")||(We=w.cardName)!=null&&We.toLowerCase().includes(" ex"))&&(b=!0),((Ge=w.subTypes)!=null&&Ge.toLowerCase().includes("radiant")||(ze=w.rarity)!=null&&ze.toLowerCase().includes("shiny"))&&(f=!0))});let h=!0;L.reverse==="positive"&&!s&&(h=!1),L.reverse==="negative"&&s&&(h=!1),L.holo==="positive"&&!m&&(h=!1),L.holo==="negative"&&m&&(h=!1),L.v==="positive"&&!d&&(h=!1),L.v==="negative"&&d&&(h=!1),L.vmax==="positive"&&!y&&(h=!1),L.vmax==="negative"&&y&&(h=!1),L.ex==="positive"&&!b&&(h=!1),L.ex==="negative"&&b&&(h=!1),L.shiny==="positive"&&!f&&(h=!1),L.shiny==="negative"&&f&&(h=!1),a.style.display=h?"":"none"}),B(),k(),j()}function Q(c){L[c]==="neutral"?L[c]="positive":L[c]==="positive"?L[c]="negative":L[c]="neutral",be(),H()}function H(){let c=document.getElementById("filter-reverse"),a=document.getElementById("filter-holo"),o=document.getElementById("filter-v"),u=document.getElementById("filter-vmax"),s=document.getElementById("filter-ex"),m=document.getElementById("filter-shiny");c.className=L.reverse==="positive"?"active-positive":L.reverse==="negative"?"active-negative":"",a.className=L.holo==="positive"?"active-positive":L.holo==="negative"?"active-negative":"",o.className=L.v==="positive"?"active-positive":L.v==="negative"?"active-negative":"",u.className=L.vmax==="positive"?"active-positive":L.vmax==="negative"?"active-negative":"",s.className=L.ex==="positive"?"active-positive":L.ex==="negative"?"active-negative":"",m.className=L.shiny==="positive"?"active-positive":L.shiny==="negative"?"active-negative":""}document.getElementById("filter-alle").addEventListener("click",c=>{c.preventDefault(),L.reverse="neutral",L.holo="neutral",L.v="neutral",L.vmax="neutral",L.ex="neutral",L.shiny="neutral",be(),H()}),document.getElementById("filter-reverse").addEventListener("click",c=>{c.preventDefault(),Q("reverse")}),document.getElementById("filter-holo").addEventListener("click",c=>{c.preventDefault(),Q("holo")}),document.getElementById("filter-v").addEventListener("click",c=>{c.preventDefault(),Q("v")}),document.getElementById("filter-vmax").addEventListener("click",c=>{c.preventDefault(),Q("vmax")}),document.getElementById("filter-ex").addEventListener("click",c=>{c.preventDefault(),Q("ex")}),document.getElementById("filter-shiny").addEventListener("click",c=>{c.preventDefault(),Q("shiny")}),window.zeigePokemonTabelle=function(){document.getElementById("kartentabelle").classList.remove("hidden"),document.getElementById("trainertabelle").classList.add("hidden"),document.getElementById("energietabelle").classList.add("hidden")},window.zeigeTrainerTabelle=async function(){document.getElementById("kartentabelle").classList.add("hidden"),document.getElementById("trainertabelle").classList.remove("hidden"),document.getElementById("energietabelle").classList.add("hidden");let c=document.querySelector("#trainertabelle tbody");c.innerHTML="";let a=document.createElement("tr");a.innerHTML=`
      ...
      `,c.appendChild(o);let u=document.createElement("tr");u.innerHTML=`
        <td>Stadion</td>
        <td>
      ...
      `,c.appendChild(u);let s=document.createElement("tr");s.innerHTML=`
        <td>Ausr\xFCstung</td>
        <td>
      ...
      `,c.appendChild(s),await K()};async function K(){var f,h,v,C,w;let c=document.getElementById("supporterContainer"),a=document.getElementById("itemContainer"),o=document.getElementById("stadiumContainer"),u=document.getElementById("toolContainer"),s=await I();if(!s||!Array.isArray(s)){console.error("getTrainers() lieferte keine g\xFCltige Liste:",s);return}s.sort((T,P)=>(P.avg30||0)-(T.avg30||0));let m=document.createDocumentFragment(),d=document.createDocumentFragment(),y=document.createDocumentFragment(),b=document.createDocumentFragment();for(let T of s){window.cachedCards[T.cardId]=T;let P=document.createElement("img");P.src=T.imageLow,P.alt=T.cardId,P.style.width="50px",P.style.height="69px",P.style.objectFit="cover";let O=((f=T.subTypes)==null?void 0:f.toLowerCase())||"";P.addEventListener("click",()=>Y(T.id,O)),(h=T.subTypes)!=null&&h.toLowerCase().includes("supporter")?m.appendChild(P):(v=T.subTypes)!=null&&v.toLowerCase().includes("item")?d.appendChild(P):(C=T.subTypes)!=null&&C.toLowerCase().includes("stadium")?y.appendChild(P):(w=T.subTypes)!=null&&w.toLowerCase().includes("tool")&&b.appendChild(P)}c.appendChild(m),a.appendChild(d),o.appendChild(y),u.appendChild(b)}window.openTrainerOverlay=async function(c){let a=document.querySelector("#overlay");a.innerHTML=`
        <div id="overlayContent">
          <h2>Bitte warten...</h2>
          <p>Karten werden geladen</p>
          <div class="loader"></div>
        </div>
      `,a.classList.remove("hidden"),a.classList.add("shown");try{let o=window.cachedTrainerCardsByType[c];if(o||(o=await U(c),o&&(window.cachedTrainerCardsByType[c]=o)),!o||o.length===0){a.innerHTML=`
            <div id='overlayContent'>
              <h2>Keine Karten gefunden.</h2> 
              <button class="overlayMenuBtn" id="BackBtn">Schlie\xDFen</button>
            </div>
          ...
          <div id="overlayContent">
            ...
            <div class="kartenGrid">
        `;for(let s of o){let m=s.avg30,d="\u2013";if(m!=null){let b=m.toFixed(2),f="#DEDEDE",h="\u{1FA99}";m>20?(f="#FF4444",h="\u{1F525}"):m>5&&(f="#FFAA00",h="\u{1F4B0}"),d=`<span style="color:${f}; font-size:14px;">${h} ${b}\u20AC</span>`}let y=s.id.split("-")[1];u+=`
            <div class="kartenItem" data-id="${s.id}" data-number="${y}" onclick="trainerKarteAusw\xE4hlen('${s.id}')">
              <div>ID: ${s.id}</div>
        ...
        `,a.innerHTML=u,document.getElementById("BackBtn").addEventListener("click",()=>{a.classList.add("hidden"),a.classList.remove("shown"),a.innerHTML=""})}catch(o){console.error(o),a.innerHTML=`
          <div id='overlayContent'>
            <h2>Fehler beim Laden.</h2>
            <button class="overlayMenuBtn" id="BackBtn">Schlie\xDFen</button>
          </div>`,document.getElementById("BackBtn").addEventListener("click",()=>{a.classList.add("hidden"),a.classList.remove("shown"),a.innerHTML=""})}};async function U(c){var m,d,y,b;let a=[],o=1,u=250,s=!0;for(;s;){let f=`https://api.pokemontcg.io/v2/cards?q=supertype:Trainer subtypes:${c}&orderBy=name&page=${o}&pageSize=${u}`,h=await te.get({url:f,headers:{Accept:"application/json","X-Api-Key":ae.API_KEY,Connection:"close"}});if(h.status!==200||!((d=(m=h.data)==null?void 0:m.data)!=null&&d.length)){s=!1;break}let v=h.data.data;for(let C of v){let w=(y=C.cardmarket)==null?void 0:y.prices;C.avg30=(b=w==null?void 0:w.avg30)!=null?b:null}a=a.concat(v),v.length<u?s=!1:o++}return a}window.trainerKarteAusw\u00E4hlen=async function(c){var o,u;let a=document.querySelector("#overlay");a.innerHTML='<div id="overlayContent"><div class="loader"></div></div>',a.classList.remove("hidden"),a.classList.add("shown");try{let s=await te.get({url:`https://api.pokemontcg.io/v2/cards/${c}`,headers:{Accept:"application/json","X-Api-Key":ae.API_KEY,Connection:"close"}});if(s.status!==200){console.error("Fehler beim Abrufen der Karte:",s.status,s);return}let m=s.data.data;m.imageSmall=((o=m.images)==null?void 0:o.small)||null,m.imageLarge=((u=m.images)==null?void 0:u.large)||null;let d=await x(m);if(!d){console.error("Keine ID von insertCard erhalten \u2013 Abbruch.");return}m.id=d,window.cachedCards[m.cardId]=m,a.innerHTML=`
          <div id="overlayContent">
            <h2>Karte hinzugef\xFCgt!</h2>
        ...
        `;async function y(b,f){a.innerHTML='<div id="overlayContent"><div class="loader"></div></div>',a.classList.remove("hidden"),a.classList.add("shown");try{b!=="none"&&await $.run(`UPDATE trainer SET ${b} = 1 WHERE id = ?`,[f]);let h=document.getElementById("supporterContainer");h.innerHTML="";let v=document.getElementById("itemContainer");v.innerHTML="";let C=document.getElementById("stadiumContainer");C.innerHTML="";let w=document.getElementById("toolContainer");w.innerHTML="",await K()}catch(h){console.error("Fehler in finalizeTrainerSelection:",h.message,h)}a.classList.add("hidden"),a.classList.remove("shown"),a.innerHTML="",await j()}document.getElementById("btnBasic").addEventListener("click",()=>y("basic",d)),document.getElementById("btnReverse").addEventListener("click",()=>y("reverse",d)),document.getElementById("btnHolo").addEventListener("click",()=>y("holo",d)),document.getElementById("closeOverlayConfirm").addEventListener("click",()=>y("none",d))}catch(s){console.error("Fehler bei trainerKarteAusw\xE4hlen:",s),a.innerHTML=`
          <div id="overlayContent">
            <h2>Fehler beim Hinzuf\xFCgen.</h2>
            <p>${s.message}</p>
            <button class="overlayMenuBtn" id="closeOverlayConfirm">Schlie\xDFen</button>
          </div>
        `,document.getElementById("closeOverlayConfirm").addEventListener("click",()=>{a.classList.add("hidden"),a.classList.remove("shown"),a.innerHTML=""})}};async function Y(c,a){var b;let o=document.querySelector("#overlay");o.innerHTML='<div id="overlayContent"><div class="loader"></div></div>',o.classList.remove("hidden"),o.classList.add("shown");let u=await G();if(!u||!u.length)return;let s=[],m={};for(let f of u){let h=await N(f);if(!h)continue;let v=((b=h.subTypes)==null?void 0:b.toLowerCase())||"";(a==="supporter"&&v.includes("supporter")||a==="item"&&v.includes("item")||a==="stadium"&&v.includes("stadium")||a==="tool"&&v.includes("tool"))&&(s.push(f),m[f]=h)}if(!s.length){o.classList.add("hidden"),o.classList.remove("shown");return}let d=s.findIndex(f=>f===c);d===-1&&(d=0);async function y(){let f=s[d],h=m[f]||await N(f);if(!h)return;let v="Unbekannt";h.addedAt&&(v=new Date(h.addedAt).toLocaleString("de-DE",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"}));let C="Keine Angabe";h.basic==1&&(C="Basic"),h.reverse==1&&(C="Reverse"),h.holo==1&&(C="Holo");let w="\u2013",T=await M(h.cardId);if(T==null){let P=q(h.cardId);T=await M(P)}if(T!=null){let P=T.toFixed(2),O="#DEDEDE",J="\u{1FA99}";T>20?(O="#FF4444",J="\u{1F525}"):T>5&&(O="#FFAA00",J="\u{1F4B0}"),w=`<span style="color:${O};">${J} ${P}\u20AC</span>`}o.innerHTML=`
          <div id="overlayContent">
            <button class="closeGallery" id="closeGallery">X</button>
            <h2>Trainer-Karte ansehen</h2>
            <div style="display:flex; align-items:center; justify-content:center;">
              <div style="display:flex; flex-direction:column; align-items:center;">
                <img src="${h.imageHigh}" alt="${f}" style="max-width:300px; max-height:400px; margin:0 20px;">
                <p style="margin-top:10px;">
                  ID: ${h.cardId} | Variante: <strong>${C}</strong><br>
        ...
        `,document.getElementById("prevTrainer").addEventListener("click",()=>{d=(d-1+s.length)%s.length,y()}),document.getElementById("nextTrainer").addEventListener("click",()=>{d=(d+1)%s.length,y()}),document.getElementById("deleteTrainer").addEventListener("click",async()=>{if(confirm("Willst du diese Karte wirklich l\xF6schen?")){await $.run("DELETE FROM trainer WHERE id = ?",[f]),o.classList.add("hidden"),o.classList.remove("shown"),o.innerHTML="";let P=document.getElementById("supporterContainer"),O=document.getElementById("itemContainer"),J=document.getElementById("stadiumContainer"),ge=document.getElementById("toolContainer");P&&(P.innerHTML=""),O&&(O.innerHTML=""),J&&(J.innerHTML=""),ge&&(ge.innerHTML=""),await K(),await j()}}),document.getElementById("closeGallery").addEventListener("click",()=>{o.classList.add("hidden"),o.classList.remove("shown"),o.innerHTML=""})}y()}window.filterTrainerCardsByNumber=function(){let c=document.getElementById("nummerSuche").value.trim();document.querySelectorAll(".kartenItem").forEach(a=>{let o=a.dataset.number;a.style.display=o&&o.startsWith(c)?"block":"none"})},window.zeigeEnergieTabelle=async function(){document.getElementById("kartentabelle").classList.add("hidden"),document.getElementById("trainertabelle").classList.add("hidden"),document.getElementById("energietabelle").classList.remove("hidden");let c=document.querySelector("#energietabelle tbody");c.innerHTML="";let a=document.createElement("tr");a.innerHTML=`
        <td>Basis-Energie</td>
        <td>
      ...
      `,c.appendChild(o),await _()};async function _(){var m,d,y;let c=document.getElementById("basisEnergieContainer"),a=document.getElementById("spezialEnergieContainer"),o=await X();if(!o||!Array.isArray(o)){console.error("getEnergies() lieferte keine g\xFCltige Liste:",o);return}o.sort((b,f)=>(f.avg30||0)-(b.avg30||0));let u=document.createDocumentFragment(),s=document.createDocumentFragment();for(let b of o){window.cachedCards[b.cardId]=b;let f=document.createElement("img");f.src=b.imageLow,f.alt=b.cardId,f.style.width="50px",f.style.height="69px",f.style.objectFit="cover";let h=((m=b.subTypes)==null?void 0:m.toLowerCase())||"";f.addEventListener("click",()=>ce(b.id,h.includes("basic")?"basic":"special")),(d=b.subTypes)!=null&&d.toLowerCase().includes("basic")?u.appendChild(f):(y=b.subTypes)!=null&&y.toLowerCase().includes("special")&&s.appendChild(f)}c.appendChild(u),a.appendChild(s)}window.openEnergieOverlay=async function(c){let a=document.querySelector("#overlay");a.innerHTML=`
        <div id="overlayContent">
          <h2>Bitte warten...</h2>
          <p>Karten werden geladen</p>
          <div class="loader"></div>
        </div>
      `,a.classList.remove("hidden"),a.classList.add("shown");try{let o=window.cachedEnergyCardsByType[c];if(o||(o=await V(c),o&&(window.cachedEnergyCardsByType[c]=o)),!o||o.length===0){a.innerHTML=`
            <div id='overlayContent'>
              <h2>Keine Karten gefunden.</h2> 
              <button class="overlayMenuBtn" id="BackBtn">Schlie\xDFen</button>
            </div>
          ...
          <div id="overlayContent">
            ...
            <div class="kartenGrid">
        `;for(let s of o){let m=s.avg30,d="\u2013";if(m!=null){let b=m.toFixed(2),f="#DEDEDE",h="\u{1FA99}";m>20?(f="#FF4444",h="\u{1F525}"):m>5&&(f="#FFAA00",h="\u{1F4B0}"),d=`<span style="color:${f}; font-size:14px;">${h} ${b}\u20AC</span>`}let y=s.id.split("-")[1];u+=`
            <div class="kartenItem" data-id="${s.id}" data-number="${y}" onclick="energieKarteAusw\xE4hlen('${s.id}')">
              <div>ID: ${s.id}</div>
              <img src="${s.images.small}" alt="${s.name}">
              <div>${d}</div>
            </div>
        ...
        `,a.innerHTML=u,document.getElementById("BackBtn").addEventListener("click",()=>{a.classList.add("hidden"),a.classList.remove("shown"),a.innerHTML=""})}catch(o){console.error(o),a.innerHTML=`
          <div id='overlayContent'>
            <h2>Fehler beim Laden.</h2>
            <button class="overlayMenuBtn" id="BackBtn">Schlie\xDFen</button>
          </div>`,document.getElementById("BackBtn").addEventListener("click",()=>{a.classList.add("hidden"),a.classList.remove("shown"),a.innerHTML=""})}};async function V(c){var m,d,y,b;let a=[],o=1,u=250,s=!0;for(;s;){let f=`https://api.pokemontcg.io/v2/cards?q=supertype:Energy subtypes:${c}&orderBy=name&page=${o}&pageSize=${u}`,h=await te.get({url:f,headers:{Accept:"application/json","X-Api-Key":ae.API_KEY,Connection:"close"}});if(h.status!==200||!((d=(m=h.data)==null?void 0:m.data)!=null&&d.length)){s=!1;break}let v=h.data.data;for(let C of v){let w=(y=C.cardmarket)==null?void 0:y.prices;C.avg30=(b=w==null?void 0:w.avg30)!=null?b:null}a=a.concat(v),v.length<u?s=!1:o++}return a}window.energieKarteAusw\u00E4hlen=async function(c){var o,u;let a=document.querySelector("#overlay");a.innerHTML='<div id="overlayContent"><div class="loader"></div></div>',a.classList.remove("hidden"),a.classList.add("shown");try{let s=await te.get({url:`https://api.pokemontcg.io/v2/cards/${c}`,headers:{Accept:"application/json","X-Api-Key":ae.API_KEY,Connection:"close"}});if(s.status!==200){console.error("Fehler beim Abrufen der Karte:",s.status,s);return}let m=s.data.data;m.imageSmall=((o=m.images)==null?void 0:o.small)||null,m.imageLarge=((u=m.images)==null?void 0:u.large)||null;let d=await z(m);if(!d){console.error("Keine ID von insertCard erhalten \u2013 Abbruch.");return}m.id=d,window.cachedCards[m.cardId]=m,a.innerHTML=`
          <div id="overlayContent">
            <h2>Karte hinzugef\xFCgt!</h2>
            <p>Du hast <strong>${c}</strong> ausgew\xE4hlt.</p>
            <br>
        ...
        `;async function y(b,f){a.innerHTML='<div id="overlayContent"><div class="loader"></div></div>',a.classList.remove("hidden"),a.classList.add("shown");try{b!=="none"&&await $.run(`UPDATE energy SET ${b} = 1 WHERE id = ?`,[f]);let h=document.getElementById("basisEnergieContainer");h.innerHTML="";let v=document.getElementById("spezialEnergieContainer");v.innerHTML="",await _()}catch(h){console.error("Fehler in finalizeEnergieSelection:",h.message,h)}a.classList.add("hidden"),a.classList.remove("shown"),a.innerHTML="",await j()}document.getElementById("btnBasic").addEventListener("click",()=>y("basic",d)),document.getElementById("btnReverse").addEventListener("click",()=>y("reverse",d)),document.getElementById("btnHolo").addEventListener("click",()=>y("holo",d)),document.getElementById("closeOverlayConfirm").addEventListener("click",()=>y("none",d))}catch(s){console.error("Fehler bei energieKarteAusw\xE4hlen:",s),a.innerHTML=`
          <div id="overlayContent">
            <h2>Fehler beim Hinzuf\xFCgen.</h2>
            <p>${s.message}</p>
            <button class="overlayMenuBtn" id="closeOverlayConfirm">Schlie\xDFen</button>
          </div>
        `,document.getElementById("closeOverlayConfirm").addEventListener("click",()=>{a.classList.add("hidden"),a.classList.remove("shown"),a.innerHTML=""})}};async function ce(c,a){var b;let o=document.querySelector("#overlay");o.innerHTML='<div id="overlayContent"><div class="loader"></div></div>',o.classList.remove("hidden"),o.classList.add("shown");let u=await se();if(!u||!u.length)return;let s=[],m={};for(let f of u){let h=await le(f);if(!h)continue;let v=((b=h.subTypes)==null?void 0:b.toLowerCase())||"";(a==="basic"&&v.includes("basic")||a==="special"&&v.includes("special"))&&(s.push(f),m[f]=h)}if(!s.length){o.classList.add("hidden"),o.classList.remove("shown");return}let d=s.findIndex(f=>f===c);d===-1&&(d=0);async function y(){let f=s[d],h=m[f]||await le(f);if(!h)return;let v="Unbekannt";h.addedAt&&(v=new Date(h.addedAt).toLocaleString("de-DE",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"}));let C="Keine Angabe";h.basic==1&&(C="Basic"),h.reverse==1&&(C="Reverse"),h.holo==1&&(C="Holo");let w="\u2013",T=await M(h.cardId);if(T==null){let P=q(h.cardId);T=await M(P)}if(T!=null){let P=T.toFixed(2),O="#DEDEDE",J="\u{1FA99}";T>20?(O="#FF4444",J="\u{1F525}"):T>5&&(O="#FFAA00",J="\u{1F4B0}"),w=`<span style="color:${O};">${J} ${P}\u20AC</span>`}o.innerHTML=`
          <div id="overlayContent">
            <button class="closeGallery" id="closeGallery">X</button>
        ...
        `,document.getElementById("prevEnergie").addEventListener("click",()=>{d=(d-1+s.length)%s.length,y()}),document.getElementById("nextEnergie").addEventListener("click",()=>{d=(d+1)%s.length,y()}),document.getElementById("deleteEnergie").addEventListener("click",async()=>{if(confirm("Willst du diese Karte wirklich l\xF6schen?"))try{await $.run("DELETE FROM energy WHERE id = ?",[f]),o.classList.add("hidden"),o.classList.remove("shown"),o.innerHTML="";let P=document.getElementById("basisEnergieContainer"),O=document.getElementById("spezialEnergieContainer");P&&(P.innerHTML=""),O&&(O.innerHTML=""),await _(),await j()}catch(P){console.error("Fehler beim L\xF6schen der Energie-Karte:",P),alert("Beim L\xF6schen ist ein Fehler aufgetreten.")}}),document.getElementById("closeGallery").addEventListener("click",()=>{o.classList.add("hidden"),o.classList.remove("shown"),o.innerHTML=""})}y()}window.filterEnergieCardsByNumber=function(){let c=document.getElementById("nummerSuche").value.trim();document.querySelectorAll(".kartenItem").forEach(a=>{let o=a.dataset.number;a.style.display=o&&o.startsWith(c)?"block":"none"})}})()});})();
