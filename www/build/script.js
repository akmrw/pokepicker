(()=>{var pt=Object.defineProperty;var ee=(r,e)=>()=>(r&&(e=r(r=0)),e);var yt=(r,e)=>()=>(e||r((e={exports:{}}).exports,e),e.exports),Ce=(r,e)=>{for(var t in e)pt(r,t,{get:e[t],enumerable:!0})};var ft,bt,Ue,er,tr,de,pe,vt,wt,Et,ve,Ve,rr,we,Te=ee(()=>{ft=r=>{let e=new Map;e.set("web",{name:"web"});let t=r.CapacitorPlatforms||{currentPlatform:{name:"web"},platforms:e},n=(l,p)=>{t.platforms.set(l,p)},i=l=>{t.platforms.has(l)&&(t.currentPlatform=t.platforms.get(l))};return t.addPlatform=n,t.setPlatform=i,t},bt=r=>r.CapacitorPlatforms=ft(r),Ue=bt(typeof globalThis!="undefined"?globalThis:typeof self!="undefined"?self:typeof window!="undefined"?window:typeof global!="undefined"?global:{}),er=Ue.addPlatform,tr=Ue.setPlatform;(function(r){r.Unimplemented="UNIMPLEMENTED",r.Unavailable="UNAVAILABLE"})(de||(de={}));pe=class extends Error{constructor(e,t){super(e),this.message=e,this.code=t}},vt=r=>{var e,t;return r!=null&&r.androidBridge?"android":!((t=(e=r==null?void 0:r.webkit)===null||e===void 0?void 0:e.messageHandlers)===null||t===void 0)&&t.bridge?"ios":"web"},wt=r=>{var e,t,n,i,l;let p=r.CapacitorCustomPlatform||null,y=r.Capacitor||{},E=y.Plugins=y.Plugins||{},L=r.CapacitorPlatforms,W=()=>p!==null?p.name:vt(r),C=((e=L==null?void 0:L.currentPlatform)===null||e===void 0?void 0:e.getPlatform)||W,T=()=>C()!=="web",G=((t=L==null?void 0:L.currentPlatform)===null||t===void 0?void 0:t.isNativePlatform)||T,N=P=>{let k=ne.get(P);return!!(k!=null&&k.platforms.has(C())||se(P))},X=((n=L==null?void 0:L.currentPlatform)===null||n===void 0?void 0:n.isPluginAvailable)||N,z=P=>{var k;return(k=y.PluginHeaders)===null||k===void 0?void 0:k.find(A=>A.name===P)},se=((i=L==null?void 0:L.currentPlatform)===null||i===void 0?void 0:i.getPluginHeader)||z,le=P=>r.console.error(P),re=(P,k,A)=>Promise.reject(`${A} does not have an implementation of "${k}".`),ne=new Map,ie=(P,k={})=>{let A=ne.get(P);if(A)return console.warn(`Capacitor plugin "${P}" already registered. Cannot register plugins twice.`),A.proxy;let F=C(),q=se(P),D,x=async()=>(!D&&F in k?D=typeof k[F]=="function"?D=await k[F]():D=k[F]:p!==null&&!D&&"web"in k&&(D=typeof k.web=="function"?D=await k.web():D=k.web),D),O=(H,K)=>{var U,Y;if(q){let _=q==null?void 0:q.methods.find(V=>K===V.name);if(_)return _.rtype==="promise"?V=>y.nativePromise(P,K.toString(),V):(V,ce)=>y.nativeCallback(P,K.toString(),V,ce);if(H)return(U=H[K])===null||U===void 0?void 0:U.bind(H)}else{if(H)return(Y=H[K])===null||Y===void 0?void 0:Y.bind(H);throw new pe(`"${P}" plugin is not implemented on ${F}`,de.Unimplemented)}},Z=H=>{let K,U=(...Y)=>{let _=x().then(V=>{let ce=O(V,H);if(ce){let c=ce(...Y);return K=c==null?void 0:c.remove,c}else throw new pe(`"${P}.${H}()" is not implemented on ${F}`,de.Unimplemented)});return H==="addListener"&&(_.remove=async()=>K()),_};return U.toString=()=>`${H.toString()}() { [capacitor code] }`,Object.defineProperty(U,"name",{value:H,writable:!1,configurable:!1}),U},fe=Z("addListener"),I=Z("removeListener"),be=(H,K)=>{let U=fe({eventName:H},K),Y=async()=>{let V=await U;I({eventName:H,callbackId:V},K)},_=new Promise(V=>U.then(()=>V({remove:Y})));return _.remove=async()=>{console.warn("Using addListener() without 'await' is deprecated."),await Y()},_},Q=new Proxy({},{get(H,K){switch(K){case"$$typeof":return;case"toJSON":return()=>({});case"addListener":return q?be:fe;case"removeListener":return I;default:return Z(K)}}});return E[P]=Q,ne.set(P,{name:P,proxy:Q,platforms:new Set([...Object.keys(k),...q?[F]:[]])}),Q},he=((l=L==null?void 0:L.currentPlatform)===null||l===void 0?void 0:l.registerPlugin)||ie;return y.convertFileSrc||(y.convertFileSrc=P=>P),y.getPlatform=C,y.handleError=le,y.isNativePlatform=G,y.isPluginAvailable=X,y.pluginMethodNoop=re,y.registerPlugin=he,y.Exception=pe,y.DEBUG=!!y.DEBUG,y.isLoggingEnabled=!!y.isLoggingEnabled,y.platform=y.getPlatform(),y.isNative=y.isNativePlatform(),y},Et=r=>r.Capacitor=wt(r),ve=Et(typeof globalThis!="undefined"?globalThis:typeof self!="undefined"?self:typeof window!="undefined"?window:typeof global!="undefined"?global:{}),Ve=ve.registerPlugin,rr=ve.Plugins,we=class{constructor(e){this.listeners={},this.windowListeners={},e&&(console.warn(`Capacitor WebPlugin "${e.name}" config object was deprecated in v3 and will be removed in v4.`),this.config=e)}addListener(e,t){this.listeners[e]||(this.listeners[e]=[]),this.listeners[e].push(t);let i=this.windowListeners[e];i&&!i.registered&&this.addWindowListener(i);let l=async()=>this.removeListener(e,t),p=Promise.resolve({remove:l});return Object.defineProperty(p,"remove",{value:async()=>{console.warn("Using addListener() without 'await' is deprecated."),await l()}}),p}async removeAllListeners(){this.listeners={};for(let e in this.windowListeners)this.removeWindowListener(this.windowListeners[e]);this.windowListeners={}}notifyListeners(e,t){let n=this.listeners[e];n&&n.forEach(i=>i(t))}hasListeners(e){return!!this.listeners[e].length}registerWindowListener(e,t){this.windowListeners[t]={registered:!1,windowEventName:e,pluginEventName:t,handler:n=>{this.notifyListeners(t,n)}}}unimplemented(e="not implemented"){return new ve.Exception(e,de.Unimplemented)}unavailable(e="not available"){return new ve.Exception(e,de.Unavailable)}async removeListener(e,t){let n=this.listeners[e];if(!n)return;let i=n.indexOf(t);this.listeners[e].splice(i,1),this.listeners[e].length||this.removeWindowListener(this.windowListeners[e])}addWindowListener(e){window.addEventListener(e.windowEventName,e.handler),e.registered=!0}removeWindowListener(e){e&&(window.removeEventListener(e.windowEventName,e.handler),e.registered=!1)}}});var Je,Pe,Ie,xe=ee(()=>{Je=async r=>new Promise((e,t)=>{let n=new FileReader;n.onload=()=>{let i=n.result,l=i.substr(i.indexOf(",")+1);e(l)},n.onerror=i=>t(i),n.readAsDataURL(r)}),Pe=r=>encodeURIComponent(r).replace(/%(2[346B]|5E|60|7C)/g,decodeURIComponent).replace(/[()]/g,escape),Ie=r=>r.replace(/(%[\dA-F]{2})+/gi,decodeURIComponent)});var _e,Ee,Xe,Ze,Be,Qe=ee(()=>{xe();_e=(r,e,t={})=>{let n=Pe(r),i=Pe(e),l=`; expires=${(t.expires||"").replace("expires=","")}`,p=(t.path||"/").replace("path=","");document.cookie=`${n}=${i||""}${l}; path=${p}`},Ee=()=>{let r=[],e={};if(!document.cookie)return r;let t=document.cookie.split(";")||[];for(let i of t){let[l,p]=i.replace(/=/,"CAP_COOKIE").split("CAP_COOKIE");l=Ie(l).trim(),p=Ie(p).trim(),e[l]=p}let n=Object.entries(e);for(let[i,l]of n)r.push({key:i,value:l});return r},Xe=r=>{let e=Ee();for(let t of e)if(t.key===r)return t;return{key:r,value:""}},Ze=r=>{document.cookie=`${r}=; Max-Age=0`},Be=()=>{let r=document.cookie.split(";")||[];for(let e of r)document.cookie=e.replace(/^ +/,"").replace(/=.*/,`=;expires=${new Date().toUTCString()};path=/`)}});var St,Lt,Ae,oe,Ye,et,tt,rt,nt,at=ee(()=>{xe();St=(r={})=>{let e=Object.keys(r);return Object.keys(r).map(i=>i.toLocaleLowerCase()).reduce((i,l,p)=>(i[l]=r[e[p]],i),{})},Lt=(r,e=!0)=>r?Object.entries(r).reduce((n,i)=>{let[l,p]=i,y,E;return Array.isArray(p)?(E="",p.forEach(L=>{y=e?encodeURIComponent(L):L,E+=`${l}=${y}&`}),E.slice(0,-1)):(y=e?encodeURIComponent(p):p,E=`${l}=${y}`),`${n}&${E}`},"").substr(1):null,Ae=(r,e={})=>{let t=Object.assign({method:r.method||"GET",headers:r.headers},e),i=St(r.headers)["content-type"]||"";if(typeof r.data=="string")t.body=r.data;else if(i.includes("application/x-www-form-urlencoded")){let l=new URLSearchParams;for(let[p,y]of Object.entries(r.data||{}))l.set(p,y);t.body=l.toString()}else if(i.includes("multipart/form-data")){let l=new FormData;if(r.data instanceof FormData)r.data.forEach((y,E)=>{l.append(E,y)});else for(let y of Object.keys(r.data))l.append(y,r.data[y]);t.body=l;let p=new Headers(t.headers);p.delete("content-type"),t.headers=p}else(i.includes("application/json")||typeof r.data=="object")&&(t.body=JSON.stringify(r.data));return t},oe=async r=>{let e=Ae(r,r.webFetchExtra),t=Lt(r.params,r.shouldEncodeUrlParams),n=t?`${r.url}?${t}`:r.url,i=await fetch(n,e),l=i.headers.get("content-type")||"",{responseType:p="text"}=i.ok?r:{};l.includes("application/json")&&(p="json");let y;switch(p){case"arraybuffer":case"blob":let L=await i.blob();y=await Je(L);break;case"json":y=await i.json();break;case"document":case"text":default:y=await i.text()}let E={};return i.headers.forEach((L,W)=>{E[W]=L}),{data:y,headers:E,status:i.status,url:i.url}},Ye=async r=>oe(Object.assign(Object.assign({},r),{method:"GET"})),et=async r=>oe(Object.assign(Object.assign({},r),{method:"POST"})),tt=async r=>oe(Object.assign(Object.assign({},r),{method:"PUT"})),rt=async r=>oe(Object.assign(Object.assign({},r),{method:"PATCH"})),nt=async r=>oe(Object.assign(Object.assign({},r),{method:"DELETE"}))});var Re={};Ce(Re,{HttpWeb:()=>Me});var Me,qe=ee(()=>{Te();Qe();at();Me=class extends we{constructor(){super(),this.request=async e=>oe(e),this.get=async e=>Ye(e),this.post=async e=>et(e),this.put=async e=>tt(e),this.patch=async e=>rt(e),this.del=async e=>nt(e),this.getCookiesMap=async e=>{let t=Ee(),n={};for(let i of t)n[i.key]=i.value;return n},this.getCookies=async e=>{let{url:t}=e;return{cookies:Ee()}},this.setCookie=async e=>{let{key:t,value:n,expires:i="",path:l=""}=e;_e(t,n,{expires:i,path:l})},this.getCookie=async e=>Xe(e.key),this.deleteCookie=async e=>Ze(e.key),this.clearCookies=async e=>Be(),this.clearAllCookies=async()=>Be(),this.uploadFile=async e=>{let t=new FormData;t.append(e.name,e.blob||"undefined");let n=Object.assign(Object.assign({},e),{body:t,method:"POST"});return this.post(n)},this.downloadFile=async e=>{let t=Ae(e,e.webFetchExtra),n=await fetch(e.url,t),i;if(!(e!=null&&e.progress))i=await n.blob();else if(!(n!=null&&n.body))i=new Blob;else{let l=n.body.getReader(),p=0,y=[],E=n.headers.get("content-type"),L=parseInt(n.headers.get("content-length")||"0",10);for(;;){let{done:T,value:G}=await l.read();if(T)break;y.push(G),p+=(G==null?void 0:G.length)||0;let N={type:"DOWNLOAD",url:e.url,bytes:p,contentLength:L};this.notifyListeners("progress",N)}let W=new Uint8Array(p),C=0;for(let T of y)typeof T!="undefined"&&(W.set(T,C),C+=T.length);i=new Blob([W.buffer],{type:E||void 0})}return{blob:i}}}}});var it=yt((ur,Tt)=>{Tt.exports={API_KEY:"a5d75d50-65e6-41a4-aa2f-9b2c93afaaa7"}});var ue,ye,Pt,It,xt,Fe,ke,me,ot,st,De,mr,Bt,At,Mt,Rt,He,hr,Ke=ee(()=>{(function(r){r.Unimplemented="UNIMPLEMENTED",r.Unavailable="UNAVAILABLE"})(ue||(ue={}));ye=class extends Error{constructor(e,t,n){super(e),this.message=e,this.code=t,this.data=n}},Pt=r=>{var e,t;return r!=null&&r.androidBridge?"android":!((t=(e=r==null?void 0:r.webkit)===null||e===void 0?void 0:e.messageHandlers)===null||t===void 0)&&t.bridge?"ios":"web"},It=r=>{let e=r.CapacitorCustomPlatform||null,t=r.Capacitor||{},n=t.Plugins=t.Plugins||{},i=()=>e!==null?e.name:Pt(r),l=()=>i()!=="web",p=C=>{let T=L.get(C);return!!(T!=null&&T.platforms.has(i())||y(C))},y=C=>{var T;return(T=t.PluginHeaders)===null||T===void 0?void 0:T.find(G=>G.name===C)},E=C=>r.console.error(C),L=new Map,W=(C,T={})=>{let G=L.get(C);if(G)return console.warn(`Capacitor plugin "${C}" already registered. Cannot register plugins twice.`),G.proxy;let N=i(),X=y(C),z,se=async()=>(!z&&N in T?z=typeof T[N]=="function"?z=await T[N]():z=T[N]:e!==null&&!z&&"web"in T&&(z=typeof T.web=="function"?z=await T.web():z=T.web),z),le=(k,A)=>{var F,q;if(X){let D=X==null?void 0:X.methods.find(x=>A===x.name);if(D)return D.rtype==="promise"?x=>t.nativePromise(C,A.toString(),x):(x,O)=>t.nativeCallback(C,A.toString(),x,O);if(k)return(F=k[A])===null||F===void 0?void 0:F.bind(k)}else{if(k)return(q=k[A])===null||q===void 0?void 0:q.bind(k);throw new ye(`"${C}" plugin is not implemented on ${N}`,ue.Unimplemented)}},re=k=>{let A,F=(...q)=>{let D=se().then(x=>{let O=le(x,k);if(O){let Z=O(...q);return A=Z==null?void 0:Z.remove,Z}else throw new ye(`"${C}.${k}()" is not implemented on ${N}`,ue.Unimplemented)});return k==="addListener"&&(D.remove=async()=>A()),D};return F.toString=()=>`${k.toString()}() { [capacitor code] }`,Object.defineProperty(F,"name",{value:k,writable:!1,configurable:!1}),F},ne=re("addListener"),ie=re("removeListener"),he=(k,A)=>{let F=ne({eventName:k},A),q=async()=>{let x=await F;ie({eventName:k,callbackId:x},A)},D=new Promise(x=>F.then(()=>x({remove:q})));return D.remove=async()=>{console.warn("Using addListener() without 'await' is deprecated."),await q()},D},P=new Proxy({},{get(k,A){switch(A){case"$$typeof":return;case"toJSON":return()=>({});case"addListener":return X?he:ne;case"removeListener":return ie;default:return re(A)}}});return n[C]=P,L.set(C,{name:C,proxy:P,platforms:new Set([...Object.keys(T),...X?[N]:[]])}),P};return t.convertFileSrc||(t.convertFileSrc=C=>C),t.getPlatform=i,t.handleError=E,t.isNativePlatform=l,t.isPluginAvailable=p,t.registerPlugin=W,t.Exception=ye,t.DEBUG=!!t.DEBUG,t.isLoggingEnabled=!!t.isLoggingEnabled,t},xt=r=>r.Capacitor=It(r),Fe=xt(typeof globalThis!="undefined"?globalThis:typeof self!="undefined"?self:typeof window!="undefined"?window:typeof global!="undefined"?global:{}),ke=Fe.registerPlugin,me=class{constructor(){this.listeners={},this.retainedEventArguments={},this.windowListeners={}}addListener(e,t){let n=!1;this.listeners[e]||(this.listeners[e]=[],n=!0),this.listeners[e].push(t);let l=this.windowListeners[e];l&&!l.registered&&this.addWindowListener(l),n&&this.sendRetainedArgumentsForEvent(e);let p=async()=>this.removeListener(e,t);return Promise.resolve({remove:p})}async removeAllListeners(){this.listeners={};for(let e in this.windowListeners)this.removeWindowListener(this.windowListeners[e]);this.windowListeners={}}notifyListeners(e,t,n){let i=this.listeners[e];if(!i){if(n){let l=this.retainedEventArguments[e];l||(l=[]),l.push(t),this.retainedEventArguments[e]=l}return}i.forEach(l=>l(t))}hasListeners(e){return!!this.listeners[e].length}registerWindowListener(e,t){this.windowListeners[t]={registered:!1,windowEventName:e,pluginEventName:t,handler:n=>{this.notifyListeners(t,n)}}}unimplemented(e="not implemented"){return new Fe.Exception(e,ue.Unimplemented)}unavailable(e="not available"){return new Fe.Exception(e,ue.Unavailable)}async removeListener(e,t){let n=this.listeners[e];if(!n)return;let i=n.indexOf(t);this.listeners[e].splice(i,1),this.listeners[e].length||this.removeWindowListener(this.windowListeners[e])}addWindowListener(e){window.addEventListener(e.windowEventName,e.handler),e.registered=!0}removeWindowListener(e){e&&(window.removeEventListener(e.windowEventName,e.handler),e.registered=!1)}sendRetainedArgumentsForEvent(e){let t=this.retainedEventArguments[e];t&&(delete this.retainedEventArguments[e],t.forEach(n=>{this.notifyListeners(e,n)}))}},ot=r=>encodeURIComponent(r).replace(/%(2[346B]|5E|60|7C)/g,decodeURIComponent).replace(/[()]/g,escape),st=r=>r.replace(/(%[\dA-F]{2})+/gi,decodeURIComponent),De=class extends me{async getCookies(){let e=document.cookie,t={};return e.split(";").forEach(n=>{if(n.length<=0)return;let[i,l]=n.replace(/=/,"CAP_COOKIE").split("CAP_COOKIE");i=st(i).trim(),l=st(l).trim(),t[i]=l}),t}async setCookie(e){try{let t=ot(e.key),n=ot(e.value),i=`; expires=${(e.expires||"").replace("expires=","")}`,l=(e.path||"/").replace("path=",""),p=e.url!=null&&e.url.length>0?`domain=${e.url}`:"";document.cookie=`${t}=${n||""}${i}; path=${l}; ${p};`}catch(t){return Promise.reject(t)}}async deleteCookie(e){try{document.cookie=`${e.key}=; Max-Age=0`}catch(t){return Promise.reject(t)}}async clearCookies(){try{let e=document.cookie.split(";")||[];for(let t of e)document.cookie=t.replace(/^ +/,"").replace(/=.*/,`=;expires=${new Date().toUTCString()};path=/`)}catch(e){return Promise.reject(e)}}async clearAllCookies(){try{await this.clearCookies()}catch(e){return Promise.reject(e)}}},mr=ke("CapacitorCookies",{web:()=>new De}),Bt=async r=>new Promise((e,t)=>{let n=new FileReader;n.onload=()=>{let i=n.result;e(i.indexOf(",")>=0?i.split(",")[1]:i)},n.onerror=i=>t(i),n.readAsDataURL(r)}),At=(r={})=>{let e=Object.keys(r);return Object.keys(r).map(i=>i.toLocaleLowerCase()).reduce((i,l,p)=>(i[l]=r[e[p]],i),{})},Mt=(r,e=!0)=>r?Object.entries(r).reduce((n,i)=>{let[l,p]=i,y,E;return Array.isArray(p)?(E="",p.forEach(L=>{y=e?encodeURIComponent(L):L,E+=`${l}=${y}&`}),E.slice(0,-1)):(y=e?encodeURIComponent(p):p,E=`${l}=${y}`),`${n}&${E}`},"").substr(1):null,Rt=(r,e={})=>{let t=Object.assign({method:r.method||"GET",headers:r.headers},e),i=At(r.headers)["content-type"]||"";if(typeof r.data=="string")t.body=r.data;else if(i.includes("application/x-www-form-urlencoded")){let l=new URLSearchParams;for(let[p,y]of Object.entries(r.data||{}))l.set(p,y);t.body=l.toString()}else if(i.includes("multipart/form-data")||r.data instanceof FormData){let l=new FormData;if(r.data instanceof FormData)r.data.forEach((y,E)=>{l.append(E,y)});else for(let y of Object.keys(r.data))l.append(y,r.data[y]);t.body=l;let p=new Headers(t.headers);p.delete("content-type"),t.headers=p}else(i.includes("application/json")||typeof r.data=="object")&&(t.body=JSON.stringify(r.data));return t},He=class extends me{async request(e){let t=Rt(e,e.webFetchExtra),n=Mt(e.params,e.shouldEncodeUrlParams),i=n?`${e.url}?${n}`:e.url,l=await fetch(i,t),p=l.headers.get("content-type")||"",{responseType:y="text"}=l.ok?e:{};p.includes("application/json")&&(y="json");let E,L;switch(y){case"arraybuffer":case"blob":L=await l.blob(),E=await Bt(L);break;case"json":E=await l.json();break;case"document":case"text":default:E=await l.text()}let W={};return l.headers.forEach((C,T)=>{W[T]=C}),{data:E,headers:W,status:l.status,url:l.url}}async get(e){return this.request(Object.assign(Object.assign({},e),{method:"GET"}))}async post(e){return this.request(Object.assign(Object.assign({},e),{method:"POST"}))}async put(e){return this.request(Object.assign(Object.assign({},e),{method:"PUT"}))}async patch(e){return this.request(Object.assign(Object.assign({},e),{method:"PATCH"}))}async delete(e){return this.request(Object.assign(Object.assign({},e),{method:"DELETE"}))}},hr=ke("CapacitorHttp",{web:()=>new He})});var Se,Le,lt=ee(()=>{Se=class{constructor(e){this.sqlite=e,this._connectionDict=new Map}async initWebStore(){try{return await this.sqlite.initWebStore(),Promise.resolve()}catch(e){return Promise.reject(e)}}async saveToStore(e){try{return await this.sqlite.saveToStore({database:e}),Promise.resolve()}catch(t){return Promise.reject(t)}}async saveToLocalDisk(e){try{return await this.sqlite.saveToLocalDisk({database:e}),Promise.resolve()}catch(t){return Promise.reject(t)}}async getFromLocalDiskToStore(e){let t=e!=null?e:!0;try{return await this.sqlite.getFromLocalDiskToStore({overwrite:t}),Promise.resolve()}catch(n){return Promise.reject(n)}}async echo(e){try{let t=await this.sqlite.echo({value:e});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async isSecretStored(){try{let e=await this.sqlite.isSecretStored();return Promise.resolve(e)}catch(e){return Promise.reject(e)}}async setEncryptionSecret(e){try{return await this.sqlite.setEncryptionSecret({passphrase:e}),Promise.resolve()}catch(t){return Promise.reject(t)}}async changeEncryptionSecret(e,t){try{return await this.sqlite.changeEncryptionSecret({passphrase:e,oldpassphrase:t}),Promise.resolve()}catch(n){return Promise.reject(n)}}async clearEncryptionSecret(){try{return await this.sqlite.clearEncryptionSecret(),Promise.resolve()}catch(e){return Promise.reject(e)}}async checkEncryptionSecret(e){try{let t=await this.sqlite.checkEncryptionSecret({passphrase:e});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async addUpgradeStatement(e,t){try{return e.endsWith(".db")&&(e=e.slice(0,-3)),await this.sqlite.addUpgradeStatement({database:e,upgrade:t}),Promise.resolve()}catch(n){return Promise.reject(n)}}async createConnection(e,t,n,i,l){try{e.endsWith(".db")&&(e=e.slice(0,-3)),await this.sqlite.createConnection({database:e,encrypted:t,mode:n,version:i,readonly:l});let p=new Le(e,l,this.sqlite),y=l?`RO_${e}`:`RW_${e}`;return this._connectionDict.set(y,p),Promise.resolve(p)}catch(p){return Promise.reject(p)}}async closeConnection(e,t){try{e.endsWith(".db")&&(e=e.slice(0,-3)),await this.sqlite.closeConnection({database:e,readonly:t});let n=t?`RO_${e}`:`RW_${e}`;return this._connectionDict.delete(n),Promise.resolve()}catch(n){return Promise.reject(n)}}async isConnection(e,t){let n={};e.endsWith(".db")&&(e=e.slice(0,-3));let i=t?`RO_${e}`:`RW_${e}`;return n.result=this._connectionDict.has(i),Promise.resolve(n)}async retrieveConnection(e,t){e.endsWith(".db")&&(e=e.slice(0,-3));let n=t?`RO_${e}`:`RW_${e}`;if(this._connectionDict.has(n)){let i=this._connectionDict.get(n);return typeof i!="undefined"?Promise.resolve(i):Promise.reject(`Connection ${e} is undefined`)}else return Promise.reject(`Connection ${e} does not exist`)}async getNCDatabasePath(e,t){try{let n=await this.sqlite.getNCDatabasePath({path:e,database:t});return Promise.resolve(n)}catch(n){return Promise.reject(n)}}async createNCConnection(e,t){try{await this.sqlite.createNCConnection({databasePath:e,version:t});let n=new Le(e,!0,this.sqlite),i=`RO_${e})`;return this._connectionDict.set(i,n),Promise.resolve(n)}catch(n){return Promise.reject(n)}}async closeNCConnection(e){try{await this.sqlite.closeNCConnection({databasePath:e});let t=`RO_${e})`;return this._connectionDict.delete(t),Promise.resolve()}catch(t){return Promise.reject(t)}}async isNCConnection(e){let t={},n=`RO_${e})`;return t.result=this._connectionDict.has(n),Promise.resolve(t)}async retrieveNCConnection(e){if(this._connectionDict.has(e)){let t=`RO_${e})`,n=this._connectionDict.get(t);return typeof n!="undefined"?Promise.resolve(n):Promise.reject(`Connection ${e} is undefined`)}else return Promise.reject(`Connection ${e} does not exist`)}async isNCDatabase(e){try{let t=await this.sqlite.isNCDatabase({databasePath:e});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async retrieveAllConnections(){return this._connectionDict}async closeAllConnections(){let e=new Map;try{for(let t of this._connectionDict.keys()){let n=t.substring(3),i=t.substring(0,3)==="RO_";await this.sqlite.closeConnection({database:n,readonly:i}),e.set(t,null)}for(let t of e.keys())this._connectionDict.delete(t);return Promise.resolve()}catch(t){return Promise.reject(t)}}async checkConnectionsConsistency(){try{let e=[...this._connectionDict.keys()],t=[],n=[];for(let l of e)t.push(l.substring(0,2)),n.push(l.substring(3));let i=await this.sqlite.checkConnectionsConsistency({dbNames:n,openModes:t});return i.result||(this._connectionDict=new Map),Promise.resolve(i)}catch(e){return this._connectionDict=new Map,Promise.reject(e)}}async importFromJson(e){try{let t=await this.sqlite.importFromJson({jsonstring:e});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async isJsonValid(e){try{let t=await this.sqlite.isJsonValid({jsonstring:e});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async copyFromAssets(e){let t=e!=null?e:!0;try{return await this.sqlite.copyFromAssets({overwrite:t}),Promise.resolve()}catch(n){return Promise.reject(n)}}async getFromHTTPRequest(e,t){let n=t!=null?t:!0;try{return await this.sqlite.getFromHTTPRequest({url:e,overwrite:n}),Promise.resolve()}catch(i){return Promise.reject(i)}}async isDatabaseEncrypted(e){e.endsWith(".db")&&(e=e.slice(0,-3));try{let t=await this.sqlite.isDatabaseEncrypted({database:e});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async isInConfigEncryption(){try{let e=await this.sqlite.isInConfigEncryption();return Promise.resolve(e)}catch(e){return Promise.reject(e)}}async isInConfigBiometricAuth(){try{let e=await this.sqlite.isInConfigBiometricAuth();return Promise.resolve(e)}catch(e){return Promise.reject(e)}}async isDatabase(e){e.endsWith(".db")&&(e=e.slice(0,-3));try{let t=await this.sqlite.isDatabase({database:e});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async getDatabaseList(){try{let t=(await this.sqlite.getDatabaseList()).values;t.sort();let n={values:t};return Promise.resolve(n)}catch(e){return Promise.reject(e)}}async getMigratableDbList(e){let t=e||"default";try{let n=await this.sqlite.getMigratableDbList({folderPath:t});return Promise.resolve(n)}catch(n){return Promise.reject(n)}}async addSQLiteSuffix(e,t){let n=e||"default",i=t||[];try{let l=await this.sqlite.addSQLiteSuffix({folderPath:n,dbNameList:i});return Promise.resolve(l)}catch(l){return Promise.reject(l)}}async deleteOldDatabases(e,t){let n=e||"default",i=t||[];try{let l=await this.sqlite.deleteOldDatabases({folderPath:n,dbNameList:i});return Promise.resolve(l)}catch(l){return Promise.reject(l)}}async moveDatabasesAndAddSuffix(e,t){let n=e||"default",i=t||[];return this.sqlite.moveDatabasesAndAddSuffix({folderPath:n,dbNameList:i})}},Le=class{constructor(e,t,n){this.dbName=e,this.readonly=t,this.sqlite=n}getConnectionDBName(){return this.dbName}getConnectionReadOnly(){return this.readonly}async open(){try{return await this.sqlite.open({database:this.dbName,readonly:this.readonly}),Promise.resolve()}catch(e){return Promise.reject(e)}}async close(){try{return await this.sqlite.close({database:this.dbName,readonly:this.readonly}),Promise.resolve()}catch(e){return Promise.reject(e)}}async beginTransaction(){try{let e=await this.sqlite.beginTransaction({database:this.dbName});return Promise.resolve(e)}catch(e){return Promise.reject(e)}}async commitTransaction(){try{let e=await this.sqlite.commitTransaction({database:this.dbName});return Promise.resolve(e)}catch(e){return Promise.reject(e)}}async rollbackTransaction(){try{let e=await this.sqlite.rollbackTransaction({database:this.dbName});return Promise.resolve(e)}catch(e){return Promise.reject(e)}}async isTransactionActive(){try{let e=await this.sqlite.isTransactionActive({database:this.dbName});return Promise.resolve(e)}catch(e){return Promise.reject(e)}}async loadExtension(e){try{return await this.sqlite.loadExtension({database:this.dbName,path:e,readonly:this.readonly}),Promise.resolve()}catch(t){return Promise.reject(t)}}async enableLoadExtension(e){try{return await this.sqlite.enableLoadExtension({database:this.dbName,toggle:e,readonly:this.readonly}),Promise.resolve()}catch(t){return Promise.reject(t)}}async getUrl(){try{let e=await this.sqlite.getUrl({database:this.dbName,readonly:this.readonly});return Promise.resolve(e)}catch(e){return Promise.reject(e)}}async getVersion(){try{let e=await this.sqlite.getVersion({database:this.dbName,readonly:this.readonly});return Promise.resolve(e)}catch(e){return Promise.reject(e)}}async getTableList(){try{let e=await this.sqlite.getTableList({database:this.dbName,readonly:this.readonly});return Promise.resolve(e)}catch(e){return Promise.reject(e)}}async execute(e,t=!0,n=!0){try{if(this.readonly)return Promise.reject("not allowed in read-only mode");{let i=await this.sqlite.execute({database:this.dbName,statements:e,transaction:t,readonly:!1,isSQL92:n});return Promise.resolve(i)}}catch(i){return Promise.reject(i)}}async query(e,t,n=!0){let i;try{return t&&t.length>0?i=await this.sqlite.query({database:this.dbName,statement:e,values:t,readonly:this.readonly,isSQL92:!0}):i=await this.sqlite.query({database:this.dbName,statement:e,values:[],readonly:this.readonly,isSQL92:n}),i=await this.reorderRows(i),Promise.resolve(i)}catch(l){return Promise.reject(l)}}async run(e,t,n=!0,i="no",l=!0){let p;try{return this.readonly?Promise.reject("not allowed in read-only mode"):(t&&t.length>0?p=await this.sqlite.run({database:this.dbName,statement:e,values:t,transaction:n,readonly:!1,returnMode:i,isSQL92:!0}):p=await this.sqlite.run({database:this.dbName,statement:e,values:[],transaction:n,readonly:!1,returnMode:i,isSQL92:l}),p.changes=await this.reorderRows(p.changes),Promise.resolve(p))}catch(y){return Promise.reject(y)}}async executeSet(e,t=!0,n="no",i=!0){let l;try{return this.readonly?Promise.reject("not allowed in read-only mode"):(l=await this.sqlite.executeSet({database:this.dbName,set:e,transaction:t,readonly:!1,returnMode:n,isSQL92:i}),l.changes=await this.reorderRows(l.changes),Promise.resolve(l))}catch(p){return Promise.reject(p)}}async isExists(){try{let e=await this.sqlite.isDBExists({database:this.dbName,readonly:this.readonly});return Promise.resolve(e)}catch(e){return Promise.reject(e)}}async isTable(e){try{let t=await this.sqlite.isTableExists({database:this.dbName,table:e,readonly:this.readonly});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async isDBOpen(){try{let e=await this.sqlite.isDBOpen({database:this.dbName,readonly:this.readonly});return Promise.resolve(e)}catch(e){return Promise.reject(e)}}async delete(){try{return this.readonly?Promise.reject("not allowed in read-only mode"):(await this.sqlite.deleteDatabase({database:this.dbName,readonly:!1}),Promise.resolve())}catch(e){return Promise.reject(e)}}async createSyncTable(){try{if(this.readonly)return Promise.reject("not allowed in read-only mode");{let e=await this.sqlite.createSyncTable({database:this.dbName,readonly:!1});return Promise.resolve(e)}}catch(e){return Promise.reject(e)}}async setSyncDate(e){try{return this.readonly?Promise.reject("not allowed in read-only mode"):(await this.sqlite.setSyncDate({database:this.dbName,syncdate:e,readonly:!1}),Promise.resolve())}catch(t){return Promise.reject(t)}}async getSyncDate(){try{let e=await this.sqlite.getSyncDate({database:this.dbName,readonly:this.readonly}),t="";return e.syncDate>0&&(t=new Date(e.syncDate*1e3).toISOString()),Promise.resolve(t)}catch(e){return Promise.reject(e)}}async exportToJson(e,t=!1){try{let n=await this.sqlite.exportToJson({database:this.dbName,jsonexportmode:e,readonly:this.readonly,encrypted:t});return Promise.resolve(n)}catch(n){return Promise.reject(n)}}async deleteExportedRows(){try{return this.readonly?Promise.reject("not allowed in read-only mode"):(await this.sqlite.deleteExportedRows({database:this.dbName,readonly:!1}),Promise.resolve())}catch(e){return Promise.reject(e)}}async executeTransaction(e,t=!0){let n=0,i=!1;if(this.readonly)return Promise.reject("not allowed in read-only mode");if(await this.sqlite.beginTransaction({database:this.dbName}),i=await this.sqlite.isTransactionActive({database:this.dbName}),!i)return Promise.reject("After Begin Transaction, no transaction active");try{for(let y of e){if(typeof y!="object"||!("statement"in y))throw new Error("Error a task.statement must be provided");if("values"in y&&y.values&&y.values.length>0){let E=y.statement.toUpperCase().includes("RETURNING")?"all":"no",L=await this.sqlite.run({database:this.dbName,statement:y.statement,values:y.values,transaction:!1,readonly:!1,returnMode:E,isSQL92:t});if(L.changes.changes<0)throw new Error("Error in transaction method run ");n+=L.changes.changes}else{let E=await this.sqlite.execute({database:this.dbName,statements:y.statement,transaction:!1,readonly:!1});if(E.changes.changes<0)throw new Error("Error in transaction method execute ");n+=E.changes.changes}}let l=await this.sqlite.commitTransaction({database:this.dbName});n+=l.changes.changes;let p={changes:{changes:n}};return Promise.resolve(p)}catch(l){let p=l.message?l.message:l;return await this.sqlite.rollbackTransaction({database:this.dbName}),Promise.reject(p)}}async reorderRows(e){let t=e;if(e!=null&&e.values&&typeof e.values[0]=="object"&&Object.keys(e.values[0]).includes("ios_columns")){let n=e.values[0].ios_columns,i=[];for(let l=1;l<e.values.length;l++){let p=e.values[l],y={};for(let E of n)y[E]=p[E];i.push(y)}t.values=i}return Promise.resolve(t)}}});var ct={};Ce(ct,{CapacitorSQLiteWeb:()=>Oe});var Oe,dt=ee(()=>{Ke();Oe=class extends me{constructor(){super(...arguments),this.jeepSqliteElement=null,this.isWebStoreOpen=!1}async initWebStore(){await customElements.whenDefined("jeep-sqlite"),this.jeepSqliteElement=document.querySelector("jeep-sqlite"),this.ensureJeepSqliteIsAvailable(),this.jeepSqliteElement.addEventListener("jeepSqliteImportProgress",e=>{this.notifyListeners("sqliteImportProgressEvent",e.detail)}),this.jeepSqliteElement.addEventListener("jeepSqliteExportProgress",e=>{this.notifyListeners("sqliteExportProgressEvent",e.detail)}),this.jeepSqliteElement.addEventListener("jeepSqliteHTTPRequestEnded",e=>{this.notifyListeners("sqliteHTTPRequestEndedEvent",e.detail)}),this.jeepSqliteElement.addEventListener("jeepSqlitePickDatabaseEnded",e=>{this.notifyListeners("sqlitePickDatabaseEndedEvent",e.detail)}),this.jeepSqliteElement.addEventListener("jeepSqliteSaveDatabaseToDisk",e=>{this.notifyListeners("sqliteSaveDatabaseToDiskEvent",e.detail)}),this.isWebStoreOpen||(this.isWebStoreOpen=await this.jeepSqliteElement.isStoreOpen())}async saveToStore(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.saveToStore(e);return}catch(t){throw new Error(`${t}`)}}async getFromLocalDiskToStore(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.getFromLocalDiskToStore(e);return}catch(t){throw new Error(`${t}`)}}async saveToLocalDisk(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.saveToLocalDisk(e);return}catch(t){throw new Error(`${t}`)}}async echo(e){return this.ensureJeepSqliteIsAvailable(),await this.jeepSqliteElement.echo(e)}async createConnection(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.createConnection(e);return}catch(t){throw new Error(`${t}`)}}async open(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.open(e);return}catch(t){throw new Error(`${t}`)}}async closeConnection(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.closeConnection(e);return}catch(t){throw new Error(`${t}`)}}async getVersion(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.getVersion(e)}catch(t){throw new Error(`${t}`)}}async checkConnectionsConsistency(e){this.ensureJeepSqliteIsAvailable();try{return await this.jeepSqliteElement.checkConnectionsConsistency(e)}catch(t){throw new Error(`${t}`)}}async close(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.close(e);return}catch(t){throw new Error(`${t}`)}}async beginTransaction(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.beginTransaction(e)}catch(t){throw new Error(`${t}`)}}async commitTransaction(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.commitTransaction(e)}catch(t){throw new Error(`${t}`)}}async rollbackTransaction(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.rollbackTransaction(e)}catch(t){throw new Error(`${t}`)}}async isTransactionActive(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.isTransactionActive(e)}catch(t){throw new Error(`${t}`)}}async getTableList(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.getTableList(e)}catch(t){throw new Error(`${t}`)}}async execute(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.execute(e)}catch(t){throw new Error(`${t}`)}}async executeSet(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.executeSet(e)}catch(t){throw new Error(`${t}`)}}async run(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.run(e)}catch(t){throw new Error(`${t}`)}}async query(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.query(e)}catch(t){throw new Error(`${t}`)}}async isDBExists(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.isDBExists(e)}catch(t){throw new Error(`${t}`)}}async isDBOpen(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.isDBOpen(e)}catch(t){throw new Error(`${t}`)}}async isDatabase(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.isDatabase(e)}catch(t){throw new Error(`${t}`)}}async isTableExists(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.isTableExists(e)}catch(t){throw new Error(`${t}`)}}async deleteDatabase(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.deleteDatabase(e);return}catch(t){throw new Error(`${t}`)}}async isJsonValid(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.isJsonValid(e)}catch(t){throw new Error(`${t}`)}}async importFromJson(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.importFromJson(e)}catch(t){throw new Error(`${t}`)}}async exportToJson(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.exportToJson(e)}catch(t){throw new Error(`${t}`)}}async createSyncTable(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.createSyncTable(e)}catch(t){throw new Error(`${t}`)}}async setSyncDate(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.setSyncDate(e);return}catch(t){throw new Error(`${t}`)}}async getSyncDate(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.getSyncDate(e)}catch(t){throw new Error(`${t}`)}}async deleteExportedRows(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.deleteExportedRows(e);return}catch(t){throw new Error(`${t}`)}}async addUpgradeStatement(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.addUpgradeStatement(e);return}catch(t){throw new Error(`${t}`)}}async copyFromAssets(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.copyFromAssets(e);return}catch(t){throw new Error(`${t}`)}}async getFromHTTPRequest(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.getFromHTTPRequest(e);return}catch(t){throw new Error(`${t}`)}}async getDatabaseList(){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.getDatabaseList()}catch(e){throw new Error(`${e}`)}}ensureJeepSqliteIsAvailable(){if(this.jeepSqliteElement===null)throw new Error("The jeep-sqlite element is not present in the DOM! Please check the @capacitor-community/sqlite documentation for instructions regarding the web platform.")}ensureWebstoreIsOpen(){if(!this.isWebStoreOpen)throw new Error('WebStore is not open yet. You have to call "initWebStore()" first.')}async getUrl(){throw this.unimplemented("Not implemented on web.")}async getMigratableDbList(e){throw console.log("getMigratableDbList",e),this.unimplemented("Not implemented on web.")}async addSQLiteSuffix(e){throw console.log("addSQLiteSuffix",e),this.unimplemented("Not implemented on web.")}async deleteOldDatabases(e){throw console.log("deleteOldDatabases",e),this.unimplemented("Not implemented on web.")}async moveDatabasesAndAddSuffix(e){throw console.log("moveDatabasesAndAddSuffix",e),this.unimplemented("Not implemented on web.")}async isSecretStored(){throw this.unimplemented("Not implemented on web.")}async setEncryptionSecret(e){throw console.log("setEncryptionSecret",e),this.unimplemented("Not implemented on web.")}async changeEncryptionSecret(e){throw console.log("changeEncryptionSecret",e),this.unimplemented("Not implemented on web.")}async clearEncryptionSecret(){throw console.log("clearEncryptionSecret"),this.unimplemented("Not implemented on web.")}async checkEncryptionSecret(e){throw console.log("checkEncryptionPassPhrase",e),this.unimplemented("Not implemented on web.")}async getNCDatabasePath(e){throw console.log("getNCDatabasePath",e),this.unimplemented("Not implemented on web.")}async createNCConnection(e){throw console.log("createNCConnection",e),this.unimplemented("Not implemented on web.")}async closeNCConnection(e){throw console.log("closeNCConnection",e),this.unimplemented("Not implemented on web.")}async isNCDatabase(e){throw console.log("isNCDatabase",e),this.unimplemented("Not implemented on web.")}async isDatabaseEncrypted(e){throw console.log("isDatabaseEncrypted",e),this.unimplemented("Not implemented on web.")}async isInConfigEncryption(){throw this.unimplemented("Not implemented on web.")}async isInConfigBiometricAuth(){throw this.unimplemented("Not implemented on web.")}async loadExtension(e){throw console.log("loadExtension",e),this.unimplemented("Not implemented on web.")}async enableLoadExtension(e){throw console.log("enableLoadExtension",e),this.unimplemented("Not implemented on web.")}}});var ut,mt=ee(()=>{Ke();lt();ut=ke("CapacitorSQLite",{web:()=>Promise.resolve().then(()=>(dt(),ct)).then(r=>new r.CapacitorSQLiteWeb),electron:()=>window.CapacitorCustomPlatform.plugins.CapacitorSQLite})});var ht={};Ce(ht,{getCardById:()=>Nt,getCardIds:()=>Ot,getCardsByIds:()=>Wt,getDaten:()=>Dt,getEnergieById:()=>Qt,getEnergieCardIds:()=>Zt,getEnergies:()=>_t,getEngName:()=>Kt,getName:()=>Ht,getTrainerById:()=>Vt,getTrainerCardIds:()=>Jt,getTrainers:()=>zt,initDatabase:()=>Ft,insertCard:()=>$t,insertEnergie:()=>Xt,insertTrainer:()=>Ut,updateCardIds:()=>jt,updatePrice:()=>Gt});async function Ft(){return B=await qt.createConnection("pokepicker",!1,"no-encryption",1),await B.open(),await B.execute(`
  ...
  `),(await B.query("SELECT COUNT(*) as count FROM pokemon")).values[0].count===0&&await B.execute(`
      ...
      `),B}async function Dt(){return await B.query("SELECT * FROM pokemon")}async function Ht(r){return(await B.query("SELECT name FROM pokemon WHERE dex = ?",[r])).values[0].name}async function Kt(r){return(await B.query("SELECT engName FROM pokemon WHERE dex = ?",[r])).values[0].engName}async function Ot(r){return(await B.query("SELECT cardIds FROM pokemon WHERE dex = ?",[r])).values[0].cardIds}async function jt(r,e){await B.run("UPDATE pokemon SET cardIds = ? WHERE dex = ?",[e,r])}async function $t(r){var e,t,n,i,l;try{let p=typeof r.imageSmall=="string"?r.imageSmall:null,y=typeof r.imageLarge=="string"?r.imageLarge:null;return((l=(await B.run(`INSERT INTO cards (cardId, cardName, rarity, setName, imageLow, imageHigh, subTypes, addedAt, avg30)
       VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)`,[r.id,r.name,r.rarity||"",((e=r.set)==null?void 0:e.name)||"",p,y,Array.isArray(r.subtypes)?r.subtypes.join(", "):"",new Date().toISOString(),(i=(n=(t=r.cardmarket)==null?void 0:t.prices)==null?void 0:n.avg30)!=null?i:null])).changes)==null?void 0:l.lastId)||null}catch(p){return console.error("Fehler in insertCard():",p.message||p,(r==null?void 0:r.id)||"unbekannte Karte"),null}}async function Nt(r){var t;return((t=(await B.query("SELECT * FROM cards WHERE id = ?",[r])).values)==null?void 0:t[0])||null}async function Wt(r){let e=r.map(()=>"?").join(",");return(await B.query(`SELECT * FROM cards WHERE id IN (${e})`,r)).values}async function Gt(r,e){try{await B.run("UPDATE cards SET avg30 = ? WHERE cardId = ?",[e,r])}catch(t){console.error(`Fehler beim Speichern von avg30 f\xFCr ${r}:`,t.message)}}async function zt(){return(await B.query("SELECT * FROM trainer")).values}async function Ut(r){var e,t,n,i,l;try{let p=typeof r.imageSmall=="string"?r.imageSmall:null,y=typeof r.imageLarge=="string"?r.imageLarge:null;return((l=(await B.run(`INSERT INTO trainer (cardId, cardName, rarity, setName, imageLow, imageHigh, subTypes, addedAt, avg30)
       VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)`,[r.id,r.name,r.rarity||"",((e=r.set)==null?void 0:e.name)||"",p,y,Array.isArray(r.subtypes)?r.subtypes.join(", "):"",new Date().toISOString(),(i=(n=(t=r.cardmarket)==null?void 0:t.prices)==null?void 0:n.avg30)!=null?i:null])).changes)==null?void 0:l.lastId)||null}catch(p){return console.error("Fehler in insertTrainer():",p.message||p,(r==null?void 0:r.id)||"unbekannte Karte"),null}}async function Vt(r){var t;return((t=(await B.query("SELECT * FROM trainer WHERE id = ?",[r])).values)==null?void 0:t[0])||null}async function Jt(){return(await B.query("SELECT id FROM trainer")).values.map(e=>e.id)}async function _t(){return(await B.query("SELECT * FROM energy")).values}async function Xt(r){var e,t,n,i,l;try{let p=typeof r.imageSmall=="string"?r.imageSmall:null,y=typeof r.imageLarge=="string"?r.imageLarge:null;return((l=(await B.run(`INSERT INTO energy (cardId, cardName, rarity, setName, imageLow, imageHigh, subTypes, addedAt, avg30)
       VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)`,[r.id,r.name,r.rarity||"",((e=r.set)==null?void 0:e.name)||"",p,y,Array.isArray(r.subtypes)?r.subtypes.join(", "):"",new Date().toISOString(),(i=(n=(t=r.cardmarket)==null?void 0:t.prices)==null?void 0:n.avg30)!=null?i:null])).changes)==null?void 0:l.lastId)||null}catch(p){return console.error("Fehler in insertEnergie():",p.message||p,(r==null?void 0:r.id)||"unbekannte Karte"),null}}async function Zt(){return(await B.query("SELECT id FROM energy")).values.map(e=>e.id)}async function Qt(r){var t;return((t=(await B.query("SELECT * FROM energy WHERE id = ?",[r])).values)==null?void 0:t[0])||null}var qt,B,gt=ee(()=>{mt();qt=new Se(ut)});Te();var te=Ve("Http",{web:()=>Promise.resolve().then(()=>(qe(),Re)).then(r=>new r.HttpWeb),electron:()=>Promise.resolve().then(()=>(qe(),Re)).then(r=>new r.HttpWeb)});var ae=it(),$;document.addEventListener("DOMContentLoaded",()=>{(async()=>{let r=document.getElementById("cardLoader");r.innerHTML=`
      <p id="loaderText">Lade Karten\u2026</p>
      <div id="progressBarContainer">
        <div id="progressBar"></div>
      </div>
      <div id="progressText">0%</div>
    `,r.classList.remove("hidden"),r.classList.add("shown");let{initDatabase:e,getDaten:t,getName:n,getEngName:i,getCardIds:l,updateCardIds:p,insertCard:y,getCardById:E,getCardsByIds:L,updatePrice:W,getTrainers:C,insertTrainer:T,getTrainerCardIds:G,getTrainerById:N,getEnergies:X,insertEnergie:z,getEnergieCardIds:se,getEnergieById:le}=await Promise.resolve().then(()=>(gt(),ht));$=await e();let re=await t(),ne=document.querySelector("#kartentabelle tbody");window.cachedCards={},window.cachedPokemonCardsByName={},window.cachedTrainerCardsByType={},window.cachedEnergyCardsByType={};let ie=0,he=re.values.length;for(let c of re.values){let a=document.createElement("tr"),o=parseInt(c.dex),m=`
      ...
      `;a.innerHTML=m,ne.appendChild(a),await A(c.dex),ie++;let s=Math.min(99,Math.round(ie/he*100)),h=document.getElementById("progressBar"),d=document.getElementById("progressText");h&&(h.style.width=s+"%"),d&&(d.textContent=s+"%")}progressBar.style.width="100%",progressText.textContent="100%",r.classList.add("hidden"),r.classList.remove("shown"),r.innerHTML="",P(),k(),O(),document.querySelectorAll("#tableToggle button").forEach(c=>c.classList.remove("active")),document.getElementById("showTablePokemon").classList.add("active");function P(){let c=document.querySelectorAll("#kartentabelle tbody tr"),a=0;c.forEach(o=>{o.style.display!=="none"&&a++}),document.getElementById("eintragsAnzahl").textContent=`(${a})`}function k(){let c=document.querySelectorAll("#kartentabelle tbody tr"),a=0;c.forEach(o=>{if(o.style.display==="none")return;let m=o.querySelectorAll("div[id^='kartenContainer_'] img");a+=m.length}),document.getElementById("kartenAnzahl").textContent=`(${a})`}async function A(c){let a=document.getElementById(`kartenContainer_${c}`),o=await l(c);if(!o)return;let m=o.split(";").filter(d=>d.trim()),s=await L(m.map(d=>parseInt(d)));s.sort((d,f)=>(f.avg30||0)-(d.avg30||0));let h=document.createDocumentFragment();for(let d of s){window.cachedCards[d.cardId]=d;let f=document.createElement("img");f.alt=d.cardId,f.style.width="50px",f.style.height="69px",f.style.objectFit="cover",f.src=d.imageLow,f.addEventListener("click",()=>F(c,m.indexOf(String(d.id)))),h.appendChild(f)}a.appendChild(h)}async function F(c,a){let o=document.querySelector("#overlay");o.innerHTML='<div id="overlayContent"><div class="loader"></div></div>',o.classList.remove("hidden"),o.classList.add("shown");let m=await l(c);if(!m)return;let s=m.split(";").filter(f=>f.trim()!=="");if(s.length===0){o.classList.add("hidden"),o.classList.remove("shown");return}let h=a;async function d(){let f=s[h];try{let b=await E(f),g="Unbekannt";if(b.addedAt){let S=new Date(b.addedAt),M={day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"};g=S.toLocaleString("de-DE",M)}let u="Keine Angabe";b.basic==1&&(u="Basic"),b.reverse==1&&(u="Reverse"),b.holo==1&&(u="Holo");let v=await x(b.cardId);if(v==null){let S=q(b.cardId);v=await x(S)}let w="\u2013";if(v!=null){let S=v.toFixed(2),M="#DEDEDE",R="\u{1FA99}";v>20?(M="#FF4444",R="\u{1F525}"):v>5&&(M="#FFAA00",R="\u{1F4B0}"),w=`<span style="color:${M};">${R} ${S}\u20AC</span>`}o.innerHTML=`
      ...
      `;async function f(u){m.innerHTML='<div id="overlayContent"><div class="loader"></div></div>',m.classList.remove("hidden"),m.classList.add("shown"),u!=="none"&&await $.run(`UPDATE cards SET ${u} = 1 WHERE id = ?`,[d]);let v=await l(a);v||(v=""),v+=d+";",await p(a,v);let w=document.getElementById(`kartenContainer_${a}`);w.innerHTML="",await A(a),m.classList.add("hidden"),m.classList.remove("shown"),m.innerHTML="",P(),k(),O()}document.getElementById("btnBasic").addEventListener("click",()=>f("basic")),document.getElementById("btnReverse").addEventListener("click",()=>f("reverse")),document.getElementById("btnHolo").addEventListener("click",()=>f("holo")),document.getElementById("closeOverlayConfirm").addEventListener("click",()=>f("none"))};async function O(){try{let c=await $.query("SELECT avg30 FROM cards WHERE avg30 IS NOT NULL"),a=await $.query("SELECT avg30 FROM trainer WHERE avg30 IS NOT NULL"),o=await $.query("SELECT avg30 FROM energy WHERE avg30 IS NOT NULL"),m=0;for(let d of c.values)m+=d.avg30;for(let d of a.values)m+=d.avg30;for(let d of o.values)m+=d.avg30;let s="\u{1FA99}";m>1e3?s="\u{1F525}":m>500&&(s="\u{1F4B0}");let h=`Gesamtwert: ${s} ${m.toFixed(2)}\u20AC`;document.getElementById("gesamtwert").textContent=h}catch(c){console.error("Fehler beim Berechnen des Gesamtwerts:",c)}}async function Z(){let c=await $.query("SELECT cardId FROM cards"),a=await $.query("SELECT cardId FROM trainer"),o=await $.query("SELECT cardId FROM energy"),m=0,s=0,h=c.values.length+a.values.length+o.values.length;alert(`Aktualisierung von ${h} Preisen gestartet.`);for(let f of c.values){let b=f.cardId,g=await x(b);if(g==null){let w=q(b);g=await x(w)}g!=null&&(await W(b,g),m++),s++;let u=Math.round(s/h*100),v=document.getElementById("preiseAktualisierenProgress");v&&(v.textContent=u+"%")}for(let f of a.values){let b=f.cardId,g=await x(b);if(g==null){let w=q(b);g=await x(w)}g!=null&&(await $.run("UPDATE trainer SET avg30 = ? WHERE cardId = ?",[g,b]),m++),s++;let u=Math.round(s/h*100),v=document.getElementById("preiseAktualisierenProgress");v&&(v.textContent=u+"%")}for(let f of o.values){let b=f.cardId,g=await x(b);if(g==null){let w=q(b);g=await x(w)}g!=null&&(await $.run("UPDATE energy SET avg30 = ? WHERE cardId = ?",[g,b]),m++),s++;let u=Math.round(s/h*100),v=document.getElementById("preiseAktualisierenProgress");v&&(v.textContent=u+"%")}let d=document.getElementById("preiseAktualisierenProgress");d&&(d.textContent=""),alert(`${m} Preise wurden aktualisiert!`),O()}window.aktualisiereAllePreise=Z;function fe(){let a=document.getElementById("search").value.toUpperCase(),m=document.getElementById("kartentabelle").getElementsByTagName("tr");for(let s=1;s<m.length;s++){m[s].style.display="none";let h=m[s].getElementsByTagName("td");for(let d=0;d<h.length;d++){let f=h[d];if(f&&f.innerHTML.toUpperCase().indexOf(a)>-1){m[s].style.display="";break}}}P(),k(),O()}window.searchTable=fe;let I={reverse:"neutral",holo:"neutral",v:"neutral",vmax:"neutral",ex:"neutral",shiny:"neutral"};function be(){document.querySelectorAll("#kartentabelle tbody tr").forEach(a=>{let m=a.querySelector("div[id^='kartenContainer_']").querySelectorAll("img"),s=!1,h=!1,d=!1,f=!1,b=!1,g=!1;m.forEach(v=>{var M,R,j,J,ge,je,$e,Ne,We,Ge,ze;let w=v.alt,S=(M=window.cachedCards)==null?void 0:M[w];S&&(S.reverse==1&&(s=!0),S.holo==1&&(h=!0),((R=S.subTypes)!=null&&R.toLowerCase().includes("v")||(j=S.cardName)!=null&&j.toLowerCase().includes(" v"))&&(d=!0),((J=S.subTypes)!=null&&J.toLowerCase().includes("vmax")||(ge=S.cardName)!=null&&ge.toLowerCase().includes(" vmax")||(je=S.subTypes)!=null&&je.toLowerCase().includes("vstar")||($e=S.cardName)!=null&&$e.toLowerCase().includes(" vstar"))&&(f=!0),((Ne=S.subTypes)!=null&&Ne.toLowerCase().includes("ex")||(We=S.cardName)!=null&&We.toLowerCase().includes(" ex"))&&(b=!0),((Ge=S.subTypes)!=null&&Ge.toLowerCase().includes("radiant")||(ze=S.rarity)!=null&&ze.toLowerCase().includes("shiny"))&&(g=!0))});let u=!0;I.reverse==="positive"&&!s&&(u=!1),I.reverse==="negative"&&s&&(u=!1),I.holo==="positive"&&!h&&(u=!1),I.holo==="negative"&&h&&(u=!1),I.v==="positive"&&!d&&(u=!1),I.v==="negative"&&d&&(u=!1),I.vmax==="positive"&&!f&&(u=!1),I.vmax==="negative"&&f&&(u=!1),I.ex==="positive"&&!b&&(u=!1),I.ex==="negative"&&b&&(u=!1),I.shiny==="positive"&&!g&&(u=!1),I.shiny==="negative"&&g&&(u=!1),a.style.display=u?"":"none"}),P(),k(),O()}function Q(c){I[c]==="neutral"?I[c]="positive":I[c]==="positive"?I[c]="negative":I[c]="neutral",be(),H()}function H(){let c=["reverse","holo","v","vmax","ex","shiny"];for(let a of c){let o=document.getElementById(`filter-${a}`);o&&(o.classList.remove("active-positive","active-negative"),I[a]==="positive"?o.classList.add("active-positive"):I[a]==="negative"&&o.classList.add("active-negative"))}}document.getElementById("filter-alle").addEventListener("click",c=>{c.preventDefault(),I.reverse="neutral",I.holo="neutral",I.v="neutral",I.vmax="neutral",I.ex="neutral",I.shiny="neutral",be(),H()}),document.getElementById("filter-reverse").addEventListener("click",c=>{c.preventDefault(),Q("reverse")}),document.getElementById("filter-holo").addEventListener("click",c=>{c.preventDefault(),Q("holo")}),document.getElementById("filter-v").addEventListener("click",c=>{c.preventDefault(),Q("v")}),document.getElementById("filter-vmax").addEventListener("click",c=>{c.preventDefault(),Q("vmax")}),document.getElementById("filter-ex").addEventListener("click",c=>{c.preventDefault(),Q("ex")}),document.getElementById("filter-shiny").addEventListener("click",c=>{c.preventDefault(),Q("shiny")}),window.zeigePokemonTabelle=function(){document.getElementById("kartentabelle").classList.remove("hidden"),document.getElementById("trainertabelle").classList.add("hidden"),document.getElementById("energietabelle").classList.add("hidden"),document.querySelectorAll("#tableToggle button").forEach(c=>c.classList.remove("active")),document.getElementById("showTablePokemon").classList.add("active"),document.getElementById("pokemonFilterContainer").style.display="block"},window.zeigeTrainerTabelle=async function(){document.getElementById("kartentabelle").classList.add("hidden"),document.getElementById("trainertabelle").classList.remove("hidden"),document.getElementById("energietabelle").classList.add("hidden"),document.getElementById("pokemonFilterContainer").style.display="none",document.querySelectorAll("#tableToggle button").forEach(h=>h.classList.remove("active")),document.getElementById("showTableTrainer").classList.add("active");let c=document.querySelector("#trainertabelle tbody");c.innerHTML="";let a=document.createElement("tr");a.innerHTML=`
      ...
      `,c.appendChild(s),await K()};async function K(){let c=document.getElementById("supporterContainer"),a=document.getElementById("itemContainer"),o=document.getElementById("stadiumContainer"),m=document.getElementById("toolContainer"),s=await C();if(!s||!Array.isArray(s)){console.error("getTrainers() lieferte keine g\xFCltige Liste:",s);return}s.sort((g,u)=>(u.avg30||0)-(g.avg30||0));let h=document.createDocumentFragment(),d=document.createDocumentFragment(),f=document.createDocumentFragment(),b=document.createDocumentFragment();for(let g of s){window.cachedCards[g.cardId]=g;let u=document.createElement("img");u.src=g.imageLow,u.alt=g.cardId,u.style.width="50px",u.style.height="69px",u.style.objectFit="cover";let v="";if(Array.isArray(g.subTypes))g.subTypes.some(w=>w.toLowerCase().includes("supporter"))?v="supporter":g.subTypes.some(w=>w.toLowerCase().includes("item"))?v="item":g.subTypes.some(w=>w.toLowerCase().includes("stadium"))?v="stadium":g.subTypes.some(w=>w.toLowerCase().includes("tool"))&&(v="tool");else if(typeof g.subTypes=="string"){let w=g.subTypes.toLowerCase();w.includes("supporter")?v="supporter":w.includes("item")?v="item":w.includes("stadium")?v="stadium":w.includes("tool")&&(v="tool")}u.addEventListener("click",()=>Y(g.id,v)),v=="supporter"&&h.appendChild(u),v=="item"&&d.appendChild(u),v=="stadium"&&f.appendChild(u),v=="tool"&&b.appendChild(u)}c.appendChild(h),a.appendChild(d),o.appendChild(f),m.appendChild(b)}window.openTrainerOverlay=async function(c){let a=document.querySelector("#overlay");a.innerHTML=`
        <div id="overlayContent">
          <h2>Bitte warten...</h2>
          <p>Karten werden geladen</p>
          <div class="loader"></div>
      ...
      `,a.classList.remove("hidden"),a.classList.add("shown");try{let o=window.cachedTrainerCardsByType[c];if(o||(o=await U(c),o&&(window.cachedTrainerCardsByType[c]=o)),!o||o.length===0){a.innerHTML=`
        ...
        `,a.innerHTML=m,document.getElementById("BackBtn").addEventListener("click",()=>{a.classList.add("hidden"),a.classList.remove("shown"),a.innerHTML=""})}catch(o){console.error(o),a.innerHTML=`
          <div id='overlayContent'>
            <h2>Fehler beim Laden.</h2>
            <button class="overlayMenuBtn" id="BackBtn">Schlie\xDFen</button>
          </div>`,document.getElementById("BackBtn").addEventListener("click",()=>{a.classList.add("hidden"),a.classList.remove("shown"),a.innerHTML=""})}};async function U(c){var h,d,f,b;let a=[],o=1,m=250,s=!0;for(;s;){let g=`https://api.pokemontcg.io/v2/cards?q=supertype:Trainer subtypes:${c}&orderBy=name&page=${o}&pageSize=${m}`,u=await te.get({url:g,headers:{Accept:"application/json","X-Api-Key":ae.API_KEY,Connection:"close"}});if(u.status!==200||!((d=(h=u.data)==null?void 0:h.data)!=null&&d.length)){s=!1;break}let v=u.data.data;for(let w of v){let S=(f=w.cardmarket)==null?void 0:f.prices;w.avg30=(b=S==null?void 0:S.avg30)!=null?b:null}a=a.concat(v),v.length<m?s=!1:o++}return a}window.trainerKarteAusw\u00E4hlen=async function(c){var o,m;let a=document.querySelector("#overlay");a.innerHTML='<div id="overlayContent"><div class="loader"></div></div>',a.classList.remove("hidden"),a.classList.add("shown");try{let s=await te.get({url:`https://api.pokemontcg.io/v2/cards/${c}`,headers:{Accept:"application/json","X-Api-Key":ae.API_KEY,Connection:"close"}});if(s.status!==200){console.error("Fehler beim Abrufen der Karte:",s.status,s);return}let h=s.data.data;h.imageSmall=((o=h.images)==null?void 0:o.small)||null,h.imageLarge=((m=h.images)==null?void 0:m.large)||null;let d=await T(h);if(!d){console.error("Keine ID von insertCard erhalten \u2013 Abbruch.");return}h.id=d,window.cachedCards[h.cardId]=h,a.innerHTML=`
          <div id="overlayContent">
            <h2>Karte hinzugef\xFCgt!</h2>
          ...
          <div id="overlayContent">
            ...
            <div style="display:flex; align-items:center; justify-content:center;">
              <div style="display:flex; flex-direction:column; align-items:center;">
                ...
                <p style="margin-top:10px;">
                  ID: ${u.cardId} | Variante: <strong>${w}</strong><br>
      ...
      `,a.classList.remove("hidden"),a.classList.add("shown");try{let o=window.cachedEnergyCardsByType[c];if(o||(o=await V(c),o&&(window.cachedEnergyCardsByType[c]=o)),!o||o.length===0){a.innerHTML=`
        ...
        `,a.innerHTML=m,document.getElementById("BackBtn").addEventListener("click",()=>{a.classList.add("hidden"),a.classList.remove("shown"),a.innerHTML=""})}catch(o){console.error(o),a.innerHTML=`
          <div id='overlayContent'>
            <h2>Fehler beim Laden.</h2>
            <button class="overlayMenuBtn" id="BackBtn">Schlie\xDFen</button>
          </div>`,document.getElementById("BackBtn").addEventListener("click",()=>{a.classList.add("hidden"),a.classList.remove("shown"),a.innerHTML=""})}};async function V(c){var h,d,f,b;let a=[],o=1,m=250,s=!0;for(;s;){let g=`https://api.pokemontcg.io/v2/cards?q=supertype:Energy subtypes:${c}&orderBy=name&page=${o}&pageSize=${m}`,u=await te.get({url:g,headers:{Accept:"application/json","X-Api-Key":ae.API_KEY,Connection:"close"}});if(u.status!==200||!((d=(h=u.data)==null?void 0:h.data)!=null&&d.length)){s=!1;break}let v=u.data.data;for(let w of v){let S=(f=w.cardmarket)==null?void 0:f.prices;w.avg30=(b=S==null?void 0:S.avg30)!=null?b:null}a=a.concat(v),v.length<m?s=!1:o++}return a}window.energieKarteAusw\u00E4hlen=async function(c){var o,m;let a=document.querySelector("#overlay");a.innerHTML='<div id="overlayContent"><div class="loader"></div></div>',a.classList.remove("hidden"),a.classList.add("shown");try{let s=await te.get({url:`https://api.pokemontcg.io/v2/cards/${c}`,headers:{Accept:"application/json","X-Api-Key":ae.API_KEY,Connection:"close"}});if(s.status!==200){console.error("Fehler beim Abrufen der Karte:",s.status,s);return}let h=s.data.data;h.imageSmall=((o=h.images)==null?void 0:o.small)||null,h.imageLarge=((m=h.images)==null?void 0:m.large)||null;let d=await z(h);if(!d){console.error("Keine ID von insertCard erhalten \u2013 Abbruch.");return}h.id=d,window.cachedCards[h.cardId]=h,a.innerHTML=`
          <div id="overlayContent">
            <h2>Karte hinzugef\xFCgt!</h2>
            <p>Du hast <strong>${c}</strong> ausgew\xE4hlt.</p>
            <br>
        ...
        `;async function f(b,g){a.innerHTML='<div id="overlayContent"><div class="loader"></div></div>',a.classList.remove("hidden"),a.classList.add("shown");try{b!=="none"&&await $.run(`UPDATE energy SET ${b} = 1 WHERE id = ?`,[g]);let u=document.getElementById("basisEnergieContainer");u.innerHTML="";let v=document.getElementById("spezialEnergieContainer");v.innerHTML="",await _()}catch(u){console.error("Fehler in finalizeEnergieSelection:",u.message,u)}a.classList.add("hidden"),a.classList.remove("shown"),a.innerHTML="",await O()}document.getElementById("btnBasic").addEventListener("click",()=>f("basic",d)),document.getElementById("btnReverse").addEventListener("click",()=>f("reverse",d)),document.getElementById("btnHolo").addEventListener("click",()=>f("holo",d)),document.getElementById("closeOverlayConfirm").addEventListener("click",()=>f("none",d))}catch(s){console.error("Fehler bei energieKarteAusw\xE4hlen:",s),a.innerHTML=`
          <div id="overlayContent">
            <h2>Fehler beim Hinzuf\xFCgen.</h2>
            <p>${s.message}</p>
            <button class="overlayMenuBtn" id="closeOverlayConfirm">Schlie\xDFen</button>
          </div>
        `,document.getElementById("closeOverlayConfirm").addEventListener("click",()=>{a.classList.add("hidden"),a.classList.remove("shown"),a.innerHTML=""})}};async function ce(c,a){var b;let o=document.querySelector("#overlay");o.innerHTML='<div id="overlayContent"><div class="loader"></div></div>',o.classList.remove("hidden"),o.classList.add("shown");let m=await se();if(!m||!m.length)return;let s=[],h={};for(let g of m){let u=await le(g);if(!u)continue;let v=((b=u.subTypes)==null?void 0:b.toLowerCase())||"";(a==="basic"&&v.includes("basic")||a==="special"&&v.includes("special"))&&(s.push(g),h[g]=u)}if(!s.length){o.classList.add("hidden"),o.classList.remove("shown");return}let d=s.findIndex(g=>g===c);d===-1&&(d=0);async function f(){let g=s[d],u=h[g]||await le(g);if(!u)return;let v="Unbekannt";u.addedAt&&(v=new Date(u.addedAt).toLocaleString("de-DE",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"}));let w="Keine Angabe";u.basic==1&&(w="Basic"),u.reverse==1&&(w="Reverse"),u.holo==1&&(w="Holo");let S="\u2013",M=await x(u.cardId);if(M==null){let R=q(u.cardId);M=await x(R)}if(M!=null){let R=M.toFixed(2),j="#DEDEDE",J="\u{1FA99}";M>20?(j="#FF4444",J="\u{1F525}"):M>5&&(j="#FFAA00",J="\u{1F4B0}"),S=`<span style="color:${j};">${J} ${R}\u20AC</span>`}o.innerHTML=`
          <div id="overlayContent">
            <button class="closeGallery" id="closeGallery">X</button>
