(()=>{var et=Object.defineProperty;var N=(r,e)=>()=>(r&&(e=r(r=0)),e);var se=(r,e)=>{for(var t in e)et(r,t,{get:e[t],enumerable:!0})};var tt,rt,De,Mt,At,J,Q,at,nt,it,ee,Re,qt,te,le=N(()=>{tt=r=>{let e=new Map;e.set("web",{name:"web"});let t=r.CapacitorPlatforms||{currentPlatform:{name:"web"},platforms:e},a=(i,l)=>{t.platforms.set(i,l)},n=i=>{t.platforms.has(i)&&(t.currentPlatform=t.platforms.get(i))};return t.addPlatform=a,t.setPlatform=n,t},rt=r=>r.CapacitorPlatforms=tt(r),De=rt(typeof globalThis!="undefined"?globalThis:typeof self!="undefined"?self:typeof window!="undefined"?window:typeof global!="undefined"?global:{}),Mt=De.addPlatform,At=De.setPlatform;(function(r){r.Unimplemented="UNIMPLEMENTED",r.Unavailable="UNAVAILABLE"})(J||(J={}));Q=class extends Error{constructor(e,t){super(e),this.message=e,this.code=t}},at=r=>{var e,t;return r!=null&&r.androidBridge?"android":!((t=(e=r==null?void 0:r.webkit)===null||e===void 0?void 0:e.messageHandlers)===null||t===void 0)&&t.bridge?"ios":"web"},nt=r=>{var e,t,a,n,i;let l=r.CapacitorCustomPlatform||null,o=r.Capacitor||{},b=o.Plugins=o.Plugins||{},f=r.CapacitorPlatforms,j=()=>l!==null?l.name:at(r),E=((e=f==null?void 0:f.currentPlatform)===null||e===void 0?void 0:e.getPlatform)||j,P=()=>E()!=="web",B=((t=f==null?void 0:f.currentPlatform)===null||t===void 0?void 0:t.isNativePlatform)||P,F=C=>{let v=$.get(C);return!!(v!=null&&v.platforms.has(E())||z(C))},O=((a=f==null?void 0:f.currentPlatform)===null||a===void 0?void 0:a.isPluginAvailable)||F,D=C=>{var v;return(v=o.PluginHeaders)===null||v===void 0?void 0:v.find(d=>d.name===C)},z=((n=f==null?void 0:f.currentPlatform)===null||n===void 0?void 0:n.getPluginHeader)||D,V=C=>r.console.error(C),G=(C,v,d)=>Promise.reject(`${d} does not have an implementation of "${v}".`),$=new Map,W=(C,v={})=>{let d=$.get(C);if(d)return console.warn(`Capacitor plugin "${C}" already registered. Cannot register plugins twice.`),d.proxy;let M=E(),T=z(C),A,s=async()=>(!A&&M in v?A=typeof v[M]=="function"?A=await v[M]():A=v[M]:l!==null&&!A&&"web"in v&&(A=typeof v.web=="function"?A=await v.web():A=v.web),A),c=(m,w)=>{var x,k;if(T){let L=T==null?void 0:T.methods.find(q=>w===q.name);if(L)return L.rtype==="promise"?q=>o.nativePromise(C,w.toString(),q):(q,S)=>o.nativeCallback(C,w.toString(),q,S);if(m)return(x=m[w])===null||x===void 0?void 0:x.bind(m)}else{if(m)return(k=m[w])===null||k===void 0?void 0:k.bind(m);throw new Q(`"${C}" plugin is not implemented on ${M}`,J.Unimplemented)}},u=m=>{let w,x=(...k)=>{let L=s().then(q=>{let S=c(q,m);if(S){let R=S(...k);return w=R==null?void 0:R.remove,R}else throw new Q(`"${C}.${m}()" is not implemented on ${M}`,J.Unimplemented)});return m==="addListener"&&(L.remove=async()=>w()),L};return x.toString=()=>`${m.toString()}() { [capacitor code] }`,Object.defineProperty(x,"name",{value:m,writable:!1,configurable:!1}),x},p=u("addListener"),h=u("removeListener"),y=(m,w)=>{let x=p({eventName:m},w),k=async()=>{let q=await x;h({eventName:m,callbackId:q},w)},L=new Promise(q=>x.then(()=>q({remove:k})));return L.remove=async()=>{console.warn("Using addListener() without 'await' is deprecated."),await k()},L},g=new Proxy({},{get(m,w){switch(w){case"$$typeof":return;case"toJSON":return()=>({});case"addListener":return T?y:p;case"removeListener":return h;default:return u(w)}}});return b[C]=g,$.set(C,{name:C,proxy:g,platforms:new Set([...Object.keys(v),...T?[M]:[]])}),g},K=((i=f==null?void 0:f.currentPlatform)===null||i===void 0?void 0:i.registerPlugin)||W;return o.convertFileSrc||(o.convertFileSrc=C=>C),o.getPlatform=E,o.handleError=V,o.isNativePlatform=B,o.isPluginAvailable=O,o.pluginMethodNoop=G,o.registerPlugin=K,o.Exception=Q,o.DEBUG=!!o.DEBUG,o.isLoggingEnabled=!!o.isLoggingEnabled,o.platform=o.getPlatform(),o.isNative=o.isNativePlatform(),o},it=r=>r.Capacitor=nt(r),ee=it(typeof globalThis!="undefined"?globalThis:typeof self!="undefined"?self:typeof window!="undefined"?window:typeof global!="undefined"?global:{}),Re=ee.registerPlugin,qt=ee.Plugins,te=class{constructor(e){this.listeners={},this.windowListeners={},e&&(console.warn(`Capacitor WebPlugin "${e.name}" config object was deprecated in v3 and will be removed in v4.`),this.config=e)}addListener(e,t){this.listeners[e]||(this.listeners[e]=[]),this.listeners[e].push(t);let n=this.windowListeners[e];n&&!n.registered&&this.addWindowListener(n);let i=async()=>this.removeListener(e,t),l=Promise.resolve({remove:i});return Object.defineProperty(l,"remove",{value:async()=>{console.warn("Using addListener() without 'await' is deprecated."),await i()}}),l}async removeAllListeners(){this.listeners={};for(let e in this.windowListeners)this.removeWindowListener(this.windowListeners[e]);this.windowListeners={}}notifyListeners(e,t){let a=this.listeners[e];a&&a.forEach(n=>n(t))}hasListeners(e){return!!this.listeners[e].length}registerWindowListener(e,t){this.windowListeners[t]={registered:!1,windowEventName:e,pluginEventName:t,handler:a=>{this.notifyListeners(t,a)}}}unimplemented(e="not implemented"){return new ee.Exception(e,J.Unimplemented)}unavailable(e="not available"){return new ee.Exception(e,J.Unavailable)}async removeListener(e,t){let a=this.listeners[e];if(!a)return;let n=a.indexOf(t);this.listeners[e].splice(n,1),this.listeners[e].length||this.removeWindowListener(this.windowListeners[e])}addWindowListener(e){window.addEventListener(e.windowEventName,e.handler),e.registered=!0}removeWindowListener(e){e&&(window.removeEventListener(e.windowEventName,e.handler),e.registered=!1)}}});var Ie,ce,ue,de=N(()=>{Ie=async r=>new Promise((e,t)=>{let a=new FileReader;a.onload=()=>{let n=a.result,i=n.substr(n.indexOf(",")+1);e(i)},a.onerror=n=>t(n),a.readAsDataURL(r)}),ce=r=>encodeURIComponent(r).replace(/%(2[346B]|5E|60|7C)/g,decodeURIComponent).replace(/[()]/g,escape),ue=r=>r.replace(/(%[\dA-F]{2})+/gi,decodeURIComponent)});var Be,re,je,Fe,me,Oe=N(()=>{de();Be=(r,e,t={})=>{let a=ce(r),n=ce(e),i=`; expires=${(t.expires||"").replace("expires=","")}`,l=(t.path||"/").replace("path=","");document.cookie=`${a}=${n||""}${i}; path=${l}`},re=()=>{let r=[],e={};if(!document.cookie)return r;let t=document.cookie.split(";")||[];for(let n of t){let[i,l]=n.replace(/=/,"CAP_COOKIE").split("CAP_COOKIE");i=ue(i).trim(),l=ue(l).trim(),e[i]=l}let a=Object.entries(e);for(let[n,i]of a)r.push({key:n,value:i});return r},je=r=>{let e=re();for(let t of e)if(t.key===r)return t;return{key:r,value:""}},Fe=r=>{document.cookie=`${r}=; Max-Age=0`},me=()=>{let r=document.cookie.split(";")||[];for(let e of r)document.cookie=e.replace(/^ +/,"").replace(/=.*/,`=;expires=${new Date().toUTCString()};path=/`)}});var st,lt,he,U,Ke,Ne,We,Ge,$e,He=N(()=>{de();st=(r={})=>{let e=Object.keys(r);return Object.keys(r).map(n=>n.toLocaleLowerCase()).reduce((n,i,l)=>(n[i]=r[e[l]],n),{})},lt=(r,e=!0)=>r?Object.entries(r).reduce((a,n)=>{let[i,l]=n,o,b;return Array.isArray(l)?(b="",l.forEach(f=>{o=e?encodeURIComponent(f):f,b+=`${i}=${o}&`}),b.slice(0,-1)):(o=e?encodeURIComponent(l):l,b=`${i}=${o}`),`${a}&${b}`},"").substr(1):null,he=(r,e={})=>{let t=Object.assign({method:r.method||"GET",headers:r.headers},e),n=st(r.headers)["content-type"]||"";if(typeof r.data=="string")t.body=r.data;else if(n.includes("application/x-www-form-urlencoded")){let i=new URLSearchParams;for(let[l,o]of Object.entries(r.data||{}))i.set(l,o);t.body=i.toString()}else if(n.includes("multipart/form-data")){let i=new FormData;if(r.data instanceof FormData)r.data.forEach((o,b)=>{i.append(b,o)});else for(let o of Object.keys(r.data))i.append(o,r.data[o]);t.body=i;let l=new Headers(t.headers);l.delete("content-type"),t.headers=l}else(n.includes("application/json")||typeof r.data=="object")&&(t.body=JSON.stringify(r.data));return t},U=async r=>{let e=he(r,r.webFetchExtra),t=lt(r.params,r.shouldEncodeUrlParams),a=t?`${r.url}?${t}`:r.url,n=await fetch(a,e),i=n.headers.get("content-type")||"",{responseType:l="text"}=n.ok?r:{};i.includes("application/json")&&(l="json");let o;switch(l){case"arraybuffer":case"blob":let f=await n.blob();o=await Ie(f);break;case"json":o=await n.json();break;case"document":case"text":default:o=await n.text()}let b={};return n.headers.forEach((f,j)=>{b[j]=f}),{data:o,headers:b,status:n.status,url:n.url}},Ke=async r=>U(Object.assign(Object.assign({},r),{method:"GET"})),Ne=async r=>U(Object.assign(Object.assign({},r),{method:"POST"})),We=async r=>U(Object.assign(Object.assign({},r),{method:"PUT"})),Ge=async r=>U(Object.assign(Object.assign({},r),{method:"PATCH"})),$e=async r=>U(Object.assign(Object.assign({},r),{method:"DELETE"}))});var ge={};se(ge,{HttpWeb:()=>pe});var pe,ye=N(()=>{le();Oe();He();pe=class extends te{constructor(){super(),this.request=async e=>U(e),this.get=async e=>Ke(e),this.post=async e=>Ne(e),this.put=async e=>We(e),this.patch=async e=>Ge(e),this.del=async e=>$e(e),this.getCookiesMap=async e=>{let t=re(),a={};for(let n of t)a[n.key]=n.value;return a},this.getCookies=async e=>{let{url:t}=e;return{cookies:re()}},this.setCookie=async e=>{let{key:t,value:a,expires:n="",path:i=""}=e;Be(t,a,{expires:n,path:i})},this.getCookie=async e=>je(e.key),this.deleteCookie=async e=>Fe(e.key),this.clearCookies=async e=>me(),this.clearAllCookies=async()=>me(),this.uploadFile=async e=>{let t=new FormData;t.append(e.name,e.blob||"undefined");let a=Object.assign(Object.assign({},e),{body:t,method:"POST"});return this.post(a)},this.downloadFile=async e=>{let t=he(e,e.webFetchExtra),a=await fetch(e.url,t),n;if(!(e!=null&&e.progress))n=await a.blob();else if(!(a!=null&&a.body))n=new Blob;else{let i=a.body.getReader(),l=0,o=[],b=a.headers.get("content-type"),f=parseInt(a.headers.get("content-length")||"0",10);for(;;){let{done:P,value:B}=await i.read();if(P)break;o.push(B),l+=(B==null?void 0:B.length)||0;let F={type:"DOWNLOAD",url:e.url,bytes:l,contentLength:f};this.notifyListeners("progress",F)}let j=new Uint8Array(l),E=0;for(let P of o)typeof P!="undefined"&&(j.set(P,E),E+=P.length);n=new Blob([j.buffer],{type:b||void 0})}return{blob:n}}}}});var _,X,ut,dt,mt,be,ne,Z,ze,Ue,fe,Nt,ht,pt,gt,yt,we,Wt,ve=N(()=>{(function(r){r.Unimplemented="UNIMPLEMENTED",r.Unavailable="UNAVAILABLE"})(_||(_={}));X=class extends Error{constructor(e,t,a){super(e),this.message=e,this.code=t,this.data=a}},ut=r=>{var e,t;return r!=null&&r.androidBridge?"android":!((t=(e=r==null?void 0:r.webkit)===null||e===void 0?void 0:e.messageHandlers)===null||t===void 0)&&t.bridge?"ios":"web"},dt=r=>{let e=r.CapacitorCustomPlatform||null,t=r.Capacitor||{},a=t.Plugins=t.Plugins||{},n=()=>e!==null?e.name:ut(r),i=()=>n()!=="web",l=E=>{let P=f.get(E);return!!(P!=null&&P.platforms.has(n())||o(E))},o=E=>{var P;return(P=t.PluginHeaders)===null||P===void 0?void 0:P.find(B=>B.name===E)},b=E=>r.console.error(E),f=new Map,j=(E,P={})=>{let B=f.get(E);if(B)return console.warn(`Capacitor plugin "${E}" already registered. Cannot register plugins twice.`),B.proxy;let F=n(),O=o(E),D,z=async()=>(!D&&F in P?D=typeof P[F]=="function"?D=await P[F]():D=P[F]:e!==null&&!D&&"web"in P&&(D=typeof P.web=="function"?D=await P.web():D=P.web),D),V=(v,d)=>{var M,T;if(O){let A=O==null?void 0:O.methods.find(s=>d===s.name);if(A)return A.rtype==="promise"?s=>t.nativePromise(E,d.toString(),s):(s,c)=>t.nativeCallback(E,d.toString(),s,c);if(v)return(M=v[d])===null||M===void 0?void 0:M.bind(v)}else{if(v)return(T=v[d])===null||T===void 0?void 0:T.bind(v);throw new X(`"${E}" plugin is not implemented on ${F}`,_.Unimplemented)}},G=v=>{let d,M=(...T)=>{let A=z().then(s=>{let c=V(s,v);if(c){let u=c(...T);return d=u==null?void 0:u.remove,u}else throw new X(`"${E}.${v}()" is not implemented on ${F}`,_.Unimplemented)});return v==="addListener"&&(A.remove=async()=>d()),A};return M.toString=()=>`${v.toString()}() { [capacitor code] }`,Object.defineProperty(M,"name",{value:v,writable:!1,configurable:!1}),M},$=G("addListener"),W=G("removeListener"),K=(v,d)=>{let M=$({eventName:v},d),T=async()=>{let s=await M;W({eventName:v,callbackId:s},d)},A=new Promise(s=>M.then(()=>s({remove:T})));return A.remove=async()=>{console.warn("Using addListener() without 'await' is deprecated."),await T()},A},C=new Proxy({},{get(v,d){switch(d){case"$$typeof":return;case"toJSON":return()=>({});case"addListener":return O?K:$;case"removeListener":return W;default:return G(d)}}});return a[E]=C,f.set(E,{name:E,proxy:C,platforms:new Set([...Object.keys(P),...O?[F]:[]])}),C};return t.convertFileSrc||(t.convertFileSrc=E=>E),t.getPlatform=n,t.handleError=b,t.isNativePlatform=i,t.isPluginAvailable=l,t.registerPlugin=j,t.Exception=X,t.DEBUG=!!t.DEBUG,t.isLoggingEnabled=!!t.isLoggingEnabled,t},mt=r=>r.Capacitor=dt(r),be=mt(typeof globalThis!="undefined"?globalThis:typeof self!="undefined"?self:typeof window!="undefined"?window:typeof global!="undefined"?global:{}),ne=be.registerPlugin,Z=class{constructor(){this.listeners={},this.retainedEventArguments={},this.windowListeners={}}addListener(e,t){let a=!1;this.listeners[e]||(this.listeners[e]=[],a=!0),this.listeners[e].push(t);let i=this.windowListeners[e];i&&!i.registered&&this.addWindowListener(i),a&&this.sendRetainedArgumentsForEvent(e);let l=async()=>this.removeListener(e,t);return Promise.resolve({remove:l})}async removeAllListeners(){this.listeners={};for(let e in this.windowListeners)this.removeWindowListener(this.windowListeners[e]);this.windowListeners={}}notifyListeners(e,t,a){let n=this.listeners[e];if(!n){if(a){let i=this.retainedEventArguments[e];i||(i=[]),i.push(t),this.retainedEventArguments[e]=i}return}n.forEach(i=>i(t))}hasListeners(e){return!!this.listeners[e].length}registerWindowListener(e,t){this.windowListeners[t]={registered:!1,windowEventName:e,pluginEventName:t,handler:a=>{this.notifyListeners(t,a)}}}unimplemented(e="not implemented"){return new be.Exception(e,_.Unimplemented)}unavailable(e="not available"){return new be.Exception(e,_.Unavailable)}async removeListener(e,t){let a=this.listeners[e];if(!a)return;let n=a.indexOf(t);this.listeners[e].splice(n,1),this.listeners[e].length||this.removeWindowListener(this.windowListeners[e])}addWindowListener(e){window.addEventListener(e.windowEventName,e.handler),e.registered=!0}removeWindowListener(e){e&&(window.removeEventListener(e.windowEventName,e.handler),e.registered=!1)}sendRetainedArgumentsForEvent(e){let t=this.retainedEventArguments[e];t&&(delete this.retainedEventArguments[e],t.forEach(a=>{this.notifyListeners(e,a)}))}},ze=r=>encodeURIComponent(r).replace(/%(2[346B]|5E|60|7C)/g,decodeURIComponent).replace(/[()]/g,escape),Ue=r=>r.replace(/(%[\dA-F]{2})+/gi,decodeURIComponent),fe=class extends Z{async getCookies(){let e=document.cookie,t={};return e.split(";").forEach(a=>{if(a.length<=0)return;let[n,i]=a.replace(/=/,"CAP_COOKIE").split("CAP_COOKIE");n=Ue(n).trim(),i=Ue(i).trim(),t[n]=i}),t}async setCookie(e){try{let t=ze(e.key),a=ze(e.value),n=`; expires=${(e.expires||"").replace("expires=","")}`,i=(e.path||"/").replace("path=",""),l=e.url!=null&&e.url.length>0?`domain=${e.url}`:"";document.cookie=`${t}=${a||""}${n}; path=${i}; ${l};`}catch(t){return Promise.reject(t)}}async deleteCookie(e){try{document.cookie=`${e.key}=; Max-Age=0`}catch(t){return Promise.reject(t)}}async clearCookies(){try{let e=document.cookie.split(";")||[];for(let t of e)document.cookie=t.replace(/^ +/,"").replace(/=.*/,`=;expires=${new Date().toUTCString()};path=/`)}catch(e){return Promise.reject(e)}}async clearAllCookies(){try{await this.clearCookies()}catch(e){return Promise.reject(e)}}},Nt=ne("CapacitorCookies",{web:()=>new fe}),ht=async r=>new Promise((e,t)=>{let a=new FileReader;a.onload=()=>{let n=a.result;e(n.indexOf(",")>=0?n.split(",")[1]:n)},a.onerror=n=>t(n),a.readAsDataURL(r)}),pt=(r={})=>{let e=Object.keys(r);return Object.keys(r).map(n=>n.toLocaleLowerCase()).reduce((n,i,l)=>(n[i]=r[e[l]],n),{})},gt=(r,e=!0)=>r?Object.entries(r).reduce((a,n)=>{let[i,l]=n,o,b;return Array.isArray(l)?(b="",l.forEach(f=>{o=e?encodeURIComponent(f):f,b+=`${i}=${o}&`}),b.slice(0,-1)):(o=e?encodeURIComponent(l):l,b=`${i}=${o}`),`${a}&${b}`},"").substr(1):null,yt=(r,e={})=>{let t=Object.assign({method:r.method||"GET",headers:r.headers},e),n=pt(r.headers)["content-type"]||"";if(typeof r.data=="string")t.body=r.data;else if(n.includes("application/x-www-form-urlencoded")){let i=new URLSearchParams;for(let[l,o]of Object.entries(r.data||{}))i.set(l,o);t.body=i.toString()}else if(n.includes("multipart/form-data")||r.data instanceof FormData){let i=new FormData;if(r.data instanceof FormData)r.data.forEach((o,b)=>{i.append(b,o)});else for(let o of Object.keys(r.data))i.append(o,r.data[o]);t.body=i;let l=new Headers(t.headers);l.delete("content-type"),t.headers=l}else(n.includes("application/json")||typeof r.data=="object")&&(t.body=JSON.stringify(r.data));return t},we=class extends Z{async request(e){let t=yt(e,e.webFetchExtra),a=gt(e.params,e.shouldEncodeUrlParams),n=a?`${e.url}?${a}`:e.url,i=await fetch(n,t),l=i.headers.get("content-type")||"",{responseType:o="text"}=i.ok?e:{};l.includes("application/json")&&(o="json");let b,f;switch(o){case"arraybuffer":case"blob":f=await i.blob(),b=await ht(f);break;case"json":b=await i.json();break;case"document":case"text":default:b=await i.text()}let j={};return i.headers.forEach((E,P)=>{j[P]=E}),{data:b,headers:j,status:i.status,url:i.url}}async get(e){return this.request(Object.assign(Object.assign({},e),{method:"GET"}))}async post(e){return this.request(Object.assign(Object.assign({},e),{method:"POST"}))}async put(e){return this.request(Object.assign(Object.assign({},e),{method:"PUT"}))}async patch(e){return this.request(Object.assign(Object.assign({},e),{method:"PATCH"}))}async delete(e){return this.request(Object.assign(Object.assign({},e),{method:"DELETE"}))}},Wt=ne("CapacitorHttp",{web:()=>new we})});var ie,oe,Ve=N(()=>{ie=class{constructor(e){this.sqlite=e,this._connectionDict=new Map}async initWebStore(){try{return await this.sqlite.initWebStore(),Promise.resolve()}catch(e){return Promise.reject(e)}}async saveToStore(e){try{return await this.sqlite.saveToStore({database:e}),Promise.resolve()}catch(t){return Promise.reject(t)}}async saveToLocalDisk(e){try{return await this.sqlite.saveToLocalDisk({database:e}),Promise.resolve()}catch(t){return Promise.reject(t)}}async getFromLocalDiskToStore(e){let t=e!=null?e:!0;try{return await this.sqlite.getFromLocalDiskToStore({overwrite:t}),Promise.resolve()}catch(a){return Promise.reject(a)}}async echo(e){try{let t=await this.sqlite.echo({value:e});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async isSecretStored(){try{let e=await this.sqlite.isSecretStored();return Promise.resolve(e)}catch(e){return Promise.reject(e)}}async setEncryptionSecret(e){try{return await this.sqlite.setEncryptionSecret({passphrase:e}),Promise.resolve()}catch(t){return Promise.reject(t)}}async changeEncryptionSecret(e,t){try{return await this.sqlite.changeEncryptionSecret({passphrase:e,oldpassphrase:t}),Promise.resolve()}catch(a){return Promise.reject(a)}}async clearEncryptionSecret(){try{return await this.sqlite.clearEncryptionSecret(),Promise.resolve()}catch(e){return Promise.reject(e)}}async checkEncryptionSecret(e){try{let t=await this.sqlite.checkEncryptionSecret({passphrase:e});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async addUpgradeStatement(e,t){try{return e.endsWith(".db")&&(e=e.slice(0,-3)),await this.sqlite.addUpgradeStatement({database:e,upgrade:t}),Promise.resolve()}catch(a){return Promise.reject(a)}}async createConnection(e,t,a,n,i){try{e.endsWith(".db")&&(e=e.slice(0,-3)),await this.sqlite.createConnection({database:e,encrypted:t,mode:a,version:n,readonly:i});let l=new oe(e,i,this.sqlite),o=i?`RO_${e}`:`RW_${e}`;return this._connectionDict.set(o,l),Promise.resolve(l)}catch(l){return Promise.reject(l)}}async closeConnection(e,t){try{e.endsWith(".db")&&(e=e.slice(0,-3)),await this.sqlite.closeConnection({database:e,readonly:t});let a=t?`RO_${e}`:`RW_${e}`;return this._connectionDict.delete(a),Promise.resolve()}catch(a){return Promise.reject(a)}}async isConnection(e,t){let a={};e.endsWith(".db")&&(e=e.slice(0,-3));let n=t?`RO_${e}`:`RW_${e}`;return a.result=this._connectionDict.has(n),Promise.resolve(a)}async retrieveConnection(e,t){e.endsWith(".db")&&(e=e.slice(0,-3));let a=t?`RO_${e}`:`RW_${e}`;if(this._connectionDict.has(a)){let n=this._connectionDict.get(a);return typeof n!="undefined"?Promise.resolve(n):Promise.reject(`Connection ${e} is undefined`)}else return Promise.reject(`Connection ${e} does not exist`)}async getNCDatabasePath(e,t){try{let a=await this.sqlite.getNCDatabasePath({path:e,database:t});return Promise.resolve(a)}catch(a){return Promise.reject(a)}}async createNCConnection(e,t){try{await this.sqlite.createNCConnection({databasePath:e,version:t});let a=new oe(e,!0,this.sqlite),n=`RO_${e})`;return this._connectionDict.set(n,a),Promise.resolve(a)}catch(a){return Promise.reject(a)}}async closeNCConnection(e){try{await this.sqlite.closeNCConnection({databasePath:e});let t=`RO_${e})`;return this._connectionDict.delete(t),Promise.resolve()}catch(t){return Promise.reject(t)}}async isNCConnection(e){let t={},a=`RO_${e})`;return t.result=this._connectionDict.has(a),Promise.resolve(t)}async retrieveNCConnection(e){if(this._connectionDict.has(e)){let t=`RO_${e})`,a=this._connectionDict.get(t);return typeof a!="undefined"?Promise.resolve(a):Promise.reject(`Connection ${e} is undefined`)}else return Promise.reject(`Connection ${e} does not exist`)}async isNCDatabase(e){try{let t=await this.sqlite.isNCDatabase({databasePath:e});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async retrieveAllConnections(){return this._connectionDict}async closeAllConnections(){let e=new Map;try{for(let t of this._connectionDict.keys()){let a=t.substring(3),n=t.substring(0,3)==="RO_";await this.sqlite.closeConnection({database:a,readonly:n}),e.set(t,null)}for(let t of e.keys())this._connectionDict.delete(t);return Promise.resolve()}catch(t){return Promise.reject(t)}}async checkConnectionsConsistency(){try{let e=[...this._connectionDict.keys()],t=[],a=[];for(let i of e)t.push(i.substring(0,2)),a.push(i.substring(3));let n=await this.sqlite.checkConnectionsConsistency({dbNames:a,openModes:t});return n.result||(this._connectionDict=new Map),Promise.resolve(n)}catch(e){return this._connectionDict=new Map,Promise.reject(e)}}async importFromJson(e){try{let t=await this.sqlite.importFromJson({jsonstring:e});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async isJsonValid(e){try{let t=await this.sqlite.isJsonValid({jsonstring:e});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async copyFromAssets(e){let t=e!=null?e:!0;try{return await this.sqlite.copyFromAssets({overwrite:t}),Promise.resolve()}catch(a){return Promise.reject(a)}}async getFromHTTPRequest(e,t){let a=t!=null?t:!0;try{return await this.sqlite.getFromHTTPRequest({url:e,overwrite:a}),Promise.resolve()}catch(n){return Promise.reject(n)}}async isDatabaseEncrypted(e){e.endsWith(".db")&&(e=e.slice(0,-3));try{let t=await this.sqlite.isDatabaseEncrypted({database:e});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async isInConfigEncryption(){try{let e=await this.sqlite.isInConfigEncryption();return Promise.resolve(e)}catch(e){return Promise.reject(e)}}async isInConfigBiometricAuth(){try{let e=await this.sqlite.isInConfigBiometricAuth();return Promise.resolve(e)}catch(e){return Promise.reject(e)}}async isDatabase(e){e.endsWith(".db")&&(e=e.slice(0,-3));try{let t=await this.sqlite.isDatabase({database:e});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async getDatabaseList(){try{let t=(await this.sqlite.getDatabaseList()).values;t.sort();let a={values:t};return Promise.resolve(a)}catch(e){return Promise.reject(e)}}async getMigratableDbList(e){let t=e||"default";try{let a=await this.sqlite.getMigratableDbList({folderPath:t});return Promise.resolve(a)}catch(a){return Promise.reject(a)}}async addSQLiteSuffix(e,t){let a=e||"default",n=t||[];try{let i=await this.sqlite.addSQLiteSuffix({folderPath:a,dbNameList:n});return Promise.resolve(i)}catch(i){return Promise.reject(i)}}async deleteOldDatabases(e,t){let a=e||"default",n=t||[];try{let i=await this.sqlite.deleteOldDatabases({folderPath:a,dbNameList:n});return Promise.resolve(i)}catch(i){return Promise.reject(i)}}async moveDatabasesAndAddSuffix(e,t){let a=e||"default",n=t||[];return this.sqlite.moveDatabasesAndAddSuffix({folderPath:a,dbNameList:n})}},oe=class{constructor(e,t,a){this.dbName=e,this.readonly=t,this.sqlite=a}getConnectionDBName(){return this.dbName}getConnectionReadOnly(){return this.readonly}async open(){try{return await this.sqlite.open({database:this.dbName,readonly:this.readonly}),Promise.resolve()}catch(e){return Promise.reject(e)}}async close(){try{return await this.sqlite.close({database:this.dbName,readonly:this.readonly}),Promise.resolve()}catch(e){return Promise.reject(e)}}async beginTransaction(){try{let e=await this.sqlite.beginTransaction({database:this.dbName});return Promise.resolve(e)}catch(e){return Promise.reject(e)}}async commitTransaction(){try{let e=await this.sqlite.commitTransaction({database:this.dbName});return Promise.resolve(e)}catch(e){return Promise.reject(e)}}async rollbackTransaction(){try{let e=await this.sqlite.rollbackTransaction({database:this.dbName});return Promise.resolve(e)}catch(e){return Promise.reject(e)}}async isTransactionActive(){try{let e=await this.sqlite.isTransactionActive({database:this.dbName});return Promise.resolve(e)}catch(e){return Promise.reject(e)}}async loadExtension(e){try{return await this.sqlite.loadExtension({database:this.dbName,path:e,readonly:this.readonly}),Promise.resolve()}catch(t){return Promise.reject(t)}}async enableLoadExtension(e){try{return await this.sqlite.enableLoadExtension({database:this.dbName,toggle:e,readonly:this.readonly}),Promise.resolve()}catch(t){return Promise.reject(t)}}async getUrl(){try{let e=await this.sqlite.getUrl({database:this.dbName,readonly:this.readonly});return Promise.resolve(e)}catch(e){return Promise.reject(e)}}async getVersion(){try{let e=await this.sqlite.getVersion({database:this.dbName,readonly:this.readonly});return Promise.resolve(e)}catch(e){return Promise.reject(e)}}async getTableList(){try{let e=await this.sqlite.getTableList({database:this.dbName,readonly:this.readonly});return Promise.resolve(e)}catch(e){return Promise.reject(e)}}async execute(e,t=!0,a=!0){try{if(this.readonly)return Promise.reject("not allowed in read-only mode");{let n=await this.sqlite.execute({database:this.dbName,statements:e,transaction:t,readonly:!1,isSQL92:a});return Promise.resolve(n)}}catch(n){return Promise.reject(n)}}async query(e,t,a=!0){let n;try{return t&&t.length>0?n=await this.sqlite.query({database:this.dbName,statement:e,values:t,readonly:this.readonly,isSQL92:!0}):n=await this.sqlite.query({database:this.dbName,statement:e,values:[],readonly:this.readonly,isSQL92:a}),n=await this.reorderRows(n),Promise.resolve(n)}catch(i){return Promise.reject(i)}}async run(e,t,a=!0,n="no",i=!0){let l;try{return this.readonly?Promise.reject("not allowed in read-only mode"):(t&&t.length>0?l=await this.sqlite.run({database:this.dbName,statement:e,values:t,transaction:a,readonly:!1,returnMode:n,isSQL92:!0}):l=await this.sqlite.run({database:this.dbName,statement:e,values:[],transaction:a,readonly:!1,returnMode:n,isSQL92:i}),l.changes=await this.reorderRows(l.changes),Promise.resolve(l))}catch(o){return Promise.reject(o)}}async executeSet(e,t=!0,a="no",n=!0){let i;try{return this.readonly?Promise.reject("not allowed in read-only mode"):(i=await this.sqlite.executeSet({database:this.dbName,set:e,transaction:t,readonly:!1,returnMode:a,isSQL92:n}),i.changes=await this.reorderRows(i.changes),Promise.resolve(i))}catch(l){return Promise.reject(l)}}async isExists(){try{let e=await this.sqlite.isDBExists({database:this.dbName,readonly:this.readonly});return Promise.resolve(e)}catch(e){return Promise.reject(e)}}async isTable(e){try{let t=await this.sqlite.isTableExists({database:this.dbName,table:e,readonly:this.readonly});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async isDBOpen(){try{let e=await this.sqlite.isDBOpen({database:this.dbName,readonly:this.readonly});return Promise.resolve(e)}catch(e){return Promise.reject(e)}}async delete(){try{return this.readonly?Promise.reject("not allowed in read-only mode"):(await this.sqlite.deleteDatabase({database:this.dbName,readonly:!1}),Promise.resolve())}catch(e){return Promise.reject(e)}}async createSyncTable(){try{if(this.readonly)return Promise.reject("not allowed in read-only mode");{let e=await this.sqlite.createSyncTable({database:this.dbName,readonly:!1});return Promise.resolve(e)}}catch(e){return Promise.reject(e)}}async setSyncDate(e){try{return this.readonly?Promise.reject("not allowed in read-only mode"):(await this.sqlite.setSyncDate({database:this.dbName,syncdate:e,readonly:!1}),Promise.resolve())}catch(t){return Promise.reject(t)}}async getSyncDate(){try{let e=await this.sqlite.getSyncDate({database:this.dbName,readonly:this.readonly}),t="";return e.syncDate>0&&(t=new Date(e.syncDate*1e3).toISOString()),Promise.resolve(t)}catch(e){return Promise.reject(e)}}async exportToJson(e,t=!1){try{let a=await this.sqlite.exportToJson({database:this.dbName,jsonexportmode:e,readonly:this.readonly,encrypted:t});return Promise.resolve(a)}catch(a){return Promise.reject(a)}}async deleteExportedRows(){try{return this.readonly?Promise.reject("not allowed in read-only mode"):(await this.sqlite.deleteExportedRows({database:this.dbName,readonly:!1}),Promise.resolve())}catch(e){return Promise.reject(e)}}async executeTransaction(e,t=!0){let a=0,n=!1;if(this.readonly)return Promise.reject("not allowed in read-only mode");if(await this.sqlite.beginTransaction({database:this.dbName}),n=await this.sqlite.isTransactionActive({database:this.dbName}),!n)return Promise.reject("After Begin Transaction, no transaction active");try{for(let o of e){if(typeof o!="object"||!("statement"in o))throw new Error("Error a task.statement must be provided");if("values"in o&&o.values&&o.values.length>0){let b=o.statement.toUpperCase().includes("RETURNING")?"all":"no",f=await this.sqlite.run({database:this.dbName,statement:o.statement,values:o.values,transaction:!1,readonly:!1,returnMode:b,isSQL92:t});if(f.changes.changes<0)throw new Error("Error in transaction method run ");a+=f.changes.changes}else{let b=await this.sqlite.execute({database:this.dbName,statements:o.statement,transaction:!1,readonly:!1});if(b.changes.changes<0)throw new Error("Error in transaction method execute ");a+=b.changes.changes}}let i=await this.sqlite.commitTransaction({database:this.dbName});a+=i.changes.changes;let l={changes:{changes:a}};return Promise.resolve(l)}catch(i){let l=i.message?i.message:i;return await this.sqlite.rollbackTransaction({database:this.dbName}),Promise.reject(l)}}async reorderRows(e){let t=e;if(e!=null&&e.values&&typeof e.values[0]=="object"&&Object.keys(e.values[0]).includes("ios_columns")){let a=e.values[0].ios_columns,n=[];for(let i=1;i<e.values.length;i++){let l=e.values[i],o={};for(let b of a)o[b]=l[b];n.push(o)}t.values=n}return Promise.resolve(t)}}});var Je={};se(Je,{CapacitorSQLiteWeb:()=>ke});var ke,_e=N(()=>{ve();ke=class extends Z{constructor(){super(...arguments),this.jeepSqliteElement=null,this.isWebStoreOpen=!1}async initWebStore(){await customElements.whenDefined("jeep-sqlite"),this.jeepSqliteElement=document.querySelector("jeep-sqlite"),this.ensureJeepSqliteIsAvailable(),this.jeepSqliteElement.addEventListener("jeepSqliteImportProgress",e=>{this.notifyListeners("sqliteImportProgressEvent",e.detail)}),this.jeepSqliteElement.addEventListener("jeepSqliteExportProgress",e=>{this.notifyListeners("sqliteExportProgressEvent",e.detail)}),this.jeepSqliteElement.addEventListener("jeepSqliteHTTPRequestEnded",e=>{this.notifyListeners("sqliteHTTPRequestEndedEvent",e.detail)}),this.jeepSqliteElement.addEventListener("jeepSqlitePickDatabaseEnded",e=>{this.notifyListeners("sqlitePickDatabaseEndedEvent",e.detail)}),this.jeepSqliteElement.addEventListener("jeepSqliteSaveDatabaseToDisk",e=>{this.notifyListeners("sqliteSaveDatabaseToDiskEvent",e.detail)}),this.isWebStoreOpen||(this.isWebStoreOpen=await this.jeepSqliteElement.isStoreOpen())}async saveToStore(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.saveToStore(e);return}catch(t){throw new Error(`${t}`)}}async getFromLocalDiskToStore(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.getFromLocalDiskToStore(e);return}catch(t){throw new Error(`${t}`)}}async saveToLocalDisk(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.saveToLocalDisk(e);return}catch(t){throw new Error(`${t}`)}}async echo(e){return this.ensureJeepSqliteIsAvailable(),await this.jeepSqliteElement.echo(e)}async createConnection(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.createConnection(e);return}catch(t){throw new Error(`${t}`)}}async open(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.open(e);return}catch(t){throw new Error(`${t}`)}}async closeConnection(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.closeConnection(e);return}catch(t){throw new Error(`${t}`)}}async getVersion(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.getVersion(e)}catch(t){throw new Error(`${t}`)}}async checkConnectionsConsistency(e){this.ensureJeepSqliteIsAvailable();try{return await this.jeepSqliteElement.checkConnectionsConsistency(e)}catch(t){throw new Error(`${t}`)}}async close(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.close(e);return}catch(t){throw new Error(`${t}`)}}async beginTransaction(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.beginTransaction(e)}catch(t){throw new Error(`${t}`)}}async commitTransaction(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.commitTransaction(e)}catch(t){throw new Error(`${t}`)}}async rollbackTransaction(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.rollbackTransaction(e)}catch(t){throw new Error(`${t}`)}}async isTransactionActive(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.isTransactionActive(e)}catch(t){throw new Error(`${t}`)}}async getTableList(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.getTableList(e)}catch(t){throw new Error(`${t}`)}}async execute(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.execute(e)}catch(t){throw new Error(`${t}`)}}async executeSet(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.executeSet(e)}catch(t){throw new Error(`${t}`)}}async run(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.run(e)}catch(t){throw new Error(`${t}`)}}async query(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.query(e)}catch(t){throw new Error(`${t}`)}}async isDBExists(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.isDBExists(e)}catch(t){throw new Error(`${t}`)}}async isDBOpen(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.isDBOpen(e)}catch(t){throw new Error(`${t}`)}}async isDatabase(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.isDatabase(e)}catch(t){throw new Error(`${t}`)}}async isTableExists(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.isTableExists(e)}catch(t){throw new Error(`${t}`)}}async deleteDatabase(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.deleteDatabase(e);return}catch(t){throw new Error(`${t}`)}}async isJsonValid(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.isJsonValid(e)}catch(t){throw new Error(`${t}`)}}async importFromJson(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.importFromJson(e)}catch(t){throw new Error(`${t}`)}}async exportToJson(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.exportToJson(e)}catch(t){throw new Error(`${t}`)}}async createSyncTable(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.createSyncTable(e)}catch(t){throw new Error(`${t}`)}}async setSyncDate(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.setSyncDate(e);return}catch(t){throw new Error(`${t}`)}}async getSyncDate(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.getSyncDate(e)}catch(t){throw new Error(`${t}`)}}async deleteExportedRows(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.deleteExportedRows(e);return}catch(t){throw new Error(`${t}`)}}async addUpgradeStatement(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.addUpgradeStatement(e);return}catch(t){throw new Error(`${t}`)}}async copyFromAssets(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.copyFromAssets(e);return}catch(t){throw new Error(`${t}`)}}async getFromHTTPRequest(e){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.getFromHTTPRequest(e);return}catch(t){throw new Error(`${t}`)}}async getDatabaseList(){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.getDatabaseList()}catch(e){throw new Error(`${e}`)}}ensureJeepSqliteIsAvailable(){if(this.jeepSqliteElement===null)throw new Error("The jeep-sqlite element is not present in the DOM! Please check the @capacitor-community/sqlite documentation for instructions regarding the web platform.")}ensureWebstoreIsOpen(){if(!this.isWebStoreOpen)throw new Error('WebStore is not open yet. You have to call "initWebStore()" first.')}async getUrl(){throw this.unimplemented("Not implemented on web.")}async getMigratableDbList(e){throw console.log("getMigratableDbList",e),this.unimplemented("Not implemented on web.")}async addSQLiteSuffix(e){throw console.log("addSQLiteSuffix",e),this.unimplemented("Not implemented on web.")}async deleteOldDatabases(e){throw console.log("deleteOldDatabases",e),this.unimplemented("Not implemented on web.")}async moveDatabasesAndAddSuffix(e){throw console.log("moveDatabasesAndAddSuffix",e),this.unimplemented("Not implemented on web.")}async isSecretStored(){throw this.unimplemented("Not implemented on web.")}async setEncryptionSecret(e){throw console.log("setEncryptionSecret",e),this.unimplemented("Not implemented on web.")}async changeEncryptionSecret(e){throw console.log("changeEncryptionSecret",e),this.unimplemented("Not implemented on web.")}async clearEncryptionSecret(){throw console.log("clearEncryptionSecret"),this.unimplemented("Not implemented on web.")}async checkEncryptionSecret(e){throw console.log("checkEncryptionPassPhrase",e),this.unimplemented("Not implemented on web.")}async getNCDatabasePath(e){throw console.log("getNCDatabasePath",e),this.unimplemented("Not implemented on web.")}async createNCConnection(e){throw console.log("createNCConnection",e),this.unimplemented("Not implemented on web.")}async closeNCConnection(e){throw console.log("closeNCConnection",e),this.unimplemented("Not implemented on web.")}async isNCDatabase(e){throw console.log("isNCDatabase",e),this.unimplemented("Not implemented on web.")}async isDatabaseEncrypted(e){throw console.log("isDatabaseEncrypted",e),this.unimplemented("Not implemented on web.")}async isInConfigEncryption(){throw this.unimplemented("Not implemented on web.")}async isInConfigBiometricAuth(){throw this.unimplemented("Not implemented on web.")}async loadExtension(e){throw console.log("loadExtension",e),this.unimplemented("Not implemented on web.")}async enableLoadExtension(e){throw console.log("enableLoadExtension",e),this.unimplemented("Not implemented on web.")}}});var Ze,Qe=N(()=>{ve();Ve();Ze=ne("CapacitorSQLite",{web:()=>Promise.resolve().then(()=>(_e(),Je)).then(r=>new r.CapacitorSQLiteWeb),electron:()=>window.CapacitorCustomPlatform.plugins.CapacitorSQLite})});var Xe={};se(Xe,{getCardById:()=>Ct,getCardIds:()=>St,getCardsByIds:()=>Lt,getDaten:()=>wt,getEngName:()=>kt,getName:()=>vt,initDatabase:()=>ft,insertCard:()=>Pt,updateCardIds:()=>Et,updatePrice:()=>Tt});async function ft(){return I=await bt.createConnection("pokepicker",!1,"no-encryption",1),await I.open(),await I.execute(`
  ...
  `),(await I.query("SELECT COUNT(*) as count FROM pokemon")).values[0].count===0&&await I.execute(`
      ...
      `),I}async function wt(){return await I.query("SELECT * FROM pokemon")}async function vt(r){return(await I.query("SELECT name FROM pokemon WHERE dex = ?",[r])).values[0].name}async function kt(r){return(await I.query("SELECT engName FROM pokemon WHERE dex = ?",[r])).values[0].engName}async function St(r){return(await I.query("SELECT cardIds FROM pokemon WHERE dex = ?",[r])).values[0].cardIds}async function Et(r,e){await I.run("UPDATE pokemon SET cardIds = ? WHERE dex = ?",[e,r])}async function Pt(r){var e,t,a,n,i;try{let l=typeof r.imageSmall=="string"?r.imageSmall:null,o=typeof r.imageLarge=="string"?r.imageLarge:null;return((i=(await I.run(`INSERT INTO cards (cardId, cardName, rarity, setName, imageLow, imageHigh, subTypes, addedAt, avg30)
       VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)`,[r.id,r.name,r.rarity||"",((e=r.set)==null?void 0:e.name)||"",l,o,Array.isArray(r.subtypes)?r.subtypes.join(", "):"",new Date().toISOString(),(n=(a=(t=r.cardmarket)==null?void 0:t.prices)==null?void 0:a.avg30)!=null?n:null])).changes)==null?void 0:i.lastId)||null}catch(l){return console.error("Fehler in insertCard():",l.message||l,(r==null?void 0:r.id)||"unbekannte Karte"),null}}async function Ct(r){var t;return((t=(await I.query("SELECT * FROM cards WHERE id = ?",[r])).values)==null?void 0:t[0])||null}async function Lt(r){let e=r.map(()=>"?").join(",");return(await I.query(`SELECT * FROM cards WHERE id IN (${e})`,r)).values}async function Tt(r,e){try{await I.run("UPDATE cards SET avg30 = ? WHERE cardId = ?",[e,r])}catch(t){console.error(`Fehler beim Speichern von avg30 f\xFCr ${r}:`,t.message)}}var bt,I,Ye=N(()=>{Qe();bt=new ie(Ze)});le();var ae=Re("Http",{web:()=>Promise.resolve().then(()=>(ye(),ge)).then(r=>new r.HttpWeb),electron:()=>Promise.resolve().then(()=>(ye(),ge)).then(r=>new r.HttpWeb)});var Se="a5d75d50-65e6-41a4-aa2f-9b2c93afaaa7",Y;document.addEventListener("DOMContentLoaded",()=>{(async()=>{let r=document.getElementById("cardLoader");r.innerHTML=`
      <p id="loaderText">Lade Karten\u2026</p>
      <div id="progressBarContainer">
        <div id="progressBar"></div>
      </div>
      <div id="progressText">0%</div>
    `,r.classList.remove("hidden"),r.classList.add("shown");let{initDatabase:e,getDaten:t,getName:a,getEngName:n,getCardIds:i,updateCardIds:l,insertCard:o,getCardById:b,getCardsByIds:f,updatePrice:j}=await Promise.resolve().then(()=>(Ye(),Xe));Y=await e();let E=await t(),P=document.querySelector("#kartentabelle tbody");window.cachedCards={};let B=0,F=E.values.length;for(let s of E.values){let c=document.createElement("tr"),u=parseInt(s.dex),p=`
