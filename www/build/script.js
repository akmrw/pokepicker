(()=>{var zt=Object.defineProperty;var se=(n,t)=>()=>(n&&(t=n(n=0)),t);var $e=(n,t)=>{for(var r in t)zt(n,r,{get:t[r],enumerable:!0})};var Ut,Vt,Et,Ir,xr,Ce,xe,Jt,_t,Xt,Me,kt,Ar,Re,je=se(()=>{Ut=n=>{let t=new Map;t.set("web",{name:"web"});let r=n.CapacitorPlatforms||{currentPlatform:{name:"web"},platforms:t},a=(s,y)=>{r.platforms.set(s,y)},i=s=>{r.platforms.has(s)&&(r.currentPlatform=r.platforms.get(s))};return r.addPlatform=a,r.setPlatform=i,r},Vt=n=>n.CapacitorPlatforms=Ut(n),Et=Vt(typeof globalThis!="undefined"?globalThis:typeof self!="undefined"?self:typeof window!="undefined"?window:typeof global!="undefined"?global:{}),Ir=Et.addPlatform,xr=Et.setPlatform;(function(n){n.Unimplemented="UNIMPLEMENTED",n.Unavailable="UNAVAILABLE"})(Ce||(Ce={}));xe=class extends Error{constructor(t,r){super(t),this.message=t,this.code=r}},Jt=n=>{var t,r;return n!=null&&n.androidBridge?"android":!((r=(t=n==null?void 0:n.webkit)===null||t===void 0?void 0:t.messageHandlers)===null||r===void 0)&&r.bridge?"ios":"web"},_t=n=>{var t,r,a,i,s;let y=n.CapacitorCustomPlatform||null,f=n.Capacitor||{},L=f.Plugins=f.Plugins||{},T=n.CapacitorPlatforms,Z=()=>y!==null?y.name:Jt(n),I=((t=T==null?void 0:T.currentPlatform)===null||t===void 0?void 0:t.getPlatform)||Z,A=()=>I()!=="web",Q=((r=T==null?void 0:T.currentPlatform)===null||r===void 0?void 0:r.isNativePlatform)||A,V=B=>{let C=ce.get(B);return!!(C!=null&&C.platforms.has(I())||ve(B))},ie=((a=T==null?void 0:T.currentPlatform)===null||a===void 0?void 0:a.isPluginAvailable)||V,Y=B=>{var C;return(C=f.PluginHeaders)===null||C===void 0?void 0:C.find(F=>F.name===B)},ve=((i=T==null?void 0:T.currentPlatform)===null||i===void 0?void 0:i.getPluginHeader)||Y,we=B=>n.console.error(B),le=(B,C,F)=>Promise.reject(`${F} does not have an implementation of "${C}".`),ce=new Map,pe=(B,C={})=>{let F=ce.get(B);if(F)return console.warn(`Capacitor plugin "${B}" already registered. Cannot register plugins twice.`),F.proxy;let $=I(),W=ve(B),j,J=async()=>(!j&&$ in C?j=typeof C[$]=="function"?j=await C[$]():j=C[$]:y!==null&&!j&&"web"in C&&(j=typeof C.web=="function"?j=await C.web():j=C.web),j),de=(H,q)=>{var ee,x;if(W){let re=W==null?void 0:W.methods.find(U=>q===U.name);if(re)return re.rtype==="promise"?U=>f.nativePromise(B,q.toString(),U):(U,Ee)=>f.nativeCallback(B,q.toString(),U,Ee);if(H)return(ee=H[q])===null||ee===void 0?void 0:ee.bind(H)}else{if(H)return(x=H[q])===null||x===void 0?void 0:x.bind(H);throw new xe(`"${B}" plugin is not implemented on ${$}`,Ce.Unimplemented)}},ne=H=>{let q,ee=(...x)=>{let re=J().then(U=>{let Ee=de(U,H);if(Ee){let ue=Ee(...x);return q=ue==null?void 0:ue.remove,ue}else throw new xe(`"${B}.${H}()" is not implemented on ${$}`,Ce.Unimplemented)});return H==="addListener"&&(re.remove=async()=>q()),re};return ee.toString=()=>`${H.toString()}() { [capacitor code] }`,Object.defineProperty(ee,"name",{value:H,writable:!1,configurable:!1}),ee},te=ne("addListener"),Be=ne("removeListener"),Ie=(H,q)=>{let ee=te({eventName:H},q),x=async()=>{let U=await ee;Be({eventName:H,callbackId:U},q)},re=new Promise(U=>ee.then(()=>U({remove:x})));return re.remove=async()=>{console.warn("Using addListener() without 'await' is deprecated."),await x()},re},E=new Proxy({},{get(H,q){switch(q){case"$$typeof":return;case"toJSON":return()=>({});case"addListener":return W?Ie:te;case"removeListener":return Be;default:return ne(q)}}});return L[B]=E,ce.set(B,{name:B,proxy:E,platforms:new Set([...Object.keys(C),...W?[$]:[]])}),E},Pe=((s=T==null?void 0:T.currentPlatform)===null||s===void 0?void 0:s.registerPlugin)||pe;return f.convertFileSrc||(f.convertFileSrc=B=>B),f.getPlatform=I,f.handleError=we,f.isNativePlatform=Q,f.isPluginAvailable=ie,f.pluginMethodNoop=le,f.registerPlugin=Pe,f.Exception=xe,f.DEBUG=!!f.DEBUG,f.isLoggingEnabled=!!f.isLoggingEnabled,f.platform=f.getPlatform(),f.isNative=f.isNativePlatform(),f},Xt=n=>n.Capacitor=_t(n),Me=Xt(typeof globalThis!="undefined"?globalThis:typeof self!="undefined"?self:typeof window!="undefined"?window:typeof global!="undefined"?global:{}),kt=Me.registerPlugin,Ar=Me.Plugins,Re=class{constructor(t){this.listeners={},this.windowListeners={},t&&(console.warn(`Capacitor WebPlugin "${t.name}" config object was deprecated in v3 and will be removed in v4.`),this.config=t)}addListener(t,r){this.listeners[t]||(this.listeners[t]=[]),this.listeners[t].push(r);let i=this.windowListeners[t];i&&!i.registered&&this.addWindowListener(i);let s=async()=>this.removeListener(t,r),y=Promise.resolve({remove:s});return Object.defineProperty(y,"remove",{value:async()=>{console.warn("Using addListener() without 'await' is deprecated."),await s()}}),y}async removeAllListeners(){this.listeners={};for(let t in this.windowListeners)this.removeWindowListener(this.windowListeners[t]);this.windowListeners={}}notifyListeners(t,r){let a=this.listeners[t];a&&a.forEach(i=>i(r))}hasListeners(t){return!!this.listeners[t].length}registerWindowListener(t,r){this.windowListeners[r]={registered:!1,windowEventName:t,pluginEventName:r,handler:a=>{this.notifyListeners(r,a)}}}unimplemented(t="not implemented"){return new Me.Exception(t,Ce.Unimplemented)}unavailable(t="not available"){return new Me.Exception(t,Ce.Unavailable)}async removeListener(t,r){let a=this.listeners[t];if(!a)return;let i=a.indexOf(r);this.listeners[t].splice(i,1),this.listeners[t].length||this.removeWindowListener(this.windowListeners[t])}addWindowListener(t){window.addEventListener(t.windowEventName,t.handler),t.registered=!0}removeWindowListener(t){t&&(window.removeEventListener(t.windowEventName,t.handler),t.registered=!1)}}});var St,He,Ke,Ne=se(()=>{St=async n=>new Promise((t,r)=>{let a=new FileReader;a.onload=()=>{let i=a.result,s=i.substr(i.indexOf(",")+1);t(s)},a.onerror=i=>r(i),a.readAsDataURL(n)}),He=n=>encodeURIComponent(n).replace(/%(2[346B]|5E|60|7C)/g,decodeURIComponent).replace(/[()]/g,escape),Ke=n=>n.replace(/(%[\dA-F]{2})+/gi,decodeURIComponent)});var Ct,Fe,Lt,Tt,We,Pt=se(()=>{Ne();Ct=(n,t,r={})=>{let a=He(n),i=He(t),s=`; expires=${(r.expires||"").replace("expires=","")}`,y=(r.path||"/").replace("path=","");document.cookie=`${a}=${i||""}${s}; path=${y}`},Fe=()=>{let n=[],t={};if(!document.cookie)return n;let r=document.cookie.split(";")||[];for(let i of r){let[s,y]=i.replace(/=/,"CAP_COOKIE").split("CAP_COOKIE");s=Ke(s).trim(),y=Ke(y).trim(),t[s]=y}let a=Object.entries(t);for(let[i,s]of a)n.push({key:i,value:s});return n},Lt=n=>{let t=Fe();for(let r of t)if(r.key===n)return r;return{key:n,value:""}},Tt=n=>{document.cookie=`${n}=; Max-Age=0`},We=()=>{let n=document.cookie.split(";")||[];for(let t of n)document.cookie=t.replace(/^ +/,"").replace(/=.*/,`=;expires=${new Date().toUTCString()};path=/`)}});var Qt,Yt,Ge,fe,It,xt,At,Bt,Mt,Rt=se(()=>{Ne();Qt=(n={})=>{let t=Object.keys(n);return Object.keys(n).map(i=>i.toLocaleLowerCase()).reduce((i,s,y)=>(i[s]=n[t[y]],i),{})},Yt=(n,t=!0)=>n?Object.entries(n).reduce((a,i)=>{let[s,y]=i,f,L;return Array.isArray(y)?(L="",y.forEach(T=>{f=t?encodeURIComponent(T):T,L+=`${s}=${f}&`}),L.slice(0,-1)):(f=t?encodeURIComponent(y):y,L=`${s}=${f}`),`${a}&${L}`},"").substr(1):null,Ge=(n,t={})=>{let r=Object.assign({method:n.method||"GET",headers:n.headers},t),i=Qt(n.headers)["content-type"]||"";if(typeof n.data=="string")r.body=n.data;else if(i.includes("application/x-www-form-urlencoded")){let s=new URLSearchParams;for(let[y,f]of Object.entries(n.data||{}))s.set(y,f);r.body=s.toString()}else if(i.includes("multipart/form-data")){let s=new FormData;if(n.data instanceof FormData)n.data.forEach((f,L)=>{s.append(L,f)});else for(let f of Object.keys(n.data))s.append(f,n.data[f]);r.body=s;let y=new Headers(r.headers);y.delete("content-type"),r.headers=y}else(i.includes("application/json")||typeof n.data=="object")&&(r.body=JSON.stringify(n.data));return r},fe=async n=>{let t=Ge(n,n.webFetchExtra),r=Yt(n.params,n.shouldEncodeUrlParams),a=r?`${n.url}?${r}`:n.url,i=await fetch(a,t),s=i.headers.get("content-type")||"",{responseType:y="text"}=i.ok?n:{};s.includes("application/json")&&(y="json");let f;switch(y){case"arraybuffer":case"blob":let T=await i.blob();f=await St(T);break;case"json":f=await i.json();break;case"document":case"text":default:f=await i.text()}let L={};return i.headers.forEach((T,Z)=>{L[Z]=T}),{data:f,headers:L,status:i.status,url:i.url}},It=async n=>fe(Object.assign(Object.assign({},n),{method:"GET"})),xt=async n=>fe(Object.assign(Object.assign({},n),{method:"POST"})),At=async n=>fe(Object.assign(Object.assign({},n),{method:"PUT"})),Bt=async n=>fe(Object.assign(Object.assign({},n),{method:"PATCH"})),Mt=async n=>fe(Object.assign(Object.assign({},n),{method:"DELETE"}))});var Ue={};$e(Ue,{HttpWeb:()=>ze});var ze,Ve=se(()=>{je();Pt();Rt();ze=class extends Re{constructor(){super(),this.request=async t=>fe(t),this.get=async t=>It(t),this.post=async t=>xt(t),this.put=async t=>At(t),this.patch=async t=>Bt(t),this.del=async t=>Mt(t),this.getCookiesMap=async t=>{let r=Fe(),a={};for(let i of r)a[i.key]=i.value;return a},this.getCookies=async t=>{let{url:r}=t;return{cookies:Fe()}},this.setCookie=async t=>{let{key:r,value:a,expires:i="",path:s=""}=t;Ct(r,a,{expires:i,path:s})},this.getCookie=async t=>Lt(t.key),this.deleteCookie=async t=>Tt(t.key),this.clearCookies=async t=>We(),this.clearAllCookies=async()=>We(),this.uploadFile=async t=>{let r=new FormData;r.append(t.name,t.blob||"undefined");let a=Object.assign(Object.assign({},t),{body:r,method:"POST"});return this.post(a)},this.downloadFile=async t=>{let r=Ge(t,t.webFetchExtra),a=await fetch(t.url,r),i;if(!(t!=null&&t.progress))i=await a.blob();else if(!(a!=null&&a.body))i=new Blob;else{let s=a.body.getReader(),y=0,f=[],L=a.headers.get("content-type"),T=parseInt(a.headers.get("content-length")||"0",10);for(;;){let{done:A,value:Q}=await s.read();if(A)break;f.push(Q),y+=(Q==null?void 0:Q.length)||0;let V={type:"DOWNLOAD",url:t.url,bytes:y,contentLength:T};this.notifyListeners("progress",V)}let Z=new Uint8Array(y),I=0;for(let A of f)typeof A!="undefined"&&(Z.set(A,I),I+=A.length);i=new Blob([Z.buffer],{type:L||void 0})}return{blob:i}}}}});var Le,Ae,tr,rr,nr,Je,qe,Te,Ft,qt,_e,jr,ar,ir,or,sr,Xe,Hr,Ze=se(()=>{(function(n){n.Unimplemented="UNIMPLEMENTED",n.Unavailable="UNAVAILABLE"})(Le||(Le={}));Ae=class extends Error{constructor(t,r,a){super(t),this.message=t,this.code=r,this.data=a}},tr=n=>{var t,r;return n!=null&&n.androidBridge?"android":!((r=(t=n==null?void 0:n.webkit)===null||t===void 0?void 0:t.messageHandlers)===null||r===void 0)&&r.bridge?"ios":"web"},rr=n=>{let t=n.CapacitorCustomPlatform||null,r=n.Capacitor||{},a=r.Plugins=r.Plugins||{},i=()=>t!==null?t.name:tr(n),s=()=>i()!=="web",y=I=>{let A=T.get(I);return!!(A!=null&&A.platforms.has(i())||f(I))},f=I=>{var A;return(A=r.PluginHeaders)===null||A===void 0?void 0:A.find(Q=>Q.name===I)},L=I=>n.console.error(I),T=new Map,Z=(I,A={})=>{let Q=T.get(I);if(Q)return console.warn(`Capacitor plugin "${I}" already registered. Cannot register plugins twice.`),Q.proxy;let V=i(),ie=f(I),Y,ve=async()=>(!Y&&V in A?Y=typeof A[V]=="function"?Y=await A[V]():Y=A[V]:t!==null&&!Y&&"web"in A&&(Y=typeof A.web=="function"?Y=await A.web():Y=A.web),Y),we=(C,F)=>{var $,W;if(ie){let j=ie==null?void 0:ie.methods.find(J=>F===J.name);if(j)return j.rtype==="promise"?J=>r.nativePromise(I,F.toString(),J):(J,de)=>r.nativeCallback(I,F.toString(),J,de);if(C)return($=C[F])===null||$===void 0?void 0:$.bind(C)}else{if(C)return(W=C[F])===null||W===void 0?void 0:W.bind(C);throw new Ae(`"${I}" plugin is not implemented on ${V}`,Le.Unimplemented)}},le=C=>{let F,$=(...W)=>{let j=ve().then(J=>{let de=we(J,C);if(de){let ne=de(...W);return F=ne==null?void 0:ne.remove,ne}else throw new Ae(`"${I}.${C}()" is not implemented on ${V}`,Le.Unimplemented)});return C==="addListener"&&(j.remove=async()=>F()),j};return $.toString=()=>`${C.toString()}() { [capacitor code] }`,Object.defineProperty($,"name",{value:C,writable:!1,configurable:!1}),$},ce=le("addListener"),pe=le("removeListener"),Pe=(C,F)=>{let $=ce({eventName:C},F),W=async()=>{let J=await $;pe({eventName:C,callbackId:J},F)},j=new Promise(J=>$.then(()=>J({remove:W})));return j.remove=async()=>{console.warn("Using addListener() without 'await' is deprecated."),await W()},j},B=new Proxy({},{get(C,F){switch(F){case"$$typeof":return;case"toJSON":return()=>({});case"addListener":return ie?Pe:ce;case"removeListener":return pe;default:return le(F)}}});return a[I]=B,T.set(I,{name:I,proxy:B,platforms:new Set([...Object.keys(A),...ie?[V]:[]])}),B};return r.convertFileSrc||(r.convertFileSrc=I=>I),r.getPlatform=i,r.handleError=L,r.isNativePlatform=s,r.isPluginAvailable=y,r.registerPlugin=Z,r.Exception=Ae,r.DEBUG=!!r.DEBUG,r.isLoggingEnabled=!!r.isLoggingEnabled,r},nr=n=>n.Capacitor=rr(n),Je=nr(typeof globalThis!="undefined"?globalThis:typeof self!="undefined"?self:typeof window!="undefined"?window:typeof global!="undefined"?global:{}),qe=Je.registerPlugin,Te=class{constructor(){this.listeners={},this.retainedEventArguments={},this.windowListeners={}}addListener(t,r){let a=!1;this.listeners[t]||(this.listeners[t]=[],a=!0),this.listeners[t].push(r);let s=this.windowListeners[t];s&&!s.registered&&this.addWindowListener(s),a&&this.sendRetainedArgumentsForEvent(t);let y=async()=>this.removeListener(t,r);return Promise.resolve({remove:y})}async removeAllListeners(){this.listeners={};for(let t in this.windowListeners)this.removeWindowListener(this.windowListeners[t]);this.windowListeners={}}notifyListeners(t,r,a){let i=this.listeners[t];if(!i){if(a){let s=this.retainedEventArguments[t];s||(s=[]),s.push(r),this.retainedEventArguments[t]=s}return}i.forEach(s=>s(r))}hasListeners(t){return!!this.listeners[t].length}registerWindowListener(t,r){this.windowListeners[r]={registered:!1,windowEventName:t,pluginEventName:r,handler:a=>{this.notifyListeners(r,a)}}}unimplemented(t="not implemented"){return new Je.Exception(t,Le.Unimplemented)}unavailable(t="not available"){return new Je.Exception(t,Le.Unavailable)}async removeListener(t,r){let a=this.listeners[t];if(!a)return;let i=a.indexOf(r);this.listeners[t].splice(i,1),this.listeners[t].length||this.removeWindowListener(this.windowListeners[t])}addWindowListener(t){window.addEventListener(t.windowEventName,t.handler),t.registered=!0}removeWindowListener(t){t&&(window.removeEventListener(t.windowEventName,t.handler),t.registered=!1)}sendRetainedArgumentsForEvent(t){let r=this.retainedEventArguments[t];r&&(delete this.retainedEventArguments[t],r.forEach(a=>{this.notifyListeners(t,a)}))}},Ft=n=>encodeURIComponent(n).replace(/%(2[346B]|5E|60|7C)/g,decodeURIComponent).replace(/[()]/g,escape),qt=n=>n.replace(/(%[\dA-F]{2})+/gi,decodeURIComponent),_e=class extends Te{async getCookies(){let t=document.cookie,r={};return t.split(";").forEach(a=>{if(a.length<=0)return;let[i,s]=a.replace(/=/,"CAP_COOKIE").split("CAP_COOKIE");i=qt(i).trim(),s=qt(s).trim(),r[i]=s}),r}async setCookie(t){try{let r=Ft(t.key),a=Ft(t.value),i=`; expires=${(t.expires||"").replace("expires=","")}`,s=(t.path||"/").replace("path=",""),y=t.url!=null&&t.url.length>0?`domain=${t.url}`:"";document.cookie=`${r}=${a||""}${i}; path=${s}; ${y};`}catch(r){return Promise.reject(r)}}async deleteCookie(t){try{document.cookie=`${t.key}=; Max-Age=0`}catch(r){return Promise.reject(r)}}async clearCookies(){try{let t=document.cookie.split(";")||[];for(let r of t)document.cookie=r.replace(/^ +/,"").replace(/=.*/,`=;expires=${new Date().toUTCString()};path=/`)}catch(t){return Promise.reject(t)}}async clearAllCookies(){try{await this.clearCookies()}catch(t){return Promise.reject(t)}}},jr=qe("CapacitorCookies",{web:()=>new _e}),ar=async n=>new Promise((t,r)=>{let a=new FileReader;a.onload=()=>{let i=a.result;t(i.indexOf(",")>=0?i.split(",")[1]:i)},a.onerror=i=>r(i),a.readAsDataURL(n)}),ir=(n={})=>{let t=Object.keys(n);return Object.keys(n).map(i=>i.toLocaleLowerCase()).reduce((i,s,y)=>(i[s]=n[t[y]],i),{})},or=(n,t=!0)=>n?Object.entries(n).reduce((a,i)=>{let[s,y]=i,f,L;return Array.isArray(y)?(L="",y.forEach(T=>{f=t?encodeURIComponent(T):T,L+=`${s}=${f}&`}),L.slice(0,-1)):(f=t?encodeURIComponent(y):y,L=`${s}=${f}`),`${a}&${L}`},"").substr(1):null,sr=(n,t={})=>{let r=Object.assign({method:n.method||"GET",headers:n.headers},t),i=ir(n.headers)["content-type"]||"";if(typeof n.data=="string")r.body=n.data;else if(i.includes("application/x-www-form-urlencoded")){let s=new URLSearchParams;for(let[y,f]of Object.entries(n.data||{}))s.set(y,f);r.body=s.toString()}else if(i.includes("multipart/form-data")||n.data instanceof FormData){let s=new FormData;if(n.data instanceof FormData)n.data.forEach((f,L)=>{s.append(L,f)});else for(let f of Object.keys(n.data))s.append(f,n.data[f]);r.body=s;let y=new Headers(r.headers);y.delete("content-type"),r.headers=y}else(i.includes("application/json")||typeof n.data=="object")&&(r.body=JSON.stringify(n.data));return r},Xe=class extends Te{async request(t){let r=sr(t,t.webFetchExtra),a=or(t.params,t.shouldEncodeUrlParams),i=a?`${t.url}?${a}`:t.url,s=await fetch(i,r),y=s.headers.get("content-type")||"",{responseType:f="text"}=s.ok?t:{};y.includes("application/json")&&(f="json");let L,T;switch(f){case"arraybuffer":case"blob":T=await s.blob(),L=await ar(T);break;case"json":L=await s.json();break;case"document":case"text":default:L=await s.text()}let Z={};return s.headers.forEach((I,A)=>{Z[A]=I}),{data:L,headers:Z,status:s.status,url:s.url}}async get(t){return this.request(Object.assign(Object.assign({},t),{method:"GET"}))}async post(t){return this.request(Object.assign(Object.assign({},t),{method:"POST"}))}async put(t){return this.request(Object.assign(Object.assign({},t),{method:"PUT"}))}async patch(t){return this.request(Object.assign(Object.assign({},t),{method:"PATCH"}))}async delete(t){return this.request(Object.assign(Object.assign({},t),{method:"DELETE"}))}},Hr=qe("CapacitorHttp",{web:()=>new Xe})});var De,Oe,Dt=se(()=>{De=class{constructor(t){this.sqlite=t,this._connectionDict=new Map}async initWebStore(){try{return await this.sqlite.initWebStore(),Promise.resolve()}catch(t){return Promise.reject(t)}}async saveToStore(t){try{return await this.sqlite.saveToStore({database:t}),Promise.resolve()}catch(r){return Promise.reject(r)}}async saveToLocalDisk(t){try{return await this.sqlite.saveToLocalDisk({database:t}),Promise.resolve()}catch(r){return Promise.reject(r)}}async getFromLocalDiskToStore(t){let r=t!=null?t:!0;try{return await this.sqlite.getFromLocalDiskToStore({overwrite:r}),Promise.resolve()}catch(a){return Promise.reject(a)}}async echo(t){try{let r=await this.sqlite.echo({value:t});return Promise.resolve(r)}catch(r){return Promise.reject(r)}}async isSecretStored(){try{let t=await this.sqlite.isSecretStored();return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async setEncryptionSecret(t){try{return await this.sqlite.setEncryptionSecret({passphrase:t}),Promise.resolve()}catch(r){return Promise.reject(r)}}async changeEncryptionSecret(t,r){try{return await this.sqlite.changeEncryptionSecret({passphrase:t,oldpassphrase:r}),Promise.resolve()}catch(a){return Promise.reject(a)}}async clearEncryptionSecret(){try{return await this.sqlite.clearEncryptionSecret(),Promise.resolve()}catch(t){return Promise.reject(t)}}async checkEncryptionSecret(t){try{let r=await this.sqlite.checkEncryptionSecret({passphrase:t});return Promise.resolve(r)}catch(r){return Promise.reject(r)}}async addUpgradeStatement(t,r){try{return t.endsWith(".db")&&(t=t.slice(0,-3)),await this.sqlite.addUpgradeStatement({database:t,upgrade:r}),Promise.resolve()}catch(a){return Promise.reject(a)}}async createConnection(t,r,a,i,s){try{t.endsWith(".db")&&(t=t.slice(0,-3)),await this.sqlite.createConnection({database:t,encrypted:r,mode:a,version:i,readonly:s});let y=new Oe(t,s,this.sqlite),f=s?`RO_${t}`:`RW_${t}`;return this._connectionDict.set(f,y),Promise.resolve(y)}catch(y){return Promise.reject(y)}}async closeConnection(t,r){try{t.endsWith(".db")&&(t=t.slice(0,-3)),await this.sqlite.closeConnection({database:t,readonly:r});let a=r?`RO_${t}`:`RW_${t}`;return this._connectionDict.delete(a),Promise.resolve()}catch(a){return Promise.reject(a)}}async isConnection(t,r){let a={};t.endsWith(".db")&&(t=t.slice(0,-3));let i=r?`RO_${t}`:`RW_${t}`;return a.result=this._connectionDict.has(i),Promise.resolve(a)}async retrieveConnection(t,r){t.endsWith(".db")&&(t=t.slice(0,-3));let a=r?`RO_${t}`:`RW_${t}`;if(this._connectionDict.has(a)){let i=this._connectionDict.get(a);return typeof i!="undefined"?Promise.resolve(i):Promise.reject(`Connection ${t} is undefined`)}else return Promise.reject(`Connection ${t} does not exist`)}async getNCDatabasePath(t,r){try{let a=await this.sqlite.getNCDatabasePath({path:t,database:r});return Promise.resolve(a)}catch(a){return Promise.reject(a)}}async createNCConnection(t,r){try{await this.sqlite.createNCConnection({databasePath:t,version:r});let a=new Oe(t,!0,this.sqlite),i=`RO_${t})`;return this._connectionDict.set(i,a),Promise.resolve(a)}catch(a){return Promise.reject(a)}}async closeNCConnection(t){try{await this.sqlite.closeNCConnection({databasePath:t});let r=`RO_${t})`;return this._connectionDict.delete(r),Promise.resolve()}catch(r){return Promise.reject(r)}}async isNCConnection(t){let r={},a=`RO_${t})`;return r.result=this._connectionDict.has(a),Promise.resolve(r)}async retrieveNCConnection(t){if(this._connectionDict.has(t)){let r=`RO_${t})`,a=this._connectionDict.get(r);return typeof a!="undefined"?Promise.resolve(a):Promise.reject(`Connection ${t} is undefined`)}else return Promise.reject(`Connection ${t} does not exist`)}async isNCDatabase(t){try{let r=await this.sqlite.isNCDatabase({databasePath:t});return Promise.resolve(r)}catch(r){return Promise.reject(r)}}async retrieveAllConnections(){return this._connectionDict}async closeAllConnections(){let t=new Map;try{for(let r of this._connectionDict.keys()){let a=r.substring(3),i=r.substring(0,3)==="RO_";await this.sqlite.closeConnection({database:a,readonly:i}),t.set(r,null)}for(let r of t.keys())this._connectionDict.delete(r);return Promise.resolve()}catch(r){return Promise.reject(r)}}async checkConnectionsConsistency(){try{let t=[...this._connectionDict.keys()],r=[],a=[];for(let s of t)r.push(s.substring(0,2)),a.push(s.substring(3));let i=await this.sqlite.checkConnectionsConsistency({dbNames:a,openModes:r});return i.result||(this._connectionDict=new Map),Promise.resolve(i)}catch(t){return this._connectionDict=new Map,Promise.reject(t)}}async importFromJson(t){try{let r=await this.sqlite.importFromJson({jsonstring:t});return Promise.resolve(r)}catch(r){return Promise.reject(r)}}async isJsonValid(t){try{let r=await this.sqlite.isJsonValid({jsonstring:t});return Promise.resolve(r)}catch(r){return Promise.reject(r)}}async copyFromAssets(t){let r=t!=null?t:!0;try{return await this.sqlite.copyFromAssets({overwrite:r}),Promise.resolve()}catch(a){return Promise.reject(a)}}async getFromHTTPRequest(t,r){let a=r!=null?r:!0;try{return await this.sqlite.getFromHTTPRequest({url:t,overwrite:a}),Promise.resolve()}catch(i){return Promise.reject(i)}}async isDatabaseEncrypted(t){t.endsWith(".db")&&(t=t.slice(0,-3));try{let r=await this.sqlite.isDatabaseEncrypted({database:t});return Promise.resolve(r)}catch(r){return Promise.reject(r)}}async isInConfigEncryption(){try{let t=await this.sqlite.isInConfigEncryption();return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async isInConfigBiometricAuth(){try{let t=await this.sqlite.isInConfigBiometricAuth();return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async isDatabase(t){t.endsWith(".db")&&(t=t.slice(0,-3));try{let r=await this.sqlite.isDatabase({database:t});return Promise.resolve(r)}catch(r){return Promise.reject(r)}}async getDatabaseList(){try{let r=(await this.sqlite.getDatabaseList()).values;r.sort();let a={values:r};return Promise.resolve(a)}catch(t){return Promise.reject(t)}}async getMigratableDbList(t){let r=t||"default";try{let a=await this.sqlite.getMigratableDbList({folderPath:r});return Promise.resolve(a)}catch(a){return Promise.reject(a)}}async addSQLiteSuffix(t,r){let a=t||"default",i=r||[];try{let s=await this.sqlite.addSQLiteSuffix({folderPath:a,dbNameList:i});return Promise.resolve(s)}catch(s){return Promise.reject(s)}}async deleteOldDatabases(t,r){let a=t||"default",i=r||[];try{let s=await this.sqlite.deleteOldDatabases({folderPath:a,dbNameList:i});return Promise.resolve(s)}catch(s){return Promise.reject(s)}}async moveDatabasesAndAddSuffix(t,r){let a=t||"default",i=r||[];return this.sqlite.moveDatabasesAndAddSuffix({folderPath:a,dbNameList:i})}},Oe=class{constructor(t,r,a){this.dbName=t,this.readonly=r,this.sqlite=a}getConnectionDBName(){return this.dbName}getConnectionReadOnly(){return this.readonly}async open(){try{return await this.sqlite.open({database:this.dbName,readonly:this.readonly}),Promise.resolve()}catch(t){return Promise.reject(t)}}async close(){try{return await this.sqlite.close({database:this.dbName,readonly:this.readonly}),Promise.resolve()}catch(t){return Promise.reject(t)}}async beginTransaction(){try{let t=await this.sqlite.beginTransaction({database:this.dbName});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async commitTransaction(){try{let t=await this.sqlite.commitTransaction({database:this.dbName});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async rollbackTransaction(){try{let t=await this.sqlite.rollbackTransaction({database:this.dbName});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async isTransactionActive(){try{let t=await this.sqlite.isTransactionActive({database:this.dbName});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async loadExtension(t){try{return await this.sqlite.loadExtension({database:this.dbName,path:t,readonly:this.readonly}),Promise.resolve()}catch(r){return Promise.reject(r)}}async enableLoadExtension(t){try{return await this.sqlite.enableLoadExtension({database:this.dbName,toggle:t,readonly:this.readonly}),Promise.resolve()}catch(r){return Promise.reject(r)}}async getUrl(){try{let t=await this.sqlite.getUrl({database:this.dbName,readonly:this.readonly});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async getVersion(){try{let t=await this.sqlite.getVersion({database:this.dbName,readonly:this.readonly});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async getTableList(){try{let t=await this.sqlite.getTableList({database:this.dbName,readonly:this.readonly});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async execute(t,r=!0,a=!0){try{if(this.readonly)return Promise.reject("not allowed in read-only mode");{let i=await this.sqlite.execute({database:this.dbName,statements:t,transaction:r,readonly:!1,isSQL92:a});return Promise.resolve(i)}}catch(i){return Promise.reject(i)}}async query(t,r,a=!0){let i;try{return r&&r.length>0?i=await this.sqlite.query({database:this.dbName,statement:t,values:r,readonly:this.readonly,isSQL92:!0}):i=await this.sqlite.query({database:this.dbName,statement:t,values:[],readonly:this.readonly,isSQL92:a}),i=await this.reorderRows(i),Promise.resolve(i)}catch(s){return Promise.reject(s)}}async run(t,r,a=!0,i="no",s=!0){let y;try{return this.readonly?Promise.reject("not allowed in read-only mode"):(r&&r.length>0?y=await this.sqlite.run({database:this.dbName,statement:t,values:r,transaction:a,readonly:!1,returnMode:i,isSQL92:!0}):y=await this.sqlite.run({database:this.dbName,statement:t,values:[],transaction:a,readonly:!1,returnMode:i,isSQL92:s}),y.changes=await this.reorderRows(y.changes),Promise.resolve(y))}catch(f){return Promise.reject(f)}}async executeSet(t,r=!0,a="no",i=!0){let s;try{return this.readonly?Promise.reject("not allowed in read-only mode"):(s=await this.sqlite.executeSet({database:this.dbName,set:t,transaction:r,readonly:!1,returnMode:a,isSQL92:i}),s.changes=await this.reorderRows(s.changes),Promise.resolve(s))}catch(y){return Promise.reject(y)}}async isExists(){try{let t=await this.sqlite.isDBExists({database:this.dbName,readonly:this.readonly});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async isTable(t){try{let r=await this.sqlite.isTableExists({database:this.dbName,table:t,readonly:this.readonly});return Promise.resolve(r)}catch(r){return Promise.reject(r)}}async isDBOpen(){try{let t=await this.sqlite.isDBOpen({database:this.dbName,readonly:this.readonly});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async delete(){try{return this.readonly?Promise.reject("not allowed in read-only mode"):(await this.sqlite.deleteDatabase({database:this.dbName,readonly:!1}),Promise.resolve())}catch(t){return Promise.reject(t)}}async createSyncTable(){try{if(this.readonly)return Promise.reject("not allowed in read-only mode");{let t=await this.sqlite.createSyncTable({database:this.dbName,readonly:!1});return Promise.resolve(t)}}catch(t){return Promise.reject(t)}}async setSyncDate(t){try{return this.readonly?Promise.reject("not allowed in read-only mode"):(await this.sqlite.setSyncDate({database:this.dbName,syncdate:t,readonly:!1}),Promise.resolve())}catch(r){return Promise.reject(r)}}async getSyncDate(){try{let t=await this.sqlite.getSyncDate({database:this.dbName,readonly:this.readonly}),r="";return t.syncDate>0&&(r=new Date(t.syncDate*1e3).toISOString()),Promise.resolve(r)}catch(t){return Promise.reject(t)}}async exportToJson(t,r=!1){try{let a=await this.sqlite.exportToJson({database:this.dbName,jsonexportmode:t,readonly:this.readonly,encrypted:r});return Promise.resolve(a)}catch(a){return Promise.reject(a)}}async deleteExportedRows(){try{return this.readonly?Promise.reject("not allowed in read-only mode"):(await this.sqlite.deleteExportedRows({database:this.dbName,readonly:!1}),Promise.resolve())}catch(t){return Promise.reject(t)}}async executeTransaction(t,r=!0){let a=0,i=!1;if(this.readonly)return Promise.reject("not allowed in read-only mode");if(await this.sqlite.beginTransaction({database:this.dbName}),i=await this.sqlite.isTransactionActive({database:this.dbName}),!i)return Promise.reject("After Begin Transaction, no transaction active");try{for(let f of t){if(typeof f!="object"||!("statement"in f))throw new Error("Error a task.statement must be provided");if("values"in f&&f.values&&f.values.length>0){let L=f.statement.toUpperCase().includes("RETURNING")?"all":"no",T=await this.sqlite.run({database:this.dbName,statement:f.statement,values:f.values,transaction:!1,readonly:!1,returnMode:L,isSQL92:r});if(T.changes.changes<0)throw new Error("Error in transaction method run ");a+=T.changes.changes}else{let L=await this.sqlite.execute({database:this.dbName,statements:f.statement,transaction:!1,readonly:!1});if(L.changes.changes<0)throw new Error("Error in transaction method execute ");a+=L.changes.changes}}let s=await this.sqlite.commitTransaction({database:this.dbName});a+=s.changes.changes;let y={changes:{changes:a}};return Promise.resolve(y)}catch(s){let y=s.message?s.message:s;return await this.sqlite.rollbackTransaction({database:this.dbName}),Promise.reject(y)}}async reorderRows(t){let r=t;if(t!=null&&t.values&&typeof t.values[0]=="object"&&Object.keys(t.values[0]).includes("ios_columns")){let a=t.values[0].ios_columns,i=[];for(let s=1;s<t.values.length;s++){let y=t.values[s],f={};for(let L of a)f[L]=y[L];i.push(f)}r.values=i}return Promise.resolve(r)}}});var Ot={};$e(Ot,{CapacitorSQLiteWeb:()=>Qe});var Qe,$t=se(()=>{Ze();Qe=class extends Te{constructor(){super(...arguments),this.jeepSqliteElement=null,this.isWebStoreOpen=!1}async initWebStore(){await customElements.whenDefined("jeep-sqlite"),this.jeepSqliteElement=document.querySelector("jeep-sqlite"),this.ensureJeepSqliteIsAvailable(),this.jeepSqliteElement.addEventListener("jeepSqliteImportProgress",t=>{this.notifyListeners("sqliteImportProgressEvent",t.detail)}),this.jeepSqliteElement.addEventListener("jeepSqliteExportProgress",t=>{this.notifyListeners("sqliteExportProgressEvent",t.detail)}),this.jeepSqliteElement.addEventListener("jeepSqliteHTTPRequestEnded",t=>{this.notifyListeners("sqliteHTTPRequestEndedEvent",t.detail)}),this.jeepSqliteElement.addEventListener("jeepSqlitePickDatabaseEnded",t=>{this.notifyListeners("sqlitePickDatabaseEndedEvent",t.detail)}),this.jeepSqliteElement.addEventListener("jeepSqliteSaveDatabaseToDisk",t=>{this.notifyListeners("sqliteSaveDatabaseToDiskEvent",t.detail)}),this.isWebStoreOpen||(this.isWebStoreOpen=await this.jeepSqliteElement.isStoreOpen())}async saveToStore(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.saveToStore(t);return}catch(r){throw new Error(`${r}`)}}async getFromLocalDiskToStore(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.getFromLocalDiskToStore(t);return}catch(r){throw new Error(`${r}`)}}async saveToLocalDisk(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.saveToLocalDisk(t);return}catch(r){throw new Error(`${r}`)}}async echo(t){return this.ensureJeepSqliteIsAvailable(),await this.jeepSqliteElement.echo(t)}async createConnection(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.createConnection(t);return}catch(r){throw new Error(`${r}`)}}async open(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.open(t);return}catch(r){throw new Error(`${r}`)}}async closeConnection(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.closeConnection(t);return}catch(r){throw new Error(`${r}`)}}async getVersion(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.getVersion(t)}catch(r){throw new Error(`${r}`)}}async checkConnectionsConsistency(t){this.ensureJeepSqliteIsAvailable();try{return await this.jeepSqliteElement.checkConnectionsConsistency(t)}catch(r){throw new Error(`${r}`)}}async close(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.close(t);return}catch(r){throw new Error(`${r}`)}}async beginTransaction(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.beginTransaction(t)}catch(r){throw new Error(`${r}`)}}async commitTransaction(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.commitTransaction(t)}catch(r){throw new Error(`${r}`)}}async rollbackTransaction(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.rollbackTransaction(t)}catch(r){throw new Error(`${r}`)}}async isTransactionActive(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.isTransactionActive(t)}catch(r){throw new Error(`${r}`)}}async getTableList(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.getTableList(t)}catch(r){throw new Error(`${r}`)}}async execute(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.execute(t)}catch(r){throw new Error(`${r}`)}}async executeSet(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.executeSet(t)}catch(r){throw new Error(`${r}`)}}async run(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.run(t)}catch(r){throw new Error(`${r}`)}}async query(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.query(t)}catch(r){throw new Error(`${r}`)}}async isDBExists(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.isDBExists(t)}catch(r){throw new Error(`${r}`)}}async isDBOpen(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.isDBOpen(t)}catch(r){throw new Error(`${r}`)}}async isDatabase(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.isDatabase(t)}catch(r){throw new Error(`${r}`)}}async isTableExists(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.isTableExists(t)}catch(r){throw new Error(`${r}`)}}async deleteDatabase(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.deleteDatabase(t);return}catch(r){throw new Error(`${r}`)}}async isJsonValid(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.isJsonValid(t)}catch(r){throw new Error(`${r}`)}}async importFromJson(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.importFromJson(t)}catch(r){throw new Error(`${r}`)}}async exportToJson(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.exportToJson(t)}catch(r){throw new Error(`${r}`)}}async createSyncTable(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.createSyncTable(t)}catch(r){throw new Error(`${r}`)}}async setSyncDate(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.setSyncDate(t);return}catch(r){throw new Error(`${r}`)}}async getSyncDate(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.getSyncDate(t)}catch(r){throw new Error(`${r}`)}}async deleteExportedRows(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.deleteExportedRows(t);return}catch(r){throw new Error(`${r}`)}}async addUpgradeStatement(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.addUpgradeStatement(t);return}catch(r){throw new Error(`${r}`)}}async copyFromAssets(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.copyFromAssets(t);return}catch(r){throw new Error(`${r}`)}}async getFromHTTPRequest(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.getFromHTTPRequest(t);return}catch(r){throw new Error(`${r}`)}}async getDatabaseList(){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.getDatabaseList()}catch(t){throw new Error(`${t}`)}}ensureJeepSqliteIsAvailable(){if(this.jeepSqliteElement===null)throw new Error("The jeep-sqlite element is not present in the DOM! Please check the @capacitor-community/sqlite documentation for instructions regarding the web platform.")}ensureWebstoreIsOpen(){if(!this.isWebStoreOpen)throw new Error('WebStore is not open yet. You have to call "initWebStore()" first.')}async getUrl(){throw this.unimplemented("Not implemented on web.")}async getMigratableDbList(t){throw console.log("getMigratableDbList",t),this.unimplemented("Not implemented on web.")}async addSQLiteSuffix(t){throw console.log("addSQLiteSuffix",t),this.unimplemented("Not implemented on web.")}async deleteOldDatabases(t){throw console.log("deleteOldDatabases",t),this.unimplemented("Not implemented on web.")}async moveDatabasesAndAddSuffix(t){throw console.log("moveDatabasesAndAddSuffix",t),this.unimplemented("Not implemented on web.")}async isSecretStored(){throw this.unimplemented("Not implemented on web.")}async setEncryptionSecret(t){throw console.log("setEncryptionSecret",t),this.unimplemented("Not implemented on web.")}async changeEncryptionSecret(t){throw console.log("changeEncryptionSecret",t),this.unimplemented("Not implemented on web.")}async clearEncryptionSecret(){throw console.log("clearEncryptionSecret"),this.unimplemented("Not implemented on web.")}async checkEncryptionSecret(t){throw console.log("checkEncryptionPassPhrase",t),this.unimplemented("Not implemented on web.")}async getNCDatabasePath(t){throw console.log("getNCDatabasePath",t),this.unimplemented("Not implemented on web.")}async createNCConnection(t){throw console.log("createNCConnection",t),this.unimplemented("Not implemented on web.")}async closeNCConnection(t){throw console.log("closeNCConnection",t),this.unimplemented("Not implemented on web.")}async isNCDatabase(t){throw console.log("isNCDatabase",t),this.unimplemented("Not implemented on web.")}async isDatabaseEncrypted(t){throw console.log("isDatabaseEncrypted",t),this.unimplemented("Not implemented on web.")}async isInConfigEncryption(){throw this.unimplemented("Not implemented on web.")}async isInConfigBiometricAuth(){throw this.unimplemented("Not implemented on web.")}async loadExtension(t){throw console.log("loadExtension",t),this.unimplemented("Not implemented on web.")}async enableLoadExtension(t){throw console.log("enableLoadExtension",t),this.unimplemented("Not implemented on web.")}}});var jt,Ht=se(()=>{Ze();Dt();jt=qe("CapacitorSQLite",{web:()=>Promise.resolve().then(()=>($t(),Ot)).then(n=>new n.CapacitorSQLiteWeb),electron:()=>window.CapacitorCustomPlatform.plugins.CapacitorSQLite})});var Kt={};$e(Kt,{getCardById:()=>yr,getCardIds:()=>hr,getCardsByIds:()=>fr,getDaten:()=>dr,getEnergieById:()=>Tr,getEnergieCardIds:()=>Lr,getEnergies:()=>Sr,getEngName:()=>mr,getName:()=>ur,getTrainerById:()=>Er,getTrainerCardIds:()=>kr,getTrainers:()=>vr,initDatabase:()=>cr,insertCard:()=>gr,insertEnergie:()=>Cr,insertTrainer:()=>wr,updateCardIds:()=>pr,updatePrice:()=>br});async function cr(){return M=await lr.createConnection("pokepicker",!1,"no-encryption",1),await M.open(),await M.execute(`
  ...
  `),(await M.query("SELECT COUNT(*) as count FROM pokemon")).values[0].count===0&&await M.execute(`
      ...
      `),M}async function dr(){return await M.query("SELECT * FROM pokemon")}async function ur(n){return(await M.query("SELECT name FROM pokemon WHERE dex = ?",[n])).values[0].name}async function mr(n){return(await M.query("SELECT engName FROM pokemon WHERE dex = ?",[n])).values[0].engName}async function hr(n){return(await M.query("SELECT cardIds FROM pokemon WHERE dex = ?",[n])).values[0].cardIds}async function pr(n,t){await M.run("UPDATE pokemon SET cardIds = ? WHERE dex = ?",[t,n])}async function gr(n){var t,r,a,i,s;try{let y=typeof n.imageSmall=="string"?n.imageSmall:null,f=typeof n.imageLarge=="string"?n.imageLarge:null;return((s=(await M.run(`INSERT INTO cards (cardId, cardName, rarity, setName, imageLow, imageHigh, subTypes, addedAt, avg30)
       VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)`,[n.id,n.name,n.rarity||"",((t=n.set)==null?void 0:t.name)||"",y,f,Array.isArray(n.subtypes)?n.subtypes.join(", "):"",new Date().toISOString(),(i=(a=(r=n.cardmarket)==null?void 0:r.prices)==null?void 0:a.avg30)!=null?i:null])).changes)==null?void 0:s.lastId)||null}catch(y){return console.error("Fehler in insertCard():",y.message||y,(n==null?void 0:n.id)||"unbekannte Karte"),null}}async function yr(n){var r;return((r=(await M.query("SELECT * FROM cards WHERE id = ?",[n])).values)==null?void 0:r[0])||null}async function fr(n){let t=n.map(()=>"?").join(",");return(await M.query(`SELECT * FROM cards WHERE id IN (${t})`,n)).values}async function br(n,t){try{await M.run("UPDATE cards SET avg30 = ? WHERE cardId = ?",[t,n])}catch(r){console.error(`Fehler beim Speichern von avg30 f\xFCr ${n}:`,r.message)}}async function vr(){return(await M.query("SELECT * FROM trainer")).values}async function wr(n){var t,r,a,i,s;try{let y=typeof n.imageSmall=="string"?n.imageSmall:null,f=typeof n.imageLarge=="string"?n.imageLarge:null;return((s=(await M.run(`INSERT INTO trainer (cardId, cardName, rarity, setName, imageLow, imageHigh, subTypes, addedAt, avg30)
       VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)`,[n.id,n.name,n.rarity||"",((t=n.set)==null?void 0:t.name)||"",y,f,Array.isArray(n.subtypes)?n.subtypes.join(", "):"",new Date().toISOString(),(i=(a=(r=n.cardmarket)==null?void 0:r.prices)==null?void 0:a.avg30)!=null?i:null])).changes)==null?void 0:s.lastId)||null}catch(y){return console.error("Fehler in insertTrainer():",y.message||y,(n==null?void 0:n.id)||"unbekannte Karte"),null}}async function Er(n){var r;return((r=(await M.query("SELECT * FROM trainer WHERE id = ?",[n])).values)==null?void 0:r[0])||null}async function kr(){return(await M.query("SELECT id FROM trainer")).values.map(t=>t.id)}async function Sr(){return(await M.query("SELECT * FROM energy")).values}async function Cr(n){var t,r,a,i,s;try{let y=typeof n.imageSmall=="string"?n.imageSmall:null,f=typeof n.imageLarge=="string"?n.imageLarge:null;return((s=(await M.run(`INSERT INTO energy (cardId, cardName, rarity, setName, imageLow, imageHigh, subTypes, addedAt, avg30)
       VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)`,[n.id,n.name,n.rarity||"",((t=n.set)==null?void 0:t.name)||"",y,f,Array.isArray(n.subtypes)?n.subtypes.join(", "):"",new Date().toISOString(),(i=(a=(r=n.cardmarket)==null?void 0:r.prices)==null?void 0:a.avg30)!=null?i:null])).changes)==null?void 0:s.lastId)||null}catch(y){return console.error("Fehler in insertEnergie():",y.message||y,(n==null?void 0:n.id)||"unbekannte Karte"),null}}async function Lr(){return(await M.query("SELECT id FROM energy")).values.map(t=>t.id)}async function Tr(n){var r;return((r=(await M.query("SELECT * FROM energy WHERE id = ?",[n])).values)==null?void 0:r[0])||null}var lr,M,Nt=se(()=>{Ht();lr=new De(jt)});je();var be=kt("Http",{web:()=>Promise.resolve().then(()=>(Ve(),Ue)).then(n=>new n.HttpWeb),electron:()=>Promise.resolve().then(()=>(Ve(),Ue)).then(n=>new n.HttpWeb)});var N;document.addEventListener("DOMContentLoaded",()=>{(async()=>{let n=document.getElementById("cardLoader");n.innerHTML=`
          <p id="loaderText">Lade Karten\u2026</p>
          <div id="progressBarContainer">
            <div id="progressBar"></div>
          </div>
          <div id="progressText">0%</div>
        `,n.classList.remove("hidden"),n.classList.add("shown");let{initDatabase:t,getDaten:r,getName:a,getEngName:i,getCardIds:s,updateCardIds:y,insertCard:f,getCardById:L,getCardsByIds:T,updatePrice:Z,getTrainers:I,insertTrainer:A,getTrainerCardIds:Q,getTrainerById:V,getEnergies:ie,insertEnergie:Y,getEnergieCardIds:ve,getEnergieById:we}=await Promise.resolve().then(()=>(Nt(),Kt));N=await t();let le=await r(),ce=document.querySelector("#kartentabelle tbody"),pe=0,Pe=le.values.length;for(let o of le.values){let d=document.createElement("tr"),u=parseInt(o.dex);d.innerHTML=`
              ...
              `,ce.appendChild(d),await F(o.dex),pe++;let g=Math.min(99,Math.round(pe/Pe*100)),h=document.getElementById("progressBar"),b=document.getElementById("progressText");h&&(h.style.width=g+"%"),b&&(b.textContent=g+"%")}progressBar.style.width="100%",progressText.textContent="100%",setTimeout(()=>{n.style.height=n.offsetHeight+"px",n.offsetHeight,n.style.transition="height 0.5s ease, opacity 0.5s ease",n.style.height="0px",n.style.opacity="0",n.style.overflow="hidden"},100),B(),C(),te(),document.querySelectorAll("#tableToggle button").forEach(o=>o.classList.remove("active")),document.getElementById("showTablePokemon").classList.add("active");function B(){let o=document.querySelectorAll("#kartentabelle tbody tr"),d=0;o.forEach(u=>{u.style.display!=="none"&&d++}),document.getElementById("eintragsAnzahl").textContent=`(${d})`}function C(){let o=0;document.querySelectorAll("#kartentabelle tbody tr").forEach(l=>{if(l.style.display==="none")return;l.querySelectorAll("div[id*='Container'] img").forEach(p=>{window.getComputedStyle(p).display!=="none"&&o++})});let d=document.getElementById("kartenAnzahl");d&&(d.textContent=`(${o})`);let u=0;document.querySelectorAll("#trainertabelle tbody tr").forEach(l=>{if(l.style.display==="none")return;l.querySelectorAll("div[id*='Container'] img").forEach(p=>{window.getComputedStyle(p).display!=="none"&&u++})});let g=document.getElementById("kartenAnzahlTrainer");g&&(g.textContent=`(${u})`);let h=0;document.querySelectorAll("#energietabelle tbody tr").forEach(l=>{if(l.style.display==="none")return;l.querySelectorAll("div[id*='Container'] img").forEach(p=>{window.getComputedStyle(p).display!=="none"&&h++})});let b=document.getElementById("kartenAnzahlEnergie");b&&(b.textContent=`(${h})`)}async function F(o){let d=document.getElementById(`kartenContainer_${o}`),u=await s(o);if(!u)return;let g=u.split(";").filter(l=>l.trim()),h=await T(g.map(l=>parseInt(l)));h.sort((l,v)=>(v.avg30||0)-(l.avg30||0));let b=document.createDocumentFragment();for(let l of h){let v=document.createElement("img");v.alt=l.cardId,v.style.width="50px",v.style.height="69px",v.style.objectFit="cover",v.src="cardBackside.png";let p=new Image;p.onload=()=>v.src=l.imageLow,p.onerror=()=>console.warn("Fehler beim Laden von:",l.imageLow),p.src=l.imageLow,v.addEventListener("click",()=>$(o,g.indexOf(String(l.id)))),b.appendChild(v)}d.appendChild(b)}async function $(o,d){let u=document.querySelector("#overlay");u.innerHTML='<div id="overlayContent"><div class="loader"></div></div>',u.classList.remove("hidden"),u.classList.add("shown");let g=await s(o);if(!g)return;let h=g.split(";").filter(v=>v.trim()!=="");if(h.length===0){x();return}let b=d;async function l(){let v=h[b];try{let p=await L(v),c="Unbekannt";if(p.addedAt){let S=new Date(p.addedAt),O={day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"};c=S.toLocaleString("de-DE",O)}let m=p.avg30,k;if(m!=null){let S=m.toFixed(2),O="#DEDEDE",P="\u{1FA99}";m>20?(O="#FF4444",P="\u{1F525}"):m>5&&(O="#FFAA00",P="\u{1F4B0}"),k=`<span style="color:${O};">${P} ${S}\u20AC</span>`}else k='<span style="color:#888;">\u{1F578} Kein Preis gespeichert</span>';u.innerHTML=`
                        <div id="overlayContent">
                        <button class="closeGallery" id="closeGallery">X</button>
                          <h2>Pok\xE9mon</h2>
                          <div style="display:flex; align-items:center; justify-content:center;">
                            <div style="display:flex; flex-direction:column; align-items:center;">
                              <img id="cardImage" src="cardBackside.png" alt="${v}" style="max-width:300px; max-height:400px; margin:0 20px;">
                              <p style="margin-top:10px;">
                                ID: ${p.cardId} | Variante:
                                <select id="variantSelect">
                                  <option value="none" ${p.basic!==1&&p.reverse!==1&&p.holo!==1?"selected":""}>Keine Angabe</option>
                                  <option value="basic" ${p.basic===1?"selected":""}>Basic</option>
                                  <option value="reverse" ${p.reverse===1?"selected":""}>Reverse</option>
                                  <option value="holo" ${p.holo===1?"selected":""}>Holo</option>
                                  <option value="firstEdition" ${p.firstEdition===1?"selected":""}>First Edition</option>
                                </select>
                                <br>
                                30d-Wert: <strong>${k}</strong><br>
                                Hinzugef\xFCgt am: <strong>${c}
                              </p>
                            </div>
                          </div>
                          <br>
                      ...
                      `,document.getElementById("variantSelect").addEventListener("change",async function(){let S=this.value,O=0,P=0,R=0,D=0;S==="basic"?O=1:S==="reverse"?P=1:S==="holo"?R=1:S==="firstEdition"&&(D=1);try{await N.run(`UPDATE cards
                                 SET basic = ?,
                                     reverse = ?,
                                     holo = ?,
                                     firstEdition = ?
                                 WHERE id = ?`,[O,P,R,D,v])}catch(_){console.error("Fehler beim Aktualisieren der Variante:",_),console.error("Fehlerdetails:",JSON.stringify(_)),alert("Fehler beim Speichern der Variante.")}});let w=new Image;w.onload=()=>{document.getElementById("cardImage").src=p.imageHigh},w.onerror=()=>console.warn("Fehler beim Laden des Galerie-Bildes:",p.imageHigh),w.src=p.imageHigh,document.getElementById("deleteCard").addEventListener("click",async()=>{if(confirm("Willst du diese Karte wirklich l\xF6schen?")){let S=h[b];await N.run(`DELETE
                                          FROM cards
                                          WHERE id = ?`,[S]),h.splice(b,1),await y(o,h.join(";")+";"),x();let O=document.getElementById(`kartenContainer_${o}`);O.innerHTML="",F(o),C(),te(),H(),Ie()}}),document.getElementById("closeGallery").addEventListener("click",()=>{let S=document.getElementById("overlay");S.classList.add("fade-out"),setTimeout(()=>{S.classList.remove("shown","fade-out"),S.classList.add("hidden"),S.innerHTML=""},300)})}catch(p){console.error("Fehler beim Anzeigen der Karte:",p),x()}}l()}window.filterPokemonCardsByNumber=function(){let o=document.getElementById("nummerSuche").value.trim();document.querySelectorAll(".kartenItem").forEach(d=>{let u=d.dataset.number;d.style.display=u&&u.startsWith(o)?"block":"none"})},window.openOverlay=async function(o){if(!navigator.onLine)return alert("F\xFCr diese Funktion wird eine Internetverbindung ben\xF6tigt!"),null;let d=document.querySelector("#overlay");d.innerHTML=`
                <div id="overlayContent">
                  <h2>Bitte warten...</h2>
                  <p>Karten werden geladen</p>
                  <div class="loader"></div>
                </div>
              `,d.classList.remove("hidden"),d.classList.add("shown");try{let u=await a(o),g=await i(o),h=await j(g);if(!h||h.length===0){d.innerHTML=`
                        <div id='overlayContent'>
                          <h2>Keine Karten gefunden.</h2> 
                          <button class="overlayMenuBtn" id="BackBtn">Schlie\xDFen</button>
                        </div>
                      `,document.getElementById("BackBtn").addEventListener("click",l=>{l.preventDefault(),x()});return}let b=`
                  <div id="overlayContent">
                ...
                `;for(let l of h)if(console.log(l.image),!l.image||l.image.indexOf("tcgp")===-1){let v="\u2013",p=l.localId,c;l.image?c=l.image+"/low.webp":c="cardBackside.png",b+=`
                            <div class="kartenItem" data-id="${l.id}" data-number="${p}" onclick="karteAuswaehlen('${l.id}', '${o}', '${u}')">
                              <div>ID: ${l.id}</div>
                              <img src="${c}" alt="${u}">
                              <!--<div>${v}</div>-->
                            </div>
                ...
                `,d.innerHTML=b,document.getElementById("BackBtn").addEventListener("click",l=>{l.preventDefault(),x()})}catch(u){console.error(u),d.innerHTML=`
                    <div id='overlayContent'>
                      <h2>Fehler beim Laden.</h2>
                      <button class="overlayMenuBtn" id="BackBtn">Schlie\xDFen</button>
                    </div>`,document.getElementById("BackBtn").addEventListener("click",g=>{g.preventDefault(),x()})}};function W(o){return o.replace(/-(0*)(\d+)/,(d,u,g)=>"-"+parseInt(g,10))}async function j(o){let d=`https://api.tcgdex.net/v2/en/cards?name=${encodeURIComponent(o)}`;try{let{data:u}=await be.get({url:d,headers:{Accept:"application/json"},responseType:"json"});return u}catch(u){return console.error("Fehler beim Laden:",u),[]}}async function J(o){let d=`https://api.tcgdex.net/v2/en/cards/${encodeURIComponent(o)}`;try{let{data:u}=await be.get({url:d,headers:{Accept:"application/json"},responseType:"json"});return u}catch(u){return console.error("Fehler beim Laden:",u),[]}}async function de(o){let d=await ne(`supertype:Trainer subtypes:${o}`),g=(await ne("supertype:Trainer")).filter(b=>!b.subtypes||b.subtypes.length===0),h=[...d,...g];return h.sort((b,l)=>{var c,m;let v=((c=b.name)==null?void 0:c.toLowerCase())||"",p=((m=l.name)==null?void 0:m.toLowerCase())||"";return v.localeCompare(p)}),h}async function ne(o){var b,l,v,p;let d=[],u=1,g=250,h=!0;for(;h;){let c=`https://api.pokemontcg.io/v2/cards?q=${encodeURIComponent(o)}&page=${u}&pageSize=${g}`,m=await be.get({url:c,headers:{Accept:"application/json","X-Api-Key":config.API_KEY,Connection:"close"}});if(m.status!==200||!((l=(b=m.data)==null?void 0:b.data)!=null&&l.length))break;let k=m.data.data;for(let w of k){let S=(v=w.cardmarket)==null?void 0:v.prices;w.avg30=(p=S==null?void 0:S.avg30)!=null?p:null}d.push(...k),k.length<g?h=!1:u++}return d}window.karteAuswaehlen=async function(o,d,u){var h,b;let g=document.querySelector("#overlay");g.innerHTML='<div id="overlayContent"><div class="loader"></div></div>',g.classList.remove("hidden"),g.classList.add("shown");try{let l=await sdk.card.get(o),v=l.getImageURL("low","webp"),p=l.getImageURL("high","webp"),c={cardId:o,cardName:(l==null?void 0:l.name)||u||null,subTypes:Array.isArray(l==null?void 0:l.subtypes)?l.subtypes.join(", "):(l==null?void 0:l.subtypes)||null,rarity:(l==null?void 0:l.rarity)||null,avg30:((b=(h=l==null?void 0:l.pricing)==null?void 0:h.cardmarket)==null?void 0:b.avg30)||null,imageLow:v,imageHigh:p};await f(c)||new Error("insertCard lieferte keine ID zur\xFCck.")}catch(l){console.error("karteAusw\xE4hlen(TCGdex) Fehler:",l),g.innerHTML=`
                  <div id="overlayContent">
                    <h2>Fehler beim Hinzuf\xFCgen.</h2>
                    <p>${l&&l.message||l}</p>
                    <button class="overlayMenuBtn" id="closeOverlayConfirm">Schlie\xDFen</button>
                  </div>`,document.getElementById("closeOverlayConfirm").addEventListener("click",()=>{let v=document.getElementById("overlay");v.classList.add("fade-out"),setTimeout(()=>{v.classList.remove("shown","fade-out"),v.classList.add("hidden"),v.innerHTML=""},300)})}};async function te(){try{let o=await N.query(`SELECT avg30
                                                   FROM cards
                                                   WHERE avg30 IS NOT NULL`),d=await N.query(`SELECT avg30
                                                      FROM trainer
                                                      WHERE avg30 IS NOT NULL`),u=await N.query(`SELECT avg30
                                                      FROM energy
                                                      WHERE avg30 IS NOT NULL`),g=0;for(let m of o.values)g+=m.avg30;for(let m of d.values)g+=m.avg30;for(let m of u.values)g+=m.avg30;let h="\u{1FA99}";g>1e3?h="\u{1F525}":g>500&&(h="\u{1F4B0}"),document.getElementById("gesamtwert").textContent=`\u03A3: ${g.toFixed(2)}\u20AC ${h} | `;let b=await N.query(`SELECT COUNT(*) as count
                                                    FROM cards`),l=await N.query(`SELECT COUNT(*) as count
                                                      FROM trainer`),v=await N.query(`SELECT COUNT(*) as count
                                                      FROM energy`),p=b.values[0].count+l.values[0].count+v.values[0].count,c=document.getElementById("gesamtanzahl");c&&(c.textContent=`${p} Karten`)}catch(o){console.error("Fehler beim Berechnen des Gesamtwerts:",o)}}async function Be(){if(!navigator.onLine)return alert("F\xFCr diese Funktion wird eine Internetverbindung ben\xF6tigt!"),null;let o=await N.query(`SELECT cardId
                                           FROM cards`),d=await N.query(`SELECT cardId
                                                  FROM trainer`),u=await N.query(`SELECT cardId
                                                  FROM energy`),g=0,h=0,b=o.values.length+d.values.length+u.values.length;alert(`Aktualisierung von ${b} Preisen gestartet.`);for(let v of o.values){let p=v.cardId,c=await fetchPrice(p);if(c==null){let w=W(p);c=await fetchPrice(w)}c!=null&&(await Z(p,c),g++),h++;let m=Math.round(h/b*100),k=document.getElementById("preiseAktualisierenProgress");k&&(k.textContent=m+"%")}for(let v of d.values){let p=v.cardId,c=await fetchPrice(p);if(c==null){let w=W(p);c=await fetchPrice(w)}c!=null&&(await N.run(`UPDATE trainer
                                  SET avg30 = ?
                                  WHERE cardId = ?`,[c,p]),g++),h++;let m=Math.round(h/b*100),k=document.getElementById("preiseAktualisierenProgress");k&&(k.textContent=m+"%")}for(let v of u.values){let p=v.cardId,c=await fetchPrice(p);if(c==null){let w=W(p);c=await fetchPrice(w)}c!=null&&(await N.run(`UPDATE energy
                                  SET avg30 = ?
                                  WHERE cardId = ?`,[c,p]),g++),h++;let m=Math.round(h/b*100),k=document.getElementById("preiseAktualisierenProgress");k&&(k.textContent=m+"%")}let l=document.getElementById("preiseAktualisierenProgress");l&&(l.textContent=""),alert(`${g} Preise wurden aktualisiert!`),te()}window.aktualisiereAllePreise=Be;function Ie(){let o=document.getElementById("search").value.trim().toUpperCase();["kartentabelle","trainertabelle","energietabelle"].forEach(u=>{document.querySelectorAll(`#${u} tbody tr`).forEach(h=>{let b=h.querySelector("td.pokemon a"),l=h.querySelectorAll("div[id*='Container'] img");if(o===""){h.style.display="",l.forEach(p=>p.style.display="inline-block");return}let v=!1;if(u==="kartentabelle"&&b)if(b.textContent.toUpperCase().includes(o))v=!0,l.forEach(c=>c.style.display="inline-block");else{let c=!1;l.forEach(m=>{let w=m.alt.toUpperCase().split("-")[1]||"",S=w.includes(o)||w.startsWith(o);m.style.display=S?"inline-block":"none",S&&(c=!0)}),v=c}if(u!=="kartentabelle"){let p=!1;l.forEach(c=>{let k=c.alt.toUpperCase().split("-")[1]||"",w=k.includes(o)||k.startsWith(o);c.style.display=w?"inline-block":"none",w&&(p=!0)}),v=p}h.style.display=v?"":"none"})}),B(),C(),te()}window.searchTable=Ie,document.getElementById("search").addEventListener("input",function(){let o=document.getElementById("clearSearch");o.style.display=this.value.trim()?"inline":"none"}),document.getElementById("clearSearch").addEventListener("click",function(){let o=document.getElementById("search");o.value="",this.style.display="none",Ie()});let E={reverse:"neutral",holo:"neutral",v:"neutral",vmax:"neutral",ex:"neutral",shiny:"neutral",firstEdition:"neutral",illustration:"neutral"};function H(){["kartentabelle","trainertabelle","energietabelle"].forEach(d=>{document.querySelectorAll(`#${d} tbody tr`).forEach(g=>{var v,p,c,m,k,w,S,O,P,R,D,_,me,he,Ye,et,tt,rt,nt,at,it,ot,st,lt;let h=g.querySelector("div[id*='Container']");if(!h)return;let b=h.querySelectorAll("img");if(d==="kartentabelle"){let ae=!1;if(b.length>0){for(let oe of b){if(E.reverse==="negative"&&card.reverse===1){ae=!0;break}if(E.holo==="negative"&&card.holo===1){ae=!0;break}if(E.firstEdition==="negative"&&card.firstEdition===1){ae=!0;break}let G=((v=card.subTypes)==null?void 0:v.toLowerCase().includes("radiant"))||((p=card.rarity)==null?void 0:p.toLowerCase().includes("shiny"));if(E.shiny==="negative"&&G){ae=!0;break}let ke=((c=card.rarity)==null?void 0:c.toLowerCase().includes("illustration"))||((m=card.rarity)==null?void 0:m.toLowerCase().includes("trainer gallery"));if(E.illustration==="negative"&&ke){ae=!0;break}let ye=((k=card.subTypes)==null?void 0:k.toLowerCase().includes("v"))||((w=card.cardName)==null?void 0:w.toLowerCase().includes(" v"));if(E.v==="negative"&&ye){ae=!0;break}let z=((S=card.subTypes)==null?void 0:S.toLowerCase().includes("vmax"))||((O=card.cardName)==null?void 0:O.toLowerCase().includes(" vmax")),X=((P=card.subTypes)==null?void 0:P.toLowerCase().includes("vstar"))||((R=card.cardName)==null?void 0:R.toLowerCase().includes(" vstar"));if(E.vmax==="negative"&&(z||X)){ae=!0;break}let Se=((D=card.subTypes)==null?void 0:D.toLowerCase().includes("ex"))||((_=card.cardName)==null?void 0:_.toLowerCase().includes(" ex"));if(E.ex==="negative"&&Se){ae=!0;break}}for(let oe of b){let G={reverse:E.reverse==="positive",holo:E.holo==="positive",firstEdition:E.firstEdition==="positive",shiny:E.shiny==="positive",v:E.v==="positive",vmax:E.vmax==="positive",ex:E.ex==="positive",illustration:E.illustration==="positive"},ke=Object.values(G).some(z=>z),ye=!0;if(ke){let z=[];if(G.reverse&&z.push(card.reverse===1),G.holo&&z.push(card.holo===1),G.firstEdition&&z.push(card.firstEdition===1),G.shiny){let X=((me=card.subTypes)==null?void 0:me.toLowerCase().includes("radiant"))||((he=card.rarity)==null?void 0:he.toLowerCase().includes("shiny"));z.push(X)}if(G.illustration){let X=((Ye=card.rarity)==null?void 0:Ye.toLowerCase().includes("illustration"))||((et=card.rarity)==null?void 0:et.toLowerCase().includes("trainer gallery"));z.push(X)}if(G.v){let X=((tt=card.subTypes)==null?void 0:tt.toLowerCase().includes("v"))||((rt=card.cardName)==null?void 0:rt.toLowerCase().includes(" v"));z.push(X)}if(G.vmax){let X=((nt=card.subTypes)==null?void 0:nt.toLowerCase().includes("vmax"))||((at=card.cardName)==null?void 0:at.toLowerCase().includes(" vmax")),Se=((it=card.subTypes)==null?void 0:it.toLowerCase().includes("vstar"))||((ot=card.cardName)==null?void 0:ot.toLowerCase().includes(" vstar"));z.push(X||Se)}if(G.ex){let X=((st=card.subTypes)==null?void 0:st.toLowerCase().includes("ex"))||((lt=card.cardName)==null?void 0:lt.toLowerCase().includes(" ex"));z.push(X)}ye=z.some(Boolean)}oe.style.display=ye?"inline-block":"none"}let ge=Object.values(E).every(oe=>oe==="neutral"||oe==="negative");if(ae)g.style.display="none";else if(b.length===0)g.style.display=ge?"":"none";else{let oe=[...b].filter(G=>G.style.display!=="none");g.style.display=oe.length>0?"":"none"}return}let K=Object.values(E).every(ge=>ge==="neutral"||ge==="negative");g.style.display=K?"":"none";return}let l=0;b.forEach(ae=>{var ye,z,X,Se,ct,dt,ut,mt,ht,pt,gt,yt,ft,bt,vt,wt;let K=!0;E.reverse==="negative"&&card.reverse===1&&(K=!1),E.holo==="negative"&&card.holo===1&&(K=!1),E.firstEdition==="negative"&&card.firstEdition===1&&(K=!1),E.v==="negative"&&((ye=card.subTypes)!=null&&ye.toLowerCase().includes("v")||(z=card.cardName)!=null&&z.toLowerCase().includes(" v"))&&(K=!1);let ge=((X=card.subTypes)==null?void 0:X.toLowerCase().includes("vmax"))||((Se=card.cardName)==null?void 0:Se.toLowerCase().includes(" vmax")),oe=((ct=card.subTypes)==null?void 0:ct.toLowerCase().includes("vstar"))||((dt=card.cardName)==null?void 0:dt.toLowerCase().includes(" vstar"));E.vmax==="negative"&&(ge||oe)&&(K=!1),E.ex==="negative"&&((ut=card.subTypes)!=null&&ut.toLowerCase().includes("ex")||(mt=card.cardName)!=null&&mt.toLowerCase().includes(" ex"))&&(K=!1);let G=((ht=card.subTypes)==null?void 0:ht.toLowerCase().includes("radiant"))||((pt=card.rarity)==null?void 0:pt.toLowerCase().includes("shiny"));E.shiny==="negative"&&G&&(K=!1);let ke=((gt=card.rarity)==null?void 0:gt.toLowerCase().includes("illustration"))||((yt=card.rarity)==null?void 0:yt.toLowerCase().includes("trainer gallery"));E.illustration==="negative"&&ke&&(K=!1),E.reverse==="positive"&&card.reverse!==1&&(K=!1),E.holo==="positive"&&card.holo!==1&&(K=!1),E.firstEdition==="positive"&&card.firstEdition!==1&&(K=!1),E.v==="positive"&&!((ft=card.subTypes)!=null&&ft.toLowerCase().includes("v")||(bt=card.cardName)!=null&&bt.toLowerCase().includes(" v"))&&(K=!1),E.vmax==="positive"&&!(ge||oe)&&(K=!1),E.ex==="positive"&&!((vt=card.subTypes)!=null&&vt.toLowerCase().includes("ex")||(wt=card.cardName)!=null&&wt.toLowerCase().includes(" ex"))&&(K=!1),E.shiny==="positive"&&!G&&(K=!1),E.illustration==="positive"&&!ke&&(K=!1),ae.style.display=K?"inline-block":"none",K&&l++}),g.style.display=l>0?"":"none"})}),B(),C(),te()}function q(o){E[o]==="neutral"?E[o]="positive":E[o]==="positive"?E[o]="negative":E[o]="neutral",H(),ee()}function ee(){let o=["reverse","holo","firstEdition","v","vmax","ex","shiny","illustration"];for(let d of o){let u=document.getElementById(`filter-${d}`);u&&(u.classList.remove("active-positive","active-negative"),E[d]==="positive"?u.classList.add("active-positive"):E[d]==="negative"&&u.classList.add("active-negative"))}}document.getElementById("filter-alle").addEventListener("click",o=>{o.preventDefault(),E.reverse="neutral",E.holo="neutral",E.firstEdition="neutral",E.v="neutral",E.vmax="neutral",E.ex="neutral",E.shiny="neutral",E.illustration="neutral",H(),ee()}),document.getElementById("filter-reverse").addEventListener("click",o=>{o.preventDefault(),q("reverse")}),document.getElementById("filter-holo").addEventListener("click",o=>{o.preventDefault(),q("holo")}),document.getElementById("filter-firstEdition").addEventListener("click",o=>{o.preventDefault(),q("firstEdition")}),document.getElementById("filter-v").addEventListener("click",o=>{o.preventDefault(),q("v")}),document.getElementById("filter-vmax").addEventListener("click",o=>{o.preventDefault(),q("vmax")}),document.getElementById("filter-ex").addEventListener("click",o=>{o.preventDefault(),q("ex")}),document.getElementById("filter-shiny").addEventListener("click",o=>{o.preventDefault(),q("shiny")}),document.getElementById("filter-illustration").addEventListener("click",o=>{o.preventDefault(),q("illustration")});function x(){let o=document.getElementById("overlay");o.classList.add("fade-out"),setTimeout(()=>{o.classList.remove("shown","fade-out"),o.classList.add("hidden"),o.innerHTML=""},300)}function re(o){["kartentabelle","trainertabelle","energietabelle"].forEach(u=>{let g=document.getElementById(u);g&&(u===o?g.classList.remove("hidden"):g.classList.add("hidden"))})}window.zeigePokemonTabelle=function(){document.querySelectorAll("#tableToggle button").forEach(o=>o.classList.remove("active")),document.getElementById("showTablePokemon").classList.add("active"),re("kartentabelle")},window.zeigeTrainerTabelle=async function(){document.querySelectorAll("#tableToggle button").forEach(b=>b.classList.remove("active")),document.getElementById("showTableTrainer").classList.add("active"),re("trainertabelle");let o=document.querySelector("#trainertabelle tbody");o.innerHTML="";let d=document.createElement("tr");d.innerHTML=`
      ...
      `,o.appendChild(g);let h=document.createElement("tr");h.innerHTML=`
      ...
      `,o.appendChild(h),await U(),C()};async function U(){let o=document.getElementById("supporterContainer"),d=document.getElementById("itemContainer"),u=document.getElementById("stadiumContainer"),g=document.getElementById("toolContainer"),h=await I();if(!h||!Array.isArray(h)){console.error("getTrainers() lieferte keine g\xFCltige Liste:",h);return}h.sort((c,m)=>(m.avg30||0)-(c.avg30||0));let b=document.createDocumentFragment(),l=document.createDocumentFragment(),v=document.createDocumentFragment(),p=document.createDocumentFragment();for(let c of h){let m=document.createElement("img");m.alt=c.cardId,m.style.width="50px",m.style.height="69px",m.style.objectFit="cover",m.src="cardBackside.png";let k=new Image;k.onload=()=>m.src=c.imageLow,k.onerror=()=>console.warn("Fehler beim Laden von:",c.imageLow),k.src=c.imageLow;let w="";if(Array.isArray(c.subTypes))c.subTypes.some(S=>S.toLowerCase().includes("supporter"))?w="supporter":c.subTypes.some(S=>S.toLowerCase().includes("item"))?w="item":c.subTypes.some(S=>S.toLowerCase().includes("stadium"))?w="stadium":c.subTypes.some(S=>S.toLowerCase().includes("tool"))&&(w="tool");else if(typeof c.subTypes=="string"){let S=c.subTypes.toLowerCase();S.includes("supporter")?w="supporter":S.includes("item")?w="item":S.includes("stadium")?w="stadium":S.includes("tool")&&(w="tool")}w||(w="supporter"),m.addEventListener("click",()=>Ee(c.id,w)),w==="supporter"&&b.appendChild(m),w==="item"&&l.appendChild(m),w==="stadium"&&v.appendChild(m),w==="tool"&&p.appendChild(m)}o.appendChild(b),d.appendChild(l),u.appendChild(v),g.appendChild(p)}window.openTrainerOverlay=async function(o){if(!navigator.onLine)return alert("F\xFCr diese Funktion wird eine Internetverbindung ben\xF6tigt!"),null;let d=document.querySelector("#overlay");d.innerHTML=`
        <div id="overlayContent">
          <h2>Bitte warten...</h2>
          <p>Karten werden geladen</p>
          <div class="loader"></div>
        </div>
      `,d.classList.remove("hidden"),d.classList.add("shown");try{if(cards=await de(o),!cards||cards.length===0){d.innerHTML=`
                        <div id='overlayContent'>
                          <h2>Keine Karten gefunden.</h2> 
                          <button class="overlayMenuBtn" id="BackBtn">Schlie\xDFen</button>
                        </div>
                      `,document.getElementById("BackBtn").addEventListener("click",()=>{e.preventDefault(),x()});return}let u=`
                  <div id="overlayContent">
                    <button class="closeGallery" id="BackBtn">X</button>
                    ...
                    <div class="kartenGrid">
                `;for(let g of cards){let h=g.avg30,b="\u2013";if(h!=null){let v=h.toFixed(2),p="#DEDEDE",c="\u{1FA99}";h>20?(p="#FF4444",c="\u{1F525}"):h>5&&(p="#FFAA00",c="\u{1F4B0}"),b=`<span style="color:${p}; font-size:14px;">${c} ${v}\u20AC</span>`}let l=g.id.split("-")[1];u+=`
            <div class="kartenItem" data-id="${g.id}" data-number="${l}" onclick="trainerkarteAuswaehlen('${g.id}')">
              <div>ID: ${g.id}</div>
              <img src="${g.images.small}" alt="${g.name}">
              <div>${b}</div>
            </div>
          `}u+=`
            </div>
          </div>
        `,d.innerHTML=u,document.getElementById("BackBtn").addEventListener("click",()=>{x()})}catch(u){console.error(u),d.innerHTML=`
          <div id='overlayContent'>
            <h2>Fehler beim Laden.</h2>
            <button class="overlayMenuBtn" id="BackBtn">Schlie\xDFen</button>
          </div>`,document.getElementById("BackBtn").addEventListener("click",()=>{x()})}},window.trainerkarteAuswaehlen=async function(o){var u,g;let d=document.querySelector("#overlay");d.innerHTML='<div id="overlayContent"><div class="loader"></div></div>',d.classList.remove("hidden"),d.classList.add("shown");try{let h=await be.get({url:`https://api.pokemontcg.io/v2/cards/${o}`,headers:{Accept:"application/json","X-Api-Key":config.API_KEY,Connection:"close"}});if(h.status!==200){console.error("Fehler beim Abrufen der Karte:",h.status,h);return}let b=h.data.data;b.imageSmall=((u=b.images)==null?void 0:u.small)||null,b.imageLarge=((g=b.images)==null?void 0:g.large)||null,(!b.subtypes||b.subtypes.length===0)&&(b.subtypes="Supporter");let l=await A(b);if(!l){console.error("Keine ID von insertCard erhalten \u2013 Abbruch.");return}b.id=l,d.innerHTML=`
                  <div id="overlayContent">
                ...
                `;async function v(p,c){d.innerHTML='<div id="overlayContent"><div class="loader"></div></div>',d.classList.remove("hidden"),d.classList.add("shown");try{p!=="none"&&await N.run(`UPDATE trainer
                                          SET ${p} = 1
                                          WHERE id = ?`,[c]);let m=document.getElementById("supporterContainer");m.innerHTML="";let k=document.getElementById("itemContainer");k.innerHTML="";let w=document.getElementById("stadiumContainer");w.innerHTML="";let S=document.getElementById("toolContainer");S.innerHTML="",await U()}catch(m){console.error("Fehler in finalizeTrainerSelection:",m.message,m)}x(),await te()}document.getElementById("btnBasic").addEventListener("click",()=>v("basic",l)),document.getElementById("btnFirstEdition").addEventListener("click",()=>v("firstEdition",l)),document.getElementById("btnReverse").addEventListener("click",()=>v("reverse",l)),document.getElementById("btnHolo").addEventListener("click",()=>v("holo",l)),document.getElementById("closeOverlayConfirm").addEventListener("click",()=>v("none",l))}catch(h){console.error("Fehler bei trainerkarteAuswaehlen:",h),d.innerHTML=`
          <div id="overlayContent">
            <h2>Fehler beim Hinzuf\xFCgen.</h2>
            <p>${h.message}</p>
            <button class="overlayMenuBtn" id="closeOverlayConfirm">Schlie\xDFen</button>
          </div>
        `,document.getElementById("closeOverlayConfirm").addEventListener("click",()=>{x()})}};async function Ee(o,d){var p;let u=document.querySelector("#overlay");u.innerHTML='<div id="overlayContent"><div class="loader"></div></div>',u.classList.remove("hidden"),u.classList.add("shown");let g=await Q();if(!g||!g.length)return;let h=[],b={};for(let c of g){let m=await V(c);if(!m)continue;let k=((p=m.subTypes)==null?void 0:p.toLowerCase())||"";(d==="supporter"&&k.includes("supporter")||d==="item"&&k.includes("item")||d==="stadium"&&k.includes("stadium")||d==="tool"&&k.includes("tool"))&&(h.push(c),b[c]=m)}if(!h.length){x();return}let l=h.findIndex(c=>c===o);l===-1&&(l=0);async function v(){let c=h[l],m=b[c]||await V(c);if(!m)return;let k="Unbekannt";m.addedAt&&(k=new Date(m.addedAt).toLocaleString("de-DE",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"}));let w=m.avg30,S;if(w){let P=w.toFixed(2),R="#DEDEDE",D="\u{1FA99}";w>20?(R="#FF4444",D="\u{1F525}"):w>5&&(R="#FFAA00",D="\u{1F4B0}"),S=`<span style="color:${R};">${D} ${P}\u20AC</span>`}else S='<span style="color:#888;">\u{1F578} Kein Preis gespeichert</span>';u.innerHTML=`
                  <div id="overlayContent">
                    <button class="closeGallery" id="closeGallery">X</button>
                    <h2>Trainer</h2>
                    <div style="display:flex; align-items:center; justify-content:center;">
                      <div style="display:flex; flex-direction:column; align-items:center;">
                        <img id="cardImage" src="cardBackside.png" alt="${c}" style="max-width:300px; max-height:400px; margin:0 20px;">
                        <p style="margin-top:10px;">
                          ID: ${m.cardId} | Variante:
                          <select id="variantSelect">
                            <option value="none" ${m.basic!==1&&m.reverse!==1&&m.holo!==1?"selected":""}>Keine Angabe</option>
                            <option value="basic" ${m.basic===1?"selected":""}>Basic</option>
                            <option value="reverse" ${m.reverse===1?"selected":""}>Reverse</option>
                            <option value="holo" ${m.holo===1?"selected":""}>Holo</option>
                            <option value="firstEdition" ${m.firstEdition===1?"selected":""}>First Edition</option>
                          </select>
                          <br>
                          30d-Wert: <strong>${S}</strong><br>
                          Hinzugef\xFCgt am: <strong>${k}</strong>
                        </p>
                      </div>
                    </div>
                    <br>
                ...
                `,document.getElementById("variantSelect").addEventListener("change",async function(){let P=this.value,R=0,D=0,_=0,me=0;P==="basic"?R=1:P==="reverse"?D=1:P==="holo"?_=1:P==="firstEdition"&&(me=1);try{await N.run(`UPDATE trainer
                             SET basic = ?,
                                 reverse = ?,
                                 holo = ?,
                                 firstEdition = ?
                             WHERE id = ?`,[R,D,_,me,c])}catch(he){console.error("Fehler beim Aktualisieren der Variante:",he),console.error("Fehlerdetails:",JSON.stringify(he)),alert("Fehler beim Speichern der Variante.")}});let O=new Image;O.onload=()=>{document.getElementById("cardImage").src=m.imageHigh},O.onerror=()=>console.warn("Fehler beim Laden des Galerie-Bildes:",m.imageHigh),O.src=m.imageHigh,document.getElementById("deleteTrainer").addEventListener("click",async()=>{if(confirm("Willst du diese Karte wirklich l\xF6schen?")){await N.run(`DELETE
                                      FROM trainer
                                      WHERE id = ?`,[c]),x();let P=document.getElementById("supporterContainer"),R=document.getElementById("itemContainer"),D=document.getElementById("stadiumContainer"),_=document.getElementById("toolContainer");P&&(P.innerHTML=""),R&&(R.innerHTML=""),D&&(D.innerHTML=""),_&&(_.innerHTML=""),await U(),await te()}}),document.getElementById("closeGallery").addEventListener("click",()=>{x()})}v()}window.filterTrainerCardsByNumber=function(){let o=document.getElementById("nummerSuche").value.trim();document.querySelectorAll(".kartenItem").forEach(d=>{let u=d.dataset.number;d.style.display=u&&u.startsWith(o)?"block":"none"})},window.zeigeEnergieTabelle=async function(){document.querySelectorAll("#tableToggle button").forEach(g=>g.classList.remove("active")),document.getElementById("showTableEnergie").classList.add("active"),re("energietabelle");let o=document.querySelector("#energietabelle tbody");o.innerHTML="";let d=document.createElement("tr");d.innerHTML=`
        <td>Basis-Energie</td>
        <td>
      ...
      `,o.appendChild(u),await ue(),C()};async function ue(){var b,l,v;let o=document.getElementById("basisEnergieContainer"),d=document.getElementById("spezialEnergieContainer"),u=await ie();if(!u||!Array.isArray(u)){console.error("getEnergies() lieferte keine g\xFCltige Liste:",u);return}u.sort((p,c)=>(c.avg30||0)-(p.avg30||0));let g=document.createDocumentFragment(),h=document.createDocumentFragment();for(let p of u){let c=document.createElement("img");c.alt=p.cardId,c.style.width="50px",c.style.height="69px",c.style.objectFit="cover";let m=((b=p.subTypes)==null?void 0:b.toLowerCase())||"";c.addEventListener("click",()=>Gt(p.id,m.includes("basic")?"basic":"special")),c.src="cardBackside.png";let k=new Image;k.onload=()=>c.src=p.imageLow,k.onerror=()=>console.warn("Fehler beim Laden von:",p.imageLow),k.src=p.imageLow,(l=p.subTypes)!=null&&l.toLowerCase().includes("basic")?g.appendChild(c):(v=p.subTypes)!=null&&v.toLowerCase().includes("special")&&h.appendChild(c)}o.appendChild(g),d.appendChild(h)}window.openEnergieOverlay=async function(o){if(!navigator.onLine)return alert("F\xFCr diese Funktion wird eine Internetverbindung ben\xF6tigt!"),null;let d=document.querySelector("#overlay");d.innerHTML=`
                <div id="overlayContent">
                  <h2>Bitte warten...</h2>
                  <p>Karten werden geladen</p>
                  <div class="loader"></div>
                </div>
              `,d.classList.remove("hidden"),d.classList.add("shown");try{if(cards=await Wt(o),!cards||cards.length===0){d.innerHTML=`
                        <div id='overlayContent'>
                          <h2>Keine Karten gefunden.</h2> 
                          <button class="overlayMenuBtn" id="BackBtn">Schlie\xDFen</button>
                        </div>
                      `,document.getElementById("BackBtn").addEventListener("click",()=>{x()});return}let u=`
                  <div id="overlayContent">
                    <button class="closeGallery" id="BackBtn">X</button>
                    <h2>Kartenauswahl f\xFCr<br><strong>${o}</strong>:</h2>
                    <p>
                    ...
                    <div class="kartenGrid">
                `;for(let g of cards){let h=g.avg30,b="\u2013";if(h!=null){let v=h.toFixed(2),p="#DEDEDE",c="\u{1FA99}";h>20?(p="#FF4444",c="\u{1F525}"):h>5&&(p="#FFAA00",c="\u{1F4B0}"),b=`<span style="color:${p}; font-size:14px;">${c} ${v}\u20AC</span>`}let l=g.id.split("-")[1];u+=`
            <div class="kartenItem" data-id="${g.id}" data-number="${l}" onclick="energiekarteAuswaehlen('${g.id}')">
              <div>ID: ${g.id}</div>
              <img src="${g.images.small}" alt="${g.name}">
              <div>${b}</div>
            </div>
        ...
        `,d.innerHTML=u,document.getElementById("BackBtn").addEventListener("click",()=>{x()})}catch(u){console.error(u),d.innerHTML=`
          <div id='overlayContent'>
            <h2>Fehler beim Laden.</h2>
            <button class="overlayMenuBtn" id="BackBtn">Schlie\xDFen</button>
          </div>`,document.getElementById("BackBtn").addEventListener("click",()=>{x()})}};async function Wt(o){var b,l,v,p;let d=[],u=1,g=250,h=!0;for(;h;){let c=`https://api.pokemontcg.io/v2/cards?q=supertype:Energy subtypes:${o}&orderBy=name&page=${u}&pageSize=${g}`,m=await be.get({url:c,headers:{Accept:"application/json","X-Api-Key":config.API_KEY,Connection:"close"}});if(m.status!==200||!((l=(b=m.data)==null?void 0:b.data)!=null&&l.length)){h=!1;break}let k=m.data.data;for(let w of k){let S=(v=w.cardmarket)==null?void 0:v.prices;w.avg30=(p=S==null?void 0:S.avg30)!=null?p:null}d=d.concat(k),k.length<g?h=!1:u++}return d}window.energiekarteAuswaehlen=async function(o){var u,g;let d=document.querySelector("#overlay");d.innerHTML='<div id="overlayContent"><div class="loader"></div></div>',d.classList.remove("hidden"),d.classList.add("shown");try{let h=await be.get({url:`https://api.pokemontcg.io/v2/cards/${o}`,headers:{Accept:"application/json","X-Api-Key":config.API_KEY,Connection:"close"}});if(h.status!==200){console.error("Fehler beim Abrufen der Karte:",h.status,h);return}let b=h.data.data;b.imageSmall=((u=b.images)==null?void 0:u.small)||null,b.imageLarge=((g=b.images)==null?void 0:g.large)||null;let l=await Y(b);if(!l){console.error("Keine ID von insertCard erhalten \u2013 Abbruch.");return}b.id=l,d.innerHTML=`
                  <div id="overlayContent">
                    <h2>Karte hinzugef\xFCgt!</h2>
                    <p>Du hast <strong>${o}</strong> ausgew\xE4hlt.</p>
                    <br>
                ...
                `;async function v(p,c){d.innerHTML='<div id="overlayContent"><div class="loader"></div></div>',d.classList.remove("hidden"),d.classList.add("shown");try{p!=="none"&&await N.run(`UPDATE energy
                                          SET ${p} = 1
                                          WHERE id = ?`,[c]);let m=document.getElementById("basisEnergieContainer");m.innerHTML="";let k=document.getElementById("spezialEnergieContainer");k.innerHTML="",await ue()}catch(m){console.error("Fehler in finalizeEnergieSelection:",m.message,m)}x(),await te()}document.getElementById("btnBasic").addEventListener("click",()=>v("basic",l)),document.getElementById("btnFirstEdition").addEventListener("click",()=>v("firstEdition",l)),document.getElementById("btnReverse").addEventListener("click",()=>v("reverse",l)),document.getElementById("btnHolo").addEventListener("click",()=>v("holo",l)),document.getElementById("closeOverlayConfirm").addEventListener("click",()=>v("none",l))}catch(h){console.error("Fehler bei energiekarteAuswaehlen:",h),d.innerHTML=`
          <div id="overlayContent">
            <h2>Fehler beim Hinzuf\xFCgen.</h2>
            <p>${h.message}</p>
            <button class="overlayMenuBtn" id="closeOverlayConfirm">Schlie\xDFen</button>
          </div>
        `,document.getElementById("closeOverlayConfirm").addEventListener("click",()=>{x()})}};async function Gt(o,d){var p;let u=document.querySelector("#overlay");u.innerHTML='<div id="overlayContent"><div class="loader"></div></div>',u.classList.remove("hidden"),u.classList.add("shown");let g=await ve();if(!g||!g.length)return;let h=[],b={};for(let c of g){let m=await we(c);if(!m)continue;let k=((p=m.subTypes)==null?void 0:p.toLowerCase())||"";(d==="basic"&&k.includes("basic")||d==="special"&&k.includes("special"))&&(h.push(c),b[c]=m)}if(!h.length){x();return}let l=h.findIndex(c=>c===o);l===-1&&(l=0);async function v(){let c=h[l],m=b[c]||await we(c);if(!m)return;let k="Unbekannt";m.addedAt&&(k=new Date(m.addedAt).toLocaleString("de-DE",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"}));let w=m.avg30,S;if(w!=null){let P=w.toFixed(2),R="#DEDEDE",D="\u{1FA99}";w>20?(R="#FF4444",D="\u{1F525}"):w>5&&(R="#FFAA00",D="\u{1F4B0}"),S=`<span style="color:${R};">${D} ${P}\u20AC</span>`}else S='<span style="color:#888;">\u{1F578} Kein Preis gespeichert</span>';u.innerHTML=`
          <div id="overlayContent">
            <button class="closeGallery" id="closeGallery">X</button>
            <h2>Energie</h2>
            <div style="display:flex; align-items:center; justify-content:center;">
        ...
        `,document.getElementById("variantSelect").addEventListener("change",async function(){let P=this.value,R=0,D=0,_=0,me=0;P==="basic"?R=1:P==="reverse"?D=1:P==="holo"?_=1:P==="firstEdition"&&(me=1);try{await N.run(`UPDATE energy
                             SET basic = ?,
                                 reverse = ?,
                                 holo = ?,
                                 firstEdition = ?
                             WHERE id = ?`,[R,D,_,me,c])}catch(he){console.error("Fehler beim Aktualisieren der Variante:",he),console.error("Fehlerdetails:",JSON.stringify(he)),alert("Fehler beim Speichern der Variante.")}});let O=new Image;O.onload=()=>{document.getElementById("cardImage").src=m.imageHigh},O.onerror=()=>console.warn("Fehler beim Laden des Galerie-Bildes:",m.imageHigh),O.src=m.imageHigh,document.getElementById("deleteEnergie").addEventListener("click",async()=>{if(confirm("Willst du diese Karte wirklich l\xF6schen?"))try{await N.run(`DELETE
                                          FROM energy
                                          WHERE id = ?`,[c]),x();let P=document.getElementById("basisEnergieContainer"),R=document.getElementById("spezialEnergieContainer");P&&(P.innerHTML=""),R&&(R.innerHTML=""),await ue(),await te()}catch(P){console.error("Fehler beim L\xF6schen der Energie-Karte:",P),alert("Beim L\xF6schen ist ein Fehler aufgetreten.")}}),document.getElementById("closeGallery").addEventListener("click",()=>{x()})}v()}window.filterEnergieCardsByNumber=function(){let o=document.getElementById("nummerSuche").value.trim();document.querySelectorAll(".kartenItem").forEach(d=>{let u=d.dataset.number;d.style.display=u&&u.startsWith(o)?"block":"none"})}})()});})();
