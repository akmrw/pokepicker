(()=>{var Tt=Object.defineProperty;var ee=(n,t)=>()=>(n&&(t=n(n=0)),t);var Lt=(n,t)=>()=>(t||n((t={exports:{}}).exports,t),t.exports),xe=(n,t)=>{for(var r in t)Tt(n,r,{get:t[r],enumerable:!0})};var Pt,xt,et,dr,ur,me,fe,It,At,Bt,we,tt,mr,Ee,Ie=ee(()=>{Pt=n=>{let t=new Map;t.set("web",{name:"web"});let r=n.CapacitorPlatforms||{currentPlatform:{name:"web"},platforms:t},a=(o,y)=>{r.platforms.set(o,y)},i=o=>{r.platforms.has(o)&&(r.currentPlatform=r.platforms.get(o))};return r.addPlatform=a,r.setPlatform=i,r},xt=n=>n.CapacitorPlatforms=Pt(n),et=xt(typeof globalThis!="undefined"?globalThis:typeof self!="undefined"?self:typeof window!="undefined"?window:typeof global!="undefined"?global:{}),dr=et.addPlatform,ur=et.setPlatform;(function(n){n.Unimplemented="UNIMPLEMENTED",n.Unavailable="UNAVAILABLE"})(me||(me={}));fe=class extends Error{constructor(t,r){super(t),this.message=t,this.code=r}},It=n=>{var t,r;return n!=null&&n.androidBridge?"android":!((r=(t=n==null?void 0:n.webkit)===null||t===void 0?void 0:t.messageHandlers)===null||r===void 0)&&r.bridge?"ios":"web"},At=n=>{var t,r,a,i,o;let y=n.CapacitorCustomPlatform||null,f=n.Capacitor||{},S=f.Plugins=f.Plugins||{},C=n.CapacitorPlatforms,U=()=>y!==null?y.name:It(n),P=((t=C==null?void 0:C.currentPlatform)===null||t===void 0?void 0:t.getPlatform)||U,I=()=>P()!=="web",V=((r=C==null?void 0:C.currentPlatform)===null||r===void 0?void 0:r.isNativePlatform)||I,G=A=>{let E=ne.get(A);return!!(E!=null&&E.platforms.has(P())||ce(A))},Y=((a=C==null?void 0:C.currentPlatform)===null||a===void 0?void 0:a.isPluginAvailable)||G,J=A=>{var E;return(E=f.PluginHeaders)===null||E===void 0?void 0:E.find(B=>B.name===A)},ce=((i=C==null?void 0:C.currentPlatform)===null||i===void 0?void 0:i.getPluginHeader)||J,de=A=>n.console.error(A),re=(A,E,B)=>Promise.reject(`${B} does not have an implementation of "${E}".`),ne=new Map,oe=(A,E={})=>{let B=ne.get(A);if(B)return console.warn(`Capacitor plugin "${A}" already registered. Cannot register plugins twice.`),B.proxy;let M=P(),j=ce(A),K,$=async()=>(!K&&M in E?K=typeof E[M]=="function"?K=await E[M]():K=E[M]:y!==null&&!K&&"web"in E&&(K=typeof E.web=="function"?K=await E.web():K=E.web),K),ae=(H,O)=>{var X,L;if(j){let Q=j==null?void 0:j.methods.find(z=>O===z.name);if(Q)return Q.rtype==="promise"?z=>f.nativePromise(A,O.toString(),z):(z,se)=>f.nativeCallback(A,O.toString(),z,se);if(H)return(X=H[O])===null||X===void 0?void 0:X.bind(H)}else{if(H)return(L=H[O])===null||L===void 0?void 0:L.bind(H);throw new fe(`"${A}" plugin is not implemented on ${M}`,me.Unimplemented)}},D=H=>{let O,X=(...L)=>{let Q=$().then(z=>{let se=ae(z,H);if(se){let ue=se(...L);return O=ue==null?void 0:ue.remove,ue}else throw new fe(`"${A}.${H}()" is not implemented on ${M}`,me.Unimplemented)});return H==="addListener"&&(Q.remove=async()=>O()),Q};return X.toString=()=>`${H.toString()}() { [capacitor code] }`,Object.defineProperty(X,"name",{value:H,writable:!1,configurable:!1}),X},_=D("addListener"),ve=D("removeListener"),Le=(H,O)=>{let X=_({eventName:H},O),L=async()=>{let z=await X;ve({eventName:H,callbackId:z},O)},Q=new Promise(z=>X.then(()=>z({remove:L})));return Q.remove=async()=>{console.warn("Using addListener() without 'await' is deprecated."),await L()},Q},x=new Proxy({},{get(H,O){switch(O){case"$$typeof":return;case"toJSON":return()=>({});case"addListener":return j?Le:_;case"removeListener":return ve;default:return D(O)}}});return S[A]=x,ne.set(A,{name:A,proxy:x,platforms:new Set([...Object.keys(E),...j?[M]:[]])}),x},ge=((o=C==null?void 0:C.currentPlatform)===null||o===void 0?void 0:o.registerPlugin)||oe;return f.convertFileSrc||(f.convertFileSrc=A=>A),f.getPlatform=P,f.handleError=de,f.isNativePlatform=V,f.isPluginAvailable=Y,f.pluginMethodNoop=re,f.registerPlugin=ge,f.Exception=fe,f.DEBUG=!!f.DEBUG,f.isLoggingEnabled=!!f.isLoggingEnabled,f.platform=f.getPlatform(),f.isNative=f.isNativePlatform(),f},Bt=n=>n.Capacitor=At(n),we=Bt(typeof globalThis!="undefined"?globalThis:typeof self!="undefined"?self:typeof window!="undefined"?window:typeof global!="undefined"?global:{}),tt=we.registerPlugin,mr=we.Plugins,Ee=class{constructor(t){this.listeners={},this.windowListeners={},t&&(console.warn(`Capacitor WebPlugin "${t.name}" config object was deprecated in v3 and will be removed in v4.`),this.config=t)}addListener(t,r){this.listeners[t]||(this.listeners[t]=[]),this.listeners[t].push(r);let i=this.windowListeners[t];i&&!i.registered&&this.addWindowListener(i);let o=async()=>this.removeListener(t,r),y=Promise.resolve({remove:o});return Object.defineProperty(y,"remove",{value:async()=>{console.warn("Using addListener() without 'await' is deprecated."),await o()}}),y}async removeAllListeners(){this.listeners={};for(let t in this.windowListeners)this.removeWindowListener(this.windowListeners[t]);this.windowListeners={}}notifyListeners(t,r){let a=this.listeners[t];a&&a.forEach(i=>i(r))}hasListeners(t){return!!this.listeners[t].length}registerWindowListener(t,r){this.windowListeners[r]={registered:!1,windowEventName:t,pluginEventName:r,handler:a=>{this.notifyListeners(r,a)}}}unimplemented(t="not implemented"){return new we.Exception(t,me.Unimplemented)}unavailable(t="not available"){return new we.Exception(t,me.Unavailable)}async removeListener(t,r){let a=this.listeners[t];if(!a)return;let i=a.indexOf(r);this.listeners[t].splice(i,1),this.listeners[t].length||this.removeWindowListener(this.windowListeners[t])}addWindowListener(t){window.addEventListener(t.windowEventName,t.handler),t.registered=!0}removeWindowListener(t){t&&(window.removeEventListener(t.windowEventName,t.handler),t.registered=!1)}}});var rt,Ae,Be,Me=ee(()=>{rt=async n=>new Promise((t,r)=>{let a=new FileReader;a.onload=()=>{let i=a.result,o=i.substr(i.indexOf(",")+1);t(o)},a.onerror=i=>r(i),a.readAsDataURL(n)}),Ae=n=>encodeURIComponent(n).replace(/%(2[346B]|5E|60|7C)/g,decodeURIComponent).replace(/[()]/g,escape),Be=n=>n.replace(/(%[\dA-F]{2})+/gi,decodeURIComponent)});var nt,ke,at,it,Re,ot=ee(()=>{Me();nt=(n,t,r={})=>{let a=Ae(n),i=Ae(t),o=`; expires=${(r.expires||"").replace("expires=","")}`,y=(r.path||"/").replace("path=","");document.cookie=`${a}=${i||""}${o}; path=${y}`},ke=()=>{let n=[],t={};if(!document.cookie)return n;let r=document.cookie.split(";")||[];for(let i of r){let[o,y]=i.replace(/=/,"CAP_COOKIE").split("CAP_COOKIE");o=Be(o).trim(),y=Be(y).trim(),t[o]=y}let a=Object.entries(t);for(let[i,o]of a)n.push({key:i,value:o});return n},at=n=>{let t=ke();for(let r of t)if(r.key===n)return r;return{key:n,value:""}},it=n=>{document.cookie=`${n}=; Max-Age=0`},Re=()=>{let n=document.cookie.split(";")||[];for(let t of n)document.cookie=t.replace(/^ +/,"").replace(/=.*/,`=;expires=${new Date().toUTCString()};path=/`)}});var Rt,qt,qe,le,st,lt,ct,dt,ut,mt=ee(()=>{Me();Rt=(n={})=>{let t=Object.keys(n);return Object.keys(n).map(i=>i.toLocaleLowerCase()).reduce((i,o,y)=>(i[o]=n[t[y]],i),{})},qt=(n,t=!0)=>n?Object.entries(n).reduce((a,i)=>{let[o,y]=i,f,S;return Array.isArray(y)?(S="",y.forEach(C=>{f=t?encodeURIComponent(C):C,S+=`${o}=${f}&`}),S.slice(0,-1)):(f=t?encodeURIComponent(y):y,S=`${o}=${f}`),`${a}&${S}`},"").substr(1):null,qe=(n,t={})=>{let r=Object.assign({method:n.method||"GET",headers:n.headers},t),i=Rt(n.headers)["content-type"]||"";if(typeof n.data=="string")r.body=n.data;else if(i.includes("application/x-www-form-urlencoded")){let o=new URLSearchParams;for(let[y,f]of Object.entries(n.data||{}))o.set(y,f);r.body=o.toString()}else if(i.includes("multipart/form-data")){let o=new FormData;if(n.data instanceof FormData)n.data.forEach((f,S)=>{o.append(S,f)});else for(let f of Object.keys(n.data))o.append(f,n.data[f]);r.body=o;let y=new Headers(r.headers);y.delete("content-type"),r.headers=y}else(i.includes("application/json")||typeof n.data=="object")&&(r.body=JSON.stringify(n.data));return r},le=async n=>{let t=qe(n,n.webFetchExtra),r=qt(n.params,n.shouldEncodeUrlParams),a=r?`${n.url}?${r}`:n.url,i=await fetch(a,t),o=i.headers.get("content-type")||"",{responseType:y="text"}=i.ok?n:{};o.includes("application/json")&&(y="json");let f;switch(y){case"arraybuffer":case"blob":let C=await i.blob();f=await rt(C);break;case"json":f=await i.json();break;case"document":case"text":default:f=await i.text()}let S={};return i.headers.forEach((C,U)=>{S[U]=C}),{data:f,headers:S,status:i.status,url:i.url}},st=async n=>le(Object.assign(Object.assign({},n),{method:"GET"})),lt=async n=>le(Object.assign(Object.assign({},n),{method:"POST"})),ct=async n=>le(Object.assign(Object.assign({},n),{method:"PUT"})),dt=async n=>le(Object.assign(Object.assign({},n),{method:"PATCH"})),ut=async n=>le(Object.assign(Object.assign({},n),{method:"DELETE"}))});var De={};xe(De,{HttpWeb:()=>Fe});var Fe,Oe=ee(()=>{Ie();ot();mt();Fe=class extends Ee{constructor(){super(),this.request=async t=>le(t),this.get=async t=>st(t),this.post=async t=>lt(t),this.put=async t=>ct(t),this.patch=async t=>dt(t),this.del=async t=>ut(t),this.getCookiesMap=async t=>{let r=ke(),a={};for(let i of r)a[i.key]=i.value;return a},this.getCookies=async t=>{let{url:r}=t;return{cookies:ke()}},this.setCookie=async t=>{let{key:r,value:a,expires:i="",path:o=""}=t;nt(r,a,{expires:i,path:o})},this.getCookie=async t=>at(t.key),this.deleteCookie=async t=>it(t.key),this.clearCookies=async t=>Re(),this.clearAllCookies=async()=>Re(),this.uploadFile=async t=>{let r=new FormData;r.append(t.name,t.blob||"undefined");let a=Object.assign(Object.assign({},t),{body:r,method:"POST"});return this.post(a)},this.downloadFile=async t=>{let r=qe(t,t.webFetchExtra),a=await fetch(t.url,r),i;if(!(t!=null&&t.progress))i=await a.blob();else if(!(a!=null&&a.body))i=new Blob;else{let o=a.body.getReader(),y=0,f=[],S=a.headers.get("content-type"),C=parseInt(a.headers.get("content-length")||"0",10);for(;;){let{done:I,value:V}=await o.read();if(I)break;f.push(V),y+=(V==null?void 0:V.length)||0;let G={type:"DOWNLOAD",url:t.url,bytes:y,contentLength:C};this.notifyListeners("progress",G)}let U=new Uint8Array(y),P=0;for(let I of f)typeof I!="undefined"&&(U.set(I,P),P+=I.length);i=new Blob([U.buffer],{type:S||void 0})}return{blob:i}}}}});var ht=Lt((Er,Dt)=>{Dt.exports={API_KEY:"a5d75d50-65e6-41a4-aa2f-9b2c93afaaa7"}});var he,be,Ot,Kt,$t,Ke,Se,pe,pt,gt,$e,kr,jt,Ht,Nt,Wt,je,Sr,He=ee(()=>{(function(n){n.Unimplemented="UNIMPLEMENTED",n.Unavailable="UNAVAILABLE"})(he||(he={}));be=class extends Error{constructor(t,r,a){super(t),this.message=t,this.code=r,this.data=a}},Ot=n=>{var t,r;return n!=null&&n.androidBridge?"android":!((r=(t=n==null?void 0:n.webkit)===null||t===void 0?void 0:t.messageHandlers)===null||r===void 0)&&r.bridge?"ios":"web"},Kt=n=>{let t=n.CapacitorCustomPlatform||null,r=n.Capacitor||{},a=r.Plugins=r.Plugins||{},i=()=>t!==null?t.name:Ot(n),o=()=>i()!=="web",y=P=>{let I=C.get(P);return!!(I!=null&&I.platforms.has(i())||f(P))},f=P=>{var I;return(I=r.PluginHeaders)===null||I===void 0?void 0:I.find(V=>V.name===P)},S=P=>n.console.error(P),C=new Map,U=(P,I={})=>{let V=C.get(P);if(V)return console.warn(`Capacitor plugin "${P}" already registered. Cannot register plugins twice.`),V.proxy;let G=i(),Y=f(P),J,ce=async()=>(!J&&G in I?J=typeof I[G]=="function"?J=await I[G]():J=I[G]:t!==null&&!J&&"web"in I&&(J=typeof I.web=="function"?J=await I.web():J=I.web),J),de=(E,B)=>{var M,j;if(Y){let K=Y==null?void 0:Y.methods.find($=>B===$.name);if(K)return K.rtype==="promise"?$=>r.nativePromise(P,B.toString(),$):($,ae)=>r.nativeCallback(P,B.toString(),$,ae);if(E)return(M=E[B])===null||M===void 0?void 0:M.bind(E)}else{if(E)return(j=E[B])===null||j===void 0?void 0:j.bind(E);throw new be(`"${P}" plugin is not implemented on ${G}`,he.Unimplemented)}},re=E=>{let B,M=(...j)=>{let K=ce().then($=>{let ae=de($,E);if(ae){let D=ae(...j);return B=D==null?void 0:D.remove,D}else throw new be(`"${P}.${E}()" is not implemented on ${G}`,he.Unimplemented)});return E==="addListener"&&(K.remove=async()=>B()),K};return M.toString=()=>`${E.toString()}() { [capacitor code] }`,Object.defineProperty(M,"name",{value:E,writable:!1,configurable:!1}),M},ne=re("addListener"),oe=re("removeListener"),ge=(E,B)=>{let M=ne({eventName:E},B),j=async()=>{let $=await M;oe({eventName:E,callbackId:$},B)},K=new Promise($=>M.then(()=>$({remove:j})));return K.remove=async()=>{console.warn("Using addListener() without 'await' is deprecated."),await j()},K},A=new Proxy({},{get(E,B){switch(B){case"$$typeof":return;case"toJSON":return()=>({});case"addListener":return Y?ge:ne;case"removeListener":return oe;default:return re(B)}}});return a[P]=A,C.set(P,{name:P,proxy:A,platforms:new Set([...Object.keys(I),...Y?[G]:[]])}),A};return r.convertFileSrc||(r.convertFileSrc=P=>P),r.getPlatform=i,r.handleError=S,r.isNativePlatform=o,r.isPluginAvailable=y,r.registerPlugin=U,r.Exception=be,r.DEBUG=!!r.DEBUG,r.isLoggingEnabled=!!r.isLoggingEnabled,r},$t=n=>n.Capacitor=Kt(n),Ke=$t(typeof globalThis!="undefined"?globalThis:typeof self!="undefined"?self:typeof window!="undefined"?window:typeof global!="undefined"?global:{}),Se=Ke.registerPlugin,pe=class{constructor(){this.listeners={},this.retainedEventArguments={},this.windowListeners={}}addListener(t,r){let a=!1;this.listeners[t]||(this.listeners[t]=[],a=!0),this.listeners[t].push(r);let o=this.windowListeners[t];o&&!o.registered&&this.addWindowListener(o),a&&this.sendRetainedArgumentsForEvent(t);let y=async()=>this.removeListener(t,r);return Promise.resolve({remove:y})}async removeAllListeners(){this.listeners={};for(let t in this.windowListeners)this.removeWindowListener(this.windowListeners[t]);this.windowListeners={}}notifyListeners(t,r,a){let i=this.listeners[t];if(!i){if(a){let o=this.retainedEventArguments[t];o||(o=[]),o.push(r),this.retainedEventArguments[t]=o}return}i.forEach(o=>o(r))}hasListeners(t){return!!this.listeners[t].length}registerWindowListener(t,r){this.windowListeners[r]={registered:!1,windowEventName:t,pluginEventName:r,handler:a=>{this.notifyListeners(r,a)}}}unimplemented(t="not implemented"){return new Ke.Exception(t,he.Unimplemented)}unavailable(t="not available"){return new Ke.Exception(t,he.Unavailable)}async removeListener(t,r){let a=this.listeners[t];if(!a)return;let i=a.indexOf(r);this.listeners[t].splice(i,1),this.listeners[t].length||this.removeWindowListener(this.windowListeners[t])}addWindowListener(t){window.addEventListener(t.windowEventName,t.handler),t.registered=!0}removeWindowListener(t){t&&(window.removeEventListener(t.windowEventName,t.handler),t.registered=!1)}sendRetainedArgumentsForEvent(t){let r=this.retainedEventArguments[t];r&&(delete this.retainedEventArguments[t],r.forEach(a=>{this.notifyListeners(t,a)}))}},pt=n=>encodeURIComponent(n).replace(/%(2[346B]|5E|60|7C)/g,decodeURIComponent).replace(/[()]/g,escape),gt=n=>n.replace(/(%[\dA-F]{2})+/gi,decodeURIComponent),$e=class extends pe{async getCookies(){let t=document.cookie,r={};return t.split(";").forEach(a=>{if(a.length<=0)return;let[i,o]=a.replace(/=/,"CAP_COOKIE").split("CAP_COOKIE");i=gt(i).trim(),o=gt(o).trim(),r[i]=o}),r}async setCookie(t){try{let r=pt(t.key),a=pt(t.value),i=`; expires=${(t.expires||"").replace("expires=","")}`,o=(t.path||"/").replace("path=",""),y=t.url!=null&&t.url.length>0?`domain=${t.url}`:"";document.cookie=`${r}=${a||""}${i}; path=${o}; ${y};`}catch(r){return Promise.reject(r)}}async deleteCookie(t){try{document.cookie=`${t.key}=; Max-Age=0`}catch(r){return Promise.reject(r)}}async clearCookies(){try{let t=document.cookie.split(";")||[];for(let r of t)document.cookie=r.replace(/^ +/,"").replace(/=.*/,`=;expires=${new Date().toUTCString()};path=/`)}catch(t){return Promise.reject(t)}}async clearAllCookies(){try{await this.clearCookies()}catch(t){return Promise.reject(t)}}},kr=Se("CapacitorCookies",{web:()=>new $e}),jt=async n=>new Promise((t,r)=>{let a=new FileReader;a.onload=()=>{let i=a.result;t(i.indexOf(",")>=0?i.split(",")[1]:i)},a.onerror=i=>r(i),a.readAsDataURL(n)}),Ht=(n={})=>{let t=Object.keys(n);return Object.keys(n).map(i=>i.toLocaleLowerCase()).reduce((i,o,y)=>(i[o]=n[t[y]],i),{})},Nt=(n,t=!0)=>n?Object.entries(n).reduce((a,i)=>{let[o,y]=i,f,S;return Array.isArray(y)?(S="",y.forEach(C=>{f=t?encodeURIComponent(C):C,S+=`${o}=${f}&`}),S.slice(0,-1)):(f=t?encodeURIComponent(y):y,S=`${o}=${f}`),`${a}&${S}`},"").substr(1):null,Wt=(n,t={})=>{let r=Object.assign({method:n.method||"GET",headers:n.headers},t),i=Ht(n.headers)["content-type"]||"";if(typeof n.data=="string")r.body=n.data;else if(i.includes("application/x-www-form-urlencoded")){let o=new URLSearchParams;for(let[y,f]of Object.entries(n.data||{}))o.set(y,f);r.body=o.toString()}else if(i.includes("multipart/form-data")||n.data instanceof FormData){let o=new FormData;if(n.data instanceof FormData)n.data.forEach((f,S)=>{o.append(S,f)});else for(let f of Object.keys(n.data))o.append(f,n.data[f]);r.body=o;let y=new Headers(r.headers);y.delete("content-type"),r.headers=y}else(i.includes("application/json")||typeof n.data=="object")&&(r.body=JSON.stringify(n.data));return r},je=class extends pe{async request(t){let r=Wt(t,t.webFetchExtra),a=Nt(t.params,t.shouldEncodeUrlParams),i=a?`${t.url}?${a}`:t.url,o=await fetch(i,r),y=o.headers.get("content-type")||"",{responseType:f="text"}=o.ok?t:{};y.includes("application/json")&&(f="json");let S,C;switch(f){case"arraybuffer":case"blob":C=await o.blob(),S=await jt(C);break;case"json":S=await o.json();break;case"document":case"text":default:S=await o.text()}let U={};return o.headers.forEach((P,I)=>{U[I]=P}),{data:S,headers:U,status:o.status,url:o.url}}async get(t){return this.request(Object.assign(Object.assign({},t),{method:"GET"}))}async post(t){return this.request(Object.assign(Object.assign({},t),{method:"POST"}))}async put(t){return this.request(Object.assign(Object.assign({},t),{method:"PUT"}))}async patch(t){return this.request(Object.assign(Object.assign({},t),{method:"PATCH"}))}async delete(t){return this.request(Object.assign(Object.assign({},t),{method:"DELETE"}))}},Sr=Se("CapacitorHttp",{web:()=>new je})});var Ce,Te,yt=ee(()=>{Ce=class{constructor(t){this.sqlite=t,this._connectionDict=new Map}async initWebStore(){try{return await this.sqlite.initWebStore(),Promise.resolve()}catch(t){return Promise.reject(t)}}async saveToStore(t){try{return await this.sqlite.saveToStore({database:t}),Promise.resolve()}catch(r){return Promise.reject(r)}}async saveToLocalDisk(t){try{return await this.sqlite.saveToLocalDisk({database:t}),Promise.resolve()}catch(r){return Promise.reject(r)}}async getFromLocalDiskToStore(t){let r=t!=null?t:!0;try{return await this.sqlite.getFromLocalDiskToStore({overwrite:r}),Promise.resolve()}catch(a){return Promise.reject(a)}}async echo(t){try{let r=await this.sqlite.echo({value:t});return Promise.resolve(r)}catch(r){return Promise.reject(r)}}async isSecretStored(){try{let t=await this.sqlite.isSecretStored();return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async setEncryptionSecret(t){try{return await this.sqlite.setEncryptionSecret({passphrase:t}),Promise.resolve()}catch(r){return Promise.reject(r)}}async changeEncryptionSecret(t,r){try{return await this.sqlite.changeEncryptionSecret({passphrase:t,oldpassphrase:r}),Promise.resolve()}catch(a){return Promise.reject(a)}}async clearEncryptionSecret(){try{return await this.sqlite.clearEncryptionSecret(),Promise.resolve()}catch(t){return Promise.reject(t)}}async checkEncryptionSecret(t){try{let r=await this.sqlite.checkEncryptionSecret({passphrase:t});return Promise.resolve(r)}catch(r){return Promise.reject(r)}}async addUpgradeStatement(t,r){try{return t.endsWith(".db")&&(t=t.slice(0,-3)),await this.sqlite.addUpgradeStatement({database:t,upgrade:r}),Promise.resolve()}catch(a){return Promise.reject(a)}}async createConnection(t,r,a,i,o){try{t.endsWith(".db")&&(t=t.slice(0,-3)),await this.sqlite.createConnection({database:t,encrypted:r,mode:a,version:i,readonly:o});let y=new Te(t,o,this.sqlite),f=o?`RO_${t}`:`RW_${t}`;return this._connectionDict.set(f,y),Promise.resolve(y)}catch(y){return Promise.reject(y)}}async closeConnection(t,r){try{t.endsWith(".db")&&(t=t.slice(0,-3)),await this.sqlite.closeConnection({database:t,readonly:r});let a=r?`RO_${t}`:`RW_${t}`;return this._connectionDict.delete(a),Promise.resolve()}catch(a){return Promise.reject(a)}}async isConnection(t,r){let a={};t.endsWith(".db")&&(t=t.slice(0,-3));let i=r?`RO_${t}`:`RW_${t}`;return a.result=this._connectionDict.has(i),Promise.resolve(a)}async retrieveConnection(t,r){t.endsWith(".db")&&(t=t.slice(0,-3));let a=r?`RO_${t}`:`RW_${t}`;if(this._connectionDict.has(a)){let i=this._connectionDict.get(a);return typeof i!="undefined"?Promise.resolve(i):Promise.reject(`Connection ${t} is undefined`)}else return Promise.reject(`Connection ${t} does not exist`)}async getNCDatabasePath(t,r){try{let a=await this.sqlite.getNCDatabasePath({path:t,database:r});return Promise.resolve(a)}catch(a){return Promise.reject(a)}}async createNCConnection(t,r){try{await this.sqlite.createNCConnection({databasePath:t,version:r});let a=new Te(t,!0,this.sqlite),i=`RO_${t})`;return this._connectionDict.set(i,a),Promise.resolve(a)}catch(a){return Promise.reject(a)}}async closeNCConnection(t){try{await this.sqlite.closeNCConnection({databasePath:t});let r=`RO_${t})`;return this._connectionDict.delete(r),Promise.resolve()}catch(r){return Promise.reject(r)}}async isNCConnection(t){let r={},a=`RO_${t})`;return r.result=this._connectionDict.has(a),Promise.resolve(r)}async retrieveNCConnection(t){if(this._connectionDict.has(t)){let r=`RO_${t})`,a=this._connectionDict.get(r);return typeof a!="undefined"?Promise.resolve(a):Promise.reject(`Connection ${t} is undefined`)}else return Promise.reject(`Connection ${t} does not exist`)}async isNCDatabase(t){try{let r=await this.sqlite.isNCDatabase({databasePath:t});return Promise.resolve(r)}catch(r){return Promise.reject(r)}}async retrieveAllConnections(){return this._connectionDict}async closeAllConnections(){let t=new Map;try{for(let r of this._connectionDict.keys()){let a=r.substring(3),i=r.substring(0,3)==="RO_";await this.sqlite.closeConnection({database:a,readonly:i}),t.set(r,null)}for(let r of t.keys())this._connectionDict.delete(r);return Promise.resolve()}catch(r){return Promise.reject(r)}}async checkConnectionsConsistency(){try{let t=[...this._connectionDict.keys()],r=[],a=[];for(let o of t)r.push(o.substring(0,2)),a.push(o.substring(3));let i=await this.sqlite.checkConnectionsConsistency({dbNames:a,openModes:r});return i.result||(this._connectionDict=new Map),Promise.resolve(i)}catch(t){return this._connectionDict=new Map,Promise.reject(t)}}async importFromJson(t){try{let r=await this.sqlite.importFromJson({jsonstring:t});return Promise.resolve(r)}catch(r){return Promise.reject(r)}}async isJsonValid(t){try{let r=await this.sqlite.isJsonValid({jsonstring:t});return Promise.resolve(r)}catch(r){return Promise.reject(r)}}async copyFromAssets(t){let r=t!=null?t:!0;try{return await this.sqlite.copyFromAssets({overwrite:r}),Promise.resolve()}catch(a){return Promise.reject(a)}}async getFromHTTPRequest(t,r){let a=r!=null?r:!0;try{return await this.sqlite.getFromHTTPRequest({url:t,overwrite:a}),Promise.resolve()}catch(i){return Promise.reject(i)}}async isDatabaseEncrypted(t){t.endsWith(".db")&&(t=t.slice(0,-3));try{let r=await this.sqlite.isDatabaseEncrypted({database:t});return Promise.resolve(r)}catch(r){return Promise.reject(r)}}async isInConfigEncryption(){try{let t=await this.sqlite.isInConfigEncryption();return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async isInConfigBiometricAuth(){try{let t=await this.sqlite.isInConfigBiometricAuth();return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async isDatabase(t){t.endsWith(".db")&&(t=t.slice(0,-3));try{let r=await this.sqlite.isDatabase({database:t});return Promise.resolve(r)}catch(r){return Promise.reject(r)}}async getDatabaseList(){try{let r=(await this.sqlite.getDatabaseList()).values;r.sort();let a={values:r};return Promise.resolve(a)}catch(t){return Promise.reject(t)}}async getMigratableDbList(t){let r=t||"default";try{let a=await this.sqlite.getMigratableDbList({folderPath:r});return Promise.resolve(a)}catch(a){return Promise.reject(a)}}async addSQLiteSuffix(t,r){let a=t||"default",i=r||[];try{let o=await this.sqlite.addSQLiteSuffix({folderPath:a,dbNameList:i});return Promise.resolve(o)}catch(o){return Promise.reject(o)}}async deleteOldDatabases(t,r){let a=t||"default",i=r||[];try{let o=await this.sqlite.deleteOldDatabases({folderPath:a,dbNameList:i});return Promise.resolve(o)}catch(o){return Promise.reject(o)}}async moveDatabasesAndAddSuffix(t,r){let a=t||"default",i=r||[];return this.sqlite.moveDatabasesAndAddSuffix({folderPath:a,dbNameList:i})}},Te=class{constructor(t,r,a){this.dbName=t,this.readonly=r,this.sqlite=a}getConnectionDBName(){return this.dbName}getConnectionReadOnly(){return this.readonly}async open(){try{return await this.sqlite.open({database:this.dbName,readonly:this.readonly}),Promise.resolve()}catch(t){return Promise.reject(t)}}async close(){try{return await this.sqlite.close({database:this.dbName,readonly:this.readonly}),Promise.resolve()}catch(t){return Promise.reject(t)}}async beginTransaction(){try{let t=await this.sqlite.beginTransaction({database:this.dbName});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async commitTransaction(){try{let t=await this.sqlite.commitTransaction({database:this.dbName});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async rollbackTransaction(){try{let t=await this.sqlite.rollbackTransaction({database:this.dbName});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async isTransactionActive(){try{let t=await this.sqlite.isTransactionActive({database:this.dbName});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async loadExtension(t){try{return await this.sqlite.loadExtension({database:this.dbName,path:t,readonly:this.readonly}),Promise.resolve()}catch(r){return Promise.reject(r)}}async enableLoadExtension(t){try{return await this.sqlite.enableLoadExtension({database:this.dbName,toggle:t,readonly:this.readonly}),Promise.resolve()}catch(r){return Promise.reject(r)}}async getUrl(){try{let t=await this.sqlite.getUrl({database:this.dbName,readonly:this.readonly});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async getVersion(){try{let t=await this.sqlite.getVersion({database:this.dbName,readonly:this.readonly});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async getTableList(){try{let t=await this.sqlite.getTableList({database:this.dbName,readonly:this.readonly});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async execute(t,r=!0,a=!0){try{if(this.readonly)return Promise.reject("not allowed in read-only mode");{let i=await this.sqlite.execute({database:this.dbName,statements:t,transaction:r,readonly:!1,isSQL92:a});return Promise.resolve(i)}}catch(i){return Promise.reject(i)}}async query(t,r,a=!0){let i;try{return r&&r.length>0?i=await this.sqlite.query({database:this.dbName,statement:t,values:r,readonly:this.readonly,isSQL92:!0}):i=await this.sqlite.query({database:this.dbName,statement:t,values:[],readonly:this.readonly,isSQL92:a}),i=await this.reorderRows(i),Promise.resolve(i)}catch(o){return Promise.reject(o)}}async run(t,r,a=!0,i="no",o=!0){let y;try{return this.readonly?Promise.reject("not allowed in read-only mode"):(r&&r.length>0?y=await this.sqlite.run({database:this.dbName,statement:t,values:r,transaction:a,readonly:!1,returnMode:i,isSQL92:!0}):y=await this.sqlite.run({database:this.dbName,statement:t,values:[],transaction:a,readonly:!1,returnMode:i,isSQL92:o}),y.changes=await this.reorderRows(y.changes),Promise.resolve(y))}catch(f){return Promise.reject(f)}}async executeSet(t,r=!0,a="no",i=!0){let o;try{return this.readonly?Promise.reject("not allowed in read-only mode"):(o=await this.sqlite.executeSet({database:this.dbName,set:t,transaction:r,readonly:!1,returnMode:a,isSQL92:i}),o.changes=await this.reorderRows(o.changes),Promise.resolve(o))}catch(y){return Promise.reject(y)}}async isExists(){try{let t=await this.sqlite.isDBExists({database:this.dbName,readonly:this.readonly});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async isTable(t){try{let r=await this.sqlite.isTableExists({database:this.dbName,table:t,readonly:this.readonly});return Promise.resolve(r)}catch(r){return Promise.reject(r)}}async isDBOpen(){try{let t=await this.sqlite.isDBOpen({database:this.dbName,readonly:this.readonly});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async delete(){try{return this.readonly?Promise.reject("not allowed in read-only mode"):(await this.sqlite.deleteDatabase({database:this.dbName,readonly:!1}),Promise.resolve())}catch(t){return Promise.reject(t)}}async createSyncTable(){try{if(this.readonly)return Promise.reject("not allowed in read-only mode");{let t=await this.sqlite.createSyncTable({database:this.dbName,readonly:!1});return Promise.resolve(t)}}catch(t){return Promise.reject(t)}}async setSyncDate(t){try{return this.readonly?Promise.reject("not allowed in read-only mode"):(await this.sqlite.setSyncDate({database:this.dbName,syncdate:t,readonly:!1}),Promise.resolve())}catch(r){return Promise.reject(r)}}async getSyncDate(){try{let t=await this.sqlite.getSyncDate({database:this.dbName,readonly:this.readonly}),r="";return t.syncDate>0&&(r=new Date(t.syncDate*1e3).toISOString()),Promise.resolve(r)}catch(t){return Promise.reject(t)}}async exportToJson(t,r=!1){try{let a=await this.sqlite.exportToJson({database:this.dbName,jsonexportmode:t,readonly:this.readonly,encrypted:r});return Promise.resolve(a)}catch(a){return Promise.reject(a)}}async deleteExportedRows(){try{return this.readonly?Promise.reject("not allowed in read-only mode"):(await this.sqlite.deleteExportedRows({database:this.dbName,readonly:!1}),Promise.resolve())}catch(t){return Promise.reject(t)}}async executeTransaction(t,r=!0){let a=0,i=!1;if(this.readonly)return Promise.reject("not allowed in read-only mode");if(await this.sqlite.beginTransaction({database:this.dbName}),i=await this.sqlite.isTransactionActive({database:this.dbName}),!i)return Promise.reject("After Begin Transaction, no transaction active");try{for(let f of t){if(typeof f!="object"||!("statement"in f))throw new Error("Error a task.statement must be provided");if("values"in f&&f.values&&f.values.length>0){let S=f.statement.toUpperCase().includes("RETURNING")?"all":"no",C=await this.sqlite.run({database:this.dbName,statement:f.statement,values:f.values,transaction:!1,readonly:!1,returnMode:S,isSQL92:r});if(C.changes.changes<0)throw new Error("Error in transaction method run ");a+=C.changes.changes}else{let S=await this.sqlite.execute({database:this.dbName,statements:f.statement,transaction:!1,readonly:!1});if(S.changes.changes<0)throw new Error("Error in transaction method execute ");a+=S.changes.changes}}let o=await this.sqlite.commitTransaction({database:this.dbName});a+=o.changes.changes;let y={changes:{changes:a}};return Promise.resolve(y)}catch(o){let y=o.message?o.message:o;return await this.sqlite.rollbackTransaction({database:this.dbName}),Promise.reject(y)}}async reorderRows(t){let r=t;if(t!=null&&t.values&&typeof t.values[0]=="object"&&Object.keys(t.values[0]).includes("ios_columns")){let a=t.values[0].ios_columns,i=[];for(let o=1;o<t.values.length;o++){let y=t.values[o],f={};for(let S of a)f[S]=y[S];i.push(f)}r.values=i}return Promise.resolve(r)}}});var ft={};xe(ft,{CapacitorSQLiteWeb:()=>Ne});var Ne,bt=ee(()=>{He();Ne=class extends pe{constructor(){super(...arguments),this.jeepSqliteElement=null,this.isWebStoreOpen=!1}async initWebStore(){await customElements.whenDefined("jeep-sqlite"),this.jeepSqliteElement=document.querySelector("jeep-sqlite"),this.ensureJeepSqliteIsAvailable(),this.jeepSqliteElement.addEventListener("jeepSqliteImportProgress",t=>{this.notifyListeners("sqliteImportProgressEvent",t.detail)}),this.jeepSqliteElement.addEventListener("jeepSqliteExportProgress",t=>{this.notifyListeners("sqliteExportProgressEvent",t.detail)}),this.jeepSqliteElement.addEventListener("jeepSqliteHTTPRequestEnded",t=>{this.notifyListeners("sqliteHTTPRequestEndedEvent",t.detail)}),this.jeepSqliteElement.addEventListener("jeepSqlitePickDatabaseEnded",t=>{this.notifyListeners("sqlitePickDatabaseEndedEvent",t.detail)}),this.jeepSqliteElement.addEventListener("jeepSqliteSaveDatabaseToDisk",t=>{this.notifyListeners("sqliteSaveDatabaseToDiskEvent",t.detail)}),this.isWebStoreOpen||(this.isWebStoreOpen=await this.jeepSqliteElement.isStoreOpen())}async saveToStore(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.saveToStore(t);return}catch(r){throw new Error(`${r}`)}}async getFromLocalDiskToStore(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.getFromLocalDiskToStore(t);return}catch(r){throw new Error(`${r}`)}}async saveToLocalDisk(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.saveToLocalDisk(t);return}catch(r){throw new Error(`${r}`)}}async echo(t){return this.ensureJeepSqliteIsAvailable(),await this.jeepSqliteElement.echo(t)}async createConnection(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.createConnection(t);return}catch(r){throw new Error(`${r}`)}}async open(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.open(t);return}catch(r){throw new Error(`${r}`)}}async closeConnection(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.closeConnection(t);return}catch(r){throw new Error(`${r}`)}}async getVersion(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.getVersion(t)}catch(r){throw new Error(`${r}`)}}async checkConnectionsConsistency(t){this.ensureJeepSqliteIsAvailable();try{return await this.jeepSqliteElement.checkConnectionsConsistency(t)}catch(r){throw new Error(`${r}`)}}async close(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.close(t);return}catch(r){throw new Error(`${r}`)}}async beginTransaction(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.beginTransaction(t)}catch(r){throw new Error(`${r}`)}}async commitTransaction(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.commitTransaction(t)}catch(r){throw new Error(`${r}`)}}async rollbackTransaction(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.rollbackTransaction(t)}catch(r){throw new Error(`${r}`)}}async isTransactionActive(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.isTransactionActive(t)}catch(r){throw new Error(`${r}`)}}async getTableList(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.getTableList(t)}catch(r){throw new Error(`${r}`)}}async execute(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.execute(t)}catch(r){throw new Error(`${r}`)}}async executeSet(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.executeSet(t)}catch(r){throw new Error(`${r}`)}}async run(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.run(t)}catch(r){throw new Error(`${r}`)}}async query(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.query(t)}catch(r){throw new Error(`${r}`)}}async isDBExists(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.isDBExists(t)}catch(r){throw new Error(`${r}`)}}async isDBOpen(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.isDBOpen(t)}catch(r){throw new Error(`${r}`)}}async isDatabase(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.isDatabase(t)}catch(r){throw new Error(`${r}`)}}async isTableExists(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.isTableExists(t)}catch(r){throw new Error(`${r}`)}}async deleteDatabase(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.deleteDatabase(t);return}catch(r){throw new Error(`${r}`)}}async isJsonValid(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.isJsonValid(t)}catch(r){throw new Error(`${r}`)}}async importFromJson(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.importFromJson(t)}catch(r){throw new Error(`${r}`)}}async exportToJson(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.exportToJson(t)}catch(r){throw new Error(`${r}`)}}async createSyncTable(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.createSyncTable(t)}catch(r){throw new Error(`${r}`)}}async setSyncDate(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.setSyncDate(t);return}catch(r){throw new Error(`${r}`)}}async getSyncDate(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.getSyncDate(t)}catch(r){throw new Error(`${r}`)}}async deleteExportedRows(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.deleteExportedRows(t);return}catch(r){throw new Error(`${r}`)}}async addUpgradeStatement(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.addUpgradeStatement(t);return}catch(r){throw new Error(`${r}`)}}async copyFromAssets(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.copyFromAssets(t);return}catch(r){throw new Error(`${r}`)}}async getFromHTTPRequest(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.getFromHTTPRequest(t);return}catch(r){throw new Error(`${r}`)}}async getDatabaseList(){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.getDatabaseList()}catch(t){throw new Error(`${t}`)}}ensureJeepSqliteIsAvailable(){if(this.jeepSqliteElement===null)throw new Error("The jeep-sqlite element is not present in the DOM! Please check the @capacitor-community/sqlite documentation for instructions regarding the web platform.")}ensureWebstoreIsOpen(){if(!this.isWebStoreOpen)throw new Error('WebStore is not open yet. You have to call "initWebStore()" first.')}async getUrl(){throw this.unimplemented("Not implemented on web.")}async getMigratableDbList(t){throw console.log("getMigratableDbList",t),this.unimplemented("Not implemented on web.")}async addSQLiteSuffix(t){throw console.log("addSQLiteSuffix",t),this.unimplemented("Not implemented on web.")}async deleteOldDatabases(t){throw console.log("deleteOldDatabases",t),this.unimplemented("Not implemented on web.")}async moveDatabasesAndAddSuffix(t){throw console.log("moveDatabasesAndAddSuffix",t),this.unimplemented("Not implemented on web.")}async isSecretStored(){throw this.unimplemented("Not implemented on web.")}async setEncryptionSecret(t){throw console.log("setEncryptionSecret",t),this.unimplemented("Not implemented on web.")}async changeEncryptionSecret(t){throw console.log("changeEncryptionSecret",t),this.unimplemented("Not implemented on web.")}async clearEncryptionSecret(){throw console.log("clearEncryptionSecret"),this.unimplemented("Not implemented on web.")}async checkEncryptionSecret(t){throw console.log("checkEncryptionPassPhrase",t),this.unimplemented("Not implemented on web.")}async getNCDatabasePath(t){throw console.log("getNCDatabasePath",t),this.unimplemented("Not implemented on web.")}async createNCConnection(t){throw console.log("createNCConnection",t),this.unimplemented("Not implemented on web.")}async closeNCConnection(t){throw console.log("closeNCConnection",t),this.unimplemented("Not implemented on web.")}async isNCDatabase(t){throw console.log("isNCDatabase",t),this.unimplemented("Not implemented on web.")}async isDatabaseEncrypted(t){throw console.log("isDatabaseEncrypted",t),this.unimplemented("Not implemented on web.")}async isInConfigEncryption(){throw this.unimplemented("Not implemented on web.")}async isInConfigBiometricAuth(){throw this.unimplemented("Not implemented on web.")}async loadExtension(t){throw console.log("loadExtension",t),this.unimplemented("Not implemented on web.")}async enableLoadExtension(t){throw console.log("enableLoadExtension",t),this.unimplemented("Not implemented on web.")}}});var vt,wt=ee(()=>{He();yt();vt=Se("CapacitorSQLite",{web:()=>Promise.resolve().then(()=>(bt(),ft)).then(n=>new n.CapacitorSQLiteWeb),electron:()=>window.CapacitorCustomPlatform.plugins.CapacitorSQLite})});var Et={};xe(Et,{getCardById:()=>Qt,getCardIds:()=>_t,getCardsByIds:()=>Yt,getDaten:()=>Ut,getEnergieById:()=>lr,getEnergieCardIds:()=>sr,getEnergies:()=>ir,getEngName:()=>Jt,getName:()=>Vt,getTrainerById:()=>nr,getTrainerCardIds:()=>ar,getTrainers:()=>tr,initDatabase:()=>Gt,insertCard:()=>Zt,insertEnergie:()=>or,insertTrainer:()=>rr,updateCardIds:()=>Xt,updatePrice:()=>er});async function Gt(){return R=await zt.createConnection("pokepicker",!1,"no-encryption",1),await R.open(),await R.execute(`
  ...
  `),(await R.query("SELECT COUNT(*) as count FROM pokemon")).values[0].count===0&&await R.execute(`
      ...
      `),R}async function Ut(){return await R.query("SELECT * FROM pokemon")}async function Vt(n){return(await R.query("SELECT name FROM pokemon WHERE dex = ?",[n])).values[0].name}async function Jt(n){return(await R.query("SELECT engName FROM pokemon WHERE dex = ?",[n])).values[0].engName}async function _t(n){return(await R.query("SELECT cardIds FROM pokemon WHERE dex = ?",[n])).values[0].cardIds}async function Xt(n,t){await R.run("UPDATE pokemon SET cardIds = ? WHERE dex = ?",[t,n])}async function Zt(n){var t,r,a,i,o;try{let y=typeof n.imageSmall=="string"?n.imageSmall:null,f=typeof n.imageLarge=="string"?n.imageLarge:null;return((o=(await R.run(`INSERT INTO cards (cardId, cardName, rarity, setName, imageLow, imageHigh, subTypes, addedAt, avg30)
       VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)`,[n.id,n.name,n.rarity||"",((t=n.set)==null?void 0:t.name)||"",y,f,Array.isArray(n.subtypes)?n.subtypes.join(", "):"",new Date().toISOString(),(i=(a=(r=n.cardmarket)==null?void 0:r.prices)==null?void 0:a.avg30)!=null?i:null])).changes)==null?void 0:o.lastId)||null}catch(y){return console.error("Fehler in insertCard():",y.message||y,(n==null?void 0:n.id)||"unbekannte Karte"),null}}async function Qt(n){var r;return((r=(await R.query("SELECT * FROM cards WHERE id = ?",[n])).values)==null?void 0:r[0])||null}async function Yt(n){let t=n.map(()=>"?").join(",");return(await R.query(`SELECT * FROM cards WHERE id IN (${t})`,n)).values}async function er(n,t){try{await R.run("UPDATE cards SET avg30 = ? WHERE cardId = ?",[t,n])}catch(r){console.error(`Fehler beim Speichern von avg30 f\xFCr ${n}:`,r.message)}}async function tr(){return(await R.query("SELECT * FROM trainer")).values}async function rr(n){var t,r,a,i,o;try{let y=typeof n.imageSmall=="string"?n.imageSmall:null,f=typeof n.imageLarge=="string"?n.imageLarge:null;return((o=(await R.run(`INSERT INTO trainer (cardId, cardName, rarity, setName, imageLow, imageHigh, subTypes, addedAt, avg30)
       VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)`,[n.id,n.name,n.rarity||"",((t=n.set)==null?void 0:t.name)||"",y,f,Array.isArray(n.subtypes)?n.subtypes.join(", "):"",new Date().toISOString(),(i=(a=(r=n.cardmarket)==null?void 0:r.prices)==null?void 0:a.avg30)!=null?i:null])).changes)==null?void 0:o.lastId)||null}catch(y){return console.error("Fehler in insertTrainer():",y.message||y,(n==null?void 0:n.id)||"unbekannte Karte"),null}}async function nr(n){var r;return((r=(await R.query("SELECT * FROM trainer WHERE id = ?",[n])).values)==null?void 0:r[0])||null}async function ar(){return(await R.query("SELECT id FROM trainer")).values.map(t=>t.id)}async function ir(){return(await R.query("SELECT * FROM energy")).values}async function or(n){var t,r,a,i,o;try{let y=typeof n.imageSmall=="string"?n.imageSmall:null,f=typeof n.imageLarge=="string"?n.imageLarge:null;return((o=(await R.run(`INSERT INTO energy (cardId, cardName, rarity, setName, imageLow, imageHigh, subTypes, addedAt, avg30)
       VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)`,[n.id,n.name,n.rarity||"",((t=n.set)==null?void 0:t.name)||"",y,f,Array.isArray(n.subtypes)?n.subtypes.join(", "):"",new Date().toISOString(),(i=(a=(r=n.cardmarket)==null?void 0:r.prices)==null?void 0:a.avg30)!=null?i:null])).changes)==null?void 0:o.lastId)||null}catch(y){return console.error("Fehler in insertEnergie():",y.message||y,(n==null?void 0:n.id)||"unbekannte Karte"),null}}async function sr(){return(await R.query("SELECT id FROM energy")).values.map(t=>t.id)}async function lr(n){var r;return((r=(await R.query("SELECT * FROM energy WHERE id = ?",[n])).values)==null?void 0:r[0])||null}var zt,R,kt=ee(()=>{wt();zt=new Ce(vt)});Ie();var te=tt("Http",{web:()=>Promise.resolve().then(()=>(Oe(),De)).then(n=>new n.HttpWeb),electron:()=>Promise.resolve().then(()=>(Oe(),De)).then(n=>new n.HttpWeb)});var ie=ht(),N;document.addEventListener("DOMContentLoaded",()=>{(async()=>{let n=document.getElementById("cardLoader");n.innerHTML=`
      <p id="loaderText">Lade Karten\u2026</p>
      <div id="progressBarContainer">
        <div id="progressBar"></div>
      </div>
      <div id="progressText">0%</div>
    `,n.classList.remove("hidden"),n.classList.add("shown");let{initDatabase:t,getDaten:r,getName:a,getEngName:i,getCardIds:o,updateCardIds:y,insertCard:f,getCardById:S,getCardsByIds:C,updatePrice:U,getTrainers:P,insertTrainer:I,getTrainerCardIds:V,getTrainerById:G,getEnergies:Y,insertEnergie:J,getEnergieCardIds:ce,getEnergieById:de}=await Promise.resolve().then(()=>(kt(),Et));N=await t();let re=await r(),ne=document.querySelector("#kartentabelle tbody");window.cachedCards={},window.cachedPokemonCardsByName={},window.cachedTrainerCardsByType={},window.cachedEnergyCardsByType={};let oe=0,ge=re.values.length;for(let s of re.values){let d=document.createElement("tr"),u=parseInt(s.dex),m=`
      ...
      `;d.innerHTML=m,ne.appendChild(d),await j(s.dex),oe++;let l=Math.min(99,Math.round(oe/ge*100)),p=document.getElementById("progressBar"),h=document.getElementById("progressText");p&&(p.style.width=l+"%"),h&&(h.textContent=l+"%")}progressBar.style.width="100%",progressText.textContent="100%";let A=n.offsetHeight,E=document.createElement("div");E.style.height=A+"px",E.style.backgroundColor="#333",E.style.borderRadius="8px",E.style.display="flex",E.style.alignItems="center",E.style.justifyContent="center",E.style.color="#DEDEDE",E.style.fontFamily='"Saira", sans-serif',E.style.marginBottom="20px",E.style.marginTop="20px",E.style.gap="10px",E.innerHTML=`
      <p id="loaderText">Lade Karten\u2026</p>
    ...
    `,n.replaceWith(E),setTimeout(()=>{E.style.transition="height 0.5s ease, opacity 0.5s ease",E.style.height="0px",E.style.opacity="0",E.style.overflow="hidden"},100),setTimeout(()=>{E.remove()},700),B(),M(),_(),document.querySelectorAll("#tableToggle button").forEach(s=>s.classList.remove("active")),document.getElementById("showTablePokemon").classList.add("active");function B(){let s=document.querySelectorAll("#kartentabelle tbody tr"),d=0;s.forEach(u=>{u.style.display!=="none"&&d++}),document.getElementById("eintragsAnzahl").textContent=`(${d})`}function M(){let s=0;document.querySelectorAll("#kartentabelle tbody tr").forEach(h=>{if(h.style.display==="none")return;let b=h.querySelectorAll("div[id^='kartenContainer_'] img");s+=b.length});let d=document.getElementById("kartenAnzahl");d&&(d.textContent=`(${s})`);let u=0;document.querySelectorAll("#trainertabelle tbody tr").forEach(h=>{if(h.style.display==="none")return;let b=h.querySelectorAll("div[id$='Container'] img");u+=b.length});let m=document.getElementById("kartenAnzahlTrainer");m&&(m.textContent=`(${u})`);let l=0;document.querySelectorAll("#energietabelle tbody tr").forEach(h=>{if(h.style.display==="none")return;let b=h.querySelectorAll("div[id$='Container'] img");l+=b.length});let p=document.getElementById("kartenAnzahlEnergie");p&&(p.textContent=`(${l})`)}async function j(s){let d=document.getElementById(`kartenContainer_${s}`),u=await o(s);if(!u)return;let m=u.split(";").filter(h=>h.trim()),l=await C(m.map(h=>parseInt(h)));l.sort((h,b)=>(b.avg30||0)-(h.avg30||0));let p=document.createDocumentFragment();for(let h of l){window.cachedCards[h.cardId]=h;let b=document.createElement("img");b.alt=h.cardId,b.style.width="50px",b.style.height="69px",b.style.objectFit="cover",b.src=h.imageLow,b.addEventListener("click",()=>K(s,m.indexOf(String(h.id)))),p.appendChild(b)}d.appendChild(p)}async function K(s,d){let u=document.querySelector("#overlay");u.innerHTML='<div id="overlayContent"><div class="loader"></div></div>',u.classList.remove("hidden"),u.classList.add("shown");let m=await o(s);if(!m)return;let l=m.split(";").filter(b=>b.trim()!=="");if(l.length===0){L();return}let p=d;async function h(){let b=l[p];try{let w=await S(b),g="Unbekannt";if(w.addedAt){let T=new Date(w.addedAt),q={day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"};g=T.toLocaleString("de-DE",q)}let c="Keine Angabe";w.basic==1&&(c="Basic"),w.reverse==1&&(c="Reverse"),w.holo==1&&(c="Holo");let v=await D(w.cardId);if(v==null){let T=$(w.cardId);v=await D(T)}let k="\u2013";if(v!=null){let T=v.toFixed(2),q="#DEDEDE",F="\u{1FA99}";v>20?(q="#FF4444",F="\u{1F525}"):v>5&&(q="#FFAA00",F="\u{1F4B0}"),k=`<span style="color:${q};">${F} ${T}\u20AC</span>`}u.innerHTML=`
            <div id="overlayContent">
            <button class="closeGallery" id="closeGallery">X</button>
              <h2>Pok\xE9mon</h2>
              <div style="display:flex; align-items:center; justify-content:center;">
                <div style="display:flex; flex-direction:column; align-items:center;">
                  <img src="${w.imageHigh}" alt="${b}" style="max-width:300px; max-height:400px; margin:0 20px;">
          ...
          `,document.getElementById("deleteCard").addEventListener("click",async()=>{if(confirm("Willst du diese Karte wirklich l\xF6schen?")){let T=l[p];await N.run("DELETE FROM cards WHERE id = ?",[T]),l.splice(p,1),await y(s,l.join(";")+";"),L();let q=document.getElementById(`kartenContainer_${s}`);q.innerHTML="",j(s),M(),_()}}),document.getElementById("closeGallery").addEventListener("click",()=>{let T=document.getElementById("overlay");T.classList.add("fade-out"),setTimeout(()=>{T.classList.remove("shown","fade-out"),T.classList.add("hidden"),T.innerHTML=""},300)})}catch(w){console.error("Fehler beim Anzeigen der Karte:",w),L()}}h()}window.openOverlay=async function(s){let d=document.querySelector("#overlay");d.innerHTML=`
        <div id="overlayContent">
          <h2>Bitte warten...</h2>
          <p>Karten werden geladen</p>
          <div class="loader"></div>
        </div>
      `,d.classList.remove("hidden"),d.classList.add("shown");try{let u=await a(s),m=await i(s);m=="Nidoran\u2642"&&(m="Nidoran \u2642"),m=="Nidoran\u2640"&&(m="Nidoran \u2640"),m=="Sirfetch\u2019d"&&(m="Sirfetch'd");let l=window.cachedPokemonCardsByName[m];if(l||(l=await ae(m),l&&(window.cachedPokemonCardsByName[m]=l)),!l||l.length===0){d.innerHTML=`
            <div id='overlayContent'>
        ...
        `;for(let h of l){let b=h.avg30,w="\u2013";if(b!=null){let g=b.toFixed(2),c="#DEDEDE",v="\u{1FA99}";b>20?(c="#FF4444",v="\u{1F525}"):b>5&&(c="#FFAA00",v="\u{1F4B0}"),w=`<span style="color:${c}; font-size:14px;">${v} ${g}\u20AC</span>`}p+=`
            <div class="kartenItem" onclick="karteAusw\xE4hlen('${h.id}', '${s}', '${u}')">
              <div>ID: ${h.id}</div>
        ...
        `,d.innerHTML=p,document.getElementById("BackBtn").addEventListener("click",h=>{h.preventDefault(),L()})}catch(u){console.error(u),d.innerHTML=`
        <div id='overlayContent'>
          <h2>Fehler beim Laden.</h2>
          <button class="overlayMenuBtn" id="BackBtn">Schlie\xDFen</button>
        </div>`,document.getElementById("BackBtn").addEventListener("click",m=>{m.preventDefault(),L()})}};function $(s){return s.replace(/-(0*)(\d+)/,(d,u,m)=>"-"+parseInt(m,10))}async function ae(s){var d,u;try{let m=`https://api.pokemontcg.io/v2/cards?q=name:"${s}"&orderBy=-set.releaseDate`,l=await te.get({url:m,headers:{Accept:"application/json","X-Api-Key":ie.API_KEY,Connection:"close"}});if(l.status!==200)return console.error("Fehler beim Abrufen der Karten:",l.status,l),null;let p=l.data.data;for(let h of p){let b=(d=h.cardmarket)==null?void 0:d.prices;h.avg30=(u=b==null?void 0:b.avg30)!=null?u:null}return p}catch(m){return console.error("Fehler beim Abrufen \xFCber HTTP:",m.message),null}}async function D(s){var d,u,m,l,p;try{let h=`https://api.pokemontcg.io/v2/cards?q=id:${s}`,b=await te.get({url:h,headers:{Accept:"application/json","X-Api-Key":ie.API_KEY,Connection:"close"}});if(b.status!==200||!((u=(d=b.data)==null?void 0:d.data)!=null&&u.length))return console.error("Fehler beim Abrufen der Karte:",b.status,b),null;let w=(l=(m=b.data.data[0])==null?void 0:m.cardmarket)==null?void 0:l.prices;return(p=w==null?void 0:w.avg30)!=null?p:null}catch(h){return console.error("Fehler beim Preisabruf:",h.message),null}}window.karteAusw\u00E4hlen=async function(s,d,u){var w,g;let m=document.querySelector("#overlay");m.innerHTML='<div id="overlayContent"><div class="loader"></div></div>',m.classList.remove("hidden"),m.classList.add("shown");let l=await te.get({url:`https://api.pokemontcg.io/v2/cards/${s}`,headers:{Accept:"application/json","X-Api-Key":ie.API_KEY,Connection:"close"}});if(l.status!==200){console.error("Fehler beim Abrufen der Karte:",l.status,l);return}let p=l.data.data;p.imageSmall=((w=p.images)==null?void 0:w.small)||null,p.imageLarge=((g=p.images)==null?void 0:g.large)||null;let h=await f(p);if(!h){console.error("Keine ID von insertCard erhalten \u2013 Abbruch.");return}p.id=h,window.cachedCards[p.cardId]=p,m.innerHTML=`
        <div id="overlayContent">
      ...
      `;async function b(c){m.innerHTML='<div id="overlayContent"><div class="loader"></div></div>',m.classList.remove("hidden"),m.classList.add("shown"),c!=="none"&&await N.run(`UPDATE cards SET ${c} = 1 WHERE id = ?`,[h]);let v=await o(d);v||(v=""),v+=h+";",await y(d,v);let k=document.getElementById(`kartenContainer_${d}`);k.innerHTML="",await j(d),L(),B(),M(),_()}document.getElementById("btnBasic").addEventListener("click",()=>b("basic")),document.getElementById("btnReverse").addEventListener("click",()=>b("reverse")),document.getElementById("btnHolo").addEventListener("click",()=>b("holo")),document.getElementById("closeOverlayConfirm").addEventListener("click",()=>b("none"))};async function _(){try{let s=await N.query("SELECT avg30 FROM cards WHERE avg30 IS NOT NULL"),d=await N.query("SELECT avg30 FROM trainer WHERE avg30 IS NOT NULL"),u=await N.query("SELECT avg30 FROM energy WHERE avg30 IS NOT NULL"),m=0;for(let c of s.values)m+=c.avg30;for(let c of d.values)m+=c.avg30;for(let c of u.values)m+=c.avg30;let l="\u{1FA99}";m>1e3?l="\u{1F525}":m>500&&(l="\u{1F4B0}"),document.getElementById("gesamtwert").textContent=`\u03A3: ${m.toFixed(2)}\u20AC ${l} | `;let p=await N.query("SELECT COUNT(*) as count FROM cards"),h=await N.query("SELECT COUNT(*) as count FROM trainer"),b=await N.query("SELECT COUNT(*) as count FROM energy"),w=p.values[0].count+h.values[0].count+b.values[0].count,g=document.getElementById("gesamtanzahl");g&&(g.textContent=`${w} Karten`)}catch(s){console.error("Fehler beim Berechnen des Gesamtwerts:",s)}}async function ve(){let s=await N.query("SELECT cardId FROM cards"),d=await N.query("SELECT cardId FROM trainer"),u=await N.query("SELECT cardId FROM energy"),m=0,l=0,p=s.values.length+d.values.length+u.values.length;alert(`Aktualisierung von ${p} Preisen gestartet.`);for(let b of s.values){let w=b.cardId,g=await D(w);if(g==null){let k=$(w);g=await D(k)}g!=null&&(await U(w,g),m++),l++;let c=Math.round(l/p*100),v=document.getElementById("preiseAktualisierenProgress");v&&(v.textContent=c+"%")}for(let b of d.values){let w=b.cardId,g=await D(w);if(g==null){let k=$(w);g=await D(k)}g!=null&&(await N.run("UPDATE trainer SET avg30 = ? WHERE cardId = ?",[g,w]),m++),l++;let c=Math.round(l/p*100),v=document.getElementById("preiseAktualisierenProgress");v&&(v.textContent=c+"%")}for(let b of u.values){let w=b.cardId,g=await D(w);if(g==null){let k=$(w);g=await D(k)}g!=null&&(await N.run("UPDATE energy SET avg30 = ? WHERE cardId = ?",[g,w]),m++),l++;let c=Math.round(l/p*100),v=document.getElementById("preiseAktualisierenProgress");v&&(v.textContent=c+"%")}let h=document.getElementById("preiseAktualisierenProgress");h&&(h.textContent=""),alert(`${m} Preise wurden aktualisiert!`),_()}window.aktualisiereAllePreise=ve;function Le(){let d=document.getElementById("search").value.toUpperCase(),m=document.getElementById("kartentabelle").getElementsByTagName("tr");for(let l=1;l<m.length;l++){m[l].style.display="none";let p=m[l].getElementsByTagName("td");for(let h=0;h<p.length;h++){let b=p[h];if(b&&b.innerHTML.toUpperCase().indexOf(d)>-1){m[l].style.display="";break}}}B(),M(),_()}window.searchTable=Le;let x={reverse:"neutral",holo:"neutral",v:"neutral",vmax:"neutral",ex:"neutral",shiny:"neutral"};function H(){let s=["kartentabelle","trainertabelle","energietabelle"],d=Object.values(x).some(u=>u==="positive");s.forEach(u=>{document.querySelectorAll(`#${u} tbody tr`).forEach(l=>{let p=l.querySelector("div[id*='Container']");if(!p)return;let h=p.querySelectorAll("img"),b=0;h.forEach(w=>{var F,W,Z,ye,We,ze,Ge,Ue,Ve,Je,_e,Xe,Ze,Qe,Ye;let g=w.alt,c=(F=window.cachedCards)==null?void 0:F[g];if(!c){w.style.display="none";return}let v=!0;x.reverse==="positive"&&c.reverse!==1&&(v=!1),x.reverse==="negative"&&c.reverse===1&&(v=!1),x.holo==="positive"&&c.holo!==1&&(v=!1),x.holo==="negative"&&c.holo===1&&(v=!1),x.v==="positive"&&!((W=c.subTypes)!=null&&W.toLowerCase().includes("v")||(Z=c.cardName)!=null&&Z.toLowerCase().includes(" v"))&&(v=!1),x.v==="negative"&&((ye=c.subTypes)!=null&&ye.toLowerCase().includes("v")||(We=c.cardName)!=null&&We.toLowerCase().includes(" v"))&&(v=!1);let k=((ze=c.subTypes)==null?void 0:ze.toLowerCase().includes("vmax"))||((Ge=c.cardName)==null?void 0:Ge.toLowerCase().includes(" vmax")),T=((Ue=c.subTypes)==null?void 0:Ue.toLowerCase().includes("vstar"))||((Ve=c.cardName)==null?void 0:Ve.toLowerCase().includes(" vstar"));x.vmax==="positive"&&!(k||T)&&(v=!1),x.vmax==="negative"&&(k||T)&&(v=!1),x.ex==="positive"&&!((Je=c.subTypes)!=null&&Je.toLowerCase().includes("ex")||(_e=c.cardName)!=null&&_e.toLowerCase().includes(" ex"))&&(v=!1),x.ex==="negative"&&((Xe=c.subTypes)!=null&&Xe.toLowerCase().includes("ex")||(Ze=c.cardName)!=null&&Ze.toLowerCase().includes(" ex"))&&(v=!1);let q=((Qe=c.subTypes)==null?void 0:Qe.toLowerCase().includes("radiant"))||((Ye=c.rarity)==null?void 0:Ye.toLowerCase().includes("shiny"));x.shiny==="positive"&&!q&&(v=!1),x.shiny==="negative"&&q&&(v=!1),w.style.display=v?"inline-block":"none",v&&b++}),h.length===0?l.style.display=d?"none":"":l.style.display=b>0?"":"none"})}),B(),M(),_()}function O(s){x[s]==="neutral"?x[s]="positive":x[s]==="positive"?x[s]="negative":x[s]="neutral",H(),X()}function X(){let s=["reverse","holo","v","vmax","ex","shiny"];for(let d of s){let u=document.getElementById(`filter-${d}`);u&&(u.classList.remove("active-positive","active-negative"),x[d]==="positive"?u.classList.add("active-positive"):x[d]==="negative"&&u.classList.add("active-negative"))}}document.getElementById("filter-alle").addEventListener("click",s=>{s.preventDefault(),x.reverse="neutral",x.holo="neutral",x.v="neutral",x.vmax="neutral",x.ex="neutral",x.shiny="neutral",H(),X()}),document.getElementById("filter-reverse").addEventListener("click",s=>{s.preventDefault(),O("reverse")}),document.getElementById("filter-holo").addEventListener("click",s=>{s.preventDefault(),O("holo")}),document.getElementById("filter-v").addEventListener("click",s=>{s.preventDefault(),O("v")}),document.getElementById("filter-vmax").addEventListener("click",s=>{s.preventDefault(),O("vmax")}),document.getElementById("filter-ex").addEventListener("click",s=>{s.preventDefault(),O("ex")}),document.getElementById("filter-shiny").addEventListener("click",s=>{s.preventDefault(),O("shiny")});function L(){let s=document.getElementById("overlay");s.classList.add("fade-out"),setTimeout(()=>{s.classList.remove("shown","fade-out"),s.classList.add("hidden"),s.innerHTML=""},300)}function Q(s){["kartentabelle","trainertabelle","energietabelle"].forEach(u=>{let m=document.getElementById(u);m&&(u===s?m.classList.remove("hidden"):m.classList.add("hidden"))})}window.zeigePokemonTabelle=function(){document.querySelectorAll("#tableToggle button").forEach(s=>s.classList.remove("active")),document.getElementById("showTablePokemon").classList.add("active"),Q("kartentabelle")},window.zeigeTrainerTabelle=async function(){document.querySelectorAll("#tableToggle button").forEach(p=>p.classList.remove("active")),document.getElementById("showTableTrainer").classList.add("active"),Q("trainertabelle");let s=document.querySelector("#trainertabelle tbody");s.innerHTML="";let d=document.createElement("tr");d.innerHTML=`
      ...
      `,s.appendChild(d);let u=document.createElement("tr");u.innerHTML=`
        <td>Item</td>
        <td>
      ...
      `,s.appendChild(u);let m=document.createElement("tr");m.innerHTML=`
        <td>Stadion</td>
        <td>
      ...
      `,s.appendChild(l),await z(),M()};async function z(){let s=document.getElementById("supporterContainer"),d=document.getElementById("itemContainer"),u=document.getElementById("stadiumContainer"),m=document.getElementById("toolContainer"),l=await P();if(!l||!Array.isArray(l)){console.error("getTrainers() lieferte keine g\xFCltige Liste:",l);return}l.sort((g,c)=>(c.avg30||0)-(g.avg30||0));let p=document.createDocumentFragment(),h=document.createDocumentFragment(),b=document.createDocumentFragment(),w=document.createDocumentFragment();for(let g of l){window.cachedCards[g.cardId]=g;let c=document.createElement("img");c.src=g.imageLow,c.alt=g.cardId,c.style.width="50px",c.style.height="69px",c.style.objectFit="cover";let v="";if(Array.isArray(g.subTypes))g.subTypes.some(k=>k.toLowerCase().includes("supporter"))?v="supporter":g.subTypes.some(k=>k.toLowerCase().includes("item"))?v="item":g.subTypes.some(k=>k.toLowerCase().includes("stadium"))?v="stadium":g.subTypes.some(k=>k.toLowerCase().includes("tool"))&&(v="tool");else if(typeof g.subTypes=="string"){let k=g.subTypes.toLowerCase();k.includes("supporter")?v="supporter":k.includes("item")?v="item":k.includes("stadium")?v="stadium":k.includes("tool")&&(v="tool")}c.addEventListener("click",()=>ue(g.id,v)),v=="supporter"&&p.appendChild(c),v=="item"&&h.appendChild(c),v=="stadium"&&b.appendChild(c),v=="tool"&&w.appendChild(c)}s.appendChild(p),d.appendChild(h),u.appendChild(b),m.appendChild(w)}window.openTrainerOverlay=async function(s){let d=document.querySelector("#overlay");d.innerHTML=`
        <div id="overlayContent">
          <h2>Bitte warten...</h2>
          <p>Karten werden geladen</p>
          <div class="loader"></div>
        </div>
      `,d.classList.remove("hidden"),d.classList.add("shown");try{let u=window.cachedTrainerCardsByType[s];if(u||(u=await se(s),u&&(window.cachedTrainerCardsByType[s]=u)),!u||u.length===0){d.innerHTML=`
            <div id='overlayContent'>
              <h2>Keine Karten gefunden.</h2> 
              <button class="overlayMenuBtn" id="BackBtn">Schlie\xDFen</button>
            </div>
          ...
          <div id="overlayContent">
            ...
            <div class="kartenGrid">
        `;for(let l of u){let p=l.avg30,h="\u2013";if(p!=null){let w=p.toFixed(2),g="#DEDEDE",c="\u{1FA99}";p>20?(g="#FF4444",c="\u{1F525}"):p>5&&(g="#FFAA00",c="\u{1F4B0}"),h=`<span style="color:${g}; font-size:14px;">${c} ${w}\u20AC</span>`}let b=l.id.split("-")[1];m+=`
        ...
        `,d.innerHTML=m,document.getElementById("BackBtn").addEventListener("click",()=>{L()})}catch(u){console.error(u),d.innerHTML=`
          <div id='overlayContent'>
            <h2>Fehler beim Laden.</h2>
            <button class="overlayMenuBtn" id="BackBtn">Schlie\xDFen</button>
          </div>`,document.getElementById("BackBtn").addEventListener("click",()=>{L()})}};async function se(s){var p,h,b,w;let d=[],u=1,m=250,l=!0;for(;l;){let g=`https://api.pokemontcg.io/v2/cards?q=supertype:Trainer subtypes:${s}&orderBy=name&page=${u}&pageSize=${m}`,c=await te.get({url:g,headers:{Accept:"application/json","X-Api-Key":ie.API_KEY,Connection:"close"}});if(c.status!==200||!((h=(p=c.data)==null?void 0:p.data)!=null&&h.length)){l=!1;break}let v=c.data.data;for(let k of v){let T=(b=k.cardmarket)==null?void 0:b.prices;k.avg30=(w=T==null?void 0:T.avg30)!=null?w:null}d=d.concat(v),v.length<m?l=!1:u++}return d}window.trainerKarteAusw\u00E4hlen=async function(s){var u,m;let d=document.querySelector("#overlay");d.innerHTML='<div id="overlayContent"><div class="loader"></div></div>',d.classList.remove("hidden"),d.classList.add("shown");try{let l=await te.get({url:`https://api.pokemontcg.io/v2/cards/${s}`,headers:{Accept:"application/json","X-Api-Key":ie.API_KEY,Connection:"close"}});if(l.status!==200){console.error("Fehler beim Abrufen der Karte:",l.status,l);return}let p=l.data.data;p.imageSmall=((u=p.images)==null?void 0:u.small)||null,p.imageLarge=((m=p.images)==null?void 0:m.large)||null;let h=await I(p);if(!h){console.error("Keine ID von insertCard erhalten \u2013 Abbruch.");return}p.id=h,window.cachedCards[p.cardId]=p,d.innerHTML=`
          <div id="overlayContent">
            <h2>Karte hinzugef\xFCgt!</h2>
        ...
        `;async function b(w,g){d.innerHTML='<div id="overlayContent"><div class="loader"></div></div>',d.classList.remove("hidden"),d.classList.add("shown");try{w!=="none"&&await N.run(`UPDATE trainer SET ${w} = 1 WHERE id = ?`,[g]);let c=document.getElementById("supporterContainer");c.innerHTML="";let v=document.getElementById("itemContainer");v.innerHTML="";let k=document.getElementById("stadiumContainer");k.innerHTML="";let T=document.getElementById("toolContainer");T.innerHTML="",await z()}catch(c){console.error("Fehler in finalizeTrainerSelection:",c.message,c)}L(),await _()}document.getElementById("btnBasic").addEventListener("click",()=>b("basic",h)),document.getElementById("btnReverse").addEventListener("click",()=>b("reverse",h)),document.getElementById("btnHolo").addEventListener("click",()=>b("holo",h)),document.getElementById("closeOverlayConfirm").addEventListener("click",()=>b("none",h))}catch(l){console.error("Fehler bei trainerKarteAusw\xE4hlen:",l),d.innerHTML=`
          <div id="overlayContent">
            <h2>Fehler beim Hinzuf\xFCgen.</h2>
            <p>${l.message}</p>
            <button class="overlayMenuBtn" id="closeOverlayConfirm">Schlie\xDFen</button>
          </div>
        `,document.getElementById("closeOverlayConfirm").addEventListener("click",()=>{L()})}};async function ue(s,d){var w;let u=document.querySelector("#overlay");u.innerHTML='<div id="overlayContent"><div class="loader"></div></div>',u.classList.remove("hidden"),u.classList.add("shown");let m=await V();if(!m||!m.length)return;let l=[],p={};for(let g of m){let c=await G(g);if(!c)continue;let v=((w=c.subTypes)==null?void 0:w.toLowerCase())||"";(d==="supporter"&&v.includes("supporter")||d==="item"&&v.includes("item")||d==="stadium"&&v.includes("stadium")||d==="tool"&&v.includes("tool"))&&(l.push(g),p[g]=c)}if(!l.length){L();return}let h=l.findIndex(g=>g===s);h===-1&&(h=0);async function b(){let g=l[h],c=p[g]||await G(g);if(!c)return;let v="Unbekannt";c.addedAt&&(v=new Date(c.addedAt).toLocaleString("de-DE",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"}));let k="Keine Angabe";c.basic==1&&(k="Basic"),c.reverse==1&&(k="Reverse"),c.holo==1&&(k="Holo");let T="\u2013",q=await D(c.cardId);if(q==null){let F=$(c.cardId);q=await D(F)}if(q!=null){let F=q.toFixed(2),W="#DEDEDE",Z="\u{1FA99}";q>20?(W="#FF4444",Z="\u{1F525}"):q>5&&(W="#FFAA00",Z="\u{1F4B0}"),T=`<span style="color:${W};">${Z} ${F}\u20AC</span>`}u.innerHTML=`
          <div id="overlayContent">
            <button class="closeGallery" id="closeGallery">X</button>
            <h2>Trainer</h2>
            <div style="display:flex; align-items:center; justify-content:center;">
              <div style="display:flex; flex-direction:column; align-items:center;">
                <img src="${c.imageHigh}" alt="${g}" style="max-width:300px; max-height:400px; margin:0 20px;">
                <p style="margin-top:10px;">
                  ID: ${c.cardId} | Variante: <strong>${k}</strong><br>
                  30d-Wert: <strong>${T}</strong><br>
        ...
        `,document.getElementById("deleteTrainer").addEventListener("click",async()=>{if(confirm("Willst du diese Karte wirklich l\xF6schen?")){await N.run("DELETE FROM trainer WHERE id = ?",[g]),L();let F=document.getElementById("supporterContainer"),W=document.getElementById("itemContainer"),Z=document.getElementById("stadiumContainer"),ye=document.getElementById("toolContainer");F&&(F.innerHTML=""),W&&(W.innerHTML=""),Z&&(Z.innerHTML=""),ye&&(ye.innerHTML=""),await z(),await _()}}),document.getElementById("closeGallery").addEventListener("click",()=>{L()})}b()}window.filterTrainerCardsByNumber=function(){let s=document.getElementById("nummerSuche").value.trim();document.querySelectorAll(".kartenItem").forEach(d=>{let u=d.dataset.number;d.style.display=u&&u.startsWith(s)?"block":"none"})},window.zeigeEnergieTabelle=async function(){document.querySelectorAll("#tableToggle button").forEach(m=>m.classList.remove("active")),document.getElementById("showTableEnergie").classList.add("active"),Q("energietabelle");let s=document.querySelector("#energietabelle tbody");s.innerHTML="";let d=document.createElement("tr");d.innerHTML=`
        <td>Basis-Energie</td>
        <td>
      ...
      `,s.appendChild(u),await Pe(),M()};async function Pe(){var p,h,b;let s=document.getElementById("basisEnergieContainer"),d=document.getElementById("spezialEnergieContainer"),u=await Y();if(!u||!Array.isArray(u)){console.error("getEnergies() lieferte keine g\xFCltige Liste:",u);return}u.sort((w,g)=>(g.avg30||0)-(w.avg30||0));let m=document.createDocumentFragment(),l=document.createDocumentFragment();for(let w of u){window.cachedCards[w.cardId]=w;let g=document.createElement("img");g.src=w.imageLow,g.alt=w.cardId,g.style.width="50px",g.style.height="69px",g.style.objectFit="cover";let c=((p=w.subTypes)==null?void 0:p.toLowerCase())||"";g.addEventListener("click",()=>Ct(w.id,c.includes("basic")?"basic":"special")),(h=w.subTypes)!=null&&h.toLowerCase().includes("basic")?m.appendChild(g):(b=w.subTypes)!=null&&b.toLowerCase().includes("special")&&l.appendChild(g)}s.appendChild(m),d.appendChild(l)}window.openEnergieOverlay=async function(s){let d=document.querySelector("#overlay");d.innerHTML=`
        <div id="overlayContent">
          <h2>Bitte warten...</h2>
          <p>Karten werden geladen</p>
          <div class="loader"></div>
        </div>
      `,d.classList.remove("hidden"),d.classList.add("shown");try{let u=window.cachedEnergyCardsByType[s];if(u||(u=await St(s),u&&(window.cachedEnergyCardsByType[s]=u)),!u||u.length===0){d.innerHTML=`
            <div id='overlayContent'>
              <h2>Keine Karten gefunden.</h2> 
              <button class="overlayMenuBtn" id="BackBtn">Schlie\xDFen</button>
            </div>
        ...
        `,d.innerHTML=m,document.getElementById("BackBtn").addEventListener("click",()=>{L()})}catch(u){console.error(u),d.innerHTML=`
          <div id='overlayContent'>
            <h2>Fehler beim Laden.</h2>
            <button class="overlayMenuBtn" id="BackBtn">Schlie\xDFen</button>
          </div>`,document.getElementById("BackBtn").addEventListener("click",()=>{L()})}};async function St(s){var p,h,b,w;let d=[],u=1,m=250,l=!0;for(;l;){let g=`https://api.pokemontcg.io/v2/cards?q=supertype:Energy subtypes:${s}&orderBy=name&page=${u}&pageSize=${m}`,c=await te.get({url:g,headers:{Accept:"application/json","X-Api-Key":ie.API_KEY,Connection:"close"}});if(c.status!==200||!((h=(p=c.data)==null?void 0:p.data)!=null&&h.length)){l=!1;break}let v=c.data.data;for(let k of v){let T=(b=k.cardmarket)==null?void 0:b.prices;k.avg30=(w=T==null?void 0:T.avg30)!=null?w:null}d=d.concat(v),v.length<m?l=!1:u++}return d}window.energieKarteAusw\u00E4hlen=async function(s){var u,m;let d=document.querySelector("#overlay");d.innerHTML='<div id="overlayContent"><div class="loader"></div></div>',d.classList.remove("hidden"),d.classList.add("shown");try{let l=await te.get({url:`https://api.pokemontcg.io/v2/cards/${s}`,headers:{Accept:"application/json","X-Api-Key":ie.API_KEY,Connection:"close"}});if(l.status!==200){console.error("Fehler beim Abrufen der Karte:",l.status,l);return}let p=l.data.data;p.imageSmall=((u=p.images)==null?void 0:u.small)||null,p.imageLarge=((m=p.images)==null?void 0:m.large)||null;let h=await J(p);if(!h){console.error("Keine ID von insertCard erhalten \u2013 Abbruch.");return}p.id=h,window.cachedCards[p.cardId]=p,d.innerHTML=`
          <div id="overlayContent">
            <h2>Karte hinzugef\xFCgt!</h2>
            <p>Du hast <strong>${s}</strong> ausgew\xE4hlt.</p>
            <br>
        ...
        `;async function b(w,g){d.innerHTML='<div id="overlayContent"><div class="loader"></div></div>',d.classList.remove("hidden"),d.classList.add("shown");try{w!=="none"&&await N.run(`UPDATE energy SET ${w} = 1 WHERE id = ?`,[g]);let c=document.getElementById("basisEnergieContainer");c.innerHTML="";let v=document.getElementById("spezialEnergieContainer");v.innerHTML="",await Pe()}catch(c){console.error("Fehler in finalizeEnergieSelection:",c.message,c)}L(),await _()}document.getElementById("btnBasic").addEventListener("click",()=>b("basic",h)),document.getElementById("btnReverse").addEventListener("click",()=>b("reverse",h)),document.getElementById("btnHolo").addEventListener("click",()=>b("holo",h)),document.getElementById("closeOverlayConfirm").addEventListener("click",()=>b("none",h))}catch(l){console.error("Fehler bei energieKarteAusw\xE4hlen:",l),d.innerHTML=`
          <div id="overlayContent">
            <h2>Fehler beim Hinzuf\xFCgen.</h2>
            <p>${l.message}</p>
            <button class="overlayMenuBtn" id="closeOverlayConfirm">Schlie\xDFen</button>
          </div>
        `,document.getElementById("closeOverlayConfirm").addEventListener("click",()=>{L()})}};async function Ct(s,d){var w;let u=document.querySelector("#overlay");u.innerHTML='<div id="overlayContent"><div class="loader"></div></div>',u.classList.remove("hidden"),u.classList.add("shown");let m=await ce();if(!m||!m.length)return;let l=[],p={};for(let g of m){let c=await de(g);if(!c)continue;let v=((w=c.subTypes)==null?void 0:w.toLowerCase())||"";(d==="basic"&&v.includes("basic")||d==="special"&&v.includes("special"))&&(l.push(g),p[g]=c)}if(!l.length){L();return}let h=l.findIndex(g=>g===s);h===-1&&(h=0);async function b(){let g=l[h],c=p[g]||await de(g);if(!c)return;let v="Unbekannt";c.addedAt&&(v=new Date(c.addedAt).toLocaleString("de-DE",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"}));let k="Keine Angabe";c.basic==1&&(k="Basic"),c.reverse==1&&(k="Reverse"),c.holo==1&&(k="Holo");let T="\u2013",q=await D(c.cardId);if(q==null){let F=$(c.cardId);q=await D(F)}if(q!=null){let F=q.toFixed(2),W="#DEDEDE",Z="\u{1FA99}";q>20?(W="#FF4444",Z="\u{1F525}"):q>5&&(W="#FFAA00",Z="\u{1F4B0}"),T=`<span style="color:${W};">${Z} ${F}\u20AC</span>`}u.innerHTML=`
          <div id="overlayContent">
            <button class="closeGallery" id="closeGallery">X</button>
            <h2>Energie</h2>
            <div style="display:flex; align-items:center; justify-content:center;">
        ...
        `,document.getElementById("deleteEnergie").addEventListener("click",async()=>{if(confirm("Willst du diese Karte wirklich l\xF6schen?"))try{await N.run("DELETE FROM energy WHERE id = ?",[g]),L();let F=document.getElementById("basisEnergieContainer"),W=document.getElementById("spezialEnergieContainer");F&&(F.innerHTML=""),W&&(W.innerHTML=""),await Pe(),await _()}catch(F){console.error("Fehler beim L\xF6schen der Energie-Karte:",F),alert("Beim L\xF6schen ist ein Fehler aufgetreten.")}}),document.getElementById("closeGallery").addEventListener("click",()=>{L()})}b()}window.filterEnergieCardsByNumber=function(){let s=document.getElementById("nummerSuche").value.trim();document.querySelectorAll(".kartenItem").forEach(d=>{let u=d.dataset.number;d.style.display=u&&u.startsWith(s)?"block":"none"})}})()});})();
