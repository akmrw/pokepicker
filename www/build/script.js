(()=>{var St=Object.defineProperty;var re=(n,t)=>()=>(n&&(t=n(n=0)),t);var Ct=(n,t)=>()=>(t||n((t={exports:{}}).exports,t),t.exports),Ie=(n,t)=>{for(var r in t)St(n,r,{get:t[r],enumerable:!0})};var Tt,Lt,Ye,lr,cr,he,ve,Pt,It,xt,ke,et,dr,Se,xe=re(()=>{Tt=n=>{let t=new Map;t.set("web",{name:"web"});let r=n.CapacitorPlatforms||{currentPlatform:{name:"web"},platforms:t},a=(s,f)=>{r.platforms.set(s,f)},i=s=>{r.platforms.has(s)&&(r.currentPlatform=r.platforms.get(s))};return r.addPlatform=a,r.setPlatform=i,r},Lt=n=>n.CapacitorPlatforms=Tt(n),Ye=Lt(typeof globalThis!="undefined"?globalThis:typeof self!="undefined"?self:typeof window!="undefined"?window:typeof global!="undefined"?global:{}),lr=Ye.addPlatform,cr=Ye.setPlatform;(function(n){n.Unimplemented="UNIMPLEMENTED",n.Unavailable="UNAVAILABLE"})(he||(he={}));ve=class extends Error{constructor(t,r){super(t),this.message=t,this.code=r}},Pt=n=>{var t,r;return n!=null&&n.androidBridge?"android":!((r=(t=n==null?void 0:n.webkit)===null||t===void 0?void 0:t.messageHandlers)===null||r===void 0)&&r.bridge?"ios":"web"},It=n=>{var t,r,a,i,s;let f=n.CapacitorCustomPlatform||null,v=n.Capacitor||{},C=v.Plugins=v.Plugins||{},T=n.CapacitorPlatforms,U=()=>f!==null?f.name:Pt(n),P=((t=T==null?void 0:T.currentPlatform)===null||t===void 0?void 0:t.getPlatform)||U,I=()=>P()!=="web",V=((r=T==null?void 0:T.currentPlatform)===null||r===void 0?void 0:r.isNativePlatform)||I,G=x=>{let S=ie.get(x);return!!(S!=null&&S.platforms.has(P())||de(x))},Y=((a=T==null?void 0:T.currentPlatform)===null||a===void 0?void 0:a.isPluginAvailable)||G,J=x=>{var S;return(S=v.PluginHeaders)===null||S===void 0?void 0:S.find(M=>M.name===x)},de=((i=T==null?void 0:T.currentPlatform)===null||i===void 0?void 0:i.getPluginHeader)||J,ue=x=>n.console.error(x),ae=(x,S,M)=>Promise.reject(`${M} does not have an implementation of "${S}".`),ie=new Map,le=(x,S={})=>{let M=ie.get(x);if(M)return console.warn(`Capacitor plugin "${x}" already registered. Cannot register plugins twice.`),M.proxy;let q=P(),K=de(x),F,D=async()=>(!F&&q in S?F=typeof S[q]=="function"?F=await S[q]():F=S[q]:f!==null&&!F&&"web"in S&&(F=typeof S.web=="function"?F=await S.web():F=S.web),F),N=($,L)=>{var z,Z;if(K){let Q=K==null?void 0:K.methods.find(_=>L===_.name);if(Q)return Q.rtype==="promise"?_=>v.nativePromise(x,L.toString(),_):(_,oe)=>v.nativeCallback(x,L.toString(),_,oe);if($)return(z=$[L])===null||z===void 0?void 0:z.bind($)}else{if($)return(Z=$[L])===null||Z===void 0?void 0:Z.bind($);throw new ve(`"${x}" plugin is not implemented on ${q}`,he.Unimplemented)}},ee=$=>{let L,z=(...Z)=>{let Q=D().then(_=>{let oe=N(_,$);if(oe){let me=oe(...Z);return L=me==null?void 0:me.remove,me}else throw new ve(`"${x}.${$}()" is not implemented on ${q}`,he.Unimplemented)});return $==="addListener"&&(Q.remove=async()=>L()),Q};return z.toString=()=>`${$.toString()}() { [capacitor code] }`,Object.defineProperty(z,"name",{value:$,writable:!1,configurable:!1}),z},fe=ee("addListener"),B=ee("removeListener"),Ee=($,L)=>{let z=fe({eventName:$},L),Z=async()=>{let _=await z;B({eventName:$,callbackId:_},L)},Q=new Promise(_=>z.then(()=>_({remove:Z})));return Q.remove=async()=>{console.warn("Using addListener() without 'await' is deprecated."),await Z()},Q},te=new Proxy({},{get($,L){switch(L){case"$$typeof":return;case"toJSON":return()=>({});case"addListener":return K?Ee:fe;case"removeListener":return B;default:return ee(L)}}});return C[x]=te,ie.set(x,{name:x,proxy:te,platforms:new Set([...Object.keys(S),...K?[q]:[]])}),te},ye=((s=T==null?void 0:T.currentPlatform)===null||s===void 0?void 0:s.registerPlugin)||le;return v.convertFileSrc||(v.convertFileSrc=x=>x),v.getPlatform=P,v.handleError=ue,v.isNativePlatform=V,v.isPluginAvailable=Y,v.pluginMethodNoop=ae,v.registerPlugin=ye,v.Exception=ve,v.DEBUG=!!v.DEBUG,v.isLoggingEnabled=!!v.isLoggingEnabled,v.platform=v.getPlatform(),v.isNative=v.isNativePlatform(),v},xt=n=>n.Capacitor=It(n),ke=xt(typeof globalThis!="undefined"?globalThis:typeof self!="undefined"?self:typeof window!="undefined"?window:typeof global!="undefined"?global:{}),et=ke.registerPlugin,dr=ke.Plugins,Se=class{constructor(t){this.listeners={},this.windowListeners={},t&&(console.warn(`Capacitor WebPlugin "${t.name}" config object was deprecated in v3 and will be removed in v4.`),this.config=t)}addListener(t,r){this.listeners[t]||(this.listeners[t]=[]),this.listeners[t].push(r);let i=this.windowListeners[t];i&&!i.registered&&this.addWindowListener(i);let s=async()=>this.removeListener(t,r),f=Promise.resolve({remove:s});return Object.defineProperty(f,"remove",{value:async()=>{console.warn("Using addListener() without 'await' is deprecated."),await s()}}),f}async removeAllListeners(){this.listeners={};for(let t in this.windowListeners)this.removeWindowListener(this.windowListeners[t]);this.windowListeners={}}notifyListeners(t,r){let a=this.listeners[t];a&&a.forEach(i=>i(r))}hasListeners(t){return!!this.listeners[t].length}registerWindowListener(t,r){this.windowListeners[r]={registered:!1,windowEventName:t,pluginEventName:r,handler:a=>{this.notifyListeners(r,a)}}}unimplemented(t="not implemented"){return new ke.Exception(t,he.Unimplemented)}unavailable(t="not available"){return new ke.Exception(t,he.Unavailable)}async removeListener(t,r){let a=this.listeners[t];if(!a)return;let i=a.indexOf(r);this.listeners[t].splice(i,1),this.listeners[t].length||this.removeWindowListener(this.windowListeners[t])}addWindowListener(t){window.addEventListener(t.windowEventName,t.handler),t.registered=!0}removeWindowListener(t){t&&(window.removeEventListener(t.windowEventName,t.handler),t.registered=!1)}}});var tt,Be,Ae,Me=re(()=>{tt=async n=>new Promise((t,r)=>{let a=new FileReader;a.onload=()=>{let i=a.result,s=i.substr(i.indexOf(",")+1);t(s)},a.onerror=i=>r(i),a.readAsDataURL(n)}),Be=n=>encodeURIComponent(n).replace(/%(2[346B]|5E|60|7C)/g,decodeURIComponent).replace(/[()]/g,escape),Ae=n=>n.replace(/(%[\dA-F]{2})+/gi,decodeURIComponent)});var rt,Ce,nt,at,Re,it=re(()=>{Me();rt=(n,t,r={})=>{let a=Be(n),i=Be(t),s=`; expires=${(r.expires||"").replace("expires=","")}`,f=(r.path||"/").replace("path=","");document.cookie=`${a}=${i||""}${s}; path=${f}`},Ce=()=>{let n=[],t={};if(!document.cookie)return n;let r=document.cookie.split(";")||[];for(let i of r){let[s,f]=i.replace(/=/,"CAP_COOKIE").split("CAP_COOKIE");s=Ae(s).trim(),f=Ae(f).trim(),t[s]=f}let a=Object.entries(t);for(let[i,s]of a)n.push({key:i,value:s});return n},nt=n=>{let t=Ce();for(let r of t)if(r.key===n)return r;return{key:n,value:""}},at=n=>{document.cookie=`${n}=; Max-Age=0`},Re=()=>{let n=document.cookie.split(";")||[];for(let t of n)document.cookie=t.replace(/^ +/,"").replace(/=.*/,`=;expires=${new Date().toUTCString()};path=/`)}});var At,Mt,qe,ce,ot,st,lt,ct,dt,ut=re(()=>{Me();At=(n={})=>{let t=Object.keys(n);return Object.keys(n).map(i=>i.toLocaleLowerCase()).reduce((i,s,f)=>(i[s]=n[t[f]],i),{})},Mt=(n,t=!0)=>n?Object.entries(n).reduce((a,i)=>{let[s,f]=i,v,C;return Array.isArray(f)?(C="",f.forEach(T=>{v=t?encodeURIComponent(T):T,C+=`${s}=${v}&`}),C.slice(0,-1)):(v=t?encodeURIComponent(f):f,C=`${s}=${v}`),`${a}&${C}`},"").substr(1):null,qe=(n,t={})=>{let r=Object.assign({method:n.method||"GET",headers:n.headers},t),i=At(n.headers)["content-type"]||"";if(typeof n.data=="string")r.body=n.data;else if(i.includes("application/x-www-form-urlencoded")){let s=new URLSearchParams;for(let[f,v]of Object.entries(n.data||{}))s.set(f,v);r.body=s.toString()}else if(i.includes("multipart/form-data")){let s=new FormData;if(n.data instanceof FormData)n.data.forEach((v,C)=>{s.append(C,v)});else for(let v of Object.keys(n.data))s.append(v,n.data[v]);r.body=s;let f=new Headers(r.headers);f.delete("content-type"),r.headers=f}else(i.includes("application/json")||typeof n.data=="object")&&(r.body=JSON.stringify(n.data));return r},ce=async n=>{let t=qe(n,n.webFetchExtra),r=Mt(n.params,n.shouldEncodeUrlParams),a=r?`${n.url}?${r}`:n.url,i=await fetch(a,t),s=i.headers.get("content-type")||"",{responseType:f="text"}=i.ok?n:{};s.includes("application/json")&&(f="json");let v;switch(f){case"arraybuffer":case"blob":let T=await i.blob();v=await tt(T);break;case"json":v=await i.json();break;case"document":case"text":default:v=await i.text()}let C={};return i.headers.forEach((T,U)=>{C[U]=T}),{data:v,headers:C,status:i.status,url:i.url}},ot=async n=>ce(Object.assign(Object.assign({},n),{method:"GET"})),st=async n=>ce(Object.assign(Object.assign({},n),{method:"POST"})),lt=async n=>ce(Object.assign(Object.assign({},n),{method:"PUT"})),ct=async n=>ce(Object.assign(Object.assign({},n),{method:"PATCH"})),dt=async n=>ce(Object.assign(Object.assign({},n),{method:"DELETE"}))});var De={};Ie(De,{HttpWeb:()=>Fe});var Fe,Oe=re(()=>{xe();it();ut();Fe=class extends Se{constructor(){super(),this.request=async t=>ce(t),this.get=async t=>ot(t),this.post=async t=>st(t),this.put=async t=>lt(t),this.patch=async t=>ct(t),this.del=async t=>dt(t),this.getCookiesMap=async t=>{let r=Ce(),a={};for(let i of r)a[i.key]=i.value;return a},this.getCookies=async t=>{let{url:r}=t;return{cookies:Ce()}},this.setCookie=async t=>{let{key:r,value:a,expires:i="",path:s=""}=t;rt(r,a,{expires:i,path:s})},this.getCookie=async t=>nt(t.key),this.deleteCookie=async t=>at(t.key),this.clearCookies=async t=>Re(),this.clearAllCookies=async()=>Re(),this.uploadFile=async t=>{let r=new FormData;r.append(t.name,t.blob||"undefined");let a=Object.assign(Object.assign({},t),{body:r,method:"POST"});return this.post(a)},this.downloadFile=async t=>{let r=qe(t,t.webFetchExtra),a=await fetch(t.url,r),i;if(!(t!=null&&t.progress))i=await a.blob();else if(!(a!=null&&a.body))i=new Blob;else{let s=a.body.getReader(),f=0,v=[],C=a.headers.get("content-type"),T=parseInt(a.headers.get("content-length")||"0",10);for(;;){let{done:I,value:V}=await s.read();if(I)break;v.push(V),f+=(V==null?void 0:V.length)||0;let G={type:"DOWNLOAD",url:t.url,bytes:f,contentLength:T};this.notifyListeners("progress",G)}let U=new Uint8Array(f),P=0;for(let I of v)typeof I!="undefined"&&(U.set(I,P),P+=I.length);i=new Blob([U.buffer],{type:C||void 0})}return{blob:i}}}}});var mt=Ct((vr,qt)=>{qt.exports={API_KEY:"a5d75d50-65e6-41a4-aa2f-9b2c93afaaa7"}});var ge,we,Ft,Dt,Ot,Ke,Te,pe,ht,gt,$e,wr,Kt,$t,jt,Ht,je,Er,He=re(()=>{(function(n){n.Unimplemented="UNIMPLEMENTED",n.Unavailable="UNAVAILABLE"})(ge||(ge={}));we=class extends Error{constructor(t,r,a){super(t),this.message=t,this.code=r,this.data=a}},Ft=n=>{var t,r;return n!=null&&n.androidBridge?"android":!((r=(t=n==null?void 0:n.webkit)===null||t===void 0?void 0:t.messageHandlers)===null||r===void 0)&&r.bridge?"ios":"web"},Dt=n=>{let t=n.CapacitorCustomPlatform||null,r=n.Capacitor||{},a=r.Plugins=r.Plugins||{},i=()=>t!==null?t.name:Ft(n),s=()=>i()!=="web",f=P=>{let I=T.get(P);return!!(I!=null&&I.platforms.has(i())||v(P))},v=P=>{var I;return(I=r.PluginHeaders)===null||I===void 0?void 0:I.find(V=>V.name===P)},C=P=>n.console.error(P),T=new Map,U=(P,I={})=>{let V=T.get(P);if(V)return console.warn(`Capacitor plugin "${P}" already registered. Cannot register plugins twice.`),V.proxy;let G=i(),Y=v(P),J,de=async()=>(!J&&G in I?J=typeof I[G]=="function"?J=await I[G]():J=I[G]:t!==null&&!J&&"web"in I&&(J=typeof I.web=="function"?J=await I.web():J=I.web),J),ue=(S,M)=>{var q,K;if(Y){let F=Y==null?void 0:Y.methods.find(D=>M===D.name);if(F)return F.rtype==="promise"?D=>r.nativePromise(P,M.toString(),D):(D,N)=>r.nativeCallback(P,M.toString(),D,N);if(S)return(q=S[M])===null||q===void 0?void 0:q.bind(S)}else{if(S)return(K=S[M])===null||K===void 0?void 0:K.bind(S);throw new we(`"${P}" plugin is not implemented on ${G}`,ge.Unimplemented)}},ae=S=>{let M,q=(...K)=>{let F=de().then(D=>{let N=ue(D,S);if(N){let ee=N(...K);return M=ee==null?void 0:ee.remove,ee}else throw new we(`"${P}.${S}()" is not implemented on ${G}`,ge.Unimplemented)});return S==="addListener"&&(F.remove=async()=>M()),F};return q.toString=()=>`${S.toString()}() { [capacitor code] }`,Object.defineProperty(q,"name",{value:S,writable:!1,configurable:!1}),q},ie=ae("addListener"),le=ae("removeListener"),ye=(S,M)=>{let q=ie({eventName:S},M),K=async()=>{let D=await q;le({eventName:S,callbackId:D},M)},F=new Promise(D=>q.then(()=>D({remove:K})));return F.remove=async()=>{console.warn("Using addListener() without 'await' is deprecated."),await K()},F},x=new Proxy({},{get(S,M){switch(M){case"$$typeof":return;case"toJSON":return()=>({});case"addListener":return Y?ye:ie;case"removeListener":return le;default:return ae(M)}}});return a[P]=x,T.set(P,{name:P,proxy:x,platforms:new Set([...Object.keys(I),...Y?[G]:[]])}),x};return r.convertFileSrc||(r.convertFileSrc=P=>P),r.getPlatform=i,r.handleError=C,r.isNativePlatform=s,r.isPluginAvailable=f,r.registerPlugin=U,r.Exception=we,r.DEBUG=!!r.DEBUG,r.isLoggingEnabled=!!r.isLoggingEnabled,r},Ot=n=>n.Capacitor=Dt(n),Ke=Ot(typeof globalThis!="undefined"?globalThis:typeof self!="undefined"?self:typeof window!="undefined"?window:typeof global!="undefined"?global:{}),Te=Ke.registerPlugin,pe=class{constructor(){this.listeners={},this.retainedEventArguments={},this.windowListeners={}}addListener(t,r){let a=!1;this.listeners[t]||(this.listeners[t]=[],a=!0),this.listeners[t].push(r);let s=this.windowListeners[t];s&&!s.registered&&this.addWindowListener(s),a&&this.sendRetainedArgumentsForEvent(t);let f=async()=>this.removeListener(t,r);return Promise.resolve({remove:f})}async removeAllListeners(){this.listeners={};for(let t in this.windowListeners)this.removeWindowListener(this.windowListeners[t]);this.windowListeners={}}notifyListeners(t,r,a){let i=this.listeners[t];if(!i){if(a){let s=this.retainedEventArguments[t];s||(s=[]),s.push(r),this.retainedEventArguments[t]=s}return}i.forEach(s=>s(r))}hasListeners(t){return!!this.listeners[t].length}registerWindowListener(t,r){this.windowListeners[r]={registered:!1,windowEventName:t,pluginEventName:r,handler:a=>{this.notifyListeners(r,a)}}}unimplemented(t="not implemented"){return new Ke.Exception(t,ge.Unimplemented)}unavailable(t="not available"){return new Ke.Exception(t,ge.Unavailable)}async removeListener(t,r){let a=this.listeners[t];if(!a)return;let i=a.indexOf(r);this.listeners[t].splice(i,1),this.listeners[t].length||this.removeWindowListener(this.windowListeners[t])}addWindowListener(t){window.addEventListener(t.windowEventName,t.handler),t.registered=!0}removeWindowListener(t){t&&(window.removeEventListener(t.windowEventName,t.handler),t.registered=!1)}sendRetainedArgumentsForEvent(t){let r=this.retainedEventArguments[t];r&&(delete this.retainedEventArguments[t],r.forEach(a=>{this.notifyListeners(t,a)}))}},ht=n=>encodeURIComponent(n).replace(/%(2[346B]|5E|60|7C)/g,decodeURIComponent).replace(/[()]/g,escape),gt=n=>n.replace(/(%[\dA-F]{2})+/gi,decodeURIComponent),$e=class extends pe{async getCookies(){let t=document.cookie,r={};return t.split(";").forEach(a=>{if(a.length<=0)return;let[i,s]=a.replace(/=/,"CAP_COOKIE").split("CAP_COOKIE");i=gt(i).trim(),s=gt(s).trim(),r[i]=s}),r}async setCookie(t){try{let r=ht(t.key),a=ht(t.value),i=`; expires=${(t.expires||"").replace("expires=","")}`,s=(t.path||"/").replace("path=",""),f=t.url!=null&&t.url.length>0?`domain=${t.url}`:"";document.cookie=`${r}=${a||""}${i}; path=${s}; ${f};`}catch(r){return Promise.reject(r)}}async deleteCookie(t){try{document.cookie=`${t.key}=; Max-Age=0`}catch(r){return Promise.reject(r)}}async clearCookies(){try{let t=document.cookie.split(";")||[];for(let r of t)document.cookie=r.replace(/^ +/,"").replace(/=.*/,`=;expires=${new Date().toUTCString()};path=/`)}catch(t){return Promise.reject(t)}}async clearAllCookies(){try{await this.clearCookies()}catch(t){return Promise.reject(t)}}},wr=Te("CapacitorCookies",{web:()=>new $e}),Kt=async n=>new Promise((t,r)=>{let a=new FileReader;a.onload=()=>{let i=a.result;t(i.indexOf(",")>=0?i.split(",")[1]:i)},a.onerror=i=>r(i),a.readAsDataURL(n)}),$t=(n={})=>{let t=Object.keys(n);return Object.keys(n).map(i=>i.toLocaleLowerCase()).reduce((i,s,f)=>(i[s]=n[t[f]],i),{})},jt=(n,t=!0)=>n?Object.entries(n).reduce((a,i)=>{let[s,f]=i,v,C;return Array.isArray(f)?(C="",f.forEach(T=>{v=t?encodeURIComponent(T):T,C+=`${s}=${v}&`}),C.slice(0,-1)):(v=t?encodeURIComponent(f):f,C=`${s}=${v}`),`${a}&${C}`},"").substr(1):null,Ht=(n,t={})=>{let r=Object.assign({method:n.method||"GET",headers:n.headers},t),i=$t(n.headers)["content-type"]||"";if(typeof n.data=="string")r.body=n.data;else if(i.includes("application/x-www-form-urlencoded")){let s=new URLSearchParams;for(let[f,v]of Object.entries(n.data||{}))s.set(f,v);r.body=s.toString()}else if(i.includes("multipart/form-data")||n.data instanceof FormData){let s=new FormData;if(n.data instanceof FormData)n.data.forEach((v,C)=>{s.append(C,v)});else for(let v of Object.keys(n.data))s.append(v,n.data[v]);r.body=s;let f=new Headers(r.headers);f.delete("content-type"),r.headers=f}else(i.includes("application/json")||typeof n.data=="object")&&(r.body=JSON.stringify(n.data));return r},je=class extends pe{async request(t){let r=Ht(t,t.webFetchExtra),a=jt(t.params,t.shouldEncodeUrlParams),i=a?`${t.url}?${a}`:t.url,s=await fetch(i,r),f=s.headers.get("content-type")||"",{responseType:v="text"}=s.ok?t:{};f.includes("application/json")&&(v="json");let C,T;switch(v){case"arraybuffer":case"blob":T=await s.blob(),C=await Kt(T);break;case"json":C=await s.json();break;case"document":case"text":default:C=await s.text()}let U={};return s.headers.forEach((P,I)=>{U[I]=P}),{data:C,headers:U,status:s.status,url:s.url}}async get(t){return this.request(Object.assign(Object.assign({},t),{method:"GET"}))}async post(t){return this.request(Object.assign(Object.assign({},t),{method:"POST"}))}async put(t){return this.request(Object.assign(Object.assign({},t),{method:"PUT"}))}async patch(t){return this.request(Object.assign(Object.assign({},t),{method:"PATCH"}))}async delete(t){return this.request(Object.assign(Object.assign({},t),{method:"DELETE"}))}},Er=Te("CapacitorHttp",{web:()=>new je})});var Le,Pe,pt=re(()=>{Le=class{constructor(t){this.sqlite=t,this._connectionDict=new Map}async initWebStore(){try{return await this.sqlite.initWebStore(),Promise.resolve()}catch(t){return Promise.reject(t)}}async saveToStore(t){try{return await this.sqlite.saveToStore({database:t}),Promise.resolve()}catch(r){return Promise.reject(r)}}async saveToLocalDisk(t){try{return await this.sqlite.saveToLocalDisk({database:t}),Promise.resolve()}catch(r){return Promise.reject(r)}}async getFromLocalDiskToStore(t){let r=t!=null?t:!0;try{return await this.sqlite.getFromLocalDiskToStore({overwrite:r}),Promise.resolve()}catch(a){return Promise.reject(a)}}async echo(t){try{let r=await this.sqlite.echo({value:t});return Promise.resolve(r)}catch(r){return Promise.reject(r)}}async isSecretStored(){try{let t=await this.sqlite.isSecretStored();return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async setEncryptionSecret(t){try{return await this.sqlite.setEncryptionSecret({passphrase:t}),Promise.resolve()}catch(r){return Promise.reject(r)}}async changeEncryptionSecret(t,r){try{return await this.sqlite.changeEncryptionSecret({passphrase:t,oldpassphrase:r}),Promise.resolve()}catch(a){return Promise.reject(a)}}async clearEncryptionSecret(){try{return await this.sqlite.clearEncryptionSecret(),Promise.resolve()}catch(t){return Promise.reject(t)}}async checkEncryptionSecret(t){try{let r=await this.sqlite.checkEncryptionSecret({passphrase:t});return Promise.resolve(r)}catch(r){return Promise.reject(r)}}async addUpgradeStatement(t,r){try{return t.endsWith(".db")&&(t=t.slice(0,-3)),await this.sqlite.addUpgradeStatement({database:t,upgrade:r}),Promise.resolve()}catch(a){return Promise.reject(a)}}async createConnection(t,r,a,i,s){try{t.endsWith(".db")&&(t=t.slice(0,-3)),await this.sqlite.createConnection({database:t,encrypted:r,mode:a,version:i,readonly:s});let f=new Pe(t,s,this.sqlite),v=s?`RO_${t}`:`RW_${t}`;return this._connectionDict.set(v,f),Promise.resolve(f)}catch(f){return Promise.reject(f)}}async closeConnection(t,r){try{t.endsWith(".db")&&(t=t.slice(0,-3)),await this.sqlite.closeConnection({database:t,readonly:r});let a=r?`RO_${t}`:`RW_${t}`;return this._connectionDict.delete(a),Promise.resolve()}catch(a){return Promise.reject(a)}}async isConnection(t,r){let a={};t.endsWith(".db")&&(t=t.slice(0,-3));let i=r?`RO_${t}`:`RW_${t}`;return a.result=this._connectionDict.has(i),Promise.resolve(a)}async retrieveConnection(t,r){t.endsWith(".db")&&(t=t.slice(0,-3));let a=r?`RO_${t}`:`RW_${t}`;if(this._connectionDict.has(a)){let i=this._connectionDict.get(a);return typeof i!="undefined"?Promise.resolve(i):Promise.reject(`Connection ${t} is undefined`)}else return Promise.reject(`Connection ${t} does not exist`)}async getNCDatabasePath(t,r){try{let a=await this.sqlite.getNCDatabasePath({path:t,database:r});return Promise.resolve(a)}catch(a){return Promise.reject(a)}}async createNCConnection(t,r){try{await this.sqlite.createNCConnection({databasePath:t,version:r});let a=new Pe(t,!0,this.sqlite),i=`RO_${t})`;return this._connectionDict.set(i,a),Promise.resolve(a)}catch(a){return Promise.reject(a)}}async closeNCConnection(t){try{await this.sqlite.closeNCConnection({databasePath:t});let r=`RO_${t})`;return this._connectionDict.delete(r),Promise.resolve()}catch(r){return Promise.reject(r)}}async isNCConnection(t){let r={},a=`RO_${t})`;return r.result=this._connectionDict.has(a),Promise.resolve(r)}async retrieveNCConnection(t){if(this._connectionDict.has(t)){let r=`RO_${t})`,a=this._connectionDict.get(r);return typeof a!="undefined"?Promise.resolve(a):Promise.reject(`Connection ${t} is undefined`)}else return Promise.reject(`Connection ${t} does not exist`)}async isNCDatabase(t){try{let r=await this.sqlite.isNCDatabase({databasePath:t});return Promise.resolve(r)}catch(r){return Promise.reject(r)}}async retrieveAllConnections(){return this._connectionDict}async closeAllConnections(){let t=new Map;try{for(let r of this._connectionDict.keys()){let a=r.substring(3),i=r.substring(0,3)==="RO_";await this.sqlite.closeConnection({database:a,readonly:i}),t.set(r,null)}for(let r of t.keys())this._connectionDict.delete(r);return Promise.resolve()}catch(r){return Promise.reject(r)}}async checkConnectionsConsistency(){try{let t=[...this._connectionDict.keys()],r=[],a=[];for(let s of t)r.push(s.substring(0,2)),a.push(s.substring(3));let i=await this.sqlite.checkConnectionsConsistency({dbNames:a,openModes:r});return i.result||(this._connectionDict=new Map),Promise.resolve(i)}catch(t){return this._connectionDict=new Map,Promise.reject(t)}}async importFromJson(t){try{let r=await this.sqlite.importFromJson({jsonstring:t});return Promise.resolve(r)}catch(r){return Promise.reject(r)}}async isJsonValid(t){try{let r=await this.sqlite.isJsonValid({jsonstring:t});return Promise.resolve(r)}catch(r){return Promise.reject(r)}}async copyFromAssets(t){let r=t!=null?t:!0;try{return await this.sqlite.copyFromAssets({overwrite:r}),Promise.resolve()}catch(a){return Promise.reject(a)}}async getFromHTTPRequest(t,r){let a=r!=null?r:!0;try{return await this.sqlite.getFromHTTPRequest({url:t,overwrite:a}),Promise.resolve()}catch(i){return Promise.reject(i)}}async isDatabaseEncrypted(t){t.endsWith(".db")&&(t=t.slice(0,-3));try{let r=await this.sqlite.isDatabaseEncrypted({database:t});return Promise.resolve(r)}catch(r){return Promise.reject(r)}}async isInConfigEncryption(){try{let t=await this.sqlite.isInConfigEncryption();return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async isInConfigBiometricAuth(){try{let t=await this.sqlite.isInConfigBiometricAuth();return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async isDatabase(t){t.endsWith(".db")&&(t=t.slice(0,-3));try{let r=await this.sqlite.isDatabase({database:t});return Promise.resolve(r)}catch(r){return Promise.reject(r)}}async getDatabaseList(){try{let r=(await this.sqlite.getDatabaseList()).values;r.sort();let a={values:r};return Promise.resolve(a)}catch(t){return Promise.reject(t)}}async getMigratableDbList(t){let r=t||"default";try{let a=await this.sqlite.getMigratableDbList({folderPath:r});return Promise.resolve(a)}catch(a){return Promise.reject(a)}}async addSQLiteSuffix(t,r){let a=t||"default",i=r||[];try{let s=await this.sqlite.addSQLiteSuffix({folderPath:a,dbNameList:i});return Promise.resolve(s)}catch(s){return Promise.reject(s)}}async deleteOldDatabases(t,r){let a=t||"default",i=r||[];try{let s=await this.sqlite.deleteOldDatabases({folderPath:a,dbNameList:i});return Promise.resolve(s)}catch(s){return Promise.reject(s)}}async moveDatabasesAndAddSuffix(t,r){let a=t||"default",i=r||[];return this.sqlite.moveDatabasesAndAddSuffix({folderPath:a,dbNameList:i})}},Pe=class{constructor(t,r,a){this.dbName=t,this.readonly=r,this.sqlite=a}getConnectionDBName(){return this.dbName}getConnectionReadOnly(){return this.readonly}async open(){try{return await this.sqlite.open({database:this.dbName,readonly:this.readonly}),Promise.resolve()}catch(t){return Promise.reject(t)}}async close(){try{return await this.sqlite.close({database:this.dbName,readonly:this.readonly}),Promise.resolve()}catch(t){return Promise.reject(t)}}async beginTransaction(){try{let t=await this.sqlite.beginTransaction({database:this.dbName});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async commitTransaction(){try{let t=await this.sqlite.commitTransaction({database:this.dbName});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async rollbackTransaction(){try{let t=await this.sqlite.rollbackTransaction({database:this.dbName});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async isTransactionActive(){try{let t=await this.sqlite.isTransactionActive({database:this.dbName});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async loadExtension(t){try{return await this.sqlite.loadExtension({database:this.dbName,path:t,readonly:this.readonly}),Promise.resolve()}catch(r){return Promise.reject(r)}}async enableLoadExtension(t){try{return await this.sqlite.enableLoadExtension({database:this.dbName,toggle:t,readonly:this.readonly}),Promise.resolve()}catch(r){return Promise.reject(r)}}async getUrl(){try{let t=await this.sqlite.getUrl({database:this.dbName,readonly:this.readonly});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async getVersion(){try{let t=await this.sqlite.getVersion({database:this.dbName,readonly:this.readonly});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async getTableList(){try{let t=await this.sqlite.getTableList({database:this.dbName,readonly:this.readonly});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async execute(t,r=!0,a=!0){try{if(this.readonly)return Promise.reject("not allowed in read-only mode");{let i=await this.sqlite.execute({database:this.dbName,statements:t,transaction:r,readonly:!1,isSQL92:a});return Promise.resolve(i)}}catch(i){return Promise.reject(i)}}async query(t,r,a=!0){let i;try{return r&&r.length>0?i=await this.sqlite.query({database:this.dbName,statement:t,values:r,readonly:this.readonly,isSQL92:!0}):i=await this.sqlite.query({database:this.dbName,statement:t,values:[],readonly:this.readonly,isSQL92:a}),i=await this.reorderRows(i),Promise.resolve(i)}catch(s){return Promise.reject(s)}}async run(t,r,a=!0,i="no",s=!0){let f;try{return this.readonly?Promise.reject("not allowed in read-only mode"):(r&&r.length>0?f=await this.sqlite.run({database:this.dbName,statement:t,values:r,transaction:a,readonly:!1,returnMode:i,isSQL92:!0}):f=await this.sqlite.run({database:this.dbName,statement:t,values:[],transaction:a,readonly:!1,returnMode:i,isSQL92:s}),f.changes=await this.reorderRows(f.changes),Promise.resolve(f))}catch(v){return Promise.reject(v)}}async executeSet(t,r=!0,a="no",i=!0){let s;try{return this.readonly?Promise.reject("not allowed in read-only mode"):(s=await this.sqlite.executeSet({database:this.dbName,set:t,transaction:r,readonly:!1,returnMode:a,isSQL92:i}),s.changes=await this.reorderRows(s.changes),Promise.resolve(s))}catch(f){return Promise.reject(f)}}async isExists(){try{let t=await this.sqlite.isDBExists({database:this.dbName,readonly:this.readonly});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async isTable(t){try{let r=await this.sqlite.isTableExists({database:this.dbName,table:t,readonly:this.readonly});return Promise.resolve(r)}catch(r){return Promise.reject(r)}}async isDBOpen(){try{let t=await this.sqlite.isDBOpen({database:this.dbName,readonly:this.readonly});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async delete(){try{return this.readonly?Promise.reject("not allowed in read-only mode"):(await this.sqlite.deleteDatabase({database:this.dbName,readonly:!1}),Promise.resolve())}catch(t){return Promise.reject(t)}}async createSyncTable(){try{if(this.readonly)return Promise.reject("not allowed in read-only mode");{let t=await this.sqlite.createSyncTable({database:this.dbName,readonly:!1});return Promise.resolve(t)}}catch(t){return Promise.reject(t)}}async setSyncDate(t){try{return this.readonly?Promise.reject("not allowed in read-only mode"):(await this.sqlite.setSyncDate({database:this.dbName,syncdate:t,readonly:!1}),Promise.resolve())}catch(r){return Promise.reject(r)}}async getSyncDate(){try{let t=await this.sqlite.getSyncDate({database:this.dbName,readonly:this.readonly}),r="";return t.syncDate>0&&(r=new Date(t.syncDate*1e3).toISOString()),Promise.resolve(r)}catch(t){return Promise.reject(t)}}async exportToJson(t,r=!1){try{let a=await this.sqlite.exportToJson({database:this.dbName,jsonexportmode:t,readonly:this.readonly,encrypted:r});return Promise.resolve(a)}catch(a){return Promise.reject(a)}}async deleteExportedRows(){try{return this.readonly?Promise.reject("not allowed in read-only mode"):(await this.sqlite.deleteExportedRows({database:this.dbName,readonly:!1}),Promise.resolve())}catch(t){return Promise.reject(t)}}async executeTransaction(t,r=!0){let a=0,i=!1;if(this.readonly)return Promise.reject("not allowed in read-only mode");if(await this.sqlite.beginTransaction({database:this.dbName}),i=await this.sqlite.isTransactionActive({database:this.dbName}),!i)return Promise.reject("After Begin Transaction, no transaction active");try{for(let v of t){if(typeof v!="object"||!("statement"in v))throw new Error("Error a task.statement must be provided");if("values"in v&&v.values&&v.values.length>0){let C=v.statement.toUpperCase().includes("RETURNING")?"all":"no",T=await this.sqlite.run({database:this.dbName,statement:v.statement,values:v.values,transaction:!1,readonly:!1,returnMode:C,isSQL92:r});if(T.changes.changes<0)throw new Error("Error in transaction method run ");a+=T.changes.changes}else{let C=await this.sqlite.execute({database:this.dbName,statements:v.statement,transaction:!1,readonly:!1});if(C.changes.changes<0)throw new Error("Error in transaction method execute ");a+=C.changes.changes}}let s=await this.sqlite.commitTransaction({database:this.dbName});a+=s.changes.changes;let f={changes:{changes:a}};return Promise.resolve(f)}catch(s){let f=s.message?s.message:s;return await this.sqlite.rollbackTransaction({database:this.dbName}),Promise.reject(f)}}async reorderRows(t){let r=t;if(t!=null&&t.values&&typeof t.values[0]=="object"&&Object.keys(t.values[0]).includes("ios_columns")){let a=t.values[0].ios_columns,i=[];for(let s=1;s<t.values.length;s++){let f=t.values[s],v={};for(let C of a)v[C]=f[C];i.push(v)}r.values=i}return Promise.resolve(r)}}});var yt={};Ie(yt,{CapacitorSQLiteWeb:()=>Ne});var Ne,ft=re(()=>{He();Ne=class extends pe{constructor(){super(...arguments),this.jeepSqliteElement=null,this.isWebStoreOpen=!1}async initWebStore(){await customElements.whenDefined("jeep-sqlite"),this.jeepSqliteElement=document.querySelector("jeep-sqlite"),this.ensureJeepSqliteIsAvailable(),this.jeepSqliteElement.addEventListener("jeepSqliteImportProgress",t=>{this.notifyListeners("sqliteImportProgressEvent",t.detail)}),this.jeepSqliteElement.addEventListener("jeepSqliteExportProgress",t=>{this.notifyListeners("sqliteExportProgressEvent",t.detail)}),this.jeepSqliteElement.addEventListener("jeepSqliteHTTPRequestEnded",t=>{this.notifyListeners("sqliteHTTPRequestEndedEvent",t.detail)}),this.jeepSqliteElement.addEventListener("jeepSqlitePickDatabaseEnded",t=>{this.notifyListeners("sqlitePickDatabaseEndedEvent",t.detail)}),this.jeepSqliteElement.addEventListener("jeepSqliteSaveDatabaseToDisk",t=>{this.notifyListeners("sqliteSaveDatabaseToDiskEvent",t.detail)}),this.isWebStoreOpen||(this.isWebStoreOpen=await this.jeepSqliteElement.isStoreOpen())}async saveToStore(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.saveToStore(t);return}catch(r){throw new Error(`${r}`)}}async getFromLocalDiskToStore(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.getFromLocalDiskToStore(t);return}catch(r){throw new Error(`${r}`)}}async saveToLocalDisk(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.saveToLocalDisk(t);return}catch(r){throw new Error(`${r}`)}}async echo(t){return this.ensureJeepSqliteIsAvailable(),await this.jeepSqliteElement.echo(t)}async createConnection(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.createConnection(t);return}catch(r){throw new Error(`${r}`)}}async open(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.open(t);return}catch(r){throw new Error(`${r}`)}}async closeConnection(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.closeConnection(t);return}catch(r){throw new Error(`${r}`)}}async getVersion(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.getVersion(t)}catch(r){throw new Error(`${r}`)}}async checkConnectionsConsistency(t){this.ensureJeepSqliteIsAvailable();try{return await this.jeepSqliteElement.checkConnectionsConsistency(t)}catch(r){throw new Error(`${r}`)}}async close(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.close(t);return}catch(r){throw new Error(`${r}`)}}async beginTransaction(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.beginTransaction(t)}catch(r){throw new Error(`${r}`)}}async commitTransaction(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.commitTransaction(t)}catch(r){throw new Error(`${r}`)}}async rollbackTransaction(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.rollbackTransaction(t)}catch(r){throw new Error(`${r}`)}}async isTransactionActive(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.isTransactionActive(t)}catch(r){throw new Error(`${r}`)}}async getTableList(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.getTableList(t)}catch(r){throw new Error(`${r}`)}}async execute(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.execute(t)}catch(r){throw new Error(`${r}`)}}async executeSet(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.executeSet(t)}catch(r){throw new Error(`${r}`)}}async run(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.run(t)}catch(r){throw new Error(`${r}`)}}async query(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.query(t)}catch(r){throw new Error(`${r}`)}}async isDBExists(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.isDBExists(t)}catch(r){throw new Error(`${r}`)}}async isDBOpen(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.isDBOpen(t)}catch(r){throw new Error(`${r}`)}}async isDatabase(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.isDatabase(t)}catch(r){throw new Error(`${r}`)}}async isTableExists(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.isTableExists(t)}catch(r){throw new Error(`${r}`)}}async deleteDatabase(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.deleteDatabase(t);return}catch(r){throw new Error(`${r}`)}}async isJsonValid(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.isJsonValid(t)}catch(r){throw new Error(`${r}`)}}async importFromJson(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.importFromJson(t)}catch(r){throw new Error(`${r}`)}}async exportToJson(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.exportToJson(t)}catch(r){throw new Error(`${r}`)}}async createSyncTable(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.createSyncTable(t)}catch(r){throw new Error(`${r}`)}}async setSyncDate(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.setSyncDate(t);return}catch(r){throw new Error(`${r}`)}}async getSyncDate(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.getSyncDate(t)}catch(r){throw new Error(`${r}`)}}async deleteExportedRows(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.deleteExportedRows(t);return}catch(r){throw new Error(`${r}`)}}async addUpgradeStatement(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.addUpgradeStatement(t);return}catch(r){throw new Error(`${r}`)}}async copyFromAssets(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.copyFromAssets(t);return}catch(r){throw new Error(`${r}`)}}async getFromHTTPRequest(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.getFromHTTPRequest(t);return}catch(r){throw new Error(`${r}`)}}async getDatabaseList(){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.getDatabaseList()}catch(t){throw new Error(`${t}`)}}ensureJeepSqliteIsAvailable(){if(this.jeepSqliteElement===null)throw new Error("The jeep-sqlite element is not present in the DOM! Please check the @capacitor-community/sqlite documentation for instructions regarding the web platform.")}ensureWebstoreIsOpen(){if(!this.isWebStoreOpen)throw new Error('WebStore is not open yet. You have to call "initWebStore()" first.')}async getUrl(){throw this.unimplemented("Not implemented on web.")}async getMigratableDbList(t){throw console.log("getMigratableDbList",t),this.unimplemented("Not implemented on web.")}async addSQLiteSuffix(t){throw console.log("addSQLiteSuffix",t),this.unimplemented("Not implemented on web.")}async deleteOldDatabases(t){throw console.log("deleteOldDatabases",t),this.unimplemented("Not implemented on web.")}async moveDatabasesAndAddSuffix(t){throw console.log("moveDatabasesAndAddSuffix",t),this.unimplemented("Not implemented on web.")}async isSecretStored(){throw this.unimplemented("Not implemented on web.")}async setEncryptionSecret(t){throw console.log("setEncryptionSecret",t),this.unimplemented("Not implemented on web.")}async changeEncryptionSecret(t){throw console.log("changeEncryptionSecret",t),this.unimplemented("Not implemented on web.")}async clearEncryptionSecret(){throw console.log("clearEncryptionSecret"),this.unimplemented("Not implemented on web.")}async checkEncryptionSecret(t){throw console.log("checkEncryptionPassPhrase",t),this.unimplemented("Not implemented on web.")}async getNCDatabasePath(t){throw console.log("getNCDatabasePath",t),this.unimplemented("Not implemented on web.")}async createNCConnection(t){throw console.log("createNCConnection",t),this.unimplemented("Not implemented on web.")}async closeNCConnection(t){throw console.log("closeNCConnection",t),this.unimplemented("Not implemented on web.")}async isNCDatabase(t){throw console.log("isNCDatabase",t),this.unimplemented("Not implemented on web.")}async isDatabaseEncrypted(t){throw console.log("isDatabaseEncrypted",t),this.unimplemented("Not implemented on web.")}async isInConfigEncryption(){throw this.unimplemented("Not implemented on web.")}async isInConfigBiometricAuth(){throw this.unimplemented("Not implemented on web.")}async loadExtension(t){throw console.log("loadExtension",t),this.unimplemented("Not implemented on web.")}async enableLoadExtension(t){throw console.log("enableLoadExtension",t),this.unimplemented("Not implemented on web.")}}});var bt,vt=re(()=>{He();pt();bt=Te("CapacitorSQLite",{web:()=>Promise.resolve().then(()=>(ft(),yt)).then(n=>new n.CapacitorSQLiteWeb),electron:()=>window.CapacitorCustomPlatform.plugins.CapacitorSQLite})});var wt={};Ie(wt,{getCardById:()=>Xt,getCardIds:()=>Vt,getCardsByIds:()=>Zt,getDaten:()=>Gt,getEnergieById:()=>or,getEnergieCardIds:()=>ir,getEnergies:()=>nr,getEngName:()=>Ut,getName:()=>zt,getTrainerById:()=>tr,getTrainerCardIds:()=>rr,getTrainers:()=>Yt,initDatabase:()=>Wt,insertCard:()=>_t,insertEnergie:()=>ar,insertTrainer:()=>er,updateCardIds:()=>Jt,updatePrice:()=>Qt});async function Wt(){return A=await Nt.createConnection("pokepicker",!1,"no-encryption",1),await A.open(),await A.execute(`
  ...
  `),(await A.query("SELECT COUNT(*) as count FROM pokemon")).values[0].count===0&&await A.execute(`
      ...
      `),A}async function Gt(){return await A.query("SELECT * FROM pokemon")}async function zt(n){return(await A.query("SELECT name FROM pokemon WHERE dex = ?",[n])).values[0].name}async function Ut(n){return(await A.query("SELECT engName FROM pokemon WHERE dex = ?",[n])).values[0].engName}async function Vt(n){return(await A.query("SELECT cardIds FROM pokemon WHERE dex = ?",[n])).values[0].cardIds}async function Jt(n,t){await A.run("UPDATE pokemon SET cardIds = ? WHERE dex = ?",[t,n])}async function _t(n){var t,r,a,i,s;try{let f=typeof n.imageSmall=="string"?n.imageSmall:null,v=typeof n.imageLarge=="string"?n.imageLarge:null;return((s=(await A.run(`INSERT INTO cards (cardId, cardName, rarity, setName, imageLow, imageHigh, subTypes, addedAt, avg30)
       VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)`,[n.id,n.name,n.rarity||"",((t=n.set)==null?void 0:t.name)||"",f,v,Array.isArray(n.subtypes)?n.subtypes.join(", "):"",new Date().toISOString(),(i=(a=(r=n.cardmarket)==null?void 0:r.prices)==null?void 0:a.avg30)!=null?i:null])).changes)==null?void 0:s.lastId)||null}catch(f){return console.error("Fehler in insertCard():",f.message||f,(n==null?void 0:n.id)||"unbekannte Karte"),null}}async function Xt(n){var r;return((r=(await A.query("SELECT * FROM cards WHERE id = ?",[n])).values)==null?void 0:r[0])||null}async function Zt(n){let t=n.map(()=>"?").join(",");return(await A.query(`SELECT * FROM cards WHERE id IN (${t})`,n)).values}async function Qt(n,t){try{await A.run("UPDATE cards SET avg30 = ? WHERE cardId = ?",[t,n])}catch(r){console.error(`Fehler beim Speichern von avg30 f\xFCr ${n}:`,r.message)}}async function Yt(){return(await A.query("SELECT * FROM trainer")).values}async function er(n){var t,r,a,i,s;try{let f=typeof n.imageSmall=="string"?n.imageSmall:null,v=typeof n.imageLarge=="string"?n.imageLarge:null;return((s=(await A.run(`INSERT INTO trainer (cardId, cardName, rarity, setName, imageLow, imageHigh, subTypes, addedAt, avg30)
       VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)`,[n.id,n.name,n.rarity||"",((t=n.set)==null?void 0:t.name)||"",f,v,Array.isArray(n.subtypes)?n.subtypes.join(", "):"",new Date().toISOString(),(i=(a=(r=n.cardmarket)==null?void 0:r.prices)==null?void 0:a.avg30)!=null?i:null])).changes)==null?void 0:s.lastId)||null}catch(f){return console.error("Fehler in insertTrainer():",f.message||f,(n==null?void 0:n.id)||"unbekannte Karte"),null}}async function tr(n){var r;return((r=(await A.query("SELECT * FROM trainer WHERE id = ?",[n])).values)==null?void 0:r[0])||null}async function rr(){return(await A.query("SELECT id FROM trainer")).values.map(t=>t.id)}async function nr(){return(await A.query("SELECT * FROM energy")).values}async function ar(n){var t,r,a,i,s;try{let f=typeof n.imageSmall=="string"?n.imageSmall:null,v=typeof n.imageLarge=="string"?n.imageLarge:null;return((s=(await A.run(`INSERT INTO energy (cardId, cardName, rarity, setName, imageLow, imageHigh, subTypes, addedAt, avg30)
       VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)`,[n.id,n.name,n.rarity||"",((t=n.set)==null?void 0:t.name)||"",f,v,Array.isArray(n.subtypes)?n.subtypes.join(", "):"",new Date().toISOString(),(i=(a=(r=n.cardmarket)==null?void 0:r.prices)==null?void 0:a.avg30)!=null?i:null])).changes)==null?void 0:s.lastId)||null}catch(f){return console.error("Fehler in insertEnergie():",f.message||f,(n==null?void 0:n.id)||"unbekannte Karte"),null}}async function ir(){return(await A.query("SELECT id FROM energy")).values.map(t=>t.id)}async function or(n){var r;return((r=(await A.query("SELECT * FROM energy WHERE id = ?",[n])).values)==null?void 0:r[0])||null}var Nt,A,Et=re(()=>{vt();Nt=new Le(bt)});xe();var ne=et("Http",{web:()=>Promise.resolve().then(()=>(Oe(),De)).then(n=>new n.HttpWeb),electron:()=>Promise.resolve().then(()=>(Oe(),De)).then(n=>new n.HttpWeb)});var se=mt(),H;document.addEventListener("DOMContentLoaded",()=>{(async()=>{let n=document.getElementById("cardLoader");n.innerHTML=`
      <p id="loaderText">Lade Karten\u2026</p>
      <div id="progressBarContainer">
        <div id="progressBar"></div>
      </div>
      <div id="progressText">0%</div>
    `,n.classList.remove("hidden"),n.classList.add("shown");let{initDatabase:t,getDaten:r,getName:a,getEngName:i,getCardIds:s,updateCardIds:f,insertCard:v,getCardById:C,getCardsByIds:T,updatePrice:U,getTrainers:P,insertTrainer:I,getTrainerCardIds:V,getTrainerById:G,getEnergies:Y,insertEnergie:J,getEnergieCardIds:de,getEnergieById:ue}=await Promise.resolve().then(()=>(Et(),wt));H=await t();let ae=await r(),ie=document.querySelector("#kartentabelle tbody");window.cachedCards={},window.cachedPokemonCardsByName={},window.cachedTrainerCardsByType={},window.cachedEnergyCardsByType={};let le=0,ye=ae.values.length;for(let o of ae.values){let u=document.createElement("tr"),d=parseInt(o.dex),g=`
      ...
      `;u.innerHTML=g,ie.appendChild(u),await M(o.dex),le++;let c=Math.min(99,Math.round(le/ye*100)),p=document.getElementById("progressBar"),m=document.getElementById("progressText");p&&(p.style.width=c+"%"),m&&(m.textContent=c+"%")}progressBar.style.width="100%",progressText.textContent="100%",setTimeout(()=>{let o=n.offsetHeight+"px";n.style.height=o,n.offsetHeight,n.style.transition="height 0.5s ease, opacity 0.5s ease",n.style.height="0px",n.style.opacity="0",n.style.overflow="hidden"},100),x(),S(),N(),document.querySelectorAll("#tableToggle button").forEach(o=>o.classList.remove("active")),document.getElementById("showTablePokemon").classList.add("active");function x(){let o=document.querySelectorAll("#kartentabelle tbody tr"),u=0;o.forEach(d=>{d.style.display!=="none"&&u++}),document.getElementById("eintragsAnzahl").textContent=`(${u})`}function S(){let o=0;document.querySelectorAll("#kartentabelle tbody tr").forEach(m=>{if(m.style.display==="none")return;let b=m.querySelectorAll("div[id^='kartenContainer_'] img");o+=b.length});let u=document.getElementById("kartenAnzahl");u&&(u.textContent=`(${o})`);let d=0;document.querySelectorAll("#trainertabelle tbody tr").forEach(m=>{if(m.style.display==="none")return;let b=m.querySelectorAll("div[id$='Container'] img");d+=b.length});let g=document.getElementById("kartenAnzahlTrainer");g&&(g.textContent=`(${d})`);let c=0;document.querySelectorAll("#energietabelle tbody tr").forEach(m=>{if(m.style.display==="none")return;let b=m.querySelectorAll("div[id$='Container'] img");c+=b.length});let p=document.getElementById("kartenAnzahlEnergie");p&&(p.textContent=`(${c})`)}async function M(o){let u=document.getElementById(`kartenContainer_${o}`),d=await s(o);if(!d)return;let g=d.split(";").filter(m=>m.trim()),c=await T(g.map(m=>parseInt(m)));c.sort((m,b)=>(b.avg30||0)-(m.avg30||0));let p=document.createDocumentFragment();for(let m of c){window.cachedCards[m.cardId]=m;let b=document.createElement("img");b.alt=m.cardId,b.style.width="50px",b.style.height="69px",b.style.objectFit="cover",b.src="cardBackside.png";let y=new Image;y.onload=()=>b.src=m.imageLow,y.onerror=()=>console.warn("Fehler beim Laden von:",m.imageLow),y.src=m.imageLow,b.addEventListener("click",()=>q(o,g.indexOf(String(m.id)))),p.appendChild(b)}u.appendChild(p)}async function q(o,u){let d=document.querySelector("#overlay");d.innerHTML='<div id="overlayContent"><div class="loader"></div></div>',d.classList.remove("hidden"),d.classList.add("shown");let g=await s(o);if(!g)return;let c=g.split(";").filter(b=>b.trim()!=="");if(c.length===0){L();return}let p=u;async function m(){let b=c[p];try{let y=await C(b),h="Unbekannt";if(y.addedAt){let R=new Date(y.addedAt),j={day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"};h=R.toLocaleString("de-DE",j)}let l="Keine Angabe";y.basic==1&&(l="Basic"),y.reverse==1&&(l="Reverse"),y.holo==1&&(l="Holo");let w=y.avg30,E="\u2013";if(w!=null){let R=w.toFixed(2),j="#DEDEDE",O="\u{1FA99}";w>20?(j="#FF4444",O="\u{1F525}"):w>5&&(j="#FFAA00",O="\u{1F4B0}"),E=`<span style="color:${j};">${O} ${R}\u20AC</span>`}else E='<span style="color:#888;">\u{1F578} Kein Preis gespeichert</span>';d.innerHTML=`
              ...
              <div style="display:flex; align-items:center; justify-content:center;">
                <div style="display:flex; flex-direction:column; align-items:center;">
                  ...
                  <p style="margin-top:10px;">
                    ID: ${y.cardId} | Variante: <strong>${l}</strong><br>
          ...
          `;let k=new Image;k.onload=()=>{document.getElementById("cardImage").src=y.imageHigh},k.onerror=()=>console.warn("Fehler beim Laden des Galerie-Bildes:",y.imageHigh),k.src=y.imageHigh,document.getElementById("deleteCard").addEventListener("click",async()=>{if(confirm("Willst du diese Karte wirklich l\xF6schen?")){let R=c[p];await H.run("DELETE FROM cards WHERE id = ?",[R]),c.splice(p,1),await f(o,c.join(";")+";"),L();let j=document.getElementById(`kartenContainer_${o}`);j.innerHTML="",M(o),S(),N()}}),document.getElementById("closeGallery").addEventListener("click",()=>{let R=document.getElementById("overlay");R.classList.add("fade-out"),setTimeout(()=>{R.classList.remove("shown","fade-out"),R.classList.add("hidden"),R.innerHTML=""},300)})}catch(y){console.error("Fehler beim Anzeigen der Karte:",y),L()}}m()}window.filterPokemonCardsByNumber=function(){let o=document.getElementById("nummerSuche").value.trim();document.querySelectorAll(".kartenItem").forEach(u=>{let d=u.dataset.number;u.style.display=d&&d.startsWith(o)?"block":"none"})},window.openOverlay=async function(o){if(!navigator.onLine)return alert("F\xFCr diese Funktion wird eine Internetverbindung ben\xF6tigt!"),null;let u=document.querySelector("#overlay");u.innerHTML=`
        <div id="overlayContent">
          <h2>Bitte warten...</h2>
          <p>Karten werden geladen</p>
          <div class="loader"></div>
        </div>
      `,u.classList.remove("hidden"),u.classList.add("shown");try{let d=await a(o),g=await i(o);g=="Nidoran\u2642"&&(g="Nidoran \u2642"),g=="Nidoran\u2640"&&(g="Nidoran \u2640"),g=="Farfetch\u2019d"&&(g="Farfetch'd"),g=="Sirfetch\u2019d"&&(g="Sirfetch'd");let c=window.cachedPokemonCardsByName[g];if(c||(c=await F(g),c&&(window.cachedPokemonCardsByName[g]=c)),!c||c.length===0){u.innerHTML=`
            <div id='overlayContent'>
              <h2>Keine Karten gefunden.</h2> 
              <button class="overlayMenuBtn" id="BackBtn">Schlie\xDFen</button>
            </div>
          `,document.getElementById("BackBtn").addEventListener("click",m=>{m.preventDefault(),L()});return}let p=`
          <div id="overlayContent">
        ...
        `;for(let m of c){let b=m.avg30,y="\u2013";if(b!=null){let l=b.toFixed(2),w="#DEDEDE",E="\u{1FA99}";b>20?(w="#FF4444",E="\u{1F525}"):b>5&&(w="#FFAA00",E="\u{1F4B0}"),y=`<span style="color:${w}; font-size:14px;">${E} ${l}\u20AC</span>`}let h=m.id.split("-")[1];p+=`
        ...
        `,u.innerHTML=p,document.getElementById("BackBtn").addEventListener("click",m=>{m.preventDefault(),L()})}catch(d){console.error(d),u.innerHTML=`
        <div id='overlayContent'>
          <h2>Fehler beim Laden.</h2>
          <button class="overlayMenuBtn" id="BackBtn">Schlie\xDFen</button>
        </div>`,document.getElementById("BackBtn").addEventListener("click",g=>{g.preventDefault(),L()})}};function K(o){return o.replace(/-(0*)(\d+)/,(u,d,g)=>"-"+parseInt(g,10))}async function F(o){var u,d;try{let g=`https://api.pokemontcg.io/v2/cards?q=name:"${o}"&orderBy=-set.releaseDate`,c=await ne.get({url:g,headers:{Accept:"application/json","X-Api-Key":se.API_KEY,Connection:"close"}});if(c.status!==200)return console.error("Fehler beim Abrufen der Karten:",c.status,c),null;let p=c.data.data;for(let m of p){let b=(u=m.cardmarket)==null?void 0:u.prices;m.avg30=(d=b==null?void 0:b.avg30)!=null?d:null}return p}catch(g){return console.error("Fehler beim Abrufen \xFCber HTTP:",g.message),null}}async function D(o){var u,d,g,c,p;try{let m=`https://api.pokemontcg.io/v2/cards?q=id:${o}`,b=await ne.get({url:m,headers:{Accept:"application/json","X-Api-Key":se.API_KEY,Connection:"close"}});if(b.status!==200||!((d=(u=b.data)==null?void 0:u.data)!=null&&d.length))return console.error("Fehler beim Abrufen der Karte:",b.status,b),null;let y=(c=(g=b.data.data[0])==null?void 0:g.cardmarket)==null?void 0:c.prices;return(p=y==null?void 0:y.avg30)!=null?p:null}catch(m){return console.error("Fehler beim Preisabruf:",m.message),null}}window.karteAusw\u00E4hlen=async function(o,u,d){var y,h;let g=document.querySelector("#overlay");g.innerHTML='<div id="overlayContent"><div class="loader"></div></div>',g.classList.remove("hidden"),g.classList.add("shown");let c=await ne.get({url:`https://api.pokemontcg.io/v2/cards/${o}`,headers:{Accept:"application/json","X-Api-Key":se.API_KEY,Connection:"close"}});if(c.status!==200){console.error("Fehler beim Abrufen der Karte:",c.status,c);return}let p=c.data.data;p.imageSmall=((y=p.images)==null?void 0:y.small)||null,p.imageLarge=((h=p.images)==null?void 0:h.large)||null;let m=await v(p);if(!m){console.error("Keine ID von insertCard erhalten \u2013 Abbruch.");return}p.id=m,window.cachedCards[p.cardId]=p,g.innerHTML=`
        <div id="overlayContent">
      ...
      `;async function b(l){g.innerHTML='<div id="overlayContent"><div class="loader"></div></div>',g.classList.remove("hidden"),g.classList.add("shown"),l!=="none"&&await H.run(`UPDATE cards SET ${l} = 1 WHERE id = ?`,[m]);let w=await s(u);w||(w=""),w+=m+";",await f(u,w);let E=document.getElementById(`kartenContainer_${u}`);E.innerHTML="",await M(u),L(),x(),S(),N()}document.getElementById("btnBasic").addEventListener("click",()=>b("basic")),document.getElementById("btnReverse").addEventListener("click",()=>b("reverse")),document.getElementById("btnHolo").addEventListener("click",()=>b("holo")),document.getElementById("closeOverlayConfirm").addEventListener("click",()=>b("none"))};async function N(){try{let o=await H.query("SELECT avg30 FROM cards WHERE avg30 IS NOT NULL"),u=await H.query("SELECT avg30 FROM trainer WHERE avg30 IS NOT NULL"),d=await H.query("SELECT avg30 FROM energy WHERE avg30 IS NOT NULL"),g=0;for(let l of o.values)g+=l.avg30;for(let l of u.values)g+=l.avg30;for(let l of d.values)g+=l.avg30;let c="\u{1FA99}";g>1e3?c="\u{1F525}":g>500&&(c="\u{1F4B0}"),document.getElementById("gesamtwert").textContent=`\u03A3: ${g.toFixed(2)}\u20AC ${c} | `;let p=await H.query("SELECT COUNT(*) as count FROM cards"),m=await H.query("SELECT COUNT(*) as count FROM trainer"),b=await H.query("SELECT COUNT(*) as count FROM energy"),y=p.values[0].count+m.values[0].count+b.values[0].count,h=document.getElementById("gesamtanzahl");h&&(h.textContent=`${y} Karten`)}catch(o){console.error("Fehler beim Berechnen des Gesamtwerts:",o)}}async function ee(){if(!navigator.onLine)return alert("F\xFCr diese Funktion wird eine Internetverbindung ben\xF6tigt!"),null;let o=await H.query("SELECT cardId FROM cards"),u=await H.query("SELECT cardId FROM trainer"),d=await H.query("SELECT cardId FROM energy"),g=0,c=0,p=o.values.length+u.values.length+d.values.length;alert(`Aktualisierung von ${p} Preisen gestartet.`);for(let b of o.values){let y=b.cardId,h=await D(y);if(h==null){let E=K(y);h=await D(E)}h!=null&&(await U(y,h),g++),c++;let l=Math.round(c/p*100),w=document.getElementById("preiseAktualisierenProgress");w&&(w.textContent=l+"%")}for(let b of u.values){let y=b.cardId,h=await D(y);if(h==null){let E=K(y);h=await D(E)}h!=null&&(await H.run("UPDATE trainer SET avg30 = ? WHERE cardId = ?",[h,y]),g++),c++;let l=Math.round(c/p*100),w=document.getElementById("preiseAktualisierenProgress");w&&(w.textContent=l+"%")}for(let b of d.values){let y=b.cardId,h=await D(y);if(h==null){let E=K(y);h=await D(E)}h!=null&&(await H.run("UPDATE energy SET avg30 = ? WHERE cardId = ?",[h,y]),g++),c++;let l=Math.round(c/p*100),w=document.getElementById("preiseAktualisierenProgress");w&&(w.textContent=l+"%")}let m=document.getElementById("preiseAktualisierenProgress");m&&(m.textContent=""),alert(`${g} Preise wurden aktualisiert!`),N()}window.aktualisiereAllePreise=ee;function fe(){let o=document.getElementById("search").value.trim().toUpperCase();["kartentabelle","trainertabelle","energietabelle"].forEach(d=>{document.querySelectorAll(`#${d} tbody tr`).forEach(c=>{let p=c.querySelector("td.pokemon a"),m=c.querySelectorAll("div[id*='Container'] img");if(o===""){c.style.display="",m.forEach(y=>y.style.display="inline-block");return}let b=!1;if(d==="kartentabelle"&&p)if(p.textContent.toUpperCase().includes(o))b=!0,m.forEach(h=>h.style.display="inline-block");else{let h=!1;m.forEach(l=>{let E=l.alt.toUpperCase().split("-")[1]||"",k=E.includes(o)||E.startsWith(o);l.style.display=k?"inline-block":"none",k&&(h=!0)}),b=h}if(d!=="kartentabelle"){let y=!1;m.forEach(h=>{let w=h.alt.toUpperCase().split("-")[1]||"",E=w.includes(o)||w.startsWith(o);h.style.display=E?"inline-block":"none",E&&(y=!0)}),b=y}c.style.display=b?"":"none"})}),x(),S(),N()}window.searchTable=fe,document.getElementById("search").addEventListener("input",function(){let o=document.getElementById("clearSearch");o.style.display=this.value.trim()?"inline":"none"}),document.getElementById("clearSearch").addEventListener("click",function(){let o=document.getElementById("search");o.value="",this.style.display="none",fe()});let B={reverse:"neutral",holo:"neutral",v:"neutral",vmax:"neutral",ex:"neutral",shiny:"neutral"};function Ee(){let o=["kartentabelle","trainertabelle","energietabelle"],u=Object.values(B).some(d=>d==="positive");o.forEach(d=>{document.querySelectorAll(`#${d} tbody tr`).forEach(c=>{let p=c.querySelector("div[id*='Container']");if(!p)return;let m=p.querySelectorAll("img"),b=0;m.forEach(y=>{var j,O,W,X,be,We,Ge,ze,Ue,Ve,Je,_e,Xe,Ze,Qe;let h=y.alt,l=(j=window.cachedCards)==null?void 0:j[h];if(!l){y.style.display="none";return}let w=!0;B.reverse==="positive"&&l.reverse!==1&&(w=!1),B.reverse==="negative"&&l.reverse===1&&(w=!1),B.holo==="positive"&&l.holo!==1&&(w=!1),B.holo==="negative"&&l.holo===1&&(w=!1),B.v==="positive"&&!((O=l.subTypes)!=null&&O.toLowerCase().includes("v")||(W=l.cardName)!=null&&W.toLowerCase().includes(" v"))&&(w=!1),B.v==="negative"&&((X=l.subTypes)!=null&&X.toLowerCase().includes("v")||(be=l.cardName)!=null&&be.toLowerCase().includes(" v"))&&(w=!1);let E=((We=l.subTypes)==null?void 0:We.toLowerCase().includes("vmax"))||((Ge=l.cardName)==null?void 0:Ge.toLowerCase().includes(" vmax")),k=((ze=l.subTypes)==null?void 0:ze.toLowerCase().includes("vstar"))||((Ue=l.cardName)==null?void 0:Ue.toLowerCase().includes(" vstar"));B.vmax==="positive"&&!(E||k)&&(w=!1),B.vmax==="negative"&&(E||k)&&(w=!1),B.ex==="positive"&&!((Ve=l.subTypes)!=null&&Ve.toLowerCase().includes("ex")||(Je=l.cardName)!=null&&Je.toLowerCase().includes(" ex"))&&(w=!1),B.ex==="negative"&&((_e=l.subTypes)!=null&&_e.toLowerCase().includes("ex")||(Xe=l.cardName)!=null&&Xe.toLowerCase().includes(" ex"))&&(w=!1);let R=((Ze=l.subTypes)==null?void 0:Ze.toLowerCase().includes("radiant"))||((Qe=l.rarity)==null?void 0:Qe.toLowerCase().includes("shiny"));B.shiny==="positive"&&!R&&(w=!1),B.shiny==="negative"&&R&&(w=!1),y.style.display=w?"inline-block":"none",w&&b++}),m.length===0?c.style.display=u?"none":"":c.style.display=b>0?"":"none"})}),x(),S(),N()}function te(o){B[o]==="neutral"?B[o]="positive":B[o]==="positive"?B[o]="negative":B[o]="neutral",Ee(),$()}function $(){let o=["reverse","holo","v","vmax","ex","shiny"];for(let u of o){let d=document.getElementById(`filter-${u}`);d&&(d.classList.remove("active-positive","active-negative"),B[u]==="positive"?d.classList.add("active-positive"):B[u]==="negative"&&d.classList.add("active-negative"))}}document.getElementById("filter-alle").addEventListener("click",o=>{o.preventDefault(),B.reverse="neutral",B.holo="neutral",B.v="neutral",B.vmax="neutral",B.ex="neutral",B.shiny="neutral",Ee(),$()}),document.getElementById("filter-reverse").addEventListener("click",o=>{o.preventDefault(),te("reverse")}),document.getElementById("filter-holo").addEventListener("click",o=>{o.preventDefault(),te("holo")}),document.getElementById("filter-v").addEventListener("click",o=>{o.preventDefault(),te("v")}),document.getElementById("filter-vmax").addEventListener("click",o=>{o.preventDefault(),te("vmax")}),document.getElementById("filter-ex").addEventListener("click",o=>{o.preventDefault(),te("ex")}),document.getElementById("filter-shiny").addEventListener("click",o=>{o.preventDefault(),te("shiny")});function L(){let o=document.getElementById("overlay");o.classList.add("fade-out"),setTimeout(()=>{o.classList.remove("shown","fade-out"),o.classList.add("hidden"),o.innerHTML=""},300)}function z(o){["kartentabelle","trainertabelle","energietabelle"].forEach(d=>{let g=document.getElementById(d);g&&(d===o?g.classList.remove("hidden"):g.classList.add("hidden"))})}window.zeigePokemonTabelle=function(){document.querySelectorAll("#tableToggle button").forEach(o=>o.classList.remove("active")),document.getElementById("showTablePokemon").classList.add("active"),z("kartentabelle")},window.zeigeTrainerTabelle=async function(){document.querySelectorAll("#tableToggle button").forEach(p=>p.classList.remove("active")),document.getElementById("showTableTrainer").classList.add("active"),z("trainertabelle");let o=document.querySelector("#trainertabelle tbody");o.innerHTML="";let u=document.createElement("tr");u.innerHTML=`
      ...
      `,o.appendChild(d);let g=document.createElement("tr");g.innerHTML=`
        <td>Stadion</td>
        <td>
      ...
      `,o.appendChild(g);let c=document.createElement("tr");c.innerHTML=`
      ...
      `,o.appendChild(c),await Z(),S()};async function Z(){let o=document.getElementById("supporterContainer"),u=document.getElementById("itemContainer"),d=document.getElementById("stadiumContainer"),g=document.getElementById("toolContainer"),c=await P();if(!c||!Array.isArray(c)){console.error("getTrainers() lieferte keine g\xFCltige Liste:",c);return}c.sort((h,l)=>(l.avg30||0)-(h.avg30||0));let p=document.createDocumentFragment(),m=document.createDocumentFragment(),b=document.createDocumentFragment(),y=document.createDocumentFragment();for(let h of c){window.cachedCards[h.cardId]=h;let l=document.createElement("img");l.alt=h.cardId,l.style.width="50px",l.style.height="69px",l.style.objectFit="cover",l.src="cardBackside.png";let w=new Image;w.onload=()=>l.src=h.imageLow,w.onerror=()=>console.warn("Fehler beim Laden von:",h.imageLow),w.src=h.imageLow;let E="";if(Array.isArray(h.subTypes))h.subTypes.some(k=>k.toLowerCase().includes("supporter"))?E="supporter":h.subTypes.some(k=>k.toLowerCase().includes("item"))?E="item":h.subTypes.some(k=>k.toLowerCase().includes("stadium"))?E="stadium":h.subTypes.some(k=>k.toLowerCase().includes("tool"))&&(E="tool");else if(typeof h.subTypes=="string"){let k=h.subTypes.toLowerCase();k.includes("supporter")?E="supporter":k.includes("item")?E="item":k.includes("stadium")?E="stadium":k.includes("tool")&&(E="tool")}l.addEventListener("click",()=>_(h.id,E)),E=="supporter"&&p.appendChild(l),E=="item"&&m.appendChild(l),E=="stadium"&&b.appendChild(l),E=="tool"&&y.appendChild(l)}o.appendChild(p),u.appendChild(m),d.appendChild(b),g.appendChild(y)}window.openTrainerOverlay=async function(o){if(!navigator.onLine)return alert("F\xFCr diese Funktion wird eine Internetverbindung ben\xF6tigt!"),null;let u=document.querySelector("#overlay");u.innerHTML=`
        <div id="overlayContent">
          <h2>Bitte warten...</h2>
          <p>Karten werden geladen</p>
          <div class="loader"></div>
        </div>
      `,u.classList.remove("hidden"),u.classList.add("shown");try{let d=window.cachedTrainerCardsByType[o];if(d||(d=await Q(o),d&&(window.cachedTrainerCardsByType[o]=d)),!d||d.length===0){u.innerHTML=`
            <div id='overlayContent'>
              <h2>Keine Karten gefunden.</h2> 
              <button class="overlayMenuBtn" id="BackBtn">Schlie\xDFen</button>
            </div>
          `,document.getElementById("BackBtn").addEventListener("click",()=>{e.preventDefault(),L()});return}let g=`
          <div id="overlayContent">
            <button class="closeGallery" id="BackBtn">X</button>
            ...
            <div class="kartenGrid">
        `;for(let c of d){let p=c.avg30,m="\u2013";if(p!=null){let y=p.toFixed(2),h="#DEDEDE",l="\u{1FA99}";p>20?(h="#FF4444",l="\u{1F525}"):p>5&&(h="#FFAA00",l="\u{1F4B0}"),m=`<span style="color:${h}; font-size:14px;">${l} ${y}\u20AC</span>`}let b=c.id.split("-")[1];g+=`
            <div class="kartenItem" data-id="${c.id}" data-number="${b}" onclick="trainerKarteAusw\xE4hlen('${c.id}')">
              <div>ID: ${c.id}</div>
        ...
        `,u.innerHTML=g,document.getElementById("BackBtn").addEventListener("click",()=>{L()})}catch(d){console.error(d),u.innerHTML=`
          <div id='overlayContent'>
            <h2>Fehler beim Laden.</h2>
            <button class="overlayMenuBtn" id="BackBtn">Schlie\xDFen</button>
          </div>`,document.getElementById("BackBtn").addEventListener("click",()=>{L()})}};async function Q(o){var p,m,b,y;let u=[],d=1,g=250,c=!0;for(;c;){let h=`https://api.pokemontcg.io/v2/cards?q=supertype:Trainer subtypes:${o}&orderBy=name&page=${d}&pageSize=${g}`,l=await ne.get({url:h,headers:{Accept:"application/json","X-Api-Key":se.API_KEY,Connection:"close"}});if(l.status!==200||!((m=(p=l.data)==null?void 0:p.data)!=null&&m.length)){c=!1;break}let w=l.data.data;for(let E of w){let k=(b=E.cardmarket)==null?void 0:b.prices;E.avg30=(y=k==null?void 0:k.avg30)!=null?y:null}u=u.concat(w),w.length<g?c=!1:d++}return u}window.trainerKarteAusw\u00E4hlen=async function(o){var d,g;let u=document.querySelector("#overlay");u.innerHTML='<div id="overlayContent"><div class="loader"></div></div>',u.classList.remove("hidden"),u.classList.add("shown");try{let c=await ne.get({url:`https://api.pokemontcg.io/v2/cards/${o}`,headers:{Accept:"application/json","X-Api-Key":se.API_KEY,Connection:"close"}});if(c.status!==200){console.error("Fehler beim Abrufen der Karte:",c.status,c);return}let p=c.data.data;p.imageSmall=((d=p.images)==null?void 0:d.small)||null,p.imageLarge=((g=p.images)==null?void 0:g.large)||null;let m=await I(p);if(!m){console.error("Keine ID von insertCard erhalten \u2013 Abbruch.");return}p.id=m,window.cachedCards[p.cardId]=p,u.innerHTML=`
          <div id="overlayContent">
            <h2>Karte hinzugef\xFCgt!</h2>
        ...
        `;async function b(y,h){u.innerHTML='<div id="overlayContent"><div class="loader"></div></div>',u.classList.remove("hidden"),u.classList.add("shown");try{y!=="none"&&await H.run(`UPDATE trainer SET ${y} = 1 WHERE id = ?`,[h]);let l=document.getElementById("supporterContainer");l.innerHTML="";let w=document.getElementById("itemContainer");w.innerHTML="";let E=document.getElementById("stadiumContainer");E.innerHTML="";let k=document.getElementById("toolContainer");k.innerHTML="",await Z()}catch(l){console.error("Fehler in finalizeTrainerSelection:",l.message,l)}L(),await N()}document.getElementById("btnBasic").addEventListener("click",()=>b("basic",m)),document.getElementById("btnReverse").addEventListener("click",()=>b("reverse",m)),document.getElementById("btnHolo").addEventListener("click",()=>b("holo",m)),document.getElementById("closeOverlayConfirm").addEventListener("click",()=>b("none",m))}catch(c){console.error("Fehler bei trainerKarteAusw\xE4hlen:",c),u.innerHTML=`
          <div id="overlayContent">
            <h2>Fehler beim Hinzuf\xFCgen.</h2>
            <p>${c.message}</p>
            <button class="overlayMenuBtn" id="closeOverlayConfirm">Schlie\xDFen</button>
          </div>
        `,document.getElementById("closeOverlayConfirm").addEventListener("click",()=>{L()})}};async function _(o,u){var y;let d=document.querySelector("#overlay");d.innerHTML='<div id="overlayContent"><div class="loader"></div></div>',d.classList.remove("hidden"),d.classList.add("shown");let g=await V();if(!g||!g.length)return;let c=[],p={};for(let h of g){let l=await G(h);if(!l)continue;let w=((y=l.subTypes)==null?void 0:y.toLowerCase())||"";(u==="supporter"&&w.includes("supporter")||u==="item"&&w.includes("item")||u==="stadium"&&w.includes("stadium")||u==="tool"&&w.includes("tool"))&&(c.push(h),p[h]=l)}if(!c.length){L();return}let m=c.findIndex(h=>h===o);m===-1&&(m=0);async function b(){let h=c[m],l=p[h]||await G(h);if(!l)return;let w="Unbekannt";l.addedAt&&(w=new Date(l.addedAt).toLocaleString("de-DE",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"}));let E="Keine Angabe";l.basic==1&&(E="Basic"),l.reverse==1&&(E="Reverse"),l.holo==1&&(E="Holo");let k=l.avg30,R="\u2013";if(k!=null){let O=k.toFixed(2),W="#DEDEDE",X="\u{1FA99}";k>20?(W="#FF4444",X="\u{1F525}"):k>5&&(W="#FFAA00",X="\u{1F4B0}"),R=`<span style="color:${W};">${X} ${O}\u20AC</span>`}else R='<span style="color:#888;">\u{1F578} Kein Preis gespeichert</span>';d.innerHTML=`
          <div id="overlayContent">
            <button class="closeGallery" id="closeGallery">X</button>
            <h2>Trainer</h2>
            <div style="display:flex; align-items:center; justify-content:center;">
              <div style="display:flex; flex-direction:column; align-items:center;">
                ...
                <p style="margin-top:10px;">
                  ID: ${l.cardId} | Variante: <strong>${E}</strong><br>
                  30d-Wert: <strong>${R}</strong><br>
      ...
      `,o.appendChild(d),await oe(),S()};async function oe(){var p,m,b;let o=document.getElementById("basisEnergieContainer"),u=document.getElementById("spezialEnergieContainer"),d=await Y();if(!d||!Array.isArray(d)){console.error("getEnergies() lieferte keine g\xFCltige Liste:",d);return}d.sort((y,h)=>(h.avg30||0)-(y.avg30||0));let g=document.createDocumentFragment(),c=document.createDocumentFragment();for(let y of d){window.cachedCards[y.cardId]=y;let h=document.createElement("img");h.alt=y.cardId,h.style.width="50px",h.style.height="69px",h.style.objectFit="cover";let l=((p=y.subTypes)==null?void 0:p.toLowerCase())||"";h.addEventListener("click",()=>kt(y.id,l.includes("basic")?"basic":"special")),h.src="cardBackside.png";let w=new Image;w.onload=()=>h.src=y.imageLow,w.onerror=()=>console.warn("Fehler beim Laden von:",y.imageLow),w.src=y.imageLow,(m=y.subTypes)!=null&&m.toLowerCase().includes("basic")?g.appendChild(h):(b=y.subTypes)!=null&&b.toLowerCase().includes("special")&&c.appendChild(h)}o.appendChild(g),u.appendChild(c)}window.openEnergieOverlay=async function(o){if(!navigator.onLine)return alert("F\xFCr diese Funktion wird eine Internetverbindung ben\xF6tigt!"),null;let u=document.querySelector("#overlay");u.innerHTML=`
        <div id="overlayContent">
          <h2>Bitte warten...</h2>
          <p>Karten werden geladen</p>
          <div class="loader"></div>
        </div>
      `,u.classList.remove("hidden"),u.classList.add("shown");try{let d=window.cachedEnergyCardsByType[o];if(d||(d=await me(o),d&&(window.cachedEnergyCardsByType[o]=d)),!d||d.length===0){u.innerHTML=`
            <div id='overlayContent'>
              <h2>Keine Karten gefunden.</h2> 
              <button class="overlayMenuBtn" id="BackBtn">Schlie\xDFen</button>
            </div>
          `,document.getElementById("BackBtn").addEventListener("click",()=>{L()});return}let g=`
          <div id="overlayContent">
            <button class="closeGallery" id="BackBtn">X</button>
            <h2>Kartenauswahl f\xFCr<br><strong>${o}</strong>:</h2>
            <p>
            ...
            <div class="kartenGrid">
        `;for(let c of d){let p=c.avg30,m="\u2013";if(p!=null){let y=p.toFixed(2),h="#DEDEDE",l="\u{1FA99}";p>20?(h="#FF4444",l="\u{1F525}"):p>5&&(h="#FFAA00",l="\u{1F4B0}"),m=`<span style="color:${h}; font-size:14px;">${l} ${y}\u20AC</span>`}let b=c.id.split("-")[1];g+=`
            <div class="kartenItem" data-id="${c.id}" data-number="${b}" onclick="energieKarteAusw\xE4hlen('${c.id}')">
              <div>ID: ${c.id}</div>
              <img src="${c.images.small}" alt="${c.name}">
              <div>${m}</div>
            </div>
        ...
        `,u.innerHTML=g,document.getElementById("BackBtn").addEventListener("click",()=>{L()})}catch(d){console.error(d),u.innerHTML=`
          <div id='overlayContent'>
            <h2>Fehler beim Laden.</h2>
            <button class="overlayMenuBtn" id="BackBtn">Schlie\xDFen</button>
          </div>`,document.getElementById("BackBtn").addEventListener("click",()=>{L()})}};async function me(o){var p,m,b,y;let u=[],d=1,g=250,c=!0;for(;c;){let h=`https://api.pokemontcg.io/v2/cards?q=supertype:Energy subtypes:${o}&orderBy=name&page=${d}&pageSize=${g}`,l=await ne.get({url:h,headers:{Accept:"application/json","X-Api-Key":se.API_KEY,Connection:"close"}});if(l.status!==200||!((m=(p=l.data)==null?void 0:p.data)!=null&&m.length)){c=!1;break}let w=l.data.data;for(let E of w){let k=(b=E.cardmarket)==null?void 0:b.prices;E.avg30=(y=k==null?void 0:k.avg30)!=null?y:null}u=u.concat(w),w.length<g?c=!1:d++}return u}window.energieKarteAusw\u00E4hlen=async function(o){var d,g;let u=document.querySelector("#overlay");u.innerHTML='<div id="overlayContent"><div class="loader"></div></div>',u.classList.remove("hidden"),u.classList.add("shown");try{let c=await ne.get({url:`https://api.pokemontcg.io/v2/cards/${o}`,headers:{Accept:"application/json","X-Api-Key":se.API_KEY,Connection:"close"}});if(c.status!==200){console.error("Fehler beim Abrufen der Karte:",c.status,c);return}let p=c.data.data;p.imageSmall=((d=p.images)==null?void 0:d.small)||null,p.imageLarge=((g=p.images)==null?void 0:g.large)||null;let m=await J(p);if(!m){console.error("Keine ID von insertCard erhalten \u2013 Abbruch.");return}p.id=m,window.cachedCards[p.cardId]=p,u.innerHTML=`
          <div id="overlayContent">
            <h2>Karte hinzugef\xFCgt!</h2>
            <p>Du hast <strong>${o}</strong> ausgew\xE4hlt.</p>
            <br>
        ...
        `;async function b(y,h){u.innerHTML='<div id="overlayContent"><div class="loader"></div></div>',u.classList.remove("hidden"),u.classList.add("shown");try{y!=="none"&&await H.run(`UPDATE energy SET ${y} = 1 WHERE id = ?`,[h]);let l=document.getElementById("basisEnergieContainer");l.innerHTML="";let w=document.getElementById("spezialEnergieContainer");w.innerHTML="",await oe()}catch(l){console.error("Fehler in finalizeEnergieSelection:",l.message,l)}L(),await N()}document.getElementById("btnBasic").addEventListener("click",()=>b("basic",m)),document.getElementById("btnReverse").addEventListener("click",()=>b("reverse",m)),document.getElementById("btnHolo").addEventListener("click",()=>b("holo",m)),document.getElementById("closeOverlayConfirm").addEventListener("click",()=>b("none",m))}catch(c){console.error("Fehler bei energieKarteAusw\xE4hlen:",c),u.innerHTML=`
          <div id="overlayContent">
            <h2>Fehler beim Hinzuf\xFCgen.</h2>
            <p>${c.message}</p>
            <button class="overlayMenuBtn" id="closeOverlayConfirm">Schlie\xDFen</button>
          </div>
        `,document.getElementById("closeOverlayConfirm").addEventListener("click",()=>{L()})}};async function kt(o,u){var y;let d=document.querySelector("#overlay");d.innerHTML='<div id="overlayContent"><div class="loader"></div></div>',d.classList.remove("hidden"),d.classList.add("shown");let g=await de();if(!g||!g.length)return;let c=[],p={};for(let h of g){let l=await ue(h);if(!l)continue;let w=((y=l.subTypes)==null?void 0:y.toLowerCase())||"";(u==="basic"&&w.includes("basic")||u==="special"&&w.includes("special"))&&(c.push(h),p[h]=l)}if(!c.length){L();return}let m=c.findIndex(h=>h===o);m===-1&&(m=0);async function b(){let h=c[m],l=p[h]||await ue(h);if(!l)return;let w="Unbekannt";l.addedAt&&(w=new Date(l.addedAt).toLocaleString("de-DE",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"}));let E="Keine Angabe";l.basic==1&&(E="Basic"),l.reverse==1&&(E="Reverse"),l.holo==1&&(E="Holo");let k=l.avg30,R="\u2013";if(k!=null){let O=k.toFixed(2),W="#DEDEDE",X="\u{1FA99}";k>20?(W="#FF4444",X="\u{1F525}"):k>5&&(W="#FFAA00",X="\u{1F4B0}"),R=`<span style="color:${W};">${X} ${O}\u20AC</span>`}else R='<span style="color:#888;">\u{1F578} Kein Preis gespeichert</span>';d.innerHTML=`
          <div id="overlayContent">
            <button class="closeGallery" id="closeGallery">X</button>
            <h2>Energie</h2>
            <div style="display:flex; align-items:center; justify-content:center;">
        ...
        `;let j=new Image;j.onload=()=>{document.getElementById("cardImage").src=l.imageHigh},j.onerror=()=>console.warn("Fehler beim Laden des Galerie-Bildes:",l.imageHigh),j.src=l.imageHigh,document.getElementById("deleteEnergie").addEventListener("click",async()=>{if(confirm("Willst du diese Karte wirklich l\xF6schen?"))try{await H.run("DELETE FROM energy WHERE id = ?",[h]),L();let O=document.getElementById("basisEnergieContainer"),W=document.getElementById("spezialEnergieContainer");O&&(O.innerHTML=""),W&&(W.innerHTML=""),await oe(),await N()}catch(O){console.error("Fehler beim L\xF6schen der Energie-Karte:",O),alert("Beim L\xF6schen ist ein Fehler aufgetreten.")}}),document.getElementById("closeGallery").addEventListener("click",()=>{L()})}b()}window.filterEnergieCardsByNumber=function(){let o=document.getElementById("nummerSuche").value.trim();document.querySelectorAll(".kartenItem").forEach(u=>{let d=u.dataset.number;u.style.display=d&&d.startsWith(o)?"block":"none"})}})()});})();
