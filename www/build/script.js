(()=>{var St=Object.defineProperty;var te=(n,t)=>()=>(n&&(t=n(n=0)),t);var Ct=(n,t)=>()=>(t||n((t={exports:{}}).exports,t),t.exports),Pe=(n,t)=>{for(var r in t)St(n,r,{get:t[r],enumerable:!0})};var Tt,Lt,Ye,lr,cr,me,fe,Pt,xt,It,Ee,et,dr,ke,xe=te(()=>{Tt=n=>{let t=new Map;t.set("web",{name:"web"});let r=n.CapacitorPlatforms||{currentPlatform:{name:"web"},platforms:t},a=(o,y)=>{r.platforms.set(o,y)},i=o=>{r.platforms.has(o)&&(r.currentPlatform=r.platforms.get(o))};return r.addPlatform=a,r.setPlatform=i,r},Lt=n=>n.CapacitorPlatforms=Tt(n),Ye=Lt(typeof globalThis!="undefined"?globalThis:typeof self!="undefined"?self:typeof window!="undefined"?window:typeof global!="undefined"?global:{}),lr=Ye.addPlatform,cr=Ye.setPlatform;(function(n){n.Unimplemented="UNIMPLEMENTED",n.Unavailable="UNAVAILABLE"})(me||(me={}));fe=class extends Error{constructor(t,r){super(t),this.message=t,this.code=r}},Pt=n=>{var t,r;return n!=null&&n.androidBridge?"android":!((r=(t=n==null?void 0:n.webkit)===null||t===void 0?void 0:t.messageHandlers)===null||r===void 0)&&r.bridge?"ios":"web"},xt=n=>{var t,r,a,i,o;let y=n.CapacitorCustomPlatform||null,f=n.Capacitor||{},S=f.Plugins=f.Plugins||{},C=n.CapacitorPlatforms,G=()=>y!==null?y.name:Pt(n),P=((t=C==null?void 0:C.currentPlatform)===null||t===void 0?void 0:t.getPlatform)||G,x=()=>P()!=="web",U=((r=C==null?void 0:C.currentPlatform)===null||r===void 0?void 0:r.isNativePlatform)||x,W=I=>{let k=ae.get(I);return!!(k!=null&&k.platforms.has(P())||ce(I))},Q=((a=C==null?void 0:C.currentPlatform)===null||a===void 0?void 0:a.isPluginAvailable)||W,V=I=>{var k;return(k=f.PluginHeaders)===null||k===void 0?void 0:k.find(R=>R.name===I)},ce=((i=C==null?void 0:C.currentPlatform)===null||i===void 0?void 0:i.getPluginHeader)||V,de=I=>n.console.error(I),ne=(I,k,R)=>Promise.reject(`${R} does not have an implementation of "${k}".`),ae=new Map,se=(I,k={})=>{let R=ae.get(I);if(R)return console.warn(`Capacitor plugin "${I}" already registered. Cannot register plugins twice.`),R.proxy;let O=P(),D=ce(I),K,B=async()=>(!K&&O in k?K=typeof k[O]=="function"?K=await k[O]():K=k[O]:y!==null&&!K&&"web"in k&&(K=typeof k.web=="function"?K=await k.web():K=k.web),K),H=($,T)=>{var z,X;if(D){let Z=D==null?void 0:D.methods.find(J=>T===J.name);if(Z)return Z.rtype==="promise"?J=>f.nativePromise(I,T.toString(),J):(J,ie)=>f.nativeCallback(I,T.toString(),J,ie);if($)return(z=$[T])===null||z===void 0?void 0:z.bind($)}else{if($)return(X=$[T])===null||X===void 0?void 0:X.bind($);throw new fe(`"${I}" plugin is not implemented on ${O}`,me.Unimplemented)}},Y=$=>{let T,z=(...X)=>{let Z=B().then(J=>{let ie=H(J,$);if(ie){let ue=ie(...X);return T=ue==null?void 0:ue.remove,ue}else throw new fe(`"${I}.${$}()" is not implemented on ${O}`,me.Unimplemented)});return $==="addListener"&&(Z.remove=async()=>T()),Z};return z.toString=()=>`${$.toString()}() { [capacitor code] }`,Object.defineProperty(z,"name",{value:$,writable:!1,configurable:!1}),z},ve=Y("addListener"),A=Y("removeListener"),we=($,T)=>{let z=ve({eventName:$},T),X=async()=>{let J=await z;A({eventName:$,callbackId:J},T)},Z=new Promise(J=>z.then(()=>J({remove:X})));return Z.remove=async()=>{console.warn("Using addListener() without 'await' is deprecated."),await X()},Z},ee=new Proxy({},{get($,T){switch(T){case"$$typeof":return;case"toJSON":return()=>({});case"addListener":return D?we:ve;case"removeListener":return A;default:return Y(T)}}});return S[I]=ee,ae.set(I,{name:I,proxy:ee,platforms:new Set([...Object.keys(k),...D?[O]:[]])}),ee},ge=((o=C==null?void 0:C.currentPlatform)===null||o===void 0?void 0:o.registerPlugin)||se;return f.convertFileSrc||(f.convertFileSrc=I=>I),f.getPlatform=P,f.handleError=de,f.isNativePlatform=U,f.isPluginAvailable=Q,f.pluginMethodNoop=ne,f.registerPlugin=ge,f.Exception=fe,f.DEBUG=!!f.DEBUG,f.isLoggingEnabled=!!f.isLoggingEnabled,f.platform=f.getPlatform(),f.isNative=f.isNativePlatform(),f},It=n=>n.Capacitor=xt(n),Ee=It(typeof globalThis!="undefined"?globalThis:typeof self!="undefined"?self:typeof window!="undefined"?window:typeof global!="undefined"?global:{}),et=Ee.registerPlugin,dr=Ee.Plugins,ke=class{constructor(t){this.listeners={},this.windowListeners={},t&&(console.warn(`Capacitor WebPlugin "${t.name}" config object was deprecated in v3 and will be removed in v4.`),this.config=t)}addListener(t,r){this.listeners[t]||(this.listeners[t]=[]),this.listeners[t].push(r);let i=this.windowListeners[t];i&&!i.registered&&this.addWindowListener(i);let o=async()=>this.removeListener(t,r),y=Promise.resolve({remove:o});return Object.defineProperty(y,"remove",{value:async()=>{console.warn("Using addListener() without 'await' is deprecated."),await o()}}),y}async removeAllListeners(){this.listeners={};for(let t in this.windowListeners)this.removeWindowListener(this.windowListeners[t]);this.windowListeners={}}notifyListeners(t,r){let a=this.listeners[t];a&&a.forEach(i=>i(r))}hasListeners(t){return!!this.listeners[t].length}registerWindowListener(t,r){this.windowListeners[r]={registered:!1,windowEventName:t,pluginEventName:r,handler:a=>{this.notifyListeners(r,a)}}}unimplemented(t="not implemented"){return new Ee.Exception(t,me.Unimplemented)}unavailable(t="not available"){return new Ee.Exception(t,me.Unavailable)}async removeListener(t,r){let a=this.listeners[t];if(!a)return;let i=a.indexOf(r);this.listeners[t].splice(i,1),this.listeners[t].length||this.removeWindowListener(this.windowListeners[t])}addWindowListener(t){window.addEventListener(t.windowEventName,t.handler),t.registered=!0}removeWindowListener(t){t&&(window.removeEventListener(t.windowEventName,t.handler),t.registered=!1)}}});var tt,Ie,Ae,Be=te(()=>{tt=async n=>new Promise((t,r)=>{let a=new FileReader;a.onload=()=>{let i=a.result,o=i.substr(i.indexOf(",")+1);t(o)},a.onerror=i=>r(i),a.readAsDataURL(n)}),Ie=n=>encodeURIComponent(n).replace(/%(2[346B]|5E|60|7C)/g,decodeURIComponent).replace(/[()]/g,escape),Ae=n=>n.replace(/(%[\dA-F]{2})+/gi,decodeURIComponent)});var rt,Se,nt,at,Me,it=te(()=>{Be();rt=(n,t,r={})=>{let a=Ie(n),i=Ie(t),o=`; expires=${(r.expires||"").replace("expires=","")}`,y=(r.path||"/").replace("path=","");document.cookie=`${a}=${i||""}${o}; path=${y}`},Se=()=>{let n=[],t={};if(!document.cookie)return n;let r=document.cookie.split(";")||[];for(let i of r){let[o,y]=i.replace(/=/,"CAP_COOKIE").split("CAP_COOKIE");o=Ae(o).trim(),y=Ae(y).trim(),t[o]=y}let a=Object.entries(t);for(let[i,o]of a)n.push({key:i,value:o});return n},nt=n=>{let t=Se();for(let r of t)if(r.key===n)return r;return{key:n,value:""}},at=n=>{document.cookie=`${n}=; Max-Age=0`},Me=()=>{let n=document.cookie.split(";")||[];for(let t of n)document.cookie=t.replace(/^ +/,"").replace(/=.*/,`=;expires=${new Date().toUTCString()};path=/`)}});var Bt,Mt,Re,le,ot,st,lt,ct,dt,ut=te(()=>{Be();Bt=(n={})=>{let t=Object.keys(n);return Object.keys(n).map(i=>i.toLocaleLowerCase()).reduce((i,o,y)=>(i[o]=n[t[y]],i),{})},Mt=(n,t=!0)=>n?Object.entries(n).reduce((a,i)=>{let[o,y]=i,f,S;return Array.isArray(y)?(S="",y.forEach(C=>{f=t?encodeURIComponent(C):C,S+=`${o}=${f}&`}),S.slice(0,-1)):(f=t?encodeURIComponent(y):y,S=`${o}=${f}`),`${a}&${S}`},"").substr(1):null,Re=(n,t={})=>{let r=Object.assign({method:n.method||"GET",headers:n.headers},t),i=Bt(n.headers)["content-type"]||"";if(typeof n.data=="string")r.body=n.data;else if(i.includes("application/x-www-form-urlencoded")){let o=new URLSearchParams;for(let[y,f]of Object.entries(n.data||{}))o.set(y,f);r.body=o.toString()}else if(i.includes("multipart/form-data")){let o=new FormData;if(n.data instanceof FormData)n.data.forEach((f,S)=>{o.append(S,f)});else for(let f of Object.keys(n.data))o.append(f,n.data[f]);r.body=o;let y=new Headers(r.headers);y.delete("content-type"),r.headers=y}else(i.includes("application/json")||typeof n.data=="object")&&(r.body=JSON.stringify(n.data));return r},le=async n=>{let t=Re(n,n.webFetchExtra),r=Mt(n.params,n.shouldEncodeUrlParams),a=r?`${n.url}?${r}`:n.url,i=await fetch(a,t),o=i.headers.get("content-type")||"",{responseType:y="text"}=i.ok?n:{};o.includes("application/json")&&(y="json");let f;switch(y){case"arraybuffer":case"blob":let C=await i.blob();f=await tt(C);break;case"json":f=await i.json();break;case"document":case"text":default:f=await i.text()}let S={};return i.headers.forEach((C,G)=>{S[G]=C}),{data:f,headers:S,status:i.status,url:i.url}},ot=async n=>le(Object.assign(Object.assign({},n),{method:"GET"})),st=async n=>le(Object.assign(Object.assign({},n),{method:"POST"})),lt=async n=>le(Object.assign(Object.assign({},n),{method:"PUT"})),ct=async n=>le(Object.assign(Object.assign({},n),{method:"PATCH"})),dt=async n=>le(Object.assign(Object.assign({},n),{method:"DELETE"}))});var Fe={};Pe(Fe,{HttpWeb:()=>qe});var qe,De=te(()=>{xe();it();ut();qe=class extends ke{constructor(){super(),this.request=async t=>le(t),this.get=async t=>ot(t),this.post=async t=>st(t),this.put=async t=>lt(t),this.patch=async t=>ct(t),this.del=async t=>dt(t),this.getCookiesMap=async t=>{let r=Se(),a={};for(let i of r)a[i.key]=i.value;return a},this.getCookies=async t=>{let{url:r}=t;return{cookies:Se()}},this.setCookie=async t=>{let{key:r,value:a,expires:i="",path:o=""}=t;rt(r,a,{expires:i,path:o})},this.getCookie=async t=>nt(t.key),this.deleteCookie=async t=>at(t.key),this.clearCookies=async t=>Me(),this.clearAllCookies=async()=>Me(),this.uploadFile=async t=>{let r=new FormData;r.append(t.name,t.blob||"undefined");let a=Object.assign(Object.assign({},t),{body:r,method:"POST"});return this.post(a)},this.downloadFile=async t=>{let r=Re(t,t.webFetchExtra),a=await fetch(t.url,r),i;if(!(t!=null&&t.progress))i=await a.blob();else if(!(a!=null&&a.body))i=new Blob;else{let o=a.body.getReader(),y=0,f=[],S=a.headers.get("content-type"),C=parseInt(a.headers.get("content-length")||"0",10);for(;;){let{done:x,value:U}=await o.read();if(x)break;f.push(U),y+=(U==null?void 0:U.length)||0;let W={type:"DOWNLOAD",url:t.url,bytes:y,contentLength:C};this.notifyListeners("progress",W)}let G=new Uint8Array(y),P=0;for(let x of f)typeof x!="undefined"&&(G.set(x,P),P+=x.length);i=new Blob([G.buffer],{type:S||void 0})}return{blob:i}}}}});var mt=Ct((vr,qt)=>{qt.exports={API_KEY:"a5d75d50-65e6-41a4-aa2f-9b2c93afaaa7"}});var he,be,Ft,Dt,Ot,Oe,Ce,pe,ht,pt,Ke,wr,Kt,$t,jt,Ht,$e,Er,je=te(()=>{(function(n){n.Unimplemented="UNIMPLEMENTED",n.Unavailable="UNAVAILABLE"})(he||(he={}));be=class extends Error{constructor(t,r,a){super(t),this.message=t,this.code=r,this.data=a}},Ft=n=>{var t,r;return n!=null&&n.androidBridge?"android":!((r=(t=n==null?void 0:n.webkit)===null||t===void 0?void 0:t.messageHandlers)===null||r===void 0)&&r.bridge?"ios":"web"},Dt=n=>{let t=n.CapacitorCustomPlatform||null,r=n.Capacitor||{},a=r.Plugins=r.Plugins||{},i=()=>t!==null?t.name:Ft(n),o=()=>i()!=="web",y=P=>{let x=C.get(P);return!!(x!=null&&x.platforms.has(i())||f(P))},f=P=>{var x;return(x=r.PluginHeaders)===null||x===void 0?void 0:x.find(U=>U.name===P)},S=P=>n.console.error(P),C=new Map,G=(P,x={})=>{let U=C.get(P);if(U)return console.warn(`Capacitor plugin "${P}" already registered. Cannot register plugins twice.`),U.proxy;let W=i(),Q=f(P),V,ce=async()=>(!V&&W in x?V=typeof x[W]=="function"?V=await x[W]():V=x[W]:t!==null&&!V&&"web"in x&&(V=typeof x.web=="function"?V=await x.web():V=x.web),V),de=(k,R)=>{var O,D;if(Q){let K=Q==null?void 0:Q.methods.find(B=>R===B.name);if(K)return K.rtype==="promise"?B=>r.nativePromise(P,R.toString(),B):(B,H)=>r.nativeCallback(P,R.toString(),B,H);if(k)return(O=k[R])===null||O===void 0?void 0:O.bind(k)}else{if(k)return(D=k[R])===null||D===void 0?void 0:D.bind(k);throw new be(`"${P}" plugin is not implemented on ${W}`,he.Unimplemented)}},ne=k=>{let R,O=(...D)=>{let K=ce().then(B=>{let H=de(B,k);if(H){let Y=H(...D);return R=Y==null?void 0:Y.remove,Y}else throw new be(`"${P}.${k}()" is not implemented on ${W}`,he.Unimplemented)});return k==="addListener"&&(K.remove=async()=>R()),K};return O.toString=()=>`${k.toString()}() { [capacitor code] }`,Object.defineProperty(O,"name",{value:k,writable:!1,configurable:!1}),O},ae=ne("addListener"),se=ne("removeListener"),ge=(k,R)=>{let O=ae({eventName:k},R),D=async()=>{let B=await O;se({eventName:k,callbackId:B},R)},K=new Promise(B=>O.then(()=>B({remove:D})));return K.remove=async()=>{console.warn("Using addListener() without 'await' is deprecated."),await D()},K},I=new Proxy({},{get(k,R){switch(R){case"$$typeof":return;case"toJSON":return()=>({});case"addListener":return Q?ge:ae;case"removeListener":return se;default:return ne(R)}}});return a[P]=I,C.set(P,{name:P,proxy:I,platforms:new Set([...Object.keys(x),...Q?[W]:[]])}),I};return r.convertFileSrc||(r.convertFileSrc=P=>P),r.getPlatform=i,r.handleError=S,r.isNativePlatform=o,r.isPluginAvailable=y,r.registerPlugin=G,r.Exception=be,r.DEBUG=!!r.DEBUG,r.isLoggingEnabled=!!r.isLoggingEnabled,r},Ot=n=>n.Capacitor=Dt(n),Oe=Ot(typeof globalThis!="undefined"?globalThis:typeof self!="undefined"?self:typeof window!="undefined"?window:typeof global!="undefined"?global:{}),Ce=Oe.registerPlugin,pe=class{constructor(){this.listeners={},this.retainedEventArguments={},this.windowListeners={}}addListener(t,r){let a=!1;this.listeners[t]||(this.listeners[t]=[],a=!0),this.listeners[t].push(r);let o=this.windowListeners[t];o&&!o.registered&&this.addWindowListener(o),a&&this.sendRetainedArgumentsForEvent(t);let y=async()=>this.removeListener(t,r);return Promise.resolve({remove:y})}async removeAllListeners(){this.listeners={};for(let t in this.windowListeners)this.removeWindowListener(this.windowListeners[t]);this.windowListeners={}}notifyListeners(t,r,a){let i=this.listeners[t];if(!i){if(a){let o=this.retainedEventArguments[t];o||(o=[]),o.push(r),this.retainedEventArguments[t]=o}return}i.forEach(o=>o(r))}hasListeners(t){return!!this.listeners[t].length}registerWindowListener(t,r){this.windowListeners[r]={registered:!1,windowEventName:t,pluginEventName:r,handler:a=>{this.notifyListeners(r,a)}}}unimplemented(t="not implemented"){return new Oe.Exception(t,he.Unimplemented)}unavailable(t="not available"){return new Oe.Exception(t,he.Unavailable)}async removeListener(t,r){let a=this.listeners[t];if(!a)return;let i=a.indexOf(r);this.listeners[t].splice(i,1),this.listeners[t].length||this.removeWindowListener(this.windowListeners[t])}addWindowListener(t){window.addEventListener(t.windowEventName,t.handler),t.registered=!0}removeWindowListener(t){t&&(window.removeEventListener(t.windowEventName,t.handler),t.registered=!1)}sendRetainedArgumentsForEvent(t){let r=this.retainedEventArguments[t];r&&(delete this.retainedEventArguments[t],r.forEach(a=>{this.notifyListeners(t,a)}))}},ht=n=>encodeURIComponent(n).replace(/%(2[346B]|5E|60|7C)/g,decodeURIComponent).replace(/[()]/g,escape),pt=n=>n.replace(/(%[\dA-F]{2})+/gi,decodeURIComponent),Ke=class extends pe{async getCookies(){let t=document.cookie,r={};return t.split(";").forEach(a=>{if(a.length<=0)return;let[i,o]=a.replace(/=/,"CAP_COOKIE").split("CAP_COOKIE");i=pt(i).trim(),o=pt(o).trim(),r[i]=o}),r}async setCookie(t){try{let r=ht(t.key),a=ht(t.value),i=`; expires=${(t.expires||"").replace("expires=","")}`,o=(t.path||"/").replace("path=",""),y=t.url!=null&&t.url.length>0?`domain=${t.url}`:"";document.cookie=`${r}=${a||""}${i}; path=${o}; ${y};`}catch(r){return Promise.reject(r)}}async deleteCookie(t){try{document.cookie=`${t.key}=; Max-Age=0`}catch(r){return Promise.reject(r)}}async clearCookies(){try{let t=document.cookie.split(";")||[];for(let r of t)document.cookie=r.replace(/^ +/,"").replace(/=.*/,`=;expires=${new Date().toUTCString()};path=/`)}catch(t){return Promise.reject(t)}}async clearAllCookies(){try{await this.clearCookies()}catch(t){return Promise.reject(t)}}},wr=Ce("CapacitorCookies",{web:()=>new Ke}),Kt=async n=>new Promise((t,r)=>{let a=new FileReader;a.onload=()=>{let i=a.result;t(i.indexOf(",")>=0?i.split(",")[1]:i)},a.onerror=i=>r(i),a.readAsDataURL(n)}),$t=(n={})=>{let t=Object.keys(n);return Object.keys(n).map(i=>i.toLocaleLowerCase()).reduce((i,o,y)=>(i[o]=n[t[y]],i),{})},jt=(n,t=!0)=>n?Object.entries(n).reduce((a,i)=>{let[o,y]=i,f,S;return Array.isArray(y)?(S="",y.forEach(C=>{f=t?encodeURIComponent(C):C,S+=`${o}=${f}&`}),S.slice(0,-1)):(f=t?encodeURIComponent(y):y,S=`${o}=${f}`),`${a}&${S}`},"").substr(1):null,Ht=(n,t={})=>{let r=Object.assign({method:n.method||"GET",headers:n.headers},t),i=$t(n.headers)["content-type"]||"";if(typeof n.data=="string")r.body=n.data;else if(i.includes("application/x-www-form-urlencoded")){let o=new URLSearchParams;for(let[y,f]of Object.entries(n.data||{}))o.set(y,f);r.body=o.toString()}else if(i.includes("multipart/form-data")||n.data instanceof FormData){let o=new FormData;if(n.data instanceof FormData)n.data.forEach((f,S)=>{o.append(S,f)});else for(let f of Object.keys(n.data))o.append(f,n.data[f]);r.body=o;let y=new Headers(r.headers);y.delete("content-type"),r.headers=y}else(i.includes("application/json")||typeof n.data=="object")&&(r.body=JSON.stringify(n.data));return r},$e=class extends pe{async request(t){let r=Ht(t,t.webFetchExtra),a=jt(t.params,t.shouldEncodeUrlParams),i=a?`${t.url}?${a}`:t.url,o=await fetch(i,r),y=o.headers.get("content-type")||"",{responseType:f="text"}=o.ok?t:{};y.includes("application/json")&&(f="json");let S,C;switch(f){case"arraybuffer":case"blob":C=await o.blob(),S=await Kt(C);break;case"json":S=await o.json();break;case"document":case"text":default:S=await o.text()}let G={};return o.headers.forEach((P,x)=>{G[x]=P}),{data:S,headers:G,status:o.status,url:o.url}}async get(t){return this.request(Object.assign(Object.assign({},t),{method:"GET"}))}async post(t){return this.request(Object.assign(Object.assign({},t),{method:"POST"}))}async put(t){return this.request(Object.assign(Object.assign({},t),{method:"PUT"}))}async patch(t){return this.request(Object.assign(Object.assign({},t),{method:"PATCH"}))}async delete(t){return this.request(Object.assign(Object.assign({},t),{method:"DELETE"}))}},Er=Ce("CapacitorHttp",{web:()=>new $e})});var Te,Le,gt=te(()=>{Te=class{constructor(t){this.sqlite=t,this._connectionDict=new Map}async initWebStore(){try{return await this.sqlite.initWebStore(),Promise.resolve()}catch(t){return Promise.reject(t)}}async saveToStore(t){try{return await this.sqlite.saveToStore({database:t}),Promise.resolve()}catch(r){return Promise.reject(r)}}async saveToLocalDisk(t){try{return await this.sqlite.saveToLocalDisk({database:t}),Promise.resolve()}catch(r){return Promise.reject(r)}}async getFromLocalDiskToStore(t){let r=t!=null?t:!0;try{return await this.sqlite.getFromLocalDiskToStore({overwrite:r}),Promise.resolve()}catch(a){return Promise.reject(a)}}async echo(t){try{let r=await this.sqlite.echo({value:t});return Promise.resolve(r)}catch(r){return Promise.reject(r)}}async isSecretStored(){try{let t=await this.sqlite.isSecretStored();return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async setEncryptionSecret(t){try{return await this.sqlite.setEncryptionSecret({passphrase:t}),Promise.resolve()}catch(r){return Promise.reject(r)}}async changeEncryptionSecret(t,r){try{return await this.sqlite.changeEncryptionSecret({passphrase:t,oldpassphrase:r}),Promise.resolve()}catch(a){return Promise.reject(a)}}async clearEncryptionSecret(){try{return await this.sqlite.clearEncryptionSecret(),Promise.resolve()}catch(t){return Promise.reject(t)}}async checkEncryptionSecret(t){try{let r=await this.sqlite.checkEncryptionSecret({passphrase:t});return Promise.resolve(r)}catch(r){return Promise.reject(r)}}async addUpgradeStatement(t,r){try{return t.endsWith(".db")&&(t=t.slice(0,-3)),await this.sqlite.addUpgradeStatement({database:t,upgrade:r}),Promise.resolve()}catch(a){return Promise.reject(a)}}async createConnection(t,r,a,i,o){try{t.endsWith(".db")&&(t=t.slice(0,-3)),await this.sqlite.createConnection({database:t,encrypted:r,mode:a,version:i,readonly:o});let y=new Le(t,o,this.sqlite),f=o?`RO_${t}`:`RW_${t}`;return this._connectionDict.set(f,y),Promise.resolve(y)}catch(y){return Promise.reject(y)}}async closeConnection(t,r){try{t.endsWith(".db")&&(t=t.slice(0,-3)),await this.sqlite.closeConnection({database:t,readonly:r});let a=r?`RO_${t}`:`RW_${t}`;return this._connectionDict.delete(a),Promise.resolve()}catch(a){return Promise.reject(a)}}async isConnection(t,r){let a={};t.endsWith(".db")&&(t=t.slice(0,-3));let i=r?`RO_${t}`:`RW_${t}`;return a.result=this._connectionDict.has(i),Promise.resolve(a)}async retrieveConnection(t,r){t.endsWith(".db")&&(t=t.slice(0,-3));let a=r?`RO_${t}`:`RW_${t}`;if(this._connectionDict.has(a)){let i=this._connectionDict.get(a);return typeof i!="undefined"?Promise.resolve(i):Promise.reject(`Connection ${t} is undefined`)}else return Promise.reject(`Connection ${t} does not exist`)}async getNCDatabasePath(t,r){try{let a=await this.sqlite.getNCDatabasePath({path:t,database:r});return Promise.resolve(a)}catch(a){return Promise.reject(a)}}async createNCConnection(t,r){try{await this.sqlite.createNCConnection({databasePath:t,version:r});let a=new Le(t,!0,this.sqlite),i=`RO_${t})`;return this._connectionDict.set(i,a),Promise.resolve(a)}catch(a){return Promise.reject(a)}}async closeNCConnection(t){try{await this.sqlite.closeNCConnection({databasePath:t});let r=`RO_${t})`;return this._connectionDict.delete(r),Promise.resolve()}catch(r){return Promise.reject(r)}}async isNCConnection(t){let r={},a=`RO_${t})`;return r.result=this._connectionDict.has(a),Promise.resolve(r)}async retrieveNCConnection(t){if(this._connectionDict.has(t)){let r=`RO_${t})`,a=this._connectionDict.get(r);return typeof a!="undefined"?Promise.resolve(a):Promise.reject(`Connection ${t} is undefined`)}else return Promise.reject(`Connection ${t} does not exist`)}async isNCDatabase(t){try{let r=await this.sqlite.isNCDatabase({databasePath:t});return Promise.resolve(r)}catch(r){return Promise.reject(r)}}async retrieveAllConnections(){return this._connectionDict}async closeAllConnections(){let t=new Map;try{for(let r of this._connectionDict.keys()){let a=r.substring(3),i=r.substring(0,3)==="RO_";await this.sqlite.closeConnection({database:a,readonly:i}),t.set(r,null)}for(let r of t.keys())this._connectionDict.delete(r);return Promise.resolve()}catch(r){return Promise.reject(r)}}async checkConnectionsConsistency(){try{let t=[...this._connectionDict.keys()],r=[],a=[];for(let o of t)r.push(o.substring(0,2)),a.push(o.substring(3));let i=await this.sqlite.checkConnectionsConsistency({dbNames:a,openModes:r});return i.result||(this._connectionDict=new Map),Promise.resolve(i)}catch(t){return this._connectionDict=new Map,Promise.reject(t)}}async importFromJson(t){try{let r=await this.sqlite.importFromJson({jsonstring:t});return Promise.resolve(r)}catch(r){return Promise.reject(r)}}async isJsonValid(t){try{let r=await this.sqlite.isJsonValid({jsonstring:t});return Promise.resolve(r)}catch(r){return Promise.reject(r)}}async copyFromAssets(t){let r=t!=null?t:!0;try{return await this.sqlite.copyFromAssets({overwrite:r}),Promise.resolve()}catch(a){return Promise.reject(a)}}async getFromHTTPRequest(t,r){let a=r!=null?r:!0;try{return await this.sqlite.getFromHTTPRequest({url:t,overwrite:a}),Promise.resolve()}catch(i){return Promise.reject(i)}}async isDatabaseEncrypted(t){t.endsWith(".db")&&(t=t.slice(0,-3));try{let r=await this.sqlite.isDatabaseEncrypted({database:t});return Promise.resolve(r)}catch(r){return Promise.reject(r)}}async isInConfigEncryption(){try{let t=await this.sqlite.isInConfigEncryption();return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async isInConfigBiometricAuth(){try{let t=await this.sqlite.isInConfigBiometricAuth();return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async isDatabase(t){t.endsWith(".db")&&(t=t.slice(0,-3));try{let r=await this.sqlite.isDatabase({database:t});return Promise.resolve(r)}catch(r){return Promise.reject(r)}}async getDatabaseList(){try{let r=(await this.sqlite.getDatabaseList()).values;r.sort();let a={values:r};return Promise.resolve(a)}catch(t){return Promise.reject(t)}}async getMigratableDbList(t){let r=t||"default";try{let a=await this.sqlite.getMigratableDbList({folderPath:r});return Promise.resolve(a)}catch(a){return Promise.reject(a)}}async addSQLiteSuffix(t,r){let a=t||"default",i=r||[];try{let o=await this.sqlite.addSQLiteSuffix({folderPath:a,dbNameList:i});return Promise.resolve(o)}catch(o){return Promise.reject(o)}}async deleteOldDatabases(t,r){let a=t||"default",i=r||[];try{let o=await this.sqlite.deleteOldDatabases({folderPath:a,dbNameList:i});return Promise.resolve(o)}catch(o){return Promise.reject(o)}}async moveDatabasesAndAddSuffix(t,r){let a=t||"default",i=r||[];return this.sqlite.moveDatabasesAndAddSuffix({folderPath:a,dbNameList:i})}},Le=class{constructor(t,r,a){this.dbName=t,this.readonly=r,this.sqlite=a}getConnectionDBName(){return this.dbName}getConnectionReadOnly(){return this.readonly}async open(){try{return await this.sqlite.open({database:this.dbName,readonly:this.readonly}),Promise.resolve()}catch(t){return Promise.reject(t)}}async close(){try{return await this.sqlite.close({database:this.dbName,readonly:this.readonly}),Promise.resolve()}catch(t){return Promise.reject(t)}}async beginTransaction(){try{let t=await this.sqlite.beginTransaction({database:this.dbName});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async commitTransaction(){try{let t=await this.sqlite.commitTransaction({database:this.dbName});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async rollbackTransaction(){try{let t=await this.sqlite.rollbackTransaction({database:this.dbName});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async isTransactionActive(){try{let t=await this.sqlite.isTransactionActive({database:this.dbName});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async loadExtension(t){try{return await this.sqlite.loadExtension({database:this.dbName,path:t,readonly:this.readonly}),Promise.resolve()}catch(r){return Promise.reject(r)}}async enableLoadExtension(t){try{return await this.sqlite.enableLoadExtension({database:this.dbName,toggle:t,readonly:this.readonly}),Promise.resolve()}catch(r){return Promise.reject(r)}}async getUrl(){try{let t=await this.sqlite.getUrl({database:this.dbName,readonly:this.readonly});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async getVersion(){try{let t=await this.sqlite.getVersion({database:this.dbName,readonly:this.readonly});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async getTableList(){try{let t=await this.sqlite.getTableList({database:this.dbName,readonly:this.readonly});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async execute(t,r=!0,a=!0){try{if(this.readonly)return Promise.reject("not allowed in read-only mode");{let i=await this.sqlite.execute({database:this.dbName,statements:t,transaction:r,readonly:!1,isSQL92:a});return Promise.resolve(i)}}catch(i){return Promise.reject(i)}}async query(t,r,a=!0){let i;try{return r&&r.length>0?i=await this.sqlite.query({database:this.dbName,statement:t,values:r,readonly:this.readonly,isSQL92:!0}):i=await this.sqlite.query({database:this.dbName,statement:t,values:[],readonly:this.readonly,isSQL92:a}),i=await this.reorderRows(i),Promise.resolve(i)}catch(o){return Promise.reject(o)}}async run(t,r,a=!0,i="no",o=!0){let y;try{return this.readonly?Promise.reject("not allowed in read-only mode"):(r&&r.length>0?y=await this.sqlite.run({database:this.dbName,statement:t,values:r,transaction:a,readonly:!1,returnMode:i,isSQL92:!0}):y=await this.sqlite.run({database:this.dbName,statement:t,values:[],transaction:a,readonly:!1,returnMode:i,isSQL92:o}),y.changes=await this.reorderRows(y.changes),Promise.resolve(y))}catch(f){return Promise.reject(f)}}async executeSet(t,r=!0,a="no",i=!0){let o;try{return this.readonly?Promise.reject("not allowed in read-only mode"):(o=await this.sqlite.executeSet({database:this.dbName,set:t,transaction:r,readonly:!1,returnMode:a,isSQL92:i}),o.changes=await this.reorderRows(o.changes),Promise.resolve(o))}catch(y){return Promise.reject(y)}}async isExists(){try{let t=await this.sqlite.isDBExists({database:this.dbName,readonly:this.readonly});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async isTable(t){try{let r=await this.sqlite.isTableExists({database:this.dbName,table:t,readonly:this.readonly});return Promise.resolve(r)}catch(r){return Promise.reject(r)}}async isDBOpen(){try{let t=await this.sqlite.isDBOpen({database:this.dbName,readonly:this.readonly});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async delete(){try{return this.readonly?Promise.reject("not allowed in read-only mode"):(await this.sqlite.deleteDatabase({database:this.dbName,readonly:!1}),Promise.resolve())}catch(t){return Promise.reject(t)}}async createSyncTable(){try{if(this.readonly)return Promise.reject("not allowed in read-only mode");{let t=await this.sqlite.createSyncTable({database:this.dbName,readonly:!1});return Promise.resolve(t)}}catch(t){return Promise.reject(t)}}async setSyncDate(t){try{return this.readonly?Promise.reject("not allowed in read-only mode"):(await this.sqlite.setSyncDate({database:this.dbName,syncdate:t,readonly:!1}),Promise.resolve())}catch(r){return Promise.reject(r)}}async getSyncDate(){try{let t=await this.sqlite.getSyncDate({database:this.dbName,readonly:this.readonly}),r="";return t.syncDate>0&&(r=new Date(t.syncDate*1e3).toISOString()),Promise.resolve(r)}catch(t){return Promise.reject(t)}}async exportToJson(t,r=!1){try{let a=await this.sqlite.exportToJson({database:this.dbName,jsonexportmode:t,readonly:this.readonly,encrypted:r});return Promise.resolve(a)}catch(a){return Promise.reject(a)}}async deleteExportedRows(){try{return this.readonly?Promise.reject("not allowed in read-only mode"):(await this.sqlite.deleteExportedRows({database:this.dbName,readonly:!1}),Promise.resolve())}catch(t){return Promise.reject(t)}}async executeTransaction(t,r=!0){let a=0,i=!1;if(this.readonly)return Promise.reject("not allowed in read-only mode");if(await this.sqlite.beginTransaction({database:this.dbName}),i=await this.sqlite.isTransactionActive({database:this.dbName}),!i)return Promise.reject("After Begin Transaction, no transaction active");try{for(let f of t){if(typeof f!="object"||!("statement"in f))throw new Error("Error a task.statement must be provided");if("values"in f&&f.values&&f.values.length>0){let S=f.statement.toUpperCase().includes("RETURNING")?"all":"no",C=await this.sqlite.run({database:this.dbName,statement:f.statement,values:f.values,transaction:!1,readonly:!1,returnMode:S,isSQL92:r});if(C.changes.changes<0)throw new Error("Error in transaction method run ");a+=C.changes.changes}else{let S=await this.sqlite.execute({database:this.dbName,statements:f.statement,transaction:!1,readonly:!1});if(S.changes.changes<0)throw new Error("Error in transaction method execute ");a+=S.changes.changes}}let o=await this.sqlite.commitTransaction({database:this.dbName});a+=o.changes.changes;let y={changes:{changes:a}};return Promise.resolve(y)}catch(o){let y=o.message?o.message:o;return await this.sqlite.rollbackTransaction({database:this.dbName}),Promise.reject(y)}}async reorderRows(t){let r=t;if(t!=null&&t.values&&typeof t.values[0]=="object"&&Object.keys(t.values[0]).includes("ios_columns")){let a=t.values[0].ios_columns,i=[];for(let o=1;o<t.values.length;o++){let y=t.values[o],f={};for(let S of a)f[S]=y[S];i.push(f)}r.values=i}return Promise.resolve(r)}}});var yt={};Pe(yt,{CapacitorSQLiteWeb:()=>He});var He,ft=te(()=>{je();He=class extends pe{constructor(){super(...arguments),this.jeepSqliteElement=null,this.isWebStoreOpen=!1}async initWebStore(){await customElements.whenDefined("jeep-sqlite"),this.jeepSqliteElement=document.querySelector("jeep-sqlite"),this.ensureJeepSqliteIsAvailable(),this.jeepSqliteElement.addEventListener("jeepSqliteImportProgress",t=>{this.notifyListeners("sqliteImportProgressEvent",t.detail)}),this.jeepSqliteElement.addEventListener("jeepSqliteExportProgress",t=>{this.notifyListeners("sqliteExportProgressEvent",t.detail)}),this.jeepSqliteElement.addEventListener("jeepSqliteHTTPRequestEnded",t=>{this.notifyListeners("sqliteHTTPRequestEndedEvent",t.detail)}),this.jeepSqliteElement.addEventListener("jeepSqlitePickDatabaseEnded",t=>{this.notifyListeners("sqlitePickDatabaseEndedEvent",t.detail)}),this.jeepSqliteElement.addEventListener("jeepSqliteSaveDatabaseToDisk",t=>{this.notifyListeners("sqliteSaveDatabaseToDiskEvent",t.detail)}),this.isWebStoreOpen||(this.isWebStoreOpen=await this.jeepSqliteElement.isStoreOpen())}async saveToStore(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.saveToStore(t);return}catch(r){throw new Error(`${r}`)}}async getFromLocalDiskToStore(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.getFromLocalDiskToStore(t);return}catch(r){throw new Error(`${r}`)}}async saveToLocalDisk(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.saveToLocalDisk(t);return}catch(r){throw new Error(`${r}`)}}async echo(t){return this.ensureJeepSqliteIsAvailable(),await this.jeepSqliteElement.echo(t)}async createConnection(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.createConnection(t);return}catch(r){throw new Error(`${r}`)}}async open(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.open(t);return}catch(r){throw new Error(`${r}`)}}async closeConnection(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.closeConnection(t);return}catch(r){throw new Error(`${r}`)}}async getVersion(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.getVersion(t)}catch(r){throw new Error(`${r}`)}}async checkConnectionsConsistency(t){this.ensureJeepSqliteIsAvailable();try{return await this.jeepSqliteElement.checkConnectionsConsistency(t)}catch(r){throw new Error(`${r}`)}}async close(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.close(t);return}catch(r){throw new Error(`${r}`)}}async beginTransaction(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.beginTransaction(t)}catch(r){throw new Error(`${r}`)}}async commitTransaction(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.commitTransaction(t)}catch(r){throw new Error(`${r}`)}}async rollbackTransaction(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.rollbackTransaction(t)}catch(r){throw new Error(`${r}`)}}async isTransactionActive(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.isTransactionActive(t)}catch(r){throw new Error(`${r}`)}}async getTableList(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.getTableList(t)}catch(r){throw new Error(`${r}`)}}async execute(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.execute(t)}catch(r){throw new Error(`${r}`)}}async executeSet(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.executeSet(t)}catch(r){throw new Error(`${r}`)}}async run(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.run(t)}catch(r){throw new Error(`${r}`)}}async query(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.query(t)}catch(r){throw new Error(`${r}`)}}async isDBExists(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.isDBExists(t)}catch(r){throw new Error(`${r}`)}}async isDBOpen(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.isDBOpen(t)}catch(r){throw new Error(`${r}`)}}async isDatabase(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.isDatabase(t)}catch(r){throw new Error(`${r}`)}}async isTableExists(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.isTableExists(t)}catch(r){throw new Error(`${r}`)}}async deleteDatabase(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.deleteDatabase(t);return}catch(r){throw new Error(`${r}`)}}async isJsonValid(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.isJsonValid(t)}catch(r){throw new Error(`${r}`)}}async importFromJson(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.importFromJson(t)}catch(r){throw new Error(`${r}`)}}async exportToJson(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.exportToJson(t)}catch(r){throw new Error(`${r}`)}}async createSyncTable(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.createSyncTable(t)}catch(r){throw new Error(`${r}`)}}async setSyncDate(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.setSyncDate(t);return}catch(r){throw new Error(`${r}`)}}async getSyncDate(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.getSyncDate(t)}catch(r){throw new Error(`${r}`)}}async deleteExportedRows(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.deleteExportedRows(t);return}catch(r){throw new Error(`${r}`)}}async addUpgradeStatement(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.addUpgradeStatement(t);return}catch(r){throw new Error(`${r}`)}}async copyFromAssets(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.copyFromAssets(t);return}catch(r){throw new Error(`${r}`)}}async getFromHTTPRequest(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.getFromHTTPRequest(t);return}catch(r){throw new Error(`${r}`)}}async getDatabaseList(){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.getDatabaseList()}catch(t){throw new Error(`${t}`)}}ensureJeepSqliteIsAvailable(){if(this.jeepSqliteElement===null)throw new Error("The jeep-sqlite element is not present in the DOM! Please check the @capacitor-community/sqlite documentation for instructions regarding the web platform.")}ensureWebstoreIsOpen(){if(!this.isWebStoreOpen)throw new Error('WebStore is not open yet. You have to call "initWebStore()" first.')}async getUrl(){throw this.unimplemented("Not implemented on web.")}async getMigratableDbList(t){throw console.log("getMigratableDbList",t),this.unimplemented("Not implemented on web.")}async addSQLiteSuffix(t){throw console.log("addSQLiteSuffix",t),this.unimplemented("Not implemented on web.")}async deleteOldDatabases(t){throw console.log("deleteOldDatabases",t),this.unimplemented("Not implemented on web.")}async moveDatabasesAndAddSuffix(t){throw console.log("moveDatabasesAndAddSuffix",t),this.unimplemented("Not implemented on web.")}async isSecretStored(){throw this.unimplemented("Not implemented on web.")}async setEncryptionSecret(t){throw console.log("setEncryptionSecret",t),this.unimplemented("Not implemented on web.")}async changeEncryptionSecret(t){throw console.log("changeEncryptionSecret",t),this.unimplemented("Not implemented on web.")}async clearEncryptionSecret(){throw console.log("clearEncryptionSecret"),this.unimplemented("Not implemented on web.")}async checkEncryptionSecret(t){throw console.log("checkEncryptionPassPhrase",t),this.unimplemented("Not implemented on web.")}async getNCDatabasePath(t){throw console.log("getNCDatabasePath",t),this.unimplemented("Not implemented on web.")}async createNCConnection(t){throw console.log("createNCConnection",t),this.unimplemented("Not implemented on web.")}async closeNCConnection(t){throw console.log("closeNCConnection",t),this.unimplemented("Not implemented on web.")}async isNCDatabase(t){throw console.log("isNCDatabase",t),this.unimplemented("Not implemented on web.")}async isDatabaseEncrypted(t){throw console.log("isDatabaseEncrypted",t),this.unimplemented("Not implemented on web.")}async isInConfigEncryption(){throw this.unimplemented("Not implemented on web.")}async isInConfigBiometricAuth(){throw this.unimplemented("Not implemented on web.")}async loadExtension(t){throw console.log("loadExtension",t),this.unimplemented("Not implemented on web.")}async enableLoadExtension(t){throw console.log("enableLoadExtension",t),this.unimplemented("Not implemented on web.")}}});var bt,vt=te(()=>{je();gt();bt=Ce("CapacitorSQLite",{web:()=>Promise.resolve().then(()=>(ft(),yt)).then(n=>new n.CapacitorSQLiteWeb),electron:()=>window.CapacitorCustomPlatform.plugins.CapacitorSQLite})});var wt={};Pe(wt,{getCardById:()=>Xt,getCardIds:()=>Vt,getCardsByIds:()=>Zt,getDaten:()=>zt,getEnergieById:()=>or,getEnergieCardIds:()=>ir,getEnergies:()=>nr,getEngName:()=>Ut,getName:()=>Gt,getTrainerById:()=>tr,getTrainerCardIds:()=>rr,getTrainers:()=>Yt,initDatabase:()=>Wt,insertCard:()=>_t,insertEnergie:()=>ar,insertTrainer:()=>er,updateCardIds:()=>Jt,updatePrice:()=>Qt});async function Wt(){return M=await Nt.createConnection("pokepicker",!1,"no-encryption",1),await M.open(),await M.execute(`
  ...
  `),(await M.query("SELECT COUNT(*) as count FROM pokemon")).values[0].count===0&&await M.execute(`
      ...
      `),M}async function zt(){return await M.query("SELECT * FROM pokemon")}async function Gt(n){return(await M.query("SELECT name FROM pokemon WHERE dex = ?",[n])).values[0].name}async function Ut(n){return(await M.query("SELECT engName FROM pokemon WHERE dex = ?",[n])).values[0].engName}async function Vt(n){return(await M.query("SELECT cardIds FROM pokemon WHERE dex = ?",[n])).values[0].cardIds}async function Jt(n,t){await M.run("UPDATE pokemon SET cardIds = ? WHERE dex = ?",[t,n])}async function _t(n){var t,r,a,i,o;try{let y=typeof n.imageSmall=="string"?n.imageSmall:null,f=typeof n.imageLarge=="string"?n.imageLarge:null;return((o=(await M.run(`INSERT INTO cards (cardId, cardName, rarity, setName, imageLow, imageHigh, subTypes, addedAt, avg30)
       VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)`,[n.id,n.name,n.rarity||"",((t=n.set)==null?void 0:t.name)||"",y,f,Array.isArray(n.subtypes)?n.subtypes.join(", "):"",new Date().toISOString(),(i=(a=(r=n.cardmarket)==null?void 0:r.prices)==null?void 0:a.avg30)!=null?i:null])).changes)==null?void 0:o.lastId)||null}catch(y){return console.error("Fehler in insertCard():",y.message||y,(n==null?void 0:n.id)||"unbekannte Karte"),null}}async function Xt(n){var r;return((r=(await M.query("SELECT * FROM cards WHERE id = ?",[n])).values)==null?void 0:r[0])||null}async function Zt(n){let t=n.map(()=>"?").join(",");return(await M.query(`SELECT * FROM cards WHERE id IN (${t})`,n)).values}async function Qt(n,t){try{await M.run("UPDATE cards SET avg30 = ? WHERE cardId = ?",[t,n])}catch(r){console.error(`Fehler beim Speichern von avg30 f\xFCr ${n}:`,r.message)}}async function Yt(){return(await M.query("SELECT * FROM trainer")).values}async function er(n){var t,r,a,i,o;try{let y=typeof n.imageSmall=="string"?n.imageSmall:null,f=typeof n.imageLarge=="string"?n.imageLarge:null;return((o=(await M.run(`INSERT INTO trainer (cardId, cardName, rarity, setName, imageLow, imageHigh, subTypes, addedAt, avg30)
       VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)`,[n.id,n.name,n.rarity||"",((t=n.set)==null?void 0:t.name)||"",y,f,Array.isArray(n.subtypes)?n.subtypes.join(", "):"",new Date().toISOString(),(i=(a=(r=n.cardmarket)==null?void 0:r.prices)==null?void 0:a.avg30)!=null?i:null])).changes)==null?void 0:o.lastId)||null}catch(y){return console.error("Fehler in insertTrainer():",y.message||y,(n==null?void 0:n.id)||"unbekannte Karte"),null}}async function tr(n){var r;return((r=(await M.query("SELECT * FROM trainer WHERE id = ?",[n])).values)==null?void 0:r[0])||null}async function rr(){return(await M.query("SELECT id FROM trainer")).values.map(t=>t.id)}async function nr(){return(await M.query("SELECT * FROM energy")).values}async function ar(n){var t,r,a,i,o;try{let y=typeof n.imageSmall=="string"?n.imageSmall:null,f=typeof n.imageLarge=="string"?n.imageLarge:null;return((o=(await M.run(`INSERT INTO energy (cardId, cardName, rarity, setName, imageLow, imageHigh, subTypes, addedAt, avg30)
       VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)`,[n.id,n.name,n.rarity||"",((t=n.set)==null?void 0:t.name)||"",y,f,Array.isArray(n.subtypes)?n.subtypes.join(", "):"",new Date().toISOString(),(i=(a=(r=n.cardmarket)==null?void 0:r.prices)==null?void 0:a.avg30)!=null?i:null])).changes)==null?void 0:o.lastId)||null}catch(y){return console.error("Fehler in insertEnergie():",y.message||y,(n==null?void 0:n.id)||"unbekannte Karte"),null}}async function ir(){return(await M.query("SELECT id FROM energy")).values.map(t=>t.id)}async function or(n){var r;return((r=(await M.query("SELECT * FROM energy WHERE id = ?",[n])).values)==null?void 0:r[0])||null}var Nt,M,Et=te(()=>{vt();Nt=new Te(bt)});xe();var re=et("Http",{web:()=>Promise.resolve().then(()=>(De(),Fe)).then(n=>new n.HttpWeb),electron:()=>Promise.resolve().then(()=>(De(),Fe)).then(n=>new n.HttpWeb)});var oe=mt(),j;document.addEventListener("DOMContentLoaded",()=>{(async()=>{let n=document.getElementById("cardLoader");n.innerHTML=`
      <p id="loaderText">Lade Karten\u2026</p>
      <div id="progressBarContainer">
        <div id="progressBar"></div>
      </div>
      <div id="progressText">0%</div>
    `,n.classList.remove("hidden"),n.classList.add("shown");let{initDatabase:t,getDaten:r,getName:a,getEngName:i,getCardIds:o,updateCardIds:y,insertCard:f,getCardById:S,getCardsByIds:C,updatePrice:G,getTrainers:P,insertTrainer:x,getTrainerCardIds:U,getTrainerById:W,getEnergies:Q,insertEnergie:V,getEnergieCardIds:ce,getEnergieById:de}=await Promise.resolve().then(()=>(Et(),wt));j=await t();let ne=await r(),ae=document.querySelector("#kartentabelle tbody");window.cachedCards={},window.cachedPokemonCardsByName={},window.cachedTrainerCardsByType={},window.cachedEnergyCardsByType={};let se=0,ge=ne.values.length;for(let s of ne.values){let d=document.createElement("tr"),u=parseInt(s.dex),m=`
      ...
      `;d.innerHTML=m,ae.appendChild(d),await R(s.dex),se++;let l=Math.min(99,Math.round(se/ge*100)),p=document.getElementById("progressBar"),h=document.getElementById("progressText");p&&(p.style.width=l+"%"),h&&(h.textContent=l+"%")}progressBar.style.width="100%",progressText.textContent="100%",setTimeout(()=>{let s=n.offsetHeight+"px";n.style.height=s,n.offsetHeight,n.style.transition="height 0.5s ease, opacity 0.5s ease",n.style.height="0px",n.style.opacity="0",n.style.overflow="hidden"},100),I(),k(),H(),document.querySelectorAll("#tableToggle button").forEach(s=>s.classList.remove("active")),document.getElementById("showTablePokemon").classList.add("active");function I(){let s=document.querySelectorAll("#kartentabelle tbody tr"),d=0;s.forEach(u=>{u.style.display!=="none"&&d++}),document.getElementById("eintragsAnzahl").textContent=`(${d})`}function k(){let s=0;document.querySelectorAll("#kartentabelle tbody tr").forEach(h=>{if(h.style.display==="none")return;let b=h.querySelectorAll("div[id^='kartenContainer_'] img");s+=b.length});let d=document.getElementById("kartenAnzahl");d&&(d.textContent=`(${s})`);let u=0;document.querySelectorAll("#trainertabelle tbody tr").forEach(h=>{if(h.style.display==="none")return;let b=h.querySelectorAll("div[id$='Container'] img");u+=b.length});let m=document.getElementById("kartenAnzahlTrainer");m&&(m.textContent=`(${u})`);let l=0;document.querySelectorAll("#energietabelle tbody tr").forEach(h=>{if(h.style.display==="none")return;let b=h.querySelectorAll("div[id$='Container'] img");l+=b.length});let p=document.getElementById("kartenAnzahlEnergie");p&&(p.textContent=`(${l})`)}async function R(s){let d=document.getElementById(`kartenContainer_${s}`),u=await o(s);if(!u)return;let m=u.split(";").filter(h=>h.trim()),l=await C(m.map(h=>parseInt(h)));l.sort((h,b)=>(b.avg30||0)-(h.avg30||0));let p=document.createDocumentFragment();for(let h of l){window.cachedCards[h.cardId]=h;let b=document.createElement("img");b.alt=h.cardId,b.style.width="50px",b.style.height="69px",b.style.objectFit="cover",b.src=h.imageLow,b.addEventListener("click",()=>O(s,m.indexOf(String(h.id)))),p.appendChild(b)}d.appendChild(p)}async function O(s,d){let u=document.querySelector("#overlay");u.innerHTML='<div id="overlayContent"><div class="loader"></div></div>',u.classList.remove("hidden"),u.classList.add("shown");let m=await o(s);if(!m)return;let l=m.split(";").filter(b=>b.trim()!=="");if(l.length===0){T();return}let p=d;async function h(){let b=l[p];try{let w=await S(b),g="Unbekannt";if(w.addedAt){let L=new Date(w.addedAt),q={day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"};g=L.toLocaleString("de-DE",q)}let c="Keine Angabe";w.basic==1&&(c="Basic"),w.reverse==1&&(c="Reverse"),w.holo==1&&(c="Holo");let v=await B(w.cardId);if(v==null){let L=D(w.cardId);v=await B(L)}let E="\u2013";if(v!=null){let L=v.toFixed(2),q="#DEDEDE",F="\u{1FA99}";v>20?(q="#FF4444",F="\u{1F525}"):v>5&&(q="#FFAA00",F="\u{1F4B0}"),E=`<span style="color:${q};">${F} ${L}\u20AC</span>`}u.innerHTML=`
          ...
          `,document.getElementById("deleteCard").addEventListener("click",async()=>{if(confirm("Willst du diese Karte wirklich l\xF6schen?")){let L=l[p];await j.run("DELETE FROM cards WHERE id = ?",[L]),l.splice(p,1),await y(s,l.join(";")+";"),T();let q=document.getElementById(`kartenContainer_${s}`);q.innerHTML="",R(s),k(),H()}}),document.getElementById("closeGallery").addEventListener("click",()=>{let L=document.getElementById("overlay");L.classList.add("fade-out"),setTimeout(()=>{L.classList.remove("shown","fade-out"),L.classList.add("hidden"),L.innerHTML=""},300)})}catch(w){console.error("Fehler beim Anzeigen der Karte:",w),T()}}h()}window.openOverlay=async function(s){let d=document.querySelector("#overlay");d.innerHTML=`
        <div id="overlayContent">
          <h2>Bitte warten...</h2>
      ...
      `,d.classList.remove("hidden"),d.classList.add("shown");try{let u=await a(s),m=await i(s);m=="Nidoran\u2642"&&(m="Nidoran \u2642"),m=="Nidoran\u2640"&&(m="Nidoran \u2640"),m=="Farfetch\u2019d"&&(m="Farfetch'd"),m=="Sirfetch\u2019d"&&(m="Sirfetch'd");let l=window.cachedPokemonCardsByName[m];if(l||(l=await K(m),l&&(window.cachedPokemonCardsByName[m]=l)),!l||l.length===0){d.innerHTML=`
          ...
          `,document.getElementById("BackBtn").addEventListener("click",h=>{h.preventDefault(),T()});return}let p=`
          <div id="overlayContent">
      ...
      `;async function b(c){m.innerHTML='<div id="overlayContent"><div class="loader"></div></div>',m.classList.remove("hidden"),m.classList.add("shown"),c!=="none"&&await j.run(`UPDATE cards SET ${c} = 1 WHERE id = ?`,[h]);let v=await o(d);v||(v=""),v+=h+";",await y(d,v);let E=document.getElementById(`kartenContainer_${d}`);E.innerHTML="",await R(d),T(),I(),k(),H()}document.getElementById("btnBasic").addEventListener("click",()=>b("basic")),document.getElementById("btnReverse").addEventListener("click",()=>b("reverse")),document.getElementById("btnHolo").addEventListener("click",()=>b("holo")),document.getElementById("closeOverlayConfirm").addEventListener("click",()=>b("none"))};async function H(){try{let s=await j.query("SELECT avg30 FROM cards WHERE avg30 IS NOT NULL"),d=await j.query("SELECT avg30 FROM trainer WHERE avg30 IS NOT NULL"),u=await j.query("SELECT avg30 FROM energy WHERE avg30 IS NOT NULL"),m=0;for(let c of s.values)m+=c.avg30;for(let c of d.values)m+=c.avg30;for(let c of u.values)m+=c.avg30;let l="\u{1FA99}";m>1e3?l="\u{1F525}":m>500&&(l="\u{1F4B0}"),document.getElementById("gesamtwert").textContent=`\u03A3: ${m.toFixed(2)}\u20AC ${l} | `;let p=await j.query("SELECT COUNT(*) as count FROM cards"),h=await j.query("SELECT COUNT(*) as count FROM trainer"),b=await j.query("SELECT COUNT(*) as count FROM energy"),w=p.values[0].count+h.values[0].count+b.values[0].count,g=document.getElementById("gesamtanzahl");g&&(g.textContent=`${w} Karten`)}catch(s){console.error("Fehler beim Berechnen des Gesamtwerts:",s)}}async function Y(){let s=await j.query("SELECT cardId FROM cards"),d=await j.query("SELECT cardId FROM trainer"),u=await j.query("SELECT cardId FROM energy"),m=0,l=0,p=s.values.length+d.values.length+u.values.length;alert(`Aktualisierung von ${p} Preisen gestartet.`);for(let b of s.values){let w=b.cardId,g=await B(w);if(g==null){let E=D(w);g=await B(E)}g!=null&&(await G(w,g),m++),l++;let c=Math.round(l/p*100),v=document.getElementById("preiseAktualisierenProgress");v&&(v.textContent=c+"%")}for(let b of d.values){let w=b.cardId,g=await B(w);if(g==null){let E=D(w);g=await B(E)}g!=null&&(await j.run("UPDATE trainer SET avg30 = ? WHERE cardId = ?",[g,w]),m++),l++;let c=Math.round(l/p*100),v=document.getElementById("preiseAktualisierenProgress");v&&(v.textContent=c+"%")}for(let b of u.values){let w=b.cardId,g=await B(w);if(g==null){let E=D(w);g=await B(E)}g!=null&&(await j.run("UPDATE energy SET avg30 = ? WHERE cardId = ?",[g,w]),m++),l++;let c=Math.round(l/p*100),v=document.getElementById("preiseAktualisierenProgress");v&&(v.textContent=c+"%")}let h=document.getElementById("preiseAktualisierenProgress");h&&(h.textContent=""),alert(`${m} Preise wurden aktualisiert!`),H()}window.aktualisiereAllePreise=Y;function ve(){let d=document.getElementById("search").value.toUpperCase(),m=document.getElementById("kartentabelle").getElementsByTagName("tr");for(let l=1;l<m.length;l++){m[l].style.display="none";let p=m[l].getElementsByTagName("td");for(let h=0;h<p.length;h++){let b=p[h];if(b&&b.innerHTML.toUpperCase().indexOf(d)>-1){m[l].style.display="";break}}}I(),k(),H()}window.searchTable=ve;let A={reverse:"neutral",holo:"neutral",v:"neutral",vmax:"neutral",ex:"neutral",shiny:"neutral"};function we(){let s=["kartentabelle","trainertabelle","energietabelle"],d=Object.values(A).some(u=>u==="positive");s.forEach(u=>{document.querySelectorAll(`#${u} tbody tr`).forEach(l=>{let p=l.querySelector("div[id*='Container']");if(!p)return;let h=p.querySelectorAll("img"),b=0;h.forEach(w=>{var F,N,_,ye,Ne,We,ze,Ge,Ue,Ve,Je,_e,Xe,Ze,Qe;let g=w.alt,c=(F=window.cachedCards)==null?void 0:F[g];if(!c){w.style.display="none";return}let v=!0;A.reverse==="positive"&&c.reverse!==1&&(v=!1),A.reverse==="negative"&&c.reverse===1&&(v=!1),A.holo==="positive"&&c.holo!==1&&(v=!1),A.holo==="negative"&&c.holo===1&&(v=!1),A.v==="positive"&&!((N=c.subTypes)!=null&&N.toLowerCase().includes("v")||(_=c.cardName)!=null&&_.toLowerCase().includes(" v"))&&(v=!1),A.v==="negative"&&((ye=c.subTypes)!=null&&ye.toLowerCase().includes("v")||(Ne=c.cardName)!=null&&Ne.toLowerCase().includes(" v"))&&(v=!1);let E=((We=c.subTypes)==null?void 0:We.toLowerCase().includes("vmax"))||((ze=c.cardName)==null?void 0:ze.toLowerCase().includes(" vmax")),L=((Ge=c.subTypes)==null?void 0:Ge.toLowerCase().includes("vstar"))||((Ue=c.cardName)==null?void 0:Ue.toLowerCase().includes(" vstar"));A.vmax==="positive"&&!(E||L)&&(v=!1),A.vmax==="negative"&&(E||L)&&(v=!1),A.ex==="positive"&&!((Ve=c.subTypes)!=null&&Ve.toLowerCase().includes("ex")||(Je=c.cardName)!=null&&Je.toLowerCase().includes(" ex"))&&(v=!1),A.ex==="negative"&&((_e=c.subTypes)!=null&&_e.toLowerCase().includes("ex")||(Xe=c.cardName)!=null&&Xe.toLowerCase().includes(" ex"))&&(v=!1);let q=((Ze=c.subTypes)==null?void 0:Ze.toLowerCase().includes("radiant"))||((Qe=c.rarity)==null?void 0:Qe.toLowerCase().includes("shiny"));A.shiny==="positive"&&!q&&(v=!1),A.shiny==="negative"&&q&&(v=!1),w.style.display=v?"inline-block":"none",v&&b++}),h.length===0?l.style.display=d?"none":"":l.style.display=b>0?"":"none"})}),I(),k(),H()}function ee(s){A[s]==="neutral"?A[s]="positive":A[s]==="positive"?A[s]="negative":A[s]="neutral",we(),$()}function $(){let s=["reverse","holo","v","vmax","ex","shiny"];for(let d of s){let u=document.getElementById(`filter-${d}`);u&&(u.classList.remove("active-positive","active-negative"),A[d]==="positive"?u.classList.add("active-positive"):A[d]==="negative"&&u.classList.add("active-negative"))}}document.getElementById("filter-alle").addEventListener("click",s=>{s.preventDefault(),A.reverse="neutral",A.holo="neutral",A.v="neutral",A.vmax="neutral",A.ex="neutral",A.shiny="neutral",we(),$()}),document.getElementById("filter-reverse").addEventListener("click",s=>{s.preventDefault(),ee("reverse")}),document.getElementById("filter-holo").addEventListener("click",s=>{s.preventDefault(),ee("holo")}),document.getElementById("filter-v").addEventListener("click",s=>{s.preventDefault(),ee("v")}),document.getElementById("filter-vmax").addEventListener("click",s=>{s.preventDefault(),ee("vmax")}),document.getElementById("filter-ex").addEventListener("click",s=>{s.preventDefault(),ee("ex")}),document.getElementById("filter-shiny").addEventListener("click",s=>{s.preventDefault(),ee("shiny")});function T(){let s=document.getElementById("overlay");s.classList.add("fade-out"),setTimeout(()=>{s.classList.remove("shown","fade-out"),s.classList.add("hidden"),s.innerHTML=""},300)}function z(s){["kartentabelle","trainertabelle","energietabelle"].forEach(u=>{let m=document.getElementById(u);m&&(u===s?m.classList.remove("hidden"):m.classList.add("hidden"))})}window.zeigePokemonTabelle=function(){document.querySelectorAll("#tableToggle button").forEach(s=>s.classList.remove("active")),document.getElementById("showTablePokemon").classList.add("active"),z("kartentabelle")},window.zeigeTrainerTabelle=async function(){document.querySelectorAll("#tableToggle button").forEach(p=>p.classList.remove("active")),document.getElementById("showTableTrainer").classList.add("active"),z("trainertabelle");let s=document.querySelector("#trainertabelle tbody");s.innerHTML="";let d=document.createElement("tr");d.innerHTML=`
      ...
      `,s.appendChild(l),await X(),k()};async function X(){let s=document.getElementById("supporterContainer"),d=document.getElementById("itemContainer"),u=document.getElementById("stadiumContainer"),m=document.getElementById("toolContainer"),l=await P();if(!l||!Array.isArray(l)){console.error("getTrainers() lieferte keine g\xFCltige Liste:",l);return}l.sort((g,c)=>(c.avg30||0)-(g.avg30||0));let p=document.createDocumentFragment(),h=document.createDocumentFragment(),b=document.createDocumentFragment(),w=document.createDocumentFragment();for(let g of l){window.cachedCards[g.cardId]=g;let c=document.createElement("img");c.src=g.imageLow,c.alt=g.cardId,c.style.width="50px",c.style.height="69px",c.style.objectFit="cover";let v="";if(Array.isArray(g.subTypes))g.subTypes.some(E=>E.toLowerCase().includes("supporter"))?v="supporter":g.subTypes.some(E=>E.toLowerCase().includes("item"))?v="item":g.subTypes.some(E=>E.toLowerCase().includes("stadium"))?v="stadium":g.subTypes.some(E=>E.toLowerCase().includes("tool"))&&(v="tool");else if(typeof g.subTypes=="string"){let E=g.subTypes.toLowerCase();E.includes("supporter")?v="supporter":E.includes("item")?v="item":E.includes("stadium")?v="stadium":E.includes("tool")&&(v="tool")}c.addEventListener("click",()=>J(g.id,v)),v=="supporter"&&p.appendChild(c),v=="item"&&h.appendChild(c),v=="stadium"&&b.appendChild(c),v=="tool"&&w.appendChild(c)}s.appendChild(p),d.appendChild(h),u.appendChild(b),m.appendChild(w)}window.openTrainerOverlay=async function(s){let d=document.querySelector("#overlay");d.innerHTML=`
        <div id="overlayContent">
          <h2>Bitte warten...</h2>
          <p>Karten werden geladen</p>
          <div class="loader"></div>
        </div>
      `,d.classList.remove("hidden"),d.classList.add("shown");try{let u=window.cachedTrainerCardsByType[s];if(u||(u=await Z(s),u&&(window.cachedTrainerCardsByType[s]=u)),!u||u.length===0){d.innerHTML=`
            <div id='overlayContent'>
              <h2>Keine Karten gefunden.</h2> 
              <button class="overlayMenuBtn" id="BackBtn">Schlie\xDFen</button>
            </div>
          `,document.getElementById("BackBtn").addEventListener("click",()=>{e.preventDefault(),T()});return}let m=`
          <div id="overlayContent">
            <button class="closeGallery" id="BackBtn">X</button>
        ...
        `,d.innerHTML=m,document.getElementById("BackBtn").addEventListener("click",()=>{T()})}catch(u){console.error(u),d.innerHTML=`
          <div id='overlayContent'>
            <h2>Fehler beim Laden.</h2>
            <button class="overlayMenuBtn" id="BackBtn">Schlie\xDFen</button>
          </div>`,document.getElementById("BackBtn").addEventListener("click",()=>{T()})}};async function Z(s){var p,h,b,w;let d=[],u=1,m=250,l=!0;for(;l;){let g=`https://api.pokemontcg.io/v2/cards?q=supertype:Trainer subtypes:${s}&orderBy=name&page=${u}&pageSize=${m}`,c=await re.get({url:g,headers:{Accept:"application/json","X-Api-Key":oe.API_KEY,Connection:"close"}});if(c.status!==200||!((h=(p=c.data)==null?void 0:p.data)!=null&&h.length)){l=!1;break}let v=c.data.data;for(let E of v){let L=(b=E.cardmarket)==null?void 0:b.prices;E.avg30=(w=L==null?void 0:L.avg30)!=null?w:null}d=d.concat(v),v.length<m?l=!1:u++}return d}window.trainerKarteAusw\u00E4hlen=async function(s){var u,m;let d=document.querySelector("#overlay");d.innerHTML='<div id="overlayContent"><div class="loader"></div></div>',d.classList.remove("hidden"),d.classList.add("shown");try{let l=await re.get({url:`https://api.pokemontcg.io/v2/cards/${s}`,headers:{Accept:"application/json","X-Api-Key":oe.API_KEY,Connection:"close"}});if(l.status!==200){console.error("Fehler beim Abrufen der Karte:",l.status,l);return}let p=l.data.data;p.imageSmall=((u=p.images)==null?void 0:u.small)||null,p.imageLarge=((m=p.images)==null?void 0:m.large)||null;let h=await x(p);if(!h){console.error("Keine ID von insertCard erhalten \u2013 Abbruch.");return}p.id=h,window.cachedCards[p.cardId]=p,d.innerHTML=`
          <div id="overlayContent">
            <h2>Karte hinzugef\xFCgt!</h2>
        ...
        `;async function b(w,g){d.innerHTML='<div id="overlayContent"><div class="loader"></div></div>',d.classList.remove("hidden"),d.classList.add("shown");try{w!=="none"&&await j.run(`UPDATE trainer SET ${w} = 1 WHERE id = ?`,[g]);let c=document.getElementById("supporterContainer");c.innerHTML="";let v=document.getElementById("itemContainer");v.innerHTML="";let E=document.getElementById("stadiumContainer");E.innerHTML="";let L=document.getElementById("toolContainer");L.innerHTML="",await X()}catch(c){console.error("Fehler in finalizeTrainerSelection:",c.message,c)}T(),await H()}document.getElementById("btnBasic").addEventListener("click",()=>b("basic",h)),document.getElementById("btnReverse").addEventListener("click",()=>b("reverse",h)),document.getElementById("btnHolo").addEventListener("click",()=>b("holo",h)),document.getElementById("closeOverlayConfirm").addEventListener("click",()=>b("none",h))}catch(l){console.error("Fehler bei trainerKarteAusw\xE4hlen:",l),d.innerHTML=`
          <div id="overlayContent">
            <h2>Fehler beim Hinzuf\xFCgen.</h2>
            <p>${l.message}</p>
            <button class="overlayMenuBtn" id="closeOverlayConfirm">Schlie\xDFen</button>
          </div>
        `,document.getElementById("closeOverlayConfirm").addEventListener("click",()=>{T()})}};async function J(s,d){var w;let u=document.querySelector("#overlay");u.innerHTML='<div id="overlayContent"><div class="loader"></div></div>',u.classList.remove("hidden"),u.classList.add("shown");let m=await U();if(!m||!m.length)return;let l=[],p={};for(let g of m){let c=await W(g);if(!c)continue;let v=((w=c.subTypes)==null?void 0:w.toLowerCase())||"";(d==="supporter"&&v.includes("supporter")||d==="item"&&v.includes("item")||d==="stadium"&&v.includes("stadium")||d==="tool"&&v.includes("tool"))&&(l.push(g),p[g]=c)}if(!l.length){T();return}let h=l.findIndex(g=>g===s);h===-1&&(h=0);async function b(){let g=l[h],c=p[g]||await W(g);if(!c)return;let v="Unbekannt";c.addedAt&&(v=new Date(c.addedAt).toLocaleString("de-DE",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"}));let E="Keine Angabe";c.basic==1&&(E="Basic"),c.reverse==1&&(E="Reverse"),c.holo==1&&(E="Holo");let L="\u2013",q=await B(c.cardId);if(q==null){let F=D(c.cardId);q=await B(F)}if(q!=null){let F=q.toFixed(2),N="#DEDEDE",_="\u{1FA99}";q>20?(N="#FF4444",_="\u{1F525}"):q>5&&(N="#FFAA00",_="\u{1F4B0}"),L=`<span style="color:${N};">${_} ${F}\u20AC</span>`}u.innerHTML=`
          <div id="overlayContent">
            <button class="closeGallery" id="closeGallery">X</button>
            <h2>Trainer</h2>
            <div style="display:flex; align-items:center; justify-content:center;">
      ...
      `,s.appendChild(u),await ie(),k()};async function ie(){var p,h,b;let s=document.getElementById("basisEnergieContainer"),d=document.getElementById("spezialEnergieContainer"),u=await Q();if(!u||!Array.isArray(u)){console.error("getEnergies() lieferte keine g\xFCltige Liste:",u);return}u.sort((w,g)=>(g.avg30||0)-(w.avg30||0));let m=document.createDocumentFragment(),l=document.createDocumentFragment();for(let w of u){window.cachedCards[w.cardId]=w;let g=document.createElement("img");g.src=w.imageLow,g.alt=w.cardId,g.style.width="50px",g.style.height="69px",g.style.objectFit="cover";let c=((p=w.subTypes)==null?void 0:p.toLowerCase())||"";g.addEventListener("click",()=>kt(w.id,c.includes("basic")?"basic":"special")),(h=w.subTypes)!=null&&h.toLowerCase().includes("basic")?m.appendChild(g):(b=w.subTypes)!=null&&b.toLowerCase().includes("special")&&l.appendChild(g)}s.appendChild(m),d.appendChild(l)}window.openEnergieOverlay=async function(s){let d=document.querySelector("#overlay");d.innerHTML=`
        <div id="overlayContent">
          <h2>Bitte warten...</h2>
          <p>Karten werden geladen</p>
          <div class="loader"></div>
        </div>
      `,d.classList.remove("hidden"),d.classList.add("shown");try{let u=window.cachedEnergyCardsByType[s];if(u||(u=await ue(s),u&&(window.cachedEnergyCardsByType[s]=u)),!u||u.length===0){d.innerHTML=`
            <div id='overlayContent'>
              <h2>Keine Karten gefunden.</h2> 
              <button class="overlayMenuBtn" id="BackBtn">Schlie\xDFen</button>
            </div>
          `,document.getElementById("BackBtn").addEventListener("click",()=>{T()});return}let m=`
          <div id="overlayContent">
            <button class="closeGallery" id="BackBtn">X</button>
            <h2>Kartenauswahl f\xFCr<br><strong>${s}</strong>:</h2>
            <p>
        ...
        `,d.innerHTML=m,document.getElementById("BackBtn").addEventListener("click",()=>{T()})}catch(u){console.error(u),d.innerHTML=`
          <div id='overlayContent'>
            <h2>Fehler beim Laden.</h2>
            <button class="overlayMenuBtn" id="BackBtn">Schlie\xDFen</button>
          </div>`,document.getElementById("BackBtn").addEventListener("click",()=>{T()})}};async function ue(s){var p,h,b,w;let d=[],u=1,m=250,l=!0;for(;l;){let g=`https://api.pokemontcg.io/v2/cards?q=supertype:Energy subtypes:${s}&orderBy=name&page=${u}&pageSize=${m}`,c=await re.get({url:g,headers:{Accept:"application/json","X-Api-Key":oe.API_KEY,Connection:"close"}});if(c.status!==200||!((h=(p=c.data)==null?void 0:p.data)!=null&&h.length)){l=!1;break}let v=c.data.data;for(let E of v){let L=(b=E.cardmarket)==null?void 0:b.prices;E.avg30=(w=L==null?void 0:L.avg30)!=null?w:null}d=d.concat(v),v.length<m?l=!1:u++}return d}window.energieKarteAusw\u00E4hlen=async function(s){var u,m;let d=document.querySelector("#overlay");d.innerHTML='<div id="overlayContent"><div class="loader"></div></div>',d.classList.remove("hidden"),d.classList.add("shown");try{let l=await re.get({url:`https://api.pokemontcg.io/v2/cards/${s}`,headers:{Accept:"application/json","X-Api-Key":oe.API_KEY,Connection:"close"}});if(l.status!==200){console.error("Fehler beim Abrufen der Karte:",l.status,l);return}let p=l.data.data;p.imageSmall=((u=p.images)==null?void 0:u.small)||null,p.imageLarge=((m=p.images)==null?void 0:m.large)||null;let h=await V(p);if(!h){console.error("Keine ID von insertCard erhalten \u2013 Abbruch.");return}p.id=h,window.cachedCards[p.cardId]=p,d.innerHTML=`
          <div id="overlayContent">
            <h2>Karte hinzugef\xFCgt!</h2>
            <p>Du hast <strong>${s}</strong> ausgew\xE4hlt.</p>
            <br>
        ...
        `;async function b(w,g){d.innerHTML='<div id="overlayContent"><div class="loader"></div></div>',d.classList.remove("hidden"),d.classList.add("shown");try{w!=="none"&&await j.run(`UPDATE energy SET ${w} = 1 WHERE id = ?`,[g]);let c=document.getElementById("basisEnergieContainer");c.innerHTML="";let v=document.getElementById("spezialEnergieContainer");v.innerHTML="",await ie()}catch(c){console.error("Fehler in finalizeEnergieSelection:",c.message,c)}T(),await H()}document.getElementById("btnBasic").addEventListener("click",()=>b("basic",h)),document.getElementById("btnReverse").addEventListener("click",()=>b("reverse",h)),document.getElementById("btnHolo").addEventListener("click",()=>b("holo",h)),document.getElementById("closeOverlayConfirm").addEventListener("click",()=>b("none",h))}catch(l){console.error("Fehler bei energieKarteAusw\xE4hlen:",l),d.innerHTML=`
          <div id="overlayContent">
            <h2>Fehler beim Hinzuf\xFCgen.</h2>
            <p>${l.message}</p>
            <button class="overlayMenuBtn" id="closeOverlayConfirm">Schlie\xDFen</button>
          </div>
        `,document.getElementById("closeOverlayConfirm").addEventListener("click",()=>{T()})}};async function kt(s,d){var w;let u=document.querySelector("#overlay");u.innerHTML='<div id="overlayContent"><div class="loader"></div></div>',u.classList.remove("hidden"),u.classList.add("shown");let m=await ce();if(!m||!m.length)return;let l=[],p={};for(let g of m){let c=await de(g);if(!c)continue;let v=((w=c.subTypes)==null?void 0:w.toLowerCase())||"";(d==="basic"&&v.includes("basic")||d==="special"&&v.includes("special"))&&(l.push(g),p[g]=c)}if(!l.length){T();return}let h=l.findIndex(g=>g===s);h===-1&&(h=0);async function b(){let g=l[h],c=p[g]||await de(g);if(!c)return;let v="Unbekannt";c.addedAt&&(v=new Date(c.addedAt).toLocaleString("de-DE",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"}));let E="Keine Angabe";c.basic==1&&(E="Basic"),c.reverse==1&&(E="Reverse"),c.holo==1&&(E="Holo");let L="\u2013",q=await B(c.cardId);if(q==null){let F=D(c.cardId);q=await B(F)}if(q!=null){let F=q.toFixed(2),N="#DEDEDE",_="\u{1FA99}";q>20?(N="#FF4444",_="\u{1F525}"):q>5&&(N="#FFAA00",_="\u{1F4B0}"),L=`<span style="color:${N};">${_} ${F}\u20AC</span>`}u.innerHTML=`
          <div id="overlayContent">
            <button class="closeGallery" id="closeGallery">X</button>
            <h2>Energie</h2>
            <div style="display:flex; align-items:center; justify-content:center;">
        ...
        `,document.getElementById("deleteEnergie").addEventListener("click",async()=>{if(confirm("Willst du diese Karte wirklich l\xF6schen?"))try{await j.run("DELETE FROM energy WHERE id = ?",[g]),T();let F=document.getElementById("basisEnergieContainer"),N=document.getElementById("spezialEnergieContainer");F&&(F.innerHTML=""),N&&(N.innerHTML=""),await ie(),await H()}catch(F){console.error("Fehler beim L\xF6schen der Energie-Karte:",F),alert("Beim L\xF6schen ist ein Fehler aufgetreten.")}}),document.getElementById("closeGallery").addEventListener("click",()=>{T()})}b()}window.filterEnergieCardsByNumber=function(){let s=document.getElementById("nummerSuche").value.trim();document.querySelectorAll(".kartenItem").forEach(d=>{let u=d.dataset.number;d.style.display=u&&u.startsWith(s)?"block":"none"})}})()});})();
