(()=>{var Zt=Object.defineProperty;var ue=(n,t)=>()=>(n&&(t=n(n=0)),t);var Qt=(n,t)=>()=>(t||n((t={exports:{}}).exports,t),t.exports),Ne=(n,t)=>{for(var r in t)Zt(n,r,{get:t[r],enumerable:!0})};var Yt,er,Pt,Dr,Or,Ie,Fe,tr,rr,nr,qe,It,$r,De,We=ue(()=>{Yt=n=>{let t=new Map;t.set("web",{name:"web"});let r=n.CapacitorPlatforms||{currentPlatform:{name:"web"},platforms:t},a=(s,b)=>{r.platforms.set(s,b)},i=s=>{r.platforms.has(s)&&(r.currentPlatform=r.platforms.get(s))};return r.addPlatform=a,r.setPlatform=i,r},er=n=>n.CapacitorPlatforms=Yt(n),Pt=er(typeof globalThis!="undefined"?globalThis:typeof self!="undefined"?self:typeof window!="undefined"?window:typeof global!="undefined"?global:{}),Dr=Pt.addPlatform,Or=Pt.setPlatform;(function(n){n.Unimplemented="UNIMPLEMENTED",n.Unavailable="UNAVAILABLE"})(Ie||(Ie={}));Fe=class extends Error{constructor(t,r){super(t),this.message=t,this.code=r}},tr=n=>{var t,r;return n!=null&&n.androidBridge?"android":!((r=(t=n==null?void 0:n.webkit)===null||t===void 0?void 0:t.messageHandlers)===null||r===void 0)&&r.bridge?"ios":"web"},rr=n=>{var t,r,a,i,s;let b=n.CapacitorCustomPlatform||null,v=n.Capacitor||{},L=v.Plugins=v.Plugins||{},T=n.CapacitorPlatforms,te=()=>b!==null?b.name:tr(n),A=((t=T==null?void 0:T.currentPlatform)===null||t===void 0?void 0:t.getPlatform)||te,B=()=>A()!=="web",re=((r=T==null?void 0:T.currentPlatform)===null||r===void 0?void 0:r.isNativePlatform)||B,Z=M=>{let C=pe.get(M);return!!(C!=null&&C.platforms.has(A())||ke(M))},ce=((a=T==null?void 0:T.currentPlatform)===null||a===void 0?void 0:a.isPluginAvailable)||Z,ne=M=>{var C;return(C=v.PluginHeaders)===null||C===void 0?void 0:C.find(O=>O.name===M)},ke=((i=T==null?void 0:T.currentPlatform)===null||i===void 0?void 0:i.getPluginHeader)||ne,Se=M=>n.console.error(M),he=(M,C,O)=>Promise.reject(`${O} does not have an implementation of "${C}".`),pe=new Map,ve=(M,C={})=>{let O=pe.get(M);if(O)return console.warn(`Capacitor plugin "${M}" already registered. Cannot register plugins twice.`),O.proxy;let j=A(),z=ke(M),N,W=async()=>(!N&&j in C?N=typeof C[j]=="function"?N=await C[j]():N=C[j]:b!==null&&!N&&"web"in C&&(N=typeof C.web=="function"?N=await C.web():N=C.web),N),J=(U,P)=>{var Q,se;if(z){let le=z==null?void 0:z.methods.find(ae=>P===ae.name);if(le)return le.rtype==="promise"?ae=>v.nativePromise(M,P.toString(),ae):(ae,ge)=>v.nativeCallback(M,P.toString(),ae,ge);if(U)return(Q=U[P])===null||Q===void 0?void 0:Q.bind(U)}else{if(U)return(se=U[P])===null||se===void 0?void 0:se.bind(U);throw new Fe(`"${M}" plugin is not implemented on ${j}`,Ie.Unimplemented)}},de=U=>{let P,Q=(...se)=>{let le=W().then(ae=>{let ge=J(ae,U);if(ge){let Le=ge(...se);return P=Le==null?void 0:Le.remove,Le}else throw new Fe(`"${M}.${U}()" is not implemented on ${j}`,Ie.Unimplemented)});return U==="addListener"&&(le.remove=async()=>P()),le};return Q.toString=()=>`${U.toString()}() { [capacitor code] }`,Object.defineProperty(Q,"name",{value:U,writable:!1,configurable:!1}),Q},Me=de("addListener"),S=de("removeListener"),Ce=(U,P)=>{let Q=Me({eventName:U},P),se=async()=>{let ae=await Q;S({eventName:U,callbackId:ae},P)},le=new Promise(ae=>Q.then(()=>ae({remove:se})));return le.remove=async()=>{console.warn("Using addListener() without 'await' is deprecated."),await se()},le},oe=new Proxy({},{get(U,P){switch(P){case"$$typeof":return;case"toJSON":return()=>({});case"addListener":return z?Ce:Me;case"removeListener":return S;default:return de(P)}}});return L[M]=oe,pe.set(M,{name:M,proxy:oe,platforms:new Set([...Object.keys(C),...z?[j]:[]])}),oe},Be=((s=T==null?void 0:T.currentPlatform)===null||s===void 0?void 0:s.registerPlugin)||ve;return v.convertFileSrc||(v.convertFileSrc=M=>M),v.getPlatform=A,v.handleError=Se,v.isNativePlatform=re,v.isPluginAvailable=ce,v.pluginMethodNoop=he,v.registerPlugin=Be,v.Exception=Fe,v.DEBUG=!!v.DEBUG,v.isLoggingEnabled=!!v.isLoggingEnabled,v.platform=v.getPlatform(),v.isNative=v.isNativePlatform(),v},nr=n=>n.Capacitor=rr(n),qe=nr(typeof globalThis!="undefined"?globalThis:typeof self!="undefined"?self:typeof window!="undefined"?window:typeof global!="undefined"?global:{}),It=qe.registerPlugin,$r=qe.Plugins,De=class{constructor(t){this.listeners={},this.windowListeners={},t&&(console.warn(`Capacitor WebPlugin "${t.name}" config object was deprecated in v3 and will be removed in v4.`),this.config=t)}addListener(t,r){this.listeners[t]||(this.listeners[t]=[]),this.listeners[t].push(r);let i=this.windowListeners[t];i&&!i.registered&&this.addWindowListener(i);let s=async()=>this.removeListener(t,r),b=Promise.resolve({remove:s});return Object.defineProperty(b,"remove",{value:async()=>{console.warn("Using addListener() without 'await' is deprecated."),await s()}}),b}async removeAllListeners(){this.listeners={};for(let t in this.windowListeners)this.removeWindowListener(this.windowListeners[t]);this.windowListeners={}}notifyListeners(t,r){let a=this.listeners[t];a&&a.forEach(i=>i(r))}hasListeners(t){return!!this.listeners[t].length}registerWindowListener(t,r){this.windowListeners[r]={registered:!1,windowEventName:t,pluginEventName:r,handler:a=>{this.notifyListeners(r,a)}}}unimplemented(t="not implemented"){return new qe.Exception(t,Ie.Unimplemented)}unavailable(t="not available"){return new qe.Exception(t,Ie.Unavailable)}async removeListener(t,r){let a=this.listeners[t];if(!a)return;let i=a.indexOf(r);this.listeners[t].splice(i,1),this.listeners[t].length||this.removeWindowListener(this.windowListeners[t])}addWindowListener(t){window.addEventListener(t.windowEventName,t.handler),t.registered=!0}removeWindowListener(t){t&&(window.removeEventListener(t.windowEventName,t.handler),t.registered=!1)}}});var xt,Ge,ze,Ue=ue(()=>{xt=async n=>new Promise((t,r)=>{let a=new FileReader;a.onload=()=>{let i=a.result,s=i.substr(i.indexOf(",")+1);t(s)},a.onerror=i=>r(i),a.readAsDataURL(n)}),Ge=n=>encodeURIComponent(n).replace(/%(2[346B]|5E|60|7C)/g,decodeURIComponent).replace(/[()]/g,escape),ze=n=>n.replace(/(%[\dA-F]{2})+/gi,decodeURIComponent)});var At,Oe,Bt,Mt,Ve,Ft=ue(()=>{Ue();At=(n,t,r={})=>{let a=Ge(n),i=Ge(t),s=`; expires=${(r.expires||"").replace("expires=","")}`,b=(r.path||"/").replace("path=","");document.cookie=`${a}=${i||""}${s}; path=${b}`},Oe=()=>{let n=[],t={};if(!document.cookie)return n;let r=document.cookie.split(";")||[];for(let i of r){let[s,b]=i.replace(/=/,"CAP_COOKIE").split("CAP_COOKIE");s=ze(s).trim(),b=ze(b).trim(),t[s]=b}let a=Object.entries(t);for(let[i,s]of a)n.push({key:i,value:s});return n},Bt=n=>{let t=Oe();for(let r of t)if(r.key===n)return r;return{key:n,value:""}},Mt=n=>{document.cookie=`${n}=; Max-Age=0`},Ve=()=>{let n=document.cookie.split(";")||[];for(let t of n)document.cookie=t.replace(/^ +/,"").replace(/=.*/,`=;expires=${new Date().toUTCString()};path=/`)}});var ir,or,Je,Ee,Rt,qt,Dt,Ot,$t,Kt=ue(()=>{Ue();ir=(n={})=>{let t=Object.keys(n);return Object.keys(n).map(i=>i.toLocaleLowerCase()).reduce((i,s,b)=>(i[s]=n[t[b]],i),{})},or=(n,t=!0)=>n?Object.entries(n).reduce((a,i)=>{let[s,b]=i,v,L;return Array.isArray(b)?(L="",b.forEach(T=>{v=t?encodeURIComponent(T):T,L+=`${s}=${v}&`}),L.slice(0,-1)):(v=t?encodeURIComponent(b):b,L=`${s}=${v}`),`${a}&${L}`},"").substr(1):null,Je=(n,t={})=>{let r=Object.assign({method:n.method||"GET",headers:n.headers},t),i=ir(n.headers)["content-type"]||"";if(typeof n.data=="string")r.body=n.data;else if(i.includes("application/x-www-form-urlencoded")){let s=new URLSearchParams;for(let[b,v]of Object.entries(n.data||{}))s.set(b,v);r.body=s.toString()}else if(i.includes("multipart/form-data")){let s=new FormData;if(n.data instanceof FormData)n.data.forEach((v,L)=>{s.append(L,v)});else for(let v of Object.keys(n.data))s.append(v,n.data[v]);r.body=s;let b=new Headers(r.headers);b.delete("content-type"),r.headers=b}else(i.includes("application/json")||typeof n.data=="object")&&(r.body=JSON.stringify(n.data));return r},Ee=async n=>{let t=Je(n,n.webFetchExtra),r=or(n.params,n.shouldEncodeUrlParams),a=r?`${n.url}?${r}`:n.url,i=await fetch(a,t),s=i.headers.get("content-type")||"",{responseType:b="text"}=i.ok?n:{};s.includes("application/json")&&(b="json");let v;switch(b){case"arraybuffer":case"blob":let T=await i.blob();v=await xt(T);break;case"json":v=await i.json();break;case"document":case"text":default:v=await i.text()}let L={};return i.headers.forEach((T,te)=>{L[te]=T}),{data:v,headers:L,status:i.status,url:i.url}},Rt=async n=>Ee(Object.assign(Object.assign({},n),{method:"GET"})),qt=async n=>Ee(Object.assign(Object.assign({},n),{method:"POST"})),Dt=async n=>Ee(Object.assign(Object.assign({},n),{method:"PUT"})),Ot=async n=>Ee(Object.assign(Object.assign({},n),{method:"PATCH"})),$t=async n=>Ee(Object.assign(Object.assign({},n),{method:"DELETE"}))});var Xe={};Ne(Xe,{HttpWeb:()=>_e});var _e,Ze=ue(()=>{We();Ft();Kt();_e=class extends De{constructor(){super(),this.request=async t=>Ee(t),this.get=async t=>Rt(t),this.post=async t=>qt(t),this.put=async t=>Dt(t),this.patch=async t=>Ot(t),this.del=async t=>$t(t),this.getCookiesMap=async t=>{let r=Oe(),a={};for(let i of r)a[i.key]=i.value;return a},this.getCookies=async t=>{let{url:r}=t;return{cookies:Oe()}},this.setCookie=async t=>{let{key:r,value:a,expires:i="",path:s=""}=t;At(r,a,{expires:i,path:s})},this.getCookie=async t=>Bt(t.key),this.deleteCookie=async t=>Mt(t.key),this.clearCookies=async t=>Ve(),this.clearAllCookies=async()=>Ve(),this.uploadFile=async t=>{let r=new FormData;r.append(t.name,t.blob||"undefined");let a=Object.assign(Object.assign({},t),{body:r,method:"POST"});return this.post(a)},this.downloadFile=async t=>{let r=Je(t,t.webFetchExtra),a=await fetch(t.url,r),i;if(!(t!=null&&t.progress))i=await a.blob();else if(!(a!=null&&a.body))i=new Blob;else{let s=a.body.getReader(),b=0,v=[],L=a.headers.get("content-type"),T=parseInt(a.headers.get("content-length")||"0",10);for(;;){let{done:B,value:re}=await s.read();if(B)break;v.push(re),b+=(re==null?void 0:re.length)||0;let Z={type:"DOWNLOAD",url:t.url,bytes:b,contentLength:T};this.notifyListeners("progress",Z)}let te=new Uint8Array(b),A=0;for(let B of v)typeof B!="undefined"&&(te.set(B,A),A+=B.length);i=new Blob([te.buffer],{type:L||void 0})}return{blob:i}}}}});var Ht=Qt((Vr,lr)=>{lr.exports={API_KEY:"a5d75d50-65e6-41a4-aa2f-9b2c93afaaa7"}});var xe,Re,cr,dr,ur,Qe,$e,Ae,jt,Nt,Ye,Jr,mr,hr,pr,gr,et,_r,tt=ue(()=>{(function(n){n.Unimplemented="UNIMPLEMENTED",n.Unavailable="UNAVAILABLE"})(xe||(xe={}));Re=class extends Error{constructor(t,r,a){super(t),this.message=t,this.code=r,this.data=a}},cr=n=>{var t,r;return n!=null&&n.androidBridge?"android":!((r=(t=n==null?void 0:n.webkit)===null||t===void 0?void 0:t.messageHandlers)===null||r===void 0)&&r.bridge?"ios":"web"},dr=n=>{let t=n.CapacitorCustomPlatform||null,r=n.Capacitor||{},a=r.Plugins=r.Plugins||{},i=()=>t!==null?t.name:cr(n),s=()=>i()!=="web",b=A=>{let B=T.get(A);return!!(B!=null&&B.platforms.has(i())||v(A))},v=A=>{var B;return(B=r.PluginHeaders)===null||B===void 0?void 0:B.find(re=>re.name===A)},L=A=>n.console.error(A),T=new Map,te=(A,B={})=>{let re=T.get(A);if(re)return console.warn(`Capacitor plugin "${A}" already registered. Cannot register plugins twice.`),re.proxy;let Z=i(),ce=v(A),ne,ke=async()=>(!ne&&Z in B?ne=typeof B[Z]=="function"?ne=await B[Z]():ne=B[Z]:t!==null&&!ne&&"web"in B&&(ne=typeof B.web=="function"?ne=await B.web():ne=B.web),ne),Se=(C,O)=>{var j,z;if(ce){let N=ce==null?void 0:ce.methods.find(W=>O===W.name);if(N)return N.rtype==="promise"?W=>r.nativePromise(A,O.toString(),W):(W,J)=>r.nativeCallback(A,O.toString(),W,J);if(C)return(j=C[O])===null||j===void 0?void 0:j.bind(C)}else{if(C)return(z=C[O])===null||z===void 0?void 0:z.bind(C);throw new Re(`"${A}" plugin is not implemented on ${Z}`,xe.Unimplemented)}},he=C=>{let O,j=(...z)=>{let N=ke().then(W=>{let J=Se(W,C);if(J){let de=J(...z);return O=de==null?void 0:de.remove,de}else throw new Re(`"${A}.${C}()" is not implemented on ${Z}`,xe.Unimplemented)});return C==="addListener"&&(N.remove=async()=>O()),N};return j.toString=()=>`${C.toString()}() { [capacitor code] }`,Object.defineProperty(j,"name",{value:C,writable:!1,configurable:!1}),j},pe=he("addListener"),ve=he("removeListener"),Be=(C,O)=>{let j=pe({eventName:C},O),z=async()=>{let W=await j;ve({eventName:C,callbackId:W},O)},N=new Promise(W=>j.then(()=>W({remove:z})));return N.remove=async()=>{console.warn("Using addListener() without 'await' is deprecated."),await z()},N},M=new Proxy({},{get(C,O){switch(O){case"$$typeof":return;case"toJSON":return()=>({});case"addListener":return ce?Be:pe;case"removeListener":return ve;default:return he(O)}}});return a[A]=M,T.set(A,{name:A,proxy:M,platforms:new Set([...Object.keys(B),...ce?[Z]:[]])}),M};return r.convertFileSrc||(r.convertFileSrc=A=>A),r.getPlatform=i,r.handleError=L,r.isNativePlatform=s,r.isPluginAvailable=b,r.registerPlugin=te,r.Exception=Re,r.DEBUG=!!r.DEBUG,r.isLoggingEnabled=!!r.isLoggingEnabled,r},ur=n=>n.Capacitor=dr(n),Qe=ur(typeof globalThis!="undefined"?globalThis:typeof self!="undefined"?self:typeof window!="undefined"?window:typeof global!="undefined"?global:{}),$e=Qe.registerPlugin,Ae=class{constructor(){this.listeners={},this.retainedEventArguments={},this.windowListeners={}}addListener(t,r){let a=!1;this.listeners[t]||(this.listeners[t]=[],a=!0),this.listeners[t].push(r);let s=this.windowListeners[t];s&&!s.registered&&this.addWindowListener(s),a&&this.sendRetainedArgumentsForEvent(t);let b=async()=>this.removeListener(t,r);return Promise.resolve({remove:b})}async removeAllListeners(){this.listeners={};for(let t in this.windowListeners)this.removeWindowListener(this.windowListeners[t]);this.windowListeners={}}notifyListeners(t,r,a){let i=this.listeners[t];if(!i){if(a){let s=this.retainedEventArguments[t];s||(s=[]),s.push(r),this.retainedEventArguments[t]=s}return}i.forEach(s=>s(r))}hasListeners(t){return!!this.listeners[t].length}registerWindowListener(t,r){this.windowListeners[r]={registered:!1,windowEventName:t,pluginEventName:r,handler:a=>{this.notifyListeners(r,a)}}}unimplemented(t="not implemented"){return new Qe.Exception(t,xe.Unimplemented)}unavailable(t="not available"){return new Qe.Exception(t,xe.Unavailable)}async removeListener(t,r){let a=this.listeners[t];if(!a)return;let i=a.indexOf(r);this.listeners[t].splice(i,1),this.listeners[t].length||this.removeWindowListener(this.windowListeners[t])}addWindowListener(t){window.addEventListener(t.windowEventName,t.handler),t.registered=!0}removeWindowListener(t){t&&(window.removeEventListener(t.windowEventName,t.handler),t.registered=!1)}sendRetainedArgumentsForEvent(t){let r=this.retainedEventArguments[t];r&&(delete this.retainedEventArguments[t],r.forEach(a=>{this.notifyListeners(t,a)}))}},jt=n=>encodeURIComponent(n).replace(/%(2[346B]|5E|60|7C)/g,decodeURIComponent).replace(/[()]/g,escape),Nt=n=>n.replace(/(%[\dA-F]{2})+/gi,decodeURIComponent),Ye=class extends Ae{async getCookies(){let t=document.cookie,r={};return t.split(";").forEach(a=>{if(a.length<=0)return;let[i,s]=a.replace(/=/,"CAP_COOKIE").split("CAP_COOKIE");i=Nt(i).trim(),s=Nt(s).trim(),r[i]=s}),r}async setCookie(t){try{let r=jt(t.key),a=jt(t.value),i=`; expires=${(t.expires||"").replace("expires=","")}`,s=(t.path||"/").replace("path=",""),b=t.url!=null&&t.url.length>0?`domain=${t.url}`:"";document.cookie=`${r}=${a||""}${i}; path=${s}; ${b};`}catch(r){return Promise.reject(r)}}async deleteCookie(t){try{document.cookie=`${t.key}=; Max-Age=0`}catch(r){return Promise.reject(r)}}async clearCookies(){try{let t=document.cookie.split(";")||[];for(let r of t)document.cookie=r.replace(/^ +/,"").replace(/=.*/,`=;expires=${new Date().toUTCString()};path=/`)}catch(t){return Promise.reject(t)}}async clearAllCookies(){try{await this.clearCookies()}catch(t){return Promise.reject(t)}}},Jr=$e("CapacitorCookies",{web:()=>new Ye}),mr=async n=>new Promise((t,r)=>{let a=new FileReader;a.onload=()=>{let i=a.result;t(i.indexOf(",")>=0?i.split(",")[1]:i)},a.onerror=i=>r(i),a.readAsDataURL(n)}),hr=(n={})=>{let t=Object.keys(n);return Object.keys(n).map(i=>i.toLocaleLowerCase()).reduce((i,s,b)=>(i[s]=n[t[b]],i),{})},pr=(n,t=!0)=>n?Object.entries(n).reduce((a,i)=>{let[s,b]=i,v,L;return Array.isArray(b)?(L="",b.forEach(T=>{v=t?encodeURIComponent(T):T,L+=`${s}=${v}&`}),L.slice(0,-1)):(v=t?encodeURIComponent(b):b,L=`${s}=${v}`),`${a}&${L}`},"").substr(1):null,gr=(n,t={})=>{let r=Object.assign({method:n.method||"GET",headers:n.headers},t),i=hr(n.headers)["content-type"]||"";if(typeof n.data=="string")r.body=n.data;else if(i.includes("application/x-www-form-urlencoded")){let s=new URLSearchParams;for(let[b,v]of Object.entries(n.data||{}))s.set(b,v);r.body=s.toString()}else if(i.includes("multipart/form-data")||n.data instanceof FormData){let s=new FormData;if(n.data instanceof FormData)n.data.forEach((v,L)=>{s.append(L,v)});else for(let v of Object.keys(n.data))s.append(v,n.data[v]);r.body=s;let b=new Headers(r.headers);b.delete("content-type"),r.headers=b}else(i.includes("application/json")||typeof n.data=="object")&&(r.body=JSON.stringify(n.data));return r},et=class extends Ae{async request(t){let r=gr(t,t.webFetchExtra),a=pr(t.params,t.shouldEncodeUrlParams),i=a?`${t.url}?${a}`:t.url,s=await fetch(i,r),b=s.headers.get("content-type")||"",{responseType:v="text"}=s.ok?t:{};b.includes("application/json")&&(v="json");let L,T;switch(v){case"arraybuffer":case"blob":T=await s.blob(),L=await mr(T);break;case"json":L=await s.json();break;case"document":case"text":default:L=await s.text()}let te={};return s.headers.forEach((A,B)=>{te[B]=A}),{data:L,headers:te,status:s.status,url:s.url}}async get(t){return this.request(Object.assign(Object.assign({},t),{method:"GET"}))}async post(t){return this.request(Object.assign(Object.assign({},t),{method:"POST"}))}async put(t){return this.request(Object.assign(Object.assign({},t),{method:"PUT"}))}async patch(t){return this.request(Object.assign(Object.assign({},t),{method:"PATCH"}))}async delete(t){return this.request(Object.assign(Object.assign({},t),{method:"DELETE"}))}},_r=$e("CapacitorHttp",{web:()=>new et})});var Ke,He,Wt=ue(()=>{Ke=class{constructor(t){this.sqlite=t,this._connectionDict=new Map}async initWebStore(){try{return await this.sqlite.initWebStore(),Promise.resolve()}catch(t){return Promise.reject(t)}}async saveToStore(t){try{return await this.sqlite.saveToStore({database:t}),Promise.resolve()}catch(r){return Promise.reject(r)}}async saveToLocalDisk(t){try{return await this.sqlite.saveToLocalDisk({database:t}),Promise.resolve()}catch(r){return Promise.reject(r)}}async getFromLocalDiskToStore(t){let r=t!=null?t:!0;try{return await this.sqlite.getFromLocalDiskToStore({overwrite:r}),Promise.resolve()}catch(a){return Promise.reject(a)}}async echo(t){try{let r=await this.sqlite.echo({value:t});return Promise.resolve(r)}catch(r){return Promise.reject(r)}}async isSecretStored(){try{let t=await this.sqlite.isSecretStored();return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async setEncryptionSecret(t){try{return await this.sqlite.setEncryptionSecret({passphrase:t}),Promise.resolve()}catch(r){return Promise.reject(r)}}async changeEncryptionSecret(t,r){try{return await this.sqlite.changeEncryptionSecret({passphrase:t,oldpassphrase:r}),Promise.resolve()}catch(a){return Promise.reject(a)}}async clearEncryptionSecret(){try{return await this.sqlite.clearEncryptionSecret(),Promise.resolve()}catch(t){return Promise.reject(t)}}async checkEncryptionSecret(t){try{let r=await this.sqlite.checkEncryptionSecret({passphrase:t});return Promise.resolve(r)}catch(r){return Promise.reject(r)}}async addUpgradeStatement(t,r){try{return t.endsWith(".db")&&(t=t.slice(0,-3)),await this.sqlite.addUpgradeStatement({database:t,upgrade:r}),Promise.resolve()}catch(a){return Promise.reject(a)}}async createConnection(t,r,a,i,s){try{t.endsWith(".db")&&(t=t.slice(0,-3)),await this.sqlite.createConnection({database:t,encrypted:r,mode:a,version:i,readonly:s});let b=new He(t,s,this.sqlite),v=s?`RO_${t}`:`RW_${t}`;return this._connectionDict.set(v,b),Promise.resolve(b)}catch(b){return Promise.reject(b)}}async closeConnection(t,r){try{t.endsWith(".db")&&(t=t.slice(0,-3)),await this.sqlite.closeConnection({database:t,readonly:r});let a=r?`RO_${t}`:`RW_${t}`;return this._connectionDict.delete(a),Promise.resolve()}catch(a){return Promise.reject(a)}}async isConnection(t,r){let a={};t.endsWith(".db")&&(t=t.slice(0,-3));let i=r?`RO_${t}`:`RW_${t}`;return a.result=this._connectionDict.has(i),Promise.resolve(a)}async retrieveConnection(t,r){t.endsWith(".db")&&(t=t.slice(0,-3));let a=r?`RO_${t}`:`RW_${t}`;if(this._connectionDict.has(a)){let i=this._connectionDict.get(a);return typeof i!="undefined"?Promise.resolve(i):Promise.reject(`Connection ${t} is undefined`)}else return Promise.reject(`Connection ${t} does not exist`)}async getNCDatabasePath(t,r){try{let a=await this.sqlite.getNCDatabasePath({path:t,database:r});return Promise.resolve(a)}catch(a){return Promise.reject(a)}}async createNCConnection(t,r){try{await this.sqlite.createNCConnection({databasePath:t,version:r});let a=new He(t,!0,this.sqlite),i=`RO_${t})`;return this._connectionDict.set(i,a),Promise.resolve(a)}catch(a){return Promise.reject(a)}}async closeNCConnection(t){try{await this.sqlite.closeNCConnection({databasePath:t});let r=`RO_${t})`;return this._connectionDict.delete(r),Promise.resolve()}catch(r){return Promise.reject(r)}}async isNCConnection(t){let r={},a=`RO_${t})`;return r.result=this._connectionDict.has(a),Promise.resolve(r)}async retrieveNCConnection(t){if(this._connectionDict.has(t)){let r=`RO_${t})`,a=this._connectionDict.get(r);return typeof a!="undefined"?Promise.resolve(a):Promise.reject(`Connection ${t} is undefined`)}else return Promise.reject(`Connection ${t} does not exist`)}async isNCDatabase(t){try{let r=await this.sqlite.isNCDatabase({databasePath:t});return Promise.resolve(r)}catch(r){return Promise.reject(r)}}async retrieveAllConnections(){return this._connectionDict}async closeAllConnections(){let t=new Map;try{for(let r of this._connectionDict.keys()){let a=r.substring(3),i=r.substring(0,3)==="RO_";await this.sqlite.closeConnection({database:a,readonly:i}),t.set(r,null)}for(let r of t.keys())this._connectionDict.delete(r);return Promise.resolve()}catch(r){return Promise.reject(r)}}async checkConnectionsConsistency(){try{let t=[...this._connectionDict.keys()],r=[],a=[];for(let s of t)r.push(s.substring(0,2)),a.push(s.substring(3));let i=await this.sqlite.checkConnectionsConsistency({dbNames:a,openModes:r});return i.result||(this._connectionDict=new Map),Promise.resolve(i)}catch(t){return this._connectionDict=new Map,Promise.reject(t)}}async importFromJson(t){try{let r=await this.sqlite.importFromJson({jsonstring:t});return Promise.resolve(r)}catch(r){return Promise.reject(r)}}async isJsonValid(t){try{let r=await this.sqlite.isJsonValid({jsonstring:t});return Promise.resolve(r)}catch(r){return Promise.reject(r)}}async copyFromAssets(t){let r=t!=null?t:!0;try{return await this.sqlite.copyFromAssets({overwrite:r}),Promise.resolve()}catch(a){return Promise.reject(a)}}async getFromHTTPRequest(t,r){let a=r!=null?r:!0;try{return await this.sqlite.getFromHTTPRequest({url:t,overwrite:a}),Promise.resolve()}catch(i){return Promise.reject(i)}}async isDatabaseEncrypted(t){t.endsWith(".db")&&(t=t.slice(0,-3));try{let r=await this.sqlite.isDatabaseEncrypted({database:t});return Promise.resolve(r)}catch(r){return Promise.reject(r)}}async isInConfigEncryption(){try{let t=await this.sqlite.isInConfigEncryption();return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async isInConfigBiometricAuth(){try{let t=await this.sqlite.isInConfigBiometricAuth();return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async isDatabase(t){t.endsWith(".db")&&(t=t.slice(0,-3));try{let r=await this.sqlite.isDatabase({database:t});return Promise.resolve(r)}catch(r){return Promise.reject(r)}}async getDatabaseList(){try{let r=(await this.sqlite.getDatabaseList()).values;r.sort();let a={values:r};return Promise.resolve(a)}catch(t){return Promise.reject(t)}}async getMigratableDbList(t){let r=t||"default";try{let a=await this.sqlite.getMigratableDbList({folderPath:r});return Promise.resolve(a)}catch(a){return Promise.reject(a)}}async addSQLiteSuffix(t,r){let a=t||"default",i=r||[];try{let s=await this.sqlite.addSQLiteSuffix({folderPath:a,dbNameList:i});return Promise.resolve(s)}catch(s){return Promise.reject(s)}}async deleteOldDatabases(t,r){let a=t||"default",i=r||[];try{let s=await this.sqlite.deleteOldDatabases({folderPath:a,dbNameList:i});return Promise.resolve(s)}catch(s){return Promise.reject(s)}}async moveDatabasesAndAddSuffix(t,r){let a=t||"default",i=r||[];return this.sqlite.moveDatabasesAndAddSuffix({folderPath:a,dbNameList:i})}},He=class{constructor(t,r,a){this.dbName=t,this.readonly=r,this.sqlite=a}getConnectionDBName(){return this.dbName}getConnectionReadOnly(){return this.readonly}async open(){try{return await this.sqlite.open({database:this.dbName,readonly:this.readonly}),Promise.resolve()}catch(t){return Promise.reject(t)}}async close(){try{return await this.sqlite.close({database:this.dbName,readonly:this.readonly}),Promise.resolve()}catch(t){return Promise.reject(t)}}async beginTransaction(){try{let t=await this.sqlite.beginTransaction({database:this.dbName});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async commitTransaction(){try{let t=await this.sqlite.commitTransaction({database:this.dbName});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async rollbackTransaction(){try{let t=await this.sqlite.rollbackTransaction({database:this.dbName});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async isTransactionActive(){try{let t=await this.sqlite.isTransactionActive({database:this.dbName});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async loadExtension(t){try{return await this.sqlite.loadExtension({database:this.dbName,path:t,readonly:this.readonly}),Promise.resolve()}catch(r){return Promise.reject(r)}}async enableLoadExtension(t){try{return await this.sqlite.enableLoadExtension({database:this.dbName,toggle:t,readonly:this.readonly}),Promise.resolve()}catch(r){return Promise.reject(r)}}async getUrl(){try{let t=await this.sqlite.getUrl({database:this.dbName,readonly:this.readonly});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async getVersion(){try{let t=await this.sqlite.getVersion({database:this.dbName,readonly:this.readonly});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async getTableList(){try{let t=await this.sqlite.getTableList({database:this.dbName,readonly:this.readonly});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async execute(t,r=!0,a=!0){try{if(this.readonly)return Promise.reject("not allowed in read-only mode");{let i=await this.sqlite.execute({database:this.dbName,statements:t,transaction:r,readonly:!1,isSQL92:a});return Promise.resolve(i)}}catch(i){return Promise.reject(i)}}async query(t,r,a=!0){let i;try{return r&&r.length>0?i=await this.sqlite.query({database:this.dbName,statement:t,values:r,readonly:this.readonly,isSQL92:!0}):i=await this.sqlite.query({database:this.dbName,statement:t,values:[],readonly:this.readonly,isSQL92:a}),i=await this.reorderRows(i),Promise.resolve(i)}catch(s){return Promise.reject(s)}}async run(t,r,a=!0,i="no",s=!0){let b;try{return this.readonly?Promise.reject("not allowed in read-only mode"):(r&&r.length>0?b=await this.sqlite.run({database:this.dbName,statement:t,values:r,transaction:a,readonly:!1,returnMode:i,isSQL92:!0}):b=await this.sqlite.run({database:this.dbName,statement:t,values:[],transaction:a,readonly:!1,returnMode:i,isSQL92:s}),b.changes=await this.reorderRows(b.changes),Promise.resolve(b))}catch(v){return Promise.reject(v)}}async executeSet(t,r=!0,a="no",i=!0){let s;try{return this.readonly?Promise.reject("not allowed in read-only mode"):(s=await this.sqlite.executeSet({database:this.dbName,set:t,transaction:r,readonly:!1,returnMode:a,isSQL92:i}),s.changes=await this.reorderRows(s.changes),Promise.resolve(s))}catch(b){return Promise.reject(b)}}async isExists(){try{let t=await this.sqlite.isDBExists({database:this.dbName,readonly:this.readonly});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async isTable(t){try{let r=await this.sqlite.isTableExists({database:this.dbName,table:t,readonly:this.readonly});return Promise.resolve(r)}catch(r){return Promise.reject(r)}}async isDBOpen(){try{let t=await this.sqlite.isDBOpen({database:this.dbName,readonly:this.readonly});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async delete(){try{return this.readonly?Promise.reject("not allowed in read-only mode"):(await this.sqlite.deleteDatabase({database:this.dbName,readonly:!1}),Promise.resolve())}catch(t){return Promise.reject(t)}}async createSyncTable(){try{if(this.readonly)return Promise.reject("not allowed in read-only mode");{let t=await this.sqlite.createSyncTable({database:this.dbName,readonly:!1});return Promise.resolve(t)}}catch(t){return Promise.reject(t)}}async setSyncDate(t){try{return this.readonly?Promise.reject("not allowed in read-only mode"):(await this.sqlite.setSyncDate({database:this.dbName,syncdate:t,readonly:!1}),Promise.resolve())}catch(r){return Promise.reject(r)}}async getSyncDate(){try{let t=await this.sqlite.getSyncDate({database:this.dbName,readonly:this.readonly}),r="";return t.syncDate>0&&(r=new Date(t.syncDate*1e3).toISOString()),Promise.resolve(r)}catch(t){return Promise.reject(t)}}async exportToJson(t,r=!1){try{let a=await this.sqlite.exportToJson({database:this.dbName,jsonexportmode:t,readonly:this.readonly,encrypted:r});return Promise.resolve(a)}catch(a){return Promise.reject(a)}}async deleteExportedRows(){try{return this.readonly?Promise.reject("not allowed in read-only mode"):(await this.sqlite.deleteExportedRows({database:this.dbName,readonly:!1}),Promise.resolve())}catch(t){return Promise.reject(t)}}async executeTransaction(t,r=!0){let a=0,i=!1;if(this.readonly)return Promise.reject("not allowed in read-only mode");if(await this.sqlite.beginTransaction({database:this.dbName}),i=await this.sqlite.isTransactionActive({database:this.dbName}),!i)return Promise.reject("After Begin Transaction, no transaction active");try{for(let v of t){if(typeof v!="object"||!("statement"in v))throw new Error("Error a task.statement must be provided");if("values"in v&&v.values&&v.values.length>0){let L=v.statement.toUpperCase().includes("RETURNING")?"all":"no",T=await this.sqlite.run({database:this.dbName,statement:v.statement,values:v.values,transaction:!1,readonly:!1,returnMode:L,isSQL92:r});if(T.changes.changes<0)throw new Error("Error in transaction method run ");a+=T.changes.changes}else{let L=await this.sqlite.execute({database:this.dbName,statements:v.statement,transaction:!1,readonly:!1});if(L.changes.changes<0)throw new Error("Error in transaction method execute ");a+=L.changes.changes}}let s=await this.sqlite.commitTransaction({database:this.dbName});a+=s.changes.changes;let b={changes:{changes:a}};return Promise.resolve(b)}catch(s){let b=s.message?s.message:s;return await this.sqlite.rollbackTransaction({database:this.dbName}),Promise.reject(b)}}async reorderRows(t){let r=t;if(t!=null&&t.values&&typeof t.values[0]=="object"&&Object.keys(t.values[0]).includes("ios_columns")){let a=t.values[0].ios_columns,i=[];for(let s=1;s<t.values.length;s++){let b=t.values[s],v={};for(let L of a)v[L]=b[L];i.push(v)}r.values=i}return Promise.resolve(r)}}});var Gt={};Ne(Gt,{CapacitorSQLiteWeb:()=>rt});var rt,zt=ue(()=>{tt();rt=class extends Ae{constructor(){super(...arguments),this.jeepSqliteElement=null,this.isWebStoreOpen=!1}async initWebStore(){await customElements.whenDefined("jeep-sqlite"),this.jeepSqliteElement=document.querySelector("jeep-sqlite"),this.ensureJeepSqliteIsAvailable(),this.jeepSqliteElement.addEventListener("jeepSqliteImportProgress",t=>{this.notifyListeners("sqliteImportProgressEvent",t.detail)}),this.jeepSqliteElement.addEventListener("jeepSqliteExportProgress",t=>{this.notifyListeners("sqliteExportProgressEvent",t.detail)}),this.jeepSqliteElement.addEventListener("jeepSqliteHTTPRequestEnded",t=>{this.notifyListeners("sqliteHTTPRequestEndedEvent",t.detail)}),this.jeepSqliteElement.addEventListener("jeepSqlitePickDatabaseEnded",t=>{this.notifyListeners("sqlitePickDatabaseEndedEvent",t.detail)}),this.jeepSqliteElement.addEventListener("jeepSqliteSaveDatabaseToDisk",t=>{this.notifyListeners("sqliteSaveDatabaseToDiskEvent",t.detail)}),this.isWebStoreOpen||(this.isWebStoreOpen=await this.jeepSqliteElement.isStoreOpen())}async saveToStore(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.saveToStore(t);return}catch(r){throw new Error(`${r}`)}}async getFromLocalDiskToStore(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.getFromLocalDiskToStore(t);return}catch(r){throw new Error(`${r}`)}}async saveToLocalDisk(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.saveToLocalDisk(t);return}catch(r){throw new Error(`${r}`)}}async echo(t){return this.ensureJeepSqliteIsAvailable(),await this.jeepSqliteElement.echo(t)}async createConnection(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.createConnection(t);return}catch(r){throw new Error(`${r}`)}}async open(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.open(t);return}catch(r){throw new Error(`${r}`)}}async closeConnection(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.closeConnection(t);return}catch(r){throw new Error(`${r}`)}}async getVersion(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.getVersion(t)}catch(r){throw new Error(`${r}`)}}async checkConnectionsConsistency(t){this.ensureJeepSqliteIsAvailable();try{return await this.jeepSqliteElement.checkConnectionsConsistency(t)}catch(r){throw new Error(`${r}`)}}async close(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.close(t);return}catch(r){throw new Error(`${r}`)}}async beginTransaction(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.beginTransaction(t)}catch(r){throw new Error(`${r}`)}}async commitTransaction(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.commitTransaction(t)}catch(r){throw new Error(`${r}`)}}async rollbackTransaction(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.rollbackTransaction(t)}catch(r){throw new Error(`${r}`)}}async isTransactionActive(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.isTransactionActive(t)}catch(r){throw new Error(`${r}`)}}async getTableList(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.getTableList(t)}catch(r){throw new Error(`${r}`)}}async execute(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.execute(t)}catch(r){throw new Error(`${r}`)}}async executeSet(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.executeSet(t)}catch(r){throw new Error(`${r}`)}}async run(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.run(t)}catch(r){throw new Error(`${r}`)}}async query(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.query(t)}catch(r){throw new Error(`${r}`)}}async isDBExists(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.isDBExists(t)}catch(r){throw new Error(`${r}`)}}async isDBOpen(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.isDBOpen(t)}catch(r){throw new Error(`${r}`)}}async isDatabase(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.isDatabase(t)}catch(r){throw new Error(`${r}`)}}async isTableExists(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.isTableExists(t)}catch(r){throw new Error(`${r}`)}}async deleteDatabase(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.deleteDatabase(t);return}catch(r){throw new Error(`${r}`)}}async isJsonValid(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.isJsonValid(t)}catch(r){throw new Error(`${r}`)}}async importFromJson(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.importFromJson(t)}catch(r){throw new Error(`${r}`)}}async exportToJson(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.exportToJson(t)}catch(r){throw new Error(`${r}`)}}async createSyncTable(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.createSyncTable(t)}catch(r){throw new Error(`${r}`)}}async setSyncDate(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.setSyncDate(t);return}catch(r){throw new Error(`${r}`)}}async getSyncDate(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.getSyncDate(t)}catch(r){throw new Error(`${r}`)}}async deleteExportedRows(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.deleteExportedRows(t);return}catch(r){throw new Error(`${r}`)}}async addUpgradeStatement(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.addUpgradeStatement(t);return}catch(r){throw new Error(`${r}`)}}async copyFromAssets(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.copyFromAssets(t);return}catch(r){throw new Error(`${r}`)}}async getFromHTTPRequest(t){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{await this.jeepSqliteElement.getFromHTTPRequest(t);return}catch(r){throw new Error(`${r}`)}}async getDatabaseList(){this.ensureJeepSqliteIsAvailable(),this.ensureWebstoreIsOpen();try{return await this.jeepSqliteElement.getDatabaseList()}catch(t){throw new Error(`${t}`)}}ensureJeepSqliteIsAvailable(){if(this.jeepSqliteElement===null)throw new Error("The jeep-sqlite element is not present in the DOM! Please check the @capacitor-community/sqlite documentation for instructions regarding the web platform.")}ensureWebstoreIsOpen(){if(!this.isWebStoreOpen)throw new Error('WebStore is not open yet. You have to call "initWebStore()" first.')}async getUrl(){throw this.unimplemented("Not implemented on web.")}async getMigratableDbList(t){throw console.log("getMigratableDbList",t),this.unimplemented("Not implemented on web.")}async addSQLiteSuffix(t){throw console.log("addSQLiteSuffix",t),this.unimplemented("Not implemented on web.")}async deleteOldDatabases(t){throw console.log("deleteOldDatabases",t),this.unimplemented("Not implemented on web.")}async moveDatabasesAndAddSuffix(t){throw console.log("moveDatabasesAndAddSuffix",t),this.unimplemented("Not implemented on web.")}async isSecretStored(){throw this.unimplemented("Not implemented on web.")}async setEncryptionSecret(t){throw console.log("setEncryptionSecret",t),this.unimplemented("Not implemented on web.")}async changeEncryptionSecret(t){throw console.log("changeEncryptionSecret",t),this.unimplemented("Not implemented on web.")}async clearEncryptionSecret(){throw console.log("clearEncryptionSecret"),this.unimplemented("Not implemented on web.")}async checkEncryptionSecret(t){throw console.log("checkEncryptionPassPhrase",t),this.unimplemented("Not implemented on web.")}async getNCDatabasePath(t){throw console.log("getNCDatabasePath",t),this.unimplemented("Not implemented on web.")}async createNCConnection(t){throw console.log("createNCConnection",t),this.unimplemented("Not implemented on web.")}async closeNCConnection(t){throw console.log("closeNCConnection",t),this.unimplemented("Not implemented on web.")}async isNCDatabase(t){throw console.log("isNCDatabase",t),this.unimplemented("Not implemented on web.")}async isDatabaseEncrypted(t){throw console.log("isDatabaseEncrypted",t),this.unimplemented("Not implemented on web.")}async isInConfigEncryption(){throw this.unimplemented("Not implemented on web.")}async isInConfigBiometricAuth(){throw this.unimplemented("Not implemented on web.")}async loadExtension(t){throw console.log("loadExtension",t),this.unimplemented("Not implemented on web.")}async enableLoadExtension(t){throw console.log("enableLoadExtension",t),this.unimplemented("Not implemented on web.")}}});var Ut,Vt=ue(()=>{tt();Wt();Ut=$e("CapacitorSQLite",{web:()=>Promise.resolve().then(()=>(zt(),Gt)).then(n=>new n.CapacitorSQLiteWeb),electron:()=>window.CapacitorCustomPlatform.plugins.CapacitorSQLite})});var Jt={};Ne(Jt,{getCardById:()=>Cr,getCardIds:()=>Er,getCardsByIds:()=>Lr,getDaten:()=>br,getEnergieById:()=>Rr,getEnergieCardIds:()=>Fr,getEnergies:()=>Br,getEngName:()=>wr,getName:()=>vr,getTrainerById:()=>xr,getTrainerCardIds:()=>Ar,getTrainers:()=>Pr,initDatabase:()=>fr,insertCard:()=>Sr,insertEnergie:()=>Mr,insertTrainer:()=>Ir,updateCardIds:()=>kr,updatePrice:()=>Tr});async function fr(){return D=await yr.createConnection("pokepicker",!1,"no-encryption",1),await D.open(),await D.execute(`
  ...
  `),(await D.query("SELECT COUNT(*) as count FROM pokemon")).values[0].count===0&&await D.execute(`
      ...
      `),D}async function br(){return await D.query("SELECT * FROM pokemon")}async function vr(n){return(await D.query("SELECT name FROM pokemon WHERE dex = ?",[n])).values[0].name}async function wr(n){return(await D.query("SELECT engName FROM pokemon WHERE dex = ?",[n])).values[0].engName}async function Er(n){return(await D.query("SELECT cardIds FROM pokemon WHERE dex = ?",[n])).values[0].cardIds}async function kr(n,t){await D.run("UPDATE pokemon SET cardIds = ? WHERE dex = ?",[t,n])}async function Sr(n){var t,r,a,i,s;try{let b=typeof n.imageSmall=="string"?n.imageSmall:null,v=typeof n.imageLarge=="string"?n.imageLarge:null;return((s=(await D.run(`INSERT INTO cards (cardId, cardName, rarity, setName, imageLow, imageHigh, subTypes, addedAt, avg30)
       VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)`,[n.id,n.name,n.rarity||"",((t=n.set)==null?void 0:t.name)||"",b,v,Array.isArray(n.subtypes)?n.subtypes.join(", "):"",new Date().toISOString(),(i=(a=(r=n.cardmarket)==null?void 0:r.prices)==null?void 0:a.avg30)!=null?i:null])).changes)==null?void 0:s.lastId)||null}catch(b){return console.error("Fehler in insertCard():",b.message||b,(n==null?void 0:n.id)||"unbekannte Karte"),null}}async function Cr(n){var r;return((r=(await D.query("SELECT * FROM cards WHERE id = ?",[n])).values)==null?void 0:r[0])||null}async function Lr(n){let t=n.map(()=>"?").join(",");return(await D.query(`SELECT * FROM cards WHERE id IN (${t})`,n)).values}async function Tr(n,t){try{await D.run("UPDATE cards SET avg30 = ? WHERE cardId = ?",[t,n])}catch(r){console.error(`Fehler beim Speichern von avg30 f\xFCr ${n}:`,r.message)}}async function Pr(){return(await D.query("SELECT * FROM trainer")).values}async function Ir(n){var t,r,a,i,s;try{let b=typeof n.imageSmall=="string"?n.imageSmall:null,v=typeof n.imageLarge=="string"?n.imageLarge:null;return((s=(await D.run(`INSERT INTO trainer (cardId, cardName, rarity, setName, imageLow, imageHigh, subTypes, addedAt, avg30)
       VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)`,[n.id,n.name,n.rarity||"",((t=n.set)==null?void 0:t.name)||"",b,v,Array.isArray(n.subtypes)?n.subtypes.join(", "):"",new Date().toISOString(),(i=(a=(r=n.cardmarket)==null?void 0:r.prices)==null?void 0:a.avg30)!=null?i:null])).changes)==null?void 0:s.lastId)||null}catch(b){return console.error("Fehler in insertTrainer():",b.message||b,(n==null?void 0:n.id)||"unbekannte Karte"),null}}async function xr(n){var r;return((r=(await D.query("SELECT * FROM trainer WHERE id = ?",[n])).values)==null?void 0:r[0])||null}async function Ar(){return(await D.query("SELECT id FROM trainer")).values.map(t=>t.id)}async function Br(){return(await D.query("SELECT * FROM energy")).values}async function Mr(n){var t,r,a,i,s;try{let b=typeof n.imageSmall=="string"?n.imageSmall:null,v=typeof n.imageLarge=="string"?n.imageLarge:null;return((s=(await D.run(`INSERT INTO energy (cardId, cardName, rarity, setName, imageLow, imageHigh, subTypes, addedAt, avg30)
       VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)`,[n.id,n.name,n.rarity||"",((t=n.set)==null?void 0:t.name)||"",b,v,Array.isArray(n.subtypes)?n.subtypes.join(", "):"",new Date().toISOString(),(i=(a=(r=n.cardmarket)==null?void 0:r.prices)==null?void 0:a.avg30)!=null?i:null])).changes)==null?void 0:s.lastId)||null}catch(b){return console.error("Fehler in insertEnergie():",b.message||b,(n==null?void 0:n.id)||"unbekannte Karte"),null}}async function Fr(){return(await D.query("SELECT id FROM energy")).values.map(t=>t.id)}async function Rr(n){var r;return((r=(await D.query("SELECT * FROM energy WHERE id = ?",[n])).values)==null?void 0:r[0])||null}var yr,D,_t=ue(()=>{Vt();yr=new Ke(Ut)});We();var me=It("Http",{web:()=>Promise.resolve().then(()=>(Ze(),Xe)).then(n=>new n.HttpWeb),electron:()=>Promise.resolve().then(()=>(Ze(),Xe)).then(n=>new n.HttpWeb)});var be=Ht(),H;document.addEventListener("DOMContentLoaded",()=>{(async()=>{let n=document.getElementById("cardLoader");n.innerHTML=`
      <p id="loaderText">Lade Karten\u2026</p>
      <div id="progressBarContainer">
        <div id="progressBar"></div>
      </div>
      <div id="progressText">0%</div>
    `,n.classList.remove("hidden"),n.classList.add("shown");let{initDatabase:t,getDaten:r,getName:a,getEngName:i,getCardIds:s,updateCardIds:b,insertCard:v,getCardById:L,getCardsByIds:T,updatePrice:te,getTrainers:A,insertTrainer:B,getTrainerCardIds:re,getTrainerById:Z,getEnergies:ce,insertEnergie:ne,getEnergieCardIds:ke,getEnergieById:Se}=await Promise.resolve().then(()=>(_t(),Jt));H=await t();let he=await r(),pe=document.querySelector("#kartentabelle tbody");window.cachedCards={},window.cachedPokemonCardsByName={},window.cachedTrainerCardsByType={},window.cachedEnergyCardsByType={};let ve=0,Be=he.values.length;for(let o of he.values){let c=document.createElement("tr"),u=parseInt(o.dex),y=`
      ...
      `;c.innerHTML=y,pe.appendChild(c),await O(o.dex),ve++;let l=Math.min(99,Math.round(ve/Be*100)),g=document.getElementById("progressBar"),h=document.getElementById("progressText");g&&(g.style.width=l+"%"),h&&(h.textContent=l+"%")}progressBar.style.width="100%",progressText.textContent="100%",setTimeout(()=>{let o=n.offsetHeight+"px";n.style.height=o,n.offsetHeight,n.style.transition="height 0.5s ease, opacity 0.5s ease",n.style.height="0px",n.style.opacity="0",n.style.overflow="hidden"},100),M(),C(),J(),document.querySelectorAll("#tableToggle button").forEach(o=>o.classList.remove("active")),document.getElementById("showTablePokemon").classList.add("active");function M(){let o=document.querySelectorAll("#kartentabelle tbody tr"),c=0;o.forEach(u=>{u.style.display!=="none"&&c++}),document.getElementById("eintragsAnzahl").textContent=`(${c})`}function C(){let o=0;document.querySelectorAll("#kartentabelle tbody tr").forEach(h=>{if(h.style.display==="none")return;h.querySelectorAll("div[id*='Container'] img").forEach(p=>{window.getComputedStyle(p).display!=="none"&&o++})});let c=document.getElementById("kartenAnzahl");c&&(c.textContent=`(${o})`);let u=0;document.querySelectorAll("#trainertabelle tbody tr").forEach(h=>{if(h.style.display==="none")return;h.querySelectorAll("div[id*='Container'] img").forEach(p=>{window.getComputedStyle(p).display!=="none"&&u++})});let y=document.getElementById("kartenAnzahlTrainer");y&&(y.textContent=`(${u})`);let l=0;document.querySelectorAll("#energietabelle tbody tr").forEach(h=>{if(h.style.display==="none")return;h.querySelectorAll("div[id*='Container'] img").forEach(p=>{window.getComputedStyle(p).display!=="none"&&l++})});let g=document.getElementById("kartenAnzahlEnergie");g&&(g.textContent=`(${l})`)}async function O(o){let c=document.getElementById(`kartenContainer_${o}`),u=await s(o);if(!u)return;let y=u.split(";").filter(h=>h.trim()),l=await T(y.map(h=>parseInt(h)));l.sort((h,f)=>(f.avg30||0)-(h.avg30||0));let g=document.createDocumentFragment();for(let h of l){window.cachedCards[h.cardId]=h;let f=document.createElement("img");f.alt=h.cardId,f.style.width="50px",f.style.height="69px",f.style.objectFit="cover",f.src="cardBackside.png";let p=new Image;p.onload=()=>f.src=h.imageLow,p.onerror=()=>console.warn("Fehler beim Laden von:",h.imageLow),p.src=h.imageLow,f.addEventListener("click",()=>j(o,y.indexOf(String(h.id)))),g.appendChild(f)}c.appendChild(g)}async function j(o,c){let u=document.querySelector("#overlay");u.innerHTML='<div id="overlayContent"><div class="loader"></div></div>',u.classList.remove("hidden"),u.classList.add("shown");let y=await s(o);if(!y)return;let l=y.split(";").filter(f=>f.trim()!=="");if(l.length===0){P();return}let g=c;async function h(){let f=l[g];try{let p=await L(f),m="Unbekannt";if(p.addedAt){let k=new Date(p.addedAt),K={day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"};m=k.toLocaleString("de-DE",K)}let d=p.avg30,w="\u2013";if(d!=null){let k=d.toFixed(2),K="#DEDEDE",I="\u{1FA99}";d>20?(K="#FF4444",I="\u{1F525}"):d>5&&(K="#FFAA00",I="\u{1F4B0}"),w=`<span style="color:${K};">${I} ${k}\u20AC</span>`}else w='<span style="color:#888;">\u{1F578} Kein Preis gespeichert</span>';u.innerHTML=`
          ...
          `,document.getElementById("variantSelect").addEventListener("change",async function(){var _;let k=this.value,K=0,I=0,R=0,$=0;k==="basic"?K=1:k==="reverse"?I=1:k==="holo"?R=1:k==="firstEdition"&&($=1);try{await H.run("UPDATE cards SET basic = ?, reverse = ?, holo = ?, firstEdition = ? WHERE id = ?",[K,I,R,$,f]);let V=(_=window.cachedCards)==null?void 0:_[p.cardId];V&&(V.basic=K,V.reverse=I,V.holo=R,V.firstEdition=$),console.log("Variante aktualisiert und Cache angepasst:",k)}catch(V){console.error("Fehler beim Aktualisieren der Variante:",V),console.error("Fehlerdetails:",JSON.stringify(V)),alert("Fehler beim Speichern der Variante.")}});let E=new Image;E.onload=()=>{document.getElementById("cardImage").src=p.imageHigh},E.onerror=()=>console.warn("Fehler beim Laden des Galerie-Bildes:",p.imageHigh),E.src=p.imageHigh,document.getElementById("deleteCard").addEventListener("click",async()=>{if(confirm("Willst du diese Karte wirklich l\xF6schen?")){let k=l[g];await H.run("DELETE FROM cards WHERE id = ?",[k]),l.splice(g,1),await b(o,l.join(";")+";"),P();let K=document.getElementById(`kartenContainer_${o}`);K.innerHTML="",O(o),C(),J(),Ce()}}),document.getElementById("closeGallery").addEventListener("click",()=>{let k=document.getElementById("overlay");k.classList.add("fade-out"),setTimeout(()=>{k.classList.remove("shown","fade-out"),k.classList.add("hidden"),k.innerHTML=""},300)})}catch(p){console.error("Fehler beim Anzeigen der Karte:",p),P()}}h()}window.filterPokemonCardsByNumber=function(){let o=document.getElementById("nummerSuche").value.trim();document.querySelectorAll(".kartenItem").forEach(c=>{let u=c.dataset.number;c.style.display=u&&u.startsWith(o)?"block":"none"})},window.openOverlay=async function(o){if(!navigator.onLine)return alert("F\xFCr diese Funktion wird eine Internetverbindung ben\xF6tigt!"),null;let c=document.querySelector("#overlay");c.innerHTML=`
        <div id="overlayContent">
          <h2>Bitte warten...</h2>
          <p>Karten werden geladen</p>
          <div class="loader"></div>
        </div>
      `,c.classList.remove("hidden"),c.classList.add("shown");try{let u=await a(o),y=await i(o),l=window.cachedPokemonCardsByName[y];if(l||(l=await N(y),l&&(window.cachedPokemonCardsByName[y]=l)),!l||l.length===0){c.innerHTML=`
            <div id='overlayContent'>
              <h2>Keine Karten gefunden.</h2> 
              <button class="overlayMenuBtn" id="BackBtn">Schlie\xDFen</button>
            </div>
          `,document.getElementById("BackBtn").addEventListener("click",h=>{h.preventDefault(),P()});return}let g=`
          <div id="overlayContent">
        ...
        `;for(let h of l){let f=h.avg30,p="\u2013";if(f!=null){let d=f.toFixed(2),w="#DEDEDE",E="\u{1FA99}";f>20?(w="#FF4444",E="\u{1F525}"):f>5&&(w="#FFAA00",E="\u{1F4B0}"),p=`<span style="color:${w}; font-size:14px;">${E} ${d}\u20AC</span>`}let m=h.id.split("-")[1];g+=`
        ...
        `,c.innerHTML=g,document.getElementById("BackBtn").addEventListener("click",h=>{h.preventDefault(),P()})}catch(u){console.error(u),c.innerHTML=`
        <div id='overlayContent'>
          <h2>Fehler beim Laden.</h2>
          <button class="overlayMenuBtn" id="BackBtn">Schlie\xDFen</button>
        </div>`,document.getElementById("BackBtn").addEventListener("click",y=>{y.preventDefault(),P()})}};function z(o){return o.replace(/-(0*)(\d+)/,(c,u,y)=>"-"+parseInt(y,10))}async function N(o){var c,u;try{let y=`https://api.pokemontcg.io/v2/cards?q=name:"${o}"&orderBy=-set.releaseDate`,l=await me.get({url:y,headers:{Accept:"application/json","X-Api-Key":be.API_KEY,Connection:"close"}});if(l.status!==200)return console.error("Fehler beim Abrufen der Karten:",l.status,l),null;let g=l.data.data;for(let h of g){let f=(c=h.cardmarket)==null?void 0:c.prices;h.avg30=(u=f==null?void 0:f.avg30)!=null?u:null}return g}catch(y){return console.error("Fehler beim Abrufen \xFCber HTTP:",y.message),null}}async function W(o){var c,u,y,l,g;try{let h=`https://api.pokemontcg.io/v2/cards?q=id:${o}`,f=await me.get({url:h,headers:{Accept:"application/json","X-Api-Key":be.API_KEY,Connection:"close"}});if(f.status!==200||!((u=(c=f.data)==null?void 0:c.data)!=null&&u.length))return console.error("Fehler beim Abrufen der Karte:",f.status,f),null;let p=(l=(y=f.data.data[0])==null?void 0:y.cardmarket)==null?void 0:l.prices;return(g=p==null?void 0:p.avg30)!=null?g:null}catch(h){return console.error("Fehler beim Preisabruf:",h.message),null}}window.karteAusw\u00E4hlen=async function(o,c,u){var p,m;let y=document.querySelector("#overlay");y.innerHTML='<div id="overlayContent"><div class="loader"></div></div>',y.classList.remove("hidden"),y.classList.add("shown");let l=await me.get({url:`https://api.pokemontcg.io/v2/cards/${o}`,headers:{Accept:"application/json","X-Api-Key":be.API_KEY,Connection:"close"}});if(l.status!==200){console.error("Fehler beim Abrufen der Karte:",l.status,l);return}let g=l.data.data;g.imageSmall=((p=g.images)==null?void 0:p.small)||null,g.imageLarge=((m=g.images)==null?void 0:m.large)||null;let h=await v(g);if(!h){console.error("Keine ID von insertCard erhalten \u2013 Abbruch.");return}g.id=h,window.cachedCards[g.cardId]=g,y.innerHTML=`
        <div id="overlayContent">
      ...
      `;async function f(d){y.innerHTML='<div id="overlayContent"><div class="loader"></div></div>',y.classList.remove("hidden"),y.classList.add("shown"),d!=="none"&&await H.run(`UPDATE cards SET ${d} = 1 WHERE id = ?`,[h]);let w=await s(c);w||(w=""),w+=h+";",await b(c,w);let E=document.getElementById(`kartenContainer_${c}`);E.innerHTML="",await O(c),P(),M(),C(),J(),Ce()}document.getElementById("btnBasic").addEventListener("click",()=>f("basic")),document.getElementById("btnFirstEdition").addEventListener("click",()=>f("firstEdition")),document.getElementById("btnReverse").addEventListener("click",()=>f("reverse")),document.getElementById("btnHolo").addEventListener("click",()=>f("holo")),document.getElementById("closeOverlayConfirm").addEventListener("click",()=>f("none"))};async function J(){try{let o=await H.query("SELECT avg30 FROM cards WHERE avg30 IS NOT NULL"),c=await H.query("SELECT avg30 FROM trainer WHERE avg30 IS NOT NULL"),u=await H.query("SELECT avg30 FROM energy WHERE avg30 IS NOT NULL"),y=0;for(let d of o.values)y+=d.avg30;for(let d of c.values)y+=d.avg30;for(let d of u.values)y+=d.avg30;let l="\u{1FA99}";y>1e3?l="\u{1F525}":y>500&&(l="\u{1F4B0}"),document.getElementById("gesamtwert").textContent=`\u03A3: ${y.toFixed(2)}\u20AC ${l} | `;let g=await H.query("SELECT COUNT(*) as count FROM cards"),h=await H.query("SELECT COUNT(*) as count FROM trainer"),f=await H.query("SELECT COUNT(*) as count FROM energy"),p=g.values[0].count+h.values[0].count+f.values[0].count,m=document.getElementById("gesamtanzahl");m&&(m.textContent=`${p} Karten`)}catch(o){console.error("Fehler beim Berechnen des Gesamtwerts:",o)}}async function de(){if(!navigator.onLine)return alert("F\xFCr diese Funktion wird eine Internetverbindung ben\xF6tigt!"),null;let o=await H.query("SELECT cardId FROM cards"),c=await H.query("SELECT cardId FROM trainer"),u=await H.query("SELECT cardId FROM energy"),y=0,l=0,g=o.values.length+c.values.length+u.values.length;alert(`Aktualisierung von ${g} Preisen gestartet.`);for(let f of o.values){let p=f.cardId,m=await W(p);if(m==null){let E=z(p);m=await W(E)}m!=null&&(await te(p,m),y++),l++;let d=Math.round(l/g*100),w=document.getElementById("preiseAktualisierenProgress");w&&(w.textContent=d+"%")}for(let f of c.values){let p=f.cardId,m=await W(p);if(m==null){let E=z(p);m=await W(E)}m!=null&&(await H.run("UPDATE trainer SET avg30 = ? WHERE cardId = ?",[m,p]),y++),l++;let d=Math.round(l/g*100),w=document.getElementById("preiseAktualisierenProgress");w&&(w.textContent=d+"%")}for(let f of u.values){let p=f.cardId,m=await W(p);if(m==null){let E=z(p);m=await W(E)}m!=null&&(await H.run("UPDATE energy SET avg30 = ? WHERE cardId = ?",[m,p]),y++),l++;let d=Math.round(l/g*100),w=document.getElementById("preiseAktualisierenProgress");w&&(w.textContent=d+"%")}let h=document.getElementById("preiseAktualisierenProgress");h&&(h.textContent=""),alert(`${y} Preise wurden aktualisiert!`),J()}window.aktualisiereAllePreise=de;function Me(){let o=document.getElementById("search").value.trim().toUpperCase();["kartentabelle","trainertabelle","energietabelle"].forEach(u=>{document.querySelectorAll(`#${u} tbody tr`).forEach(l=>{let g=l.querySelector("td.pokemon a"),h=l.querySelectorAll("div[id*='Container'] img");if(o===""){l.style.display="",h.forEach(p=>p.style.display="inline-block");return}let f=!1;if(u==="kartentabelle"&&g)if(g.textContent.toUpperCase().includes(o))f=!0,h.forEach(m=>m.style.display="inline-block");else{let m=!1;h.forEach(d=>{let E=d.alt.toUpperCase().split("-")[1]||"",k=E.includes(o)||E.startsWith(o);d.style.display=k?"inline-block":"none",k&&(m=!0)}),f=m}if(u!=="kartentabelle"){let p=!1;h.forEach(m=>{let w=m.alt.toUpperCase().split("-")[1]||"",E=w.includes(o)||w.startsWith(o);m.style.display=E?"inline-block":"none",E&&(p=!0)}),f=p}l.style.display=f?"":"none"})}),M(),C(),J()}window.searchTable=Me,document.getElementById("search").addEventListener("input",function(){let o=document.getElementById("clearSearch");o.style.display=this.value.trim()?"inline":"none"}),document.getElementById("clearSearch").addEventListener("click",function(){let o=document.getElementById("search");o.value="",this.style.display="none",Me()});let S={reverse:"neutral",holo:"neutral",v:"neutral",vmax:"neutral",ex:"neutral",shiny:"neutral",firstEdition:"neutral",illustration:"neutral"};function Ce(){["kartentabelle","trainertabelle","energietabelle"].forEach(c=>{document.querySelectorAll(`#${c} tbody tr`).forEach(y=>{var f,p,m,d,w,E,k,K,I,R,$,_,V,ye,G,nt,at,it,ot,st,lt,ct,dt,ut,mt,ht;let l=y.querySelector("div[id*='Container']");if(!l)return;let g=l.querySelectorAll("img");if(c==="kartentabelle"){let ie=!1;if(g.length>0){for(let F of g){let fe=F.alt,x=(f=window.cachedCards)==null?void 0:f[fe];if(!x)continue;if(S.reverse==="negative"&&x.reverse==1){ie=!0;break}if(S.holo==="negative"&&x.holo==1){ie=!0;break}if(S.firstEdition==="negative"&&x.firstEdition==1){ie=!0;break}let Y=((p=x.subTypes)==null?void 0:p.toLowerCase().includes("radiant"))||((m=x.rarity)==null?void 0:m.toLowerCase().includes("shiny"));if(S.shiny==="negative"&&Y){ie=!0;break}let Te=((d=x.rarity)==null?void 0:d.toLowerCase().includes("illustration"))||((w=x.rarity)==null?void 0:w.toLowerCase().includes("trainer gallery"));if(S.illustration==="negative"&&Te){ie=!0;break}let we=((E=x.subTypes)==null?void 0:E.toLowerCase().includes("v"))||((k=x.cardName)==null?void 0:k.toLowerCase().includes(" v"));if(S.v==="negative"&&we){ie=!0;break}let X=((K=x.subTypes)==null?void 0:K.toLowerCase().includes("vmax"))||((I=x.cardName)==null?void 0:I.toLowerCase().includes(" vmax")),ee=((R=x.subTypes)==null?void 0:R.toLowerCase().includes("vstar"))||(($=x.cardName)==null?void 0:$.toLowerCase().includes(" vstar"));if(S.vmax==="negative"&&(X||ee)){ie=!0;break}let Pe=((_=x.subTypes)==null?void 0:_.toLowerCase().includes("ex"))||((V=x.cardName)==null?void 0:V.toLowerCase().includes(" ex"));if(S.ex==="negative"&&Pe){ie=!0;break}}for(let F of g){let fe=F.alt,x=(ye=window.cachedCards)==null?void 0:ye[fe];if(!x){F.style.display="none";continue}let Y={reverse:S.reverse==="positive",holo:S.holo==="positive",firstEdition:S.firstEdition==="positive",shiny:S.shiny==="positive",v:S.v==="positive",vmax:S.vmax==="positive",ex:S.ex==="positive",illustration:S.illustration==="positive"},Te=Object.values(Y).some(X=>X),we=!0;if(Te){let X=[];if(Y.reverse&&X.push(x.reverse==1),Y.holo&&X.push(x.holo==1),Y.firstEdition&&X.push(x.firstEdition==1),Y.shiny){let ee=((G=x.subTypes)==null?void 0:G.toLowerCase().includes("radiant"))||((nt=x.rarity)==null?void 0:nt.toLowerCase().includes("shiny"));X.push(ee)}if(Y.illustration){let ee=((at=x.rarity)==null?void 0:at.toLowerCase().includes("illustration"))||((it=x.rarity)==null?void 0:it.toLowerCase().includes("trainer gallery"));X.push(ee)}if(Y.v){let ee=((ot=x.subTypes)==null?void 0:ot.toLowerCase().includes("v"))||((st=x.cardName)==null?void 0:st.toLowerCase().includes(" v"));X.push(ee)}if(Y.vmax){let ee=((lt=x.subTypes)==null?void 0:lt.toLowerCase().includes("vmax"))||((ct=x.cardName)==null?void 0:ct.toLowerCase().includes(" vmax")),Pe=((dt=x.subTypes)==null?void 0:dt.toLowerCase().includes("vstar"))||((ut=x.cardName)==null?void 0:ut.toLowerCase().includes(" vstar"));X.push(ee||Pe)}if(Y.ex){let ee=((mt=x.subTypes)==null?void 0:mt.toLowerCase().includes("ex"))||((ht=x.cardName)==null?void 0:ht.toLowerCase().includes(" ex"));X.push(ee)}we=X.some(Boolean)}F.style.display=we?"inline-block":"none"}let q=Object.values(S).every(F=>F==="neutral"||F==="negative");if(ie)y.style.display="none";else if(g.length===0)y.style.display=q?"":"none";else{let F=[...g].filter(fe=>fe.style.display!=="none");y.style.display=F.length>0?"":"none"}return}let je=Object.values(S).every(q=>q==="neutral"||q==="negative");y.style.display=je?"":"none";return}let h=0;g.forEach(ie=>{var we,X,ee,Pe,pt,gt,yt,ft,bt,vt,wt,Et,kt,St,Ct,Lt,Tt;let je=ie.alt,q=(we=window.cachedCards)==null?void 0:we[je];if(!q){ie.style.display="none";return}let F=!0;S.reverse==="negative"&&q.reverse==1&&(F=!1),S.holo==="negative"&&q.holo==1&&(F=!1),S.firstEdition==="negative"&&q.firstEdition==1&&(F=!1),S.v==="negative"&&((X=q.subTypes)!=null&&X.toLowerCase().includes("v")||(ee=q.cardName)!=null&&ee.toLowerCase().includes(" v"))&&(F=!1);let fe=((Pe=q.subTypes)==null?void 0:Pe.toLowerCase().includes("vmax"))||((pt=q.cardName)==null?void 0:pt.toLowerCase().includes(" vmax")),x=((gt=q.subTypes)==null?void 0:gt.toLowerCase().includes("vstar"))||((yt=q.cardName)==null?void 0:yt.toLowerCase().includes(" vstar"));S.vmax==="negative"&&(fe||x)&&(F=!1),S.ex==="negative"&&((ft=q.subTypes)!=null&&ft.toLowerCase().includes("ex")||(bt=q.cardName)!=null&&bt.toLowerCase().includes(" ex"))&&(F=!1);let Y=((vt=q.subTypes)==null?void 0:vt.toLowerCase().includes("radiant"))||((wt=q.rarity)==null?void 0:wt.toLowerCase().includes("shiny"));S.shiny==="negative"&&Y&&(F=!1);let Te=((Et=q.rarity)==null?void 0:Et.toLowerCase().includes("illustration"))||((kt=q.rarity)==null?void 0:kt.toLowerCase().includes("trainer gallery"));S.illustration==="negative"&&Te&&(F=!1),S.reverse==="positive"&&q.reverse!=1&&(F=!1),S.holo==="positive"&&q.holo!=1&&(F=!1),S.firstEdition==="positive"&&q.firstEdition!=1&&(F=!1),S.v==="positive"&&!((St=q.subTypes)!=null&&St.toLowerCase().includes("v")||(Ct=q.cardName)!=null&&Ct.toLowerCase().includes(" v"))&&(F=!1),S.vmax==="positive"&&!(fe||x)&&(F=!1),S.ex==="positive"&&!((Lt=q.subTypes)!=null&&Lt.toLowerCase().includes("ex")||(Tt=q.cardName)!=null&&Tt.toLowerCase().includes(" ex"))&&(F=!1),S.shiny==="positive"&&!Y&&(F=!1),S.illustration==="positive"&&!Te&&(F=!1),ie.style.display=F?"inline-block":"none",F&&h++}),y.style.display=h>0?"":"none"})}),M(),C(),J()}function oe(o){S[o]==="neutral"?S[o]="positive":S[o]==="positive"?S[o]="negative":S[o]="neutral",Ce(),U()}function U(){let o=["reverse","holo","firstEdition","v","vmax","ex","shiny","illustration"];for(let c of o){let u=document.getElementById(`filter-${c}`);u&&(u.classList.remove("active-positive","active-negative"),S[c]==="positive"?u.classList.add("active-positive"):S[c]==="negative"&&u.classList.add("active-negative"))}}document.getElementById("filter-alle").addEventListener("click",o=>{o.preventDefault(),S.reverse="neutral",S.holo="neutral",S.firstEdition="neutral",S.v="neutral",S.vmax="neutral",S.ex="neutral",S.shiny="neutral",S.illustration="neutral",Ce(),U()}),document.getElementById("filter-reverse").addEventListener("click",o=>{o.preventDefault(),oe("reverse")}),document.getElementById("filter-holo").addEventListener("click",o=>{o.preventDefault(),oe("holo")}),document.getElementById("filter-firstEdition").addEventListener("click",o=>{o.preventDefault(),oe("firstEdition")}),document.getElementById("filter-v").addEventListener("click",o=>{o.preventDefault(),oe("v")}),document.getElementById("filter-vmax").addEventListener("click",o=>{o.preventDefault(),oe("vmax")}),document.getElementById("filter-ex").addEventListener("click",o=>{o.preventDefault(),oe("ex")}),document.getElementById("filter-shiny").addEventListener("click",o=>{o.preventDefault(),oe("shiny")}),document.getElementById("filter-illustration").addEventListener("click",o=>{o.preventDefault(),oe("illustration")});function P(){let o=document.getElementById("overlay");o.classList.add("fade-out"),setTimeout(()=>{o.classList.remove("shown","fade-out"),o.classList.add("hidden"),o.innerHTML=""},300)}function Q(o){["kartentabelle","trainertabelle","energietabelle"].forEach(u=>{let y=document.getElementById(u);y&&(u===o?y.classList.remove("hidden"):y.classList.add("hidden"))})}window.zeigePokemonTabelle=function(){document.querySelectorAll("#tableToggle button").forEach(o=>o.classList.remove("active")),document.getElementById("showTablePokemon").classList.add("active"),Q("kartentabelle")},window.zeigeTrainerTabelle=async function(){document.querySelectorAll("#tableToggle button").forEach(g=>g.classList.remove("active")),document.getElementById("showTableTrainer").classList.add("active"),Q("trainertabelle");let o=document.querySelector("#trainertabelle tbody");o.innerHTML="";let c=document.createElement("tr");c.innerHTML=`
      ...
      `,o.appendChild(l),await se(),C()};async function se(){let o=document.getElementById("supporterContainer"),c=document.getElementById("itemContainer"),u=document.getElementById("stadiumContainer"),y=document.getElementById("toolContainer"),l=await A();if(!l||!Array.isArray(l)){console.error("getTrainers() lieferte keine g\xFCltige Liste:",l);return}l.sort((m,d)=>(d.avg30||0)-(m.avg30||0));let g=document.createDocumentFragment(),h=document.createDocumentFragment(),f=document.createDocumentFragment(),p=document.createDocumentFragment();for(let m of l){window.cachedCards[m.cardId]=m;let d=document.createElement("img");d.alt=m.cardId,d.style.width="50px",d.style.height="69px",d.style.objectFit="cover",d.src="cardBackside.png";let w=new Image;w.onload=()=>d.src=m.imageLow,w.onerror=()=>console.warn("Fehler beim Laden von:",m.imageLow),w.src=m.imageLow;let E="";if(Array.isArray(m.subTypes))m.subTypes.some(k=>k.toLowerCase().includes("supporter"))?E="supporter":m.subTypes.some(k=>k.toLowerCase().includes("item"))?E="item":m.subTypes.some(k=>k.toLowerCase().includes("stadium"))?E="stadium":m.subTypes.some(k=>k.toLowerCase().includes("tool"))&&(E="tool");else if(typeof m.subTypes=="string"){let k=m.subTypes.toLowerCase();k.includes("supporter")?E="supporter":k.includes("item")?E="item":k.includes("stadium")?E="stadium":k.includes("tool")&&(E="tool")}d.addEventListener("click",()=>ae(m.id,E)),E=="supporter"&&g.appendChild(d),E=="item"&&h.appendChild(d),E=="stadium"&&f.appendChild(d),E=="tool"&&p.appendChild(d)}o.appendChild(g),c.appendChild(h),u.appendChild(f),y.appendChild(p)}window.openTrainerOverlay=async function(o){if(!navigator.onLine)return alert("F\xFCr diese Funktion wird eine Internetverbindung ben\xF6tigt!"),null;let c=document.querySelector("#overlay");c.innerHTML=`
        <div id="overlayContent">
          <h2>Bitte warten...</h2>
          <p>Karten werden geladen</p>
          <div class="loader"></div>
      ...
      `,c.classList.remove("hidden"),c.classList.add("shown");try{let u=window.cachedTrainerCardsByType[o];if(u||(u=await le(o),u&&(window.cachedTrainerCardsByType[o]=u)),!u||u.length===0){c.innerHTML=`
          ...
          `,document.getElementById("BackBtn").addEventListener("click",()=>{e.preventDefault(),P()});return}let y=`
          <div id="overlayContent">
            <button class="closeGallery" id="BackBtn">X</button>
            ...
            <div class="kartenGrid">
        `;for(let l of u){let g=l.avg30,h="\u2013";if(g!=null){let p=g.toFixed(2),m="#DEDEDE",d="\u{1FA99}";g>20?(m="#FF4444",d="\u{1F525}"):g>5&&(m="#FFAA00",d="\u{1F4B0}"),h=`<span style="color:${m}; font-size:14px;">${d} ${p}\u20AC</span>`}let f=l.id.split("-")[1];y+=`
        ...
        `,c.innerHTML=y,document.getElementById("BackBtn").addEventListener("click",()=>{P()})}catch(u){console.error(u),c.innerHTML=`
          <div id='overlayContent'>
            <h2>Fehler beim Laden.</h2>
            <button class="overlayMenuBtn" id="BackBtn">Schlie\xDFen</button>
          </div>`,document.getElementById("BackBtn").addEventListener("click",()=>{P()})}};async function le(o){var g,h,f,p;let c=[],u=1,y=250,l=!0;for(;l;){let m=`https://api.pokemontcg.io/v2/cards?q=supertype:Trainer subtypes:${o}&orderBy=name&page=${u}&pageSize=${y}`,d=await me.get({url:m,headers:{Accept:"application/json","X-Api-Key":be.API_KEY,Connection:"close"}});if(d.status!==200||!((h=(g=d.data)==null?void 0:g.data)!=null&&h.length)){l=!1;break}let w=d.data.data;for(let E of w){let k=(f=E.cardmarket)==null?void 0:f.prices;E.avg30=(p=k==null?void 0:k.avg30)!=null?p:null}c=c.concat(w),w.length<y?l=!1:u++}return c}window.trainerKarteAusw\u00E4hlen=async function(o){var u,y;let c=document.querySelector("#overlay");c.innerHTML='<div id="overlayContent"><div class="loader"></div></div>',c.classList.remove("hidden"),c.classList.add("shown");try{let l=await me.get({url:`https://api.pokemontcg.io/v2/cards/${o}`,headers:{Accept:"application/json","X-Api-Key":be.API_KEY,Connection:"close"}});if(l.status!==200){console.error("Fehler beim Abrufen der Karte:",l.status,l);return}let g=l.data.data;g.imageSmall=((u=g.images)==null?void 0:u.small)||null,g.imageLarge=((y=g.images)==null?void 0:y.large)||null;let h=await B(g);if(!h){console.error("Keine ID von insertCard erhalten \u2013 Abbruch.");return}g.id=h,window.cachedCards[g.cardId]=g,c.innerHTML=`
          <div id="overlayContent">
            <h2>Karte hinzugef\xFCgt!</h2>
        ...
        `;async function f(p,m){c.innerHTML='<div id="overlayContent"><div class="loader"></div></div>',c.classList.remove("hidden"),c.classList.add("shown");try{p!=="none"&&await H.run(`UPDATE trainer SET ${p} = 1 WHERE id = ?`,[m]);let d=document.getElementById("supporterContainer");d.innerHTML="";let w=document.getElementById("itemContainer");w.innerHTML="";let E=document.getElementById("stadiumContainer");E.innerHTML="";let k=document.getElementById("toolContainer");k.innerHTML="",await se()}catch(d){console.error("Fehler in finalizeTrainerSelection:",d.message,d)}P(),await J()}document.getElementById("btnBasic").addEventListener("click",()=>f("basic",h)),document.getElementById("btnFirstEdition").addEventListener("click",()=>f("firstEdition",h)),document.getElementById("btnReverse").addEventListener("click",()=>f("reverse",h)),document.getElementById("btnHolo").addEventListener("click",()=>f("holo",h)),document.getElementById("closeOverlayConfirm").addEventListener("click",()=>f("none",h))}catch(l){console.error("Fehler bei trainerKarteAusw\xE4hlen:",l),c.innerHTML=`
          <div id="overlayContent">
            <h2>Fehler beim Hinzuf\xFCgen.</h2>
            <p>${l.message}</p>
            <button class="overlayMenuBtn" id="closeOverlayConfirm">Schlie\xDFen</button>
          </div>
        `,document.getElementById("closeOverlayConfirm").addEventListener("click",()=>{P()})}};async function ae(o,c){var p;let u=document.querySelector("#overlay");u.innerHTML='<div id="overlayContent"><div class="loader"></div></div>',u.classList.remove("hidden"),u.classList.add("shown");let y=await re();if(!y||!y.length)return;let l=[],g={};for(let m of y){let d=await Z(m);if(!d)continue;let w=((p=d.subTypes)==null?void 0:p.toLowerCase())||"";(c==="supporter"&&w.includes("supporter")||c==="item"&&w.includes("item")||c==="stadium"&&w.includes("stadium")||c==="tool"&&w.includes("tool"))&&(l.push(m),g[m]=d)}if(!l.length){P();return}let h=l.findIndex(m=>m===o);h===-1&&(h=0);async function f(){let m=l[h],d=g[m]||await Z(m);if(!d)return;let w="Unbekannt";d.addedAt&&(w=new Date(d.addedAt).toLocaleString("de-DE",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"}));let E=d.avg30,k="\u2013";if(E!=null){let I=E.toFixed(2),R="#DEDEDE",$="\u{1FA99}";E>20?(R="#FF4444",$="\u{1F525}"):E>5&&(R="#FFAA00",$="\u{1F4B0}"),k=`<span style="color:${R};">${$} ${I}\u20AC</span>`}else k='<span style="color:#888;">\u{1F578} Kein Preis gespeichert</span>';u.innerHTML=`
          <div id="overlayContent">
            <button class="closeGallery" id="closeGallery">X</button>
            <h2>Trainer</h2>
            <div style="display:flex; align-items:center; justify-content:center;">
      ...
      `,o.appendChild(u),await ge(),C()};async function ge(){var g,h,f;let o=document.getElementById("basisEnergieContainer"),c=document.getElementById("spezialEnergieContainer"),u=await ce();if(!u||!Array.isArray(u)){console.error("getEnergies() lieferte keine g\xFCltige Liste:",u);return}u.sort((p,m)=>(m.avg30||0)-(p.avg30||0));let y=document.createDocumentFragment(),l=document.createDocumentFragment();for(let p of u){window.cachedCards[p.cardId]=p;let m=document.createElement("img");m.alt=p.cardId,m.style.width="50px",m.style.height="69px",m.style.objectFit="cover";let d=((g=p.subTypes)==null?void 0:g.toLowerCase())||"";m.addEventListener("click",()=>Xt(p.id,d.includes("basic")?"basic":"special")),m.src="cardBackside.png";let w=new Image;w.onload=()=>m.src=p.imageLow,w.onerror=()=>console.warn("Fehler beim Laden von:",p.imageLow),w.src=p.imageLow,(h=p.subTypes)!=null&&h.toLowerCase().includes("basic")?y.appendChild(m):(f=p.subTypes)!=null&&f.toLowerCase().includes("special")&&l.appendChild(m)}o.appendChild(y),c.appendChild(l)}window.openEnergieOverlay=async function(o){if(!navigator.onLine)return alert("F\xFCr diese Funktion wird eine Internetverbindung ben\xF6tigt!"),null;let c=document.querySelector("#overlay");c.innerHTML=`
        <div id="overlayContent">
          <h2>Bitte warten...</h2>
          <p>Karten werden geladen</p>
          <div class="loader"></div>
      ...
      `,c.classList.remove("hidden"),c.classList.add("shown");try{let u=window.cachedEnergyCardsByType[o];if(u||(u=await Le(o),u&&(window.cachedEnergyCardsByType[o]=u)),!u||u.length===0){c.innerHTML=`
          ...
          `,document.getElementById("BackBtn").addEventListener("click",()=>{P()});return}let y=`
          <div id="overlayContent">
            <button class="closeGallery" id="BackBtn">X</button>
            <h2>Kartenauswahl f\xFCr<br><strong>${o}</strong>:</h2>
            <p>
        ...
        `,c.innerHTML=y,document.getElementById("BackBtn").addEventListener("click",()=>{P()})}catch(u){console.error(u),c.innerHTML=`
          <div id='overlayContent'>
            <h2>Fehler beim Laden.</h2>
            <button class="overlayMenuBtn" id="BackBtn">Schlie\xDFen</button>
          </div>`,document.getElementById("BackBtn").addEventListener("click",()=>{P()})}};async function Le(o){var g,h,f,p;let c=[],u=1,y=250,l=!0;for(;l;){let m=`https://api.pokemontcg.io/v2/cards?q=supertype:Energy subtypes:${o}&orderBy=name&page=${u}&pageSize=${y}`,d=await me.get({url:m,headers:{Accept:"application/json","X-Api-Key":be.API_KEY,Connection:"close"}});if(d.status!==200||!((h=(g=d.data)==null?void 0:g.data)!=null&&h.length)){l=!1;break}let w=d.data.data;for(let E of w){let k=(f=E.cardmarket)==null?void 0:f.prices;E.avg30=(p=k==null?void 0:k.avg30)!=null?p:null}c=c.concat(w),w.length<y?l=!1:u++}return c}window.energieKarteAusw\u00E4hlen=async function(o){var u,y;let c=document.querySelector("#overlay");c.innerHTML='<div id="overlayContent"><div class="loader"></div></div>',c.classList.remove("hidden"),c.classList.add("shown");try{let l=await me.get({url:`https://api.pokemontcg.io/v2/cards/${o}`,headers:{Accept:"application/json","X-Api-Key":be.API_KEY,Connection:"close"}});if(l.status!==200){console.error("Fehler beim Abrufen der Karte:",l.status,l);return}let g=l.data.data;g.imageSmall=((u=g.images)==null?void 0:u.small)||null,g.imageLarge=((y=g.images)==null?void 0:y.large)||null;let h=await ne(g);if(!h){console.error("Keine ID von insertCard erhalten \u2013 Abbruch.");return}g.id=h,window.cachedCards[g.cardId]=g,c.innerHTML=`
          <div id="overlayContent">
            <h2>Karte hinzugef\xFCgt!</h2>
            <p>Du hast <strong>${o}</strong> ausgew\xE4hlt.</p>
            <br>
        ...
        `;async function f(p,m){c.innerHTML='<div id="overlayContent"><div class="loader"></div></div>',c.classList.remove("hidden"),c.classList.add("shown");try{p!=="none"&&await H.run(`UPDATE energy SET ${p} = 1 WHERE id = ?`,[m]);let d=document.getElementById("basisEnergieContainer");d.innerHTML="";let w=document.getElementById("spezialEnergieContainer");w.innerHTML="",await ge()}catch(d){console.error("Fehler in finalizeEnergieSelection:",d.message,d)}P(),await J()}document.getElementById("btnBasic").addEventListener("click",()=>f("basic",h)),document.getElementById("btnFirstEdition").addEventListener("click",()=>f("firstEdition",h)),document.getElementById("btnReverse").addEventListener("click",()=>f("reverse",h)),document.getElementById("btnHolo").addEventListener("click",()=>f("holo",h)),document.getElementById("closeOverlayConfirm").addEventListener("click",()=>f("none",h))}catch(l){console.error("Fehler bei energieKarteAusw\xE4hlen:",l),c.innerHTML=`
          <div id="overlayContent">
            <h2>Fehler beim Hinzuf\xFCgen.</h2>
            <p>${l.message}</p>
            <button class="overlayMenuBtn" id="closeOverlayConfirm">Schlie\xDFen</button>
          </div>
        `,document.getElementById("closeOverlayConfirm").addEventListener("click",()=>{P()})}};async function Xt(o,c){var p;let u=document.querySelector("#overlay");u.innerHTML='<div id="overlayContent"><div class="loader"></div></div>',u.classList.remove("hidden"),u.classList.add("shown");let y=await ke();if(!y||!y.length)return;let l=[],g={};for(let m of y){let d=await Se(m);if(!d)continue;let w=((p=d.subTypes)==null?void 0:p.toLowerCase())||"";(c==="basic"&&w.includes("basic")||c==="special"&&w.includes("special"))&&(l.push(m),g[m]=d)}if(!l.length){P();return}let h=l.findIndex(m=>m===o);h===-1&&(h=0);async function f(){let m=l[h],d=g[m]||await Se(m);if(!d)return;let w="Unbekannt";d.addedAt&&(w=new Date(d.addedAt).toLocaleString("de-DE",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"}));let E=d.avg30,k="\u2013";if(E!=null){let I=E.toFixed(2),R="#DEDEDE",$="\u{1FA99}";E>20?(R="#FF4444",$="\u{1F525}"):E>5&&(R="#FFAA00",$="\u{1F4B0}"),k=`<span style="color:${R};">${$} ${I}\u20AC</span>`}else k='<span style="color:#888;">\u{1F578} Kein Preis gespeichert</span>';u.innerHTML=`
          <div id="overlayContent">
            <button class="closeGallery" id="closeGallery">X</button>
            <h2>Energie</h2>
            <div style="display:flex; align-items:center; justify-content:center;">
        ...
        `,document.getElementById("variantSelect").addEventListener("change",async function(){var ye;let I=this.value,R=0,$=0,_=0,V=0;I==="basic"?R=1:I==="reverse"?$=1:I==="holo"?_=1:I==="firstEdition"&&(V=1);try{await H.run("UPDATE energy SET basic = ?, reverse = ?, holo = ?, firstEdition = ? WHERE id = ?",[R,$,_,V,m]);let G=(ye=window.cachedCards)==null?void 0:ye[d.cardId];G&&(G.basic=R,G.reverse=$,G.holo=_,G.firstEdition=V),console.log("Variante aktualisiert und Cache angepasst:",I)}catch(G){console.error("Fehler beim Aktualisieren der Variante:",G),console.error("Fehlerdetails:",JSON.stringify(G)),alert("Fehler beim Speichern der Variante.")}});let K=new Image;K.onload=()=>{document.getElementById("cardImage").src=d.imageHigh},K.onerror=()=>console.warn("Fehler beim Laden des Galerie-Bildes:",d.imageHigh),K.src=d.imageHigh,document.getElementById("deleteEnergie").addEventListener("click",async()=>{if(confirm("Willst du diese Karte wirklich l\xF6schen?"))try{await H.run("DELETE FROM energy WHERE id = ?",[m]),P();let I=document.getElementById("basisEnergieContainer"),R=document.getElementById("spezialEnergieContainer");I&&(I.innerHTML=""),R&&(R.innerHTML=""),await ge(),await J()}catch(I){console.error("Fehler beim L\xF6schen der Energie-Karte:",I),alert("Beim L\xF6schen ist ein Fehler aufgetreten.")}}),document.getElementById("closeGallery").addEventListener("click",()=>{P()})}f()}window.filterEnergieCardsByNumber=function(){let o=document.getElementById("nummerSuche").value.trim();document.querySelectorAll(".kartenItem").forEach(c=>{let u=c.dataset.number;c.style.display=u&&u.startsWith(o)?"block":"none"})}})()});})();
