...
function save(inputToSave, buttonToHide, checkmarkToShow) {

  console.log("Ausgelesener Wert: " + inputToSave.value);

  var zielArray = inputToSave.name.split("_");
  var kartenArt = zielArray[0];
  var dexNr = zielArray[1];

  console.log("Kartenart: " + kartenArt);
  console.log("Pokédex-Nummer: " + dexNr);

  buttonToHide.style.display = "none";

  checkmarkToShow.style.display = "inline";
  setTimeout( ()=>{
    document.querySelector("#" + checkmarkToShow.id).style.display = 'none'
    }, 3000)
